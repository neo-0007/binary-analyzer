...
undefined1 * FUN_00755f20(undefined1 (*param_1) [32],undefined8 param_2,ulong param_3)
...
LAB_00755f80:
    ...
    if (param_3 <= 0x1000 - (uVar6 & 0xfff)) goto LAB_00755f80;
    if (uVar4 != 0) {
      uVar6 = 0;
      for (; (uVar4 & 1) == 0; uVar4 = uVar4 >> 1 | 0x80000000) {
        uVar6 = uVar6 + 1;
  ...
  if (uVar9 <= param_3 && uVar7 != 0) {
    ...
    if (bVar10 || uVar7 == 0) {
      ...
      uVar8 = uVar8 + 0x80;
      if (uVar6 != 0) goto LAB_00756100;
      uVar6 = (int)uVar7 + 0x40;
      if (uVar6 != 0 && SCARRY4((int)uVar7,0x40) == (int)uVar6 < 0) goto LAB_007561a0;
      goto LAB_007560dc;
    }
