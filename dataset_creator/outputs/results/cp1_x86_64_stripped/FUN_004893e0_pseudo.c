...
undefined8 FUN_004893e0(undefined8 param_1,long param_2,long param_3,ulong param_4)

{
  ...
  if (0x3fffffffffffffff < param_4) {
    ...
    do {
      ...
      FUN_00488e20(param_1,lVar3,lVar1,0x4000000000000000);
  ...
  if (param_4 != 0) {
    FUN_00488e20(param_1,local_40,param_3,param_4);
  }
  return 1;
}
