...
undefined4 * FUN_006bb140(long param_1)

{
  ...
  cVar7 = *pcVar15;
  if (cVar7 == 'L') {
    puVar9 = (undefined4 *)FUN_006bac40();
    return puVar9;
  }
  if (cVar7 == 'T') {
    puVar9 = (undefined4 *)FUN_006b93b0();
    return puVar9;
  }
  if (cVar7 == 's') {
    if (pcVar15[1] == 'r') {
...
LAB_006bb648:
        FUN_006b9850(param_1);
      }
      else {
        if ((char)bVar1 < ':') {
          if ((char)bVar1 < '0') goto LAB_006bb648;
        }
        else if ((0x37 < (byte)(bVar1 - 0x43)) ||
                ((0xffffffc0040201U >> ((ulong)(bVar1 - 0x43) & 0x3f) & 1) == 0)) goto LAB_006bb648;
        *(undefined4 *)(param_1 + 0x54) = 0xffffffff;
        FUN_006baf90(param_1,0);
        if (**(char **)(param_1 + 0x18) == 'E') {
          *(char **)(param_1 + 0x18) = *(char **)(param_1 + 0x18) + 1;
        }
      }
      uVar11 = FUN_006ba730(param_1);
      if (**(char **)(param_1 + 0x18) == 'I') {
        *(char **)(param_1 + 0x18) = *(char **)(param_1 + 0x18) + 1;
        uVar13 = FUN_006baeb0(param_1);
        FUN_006b8b90(param_1,4,uVar11,uVar13);
      }
      goto LAB_006bb36e;
    }
    if (pcVar15[1] == 'p') {
...
LAB_006bb17a:
      puVar9 = (undefined4 *)FUN_006ba730(param_1);
    ...
    if (cVar7 == 'o') {
      ...
      if (((cVar7 == 'i') || (cVar7 == 't')) && (pcVar15[1] == 'l')) {
        ...
        *(char **)(param_1 + 0x18) = pcVar15;
        ...
        FUN_006bb960(param_1,0x45);
        goto LAB_006bb36e;
      }
      if (cVar7 == 'u') {
        *(char **)(param_1 + 0x18) = pcVar15 + 1;
        FUN_006b9510(param_1);
        FUN_006baeb0(param_1);
        goto LAB_006bb36e;
      }
    }
  }
  puVar10 = (uint *)FUN_006ba590(param_1);
  if (puVar10 == (uint *)0x0) {
    return (undefined4 *)0x0;
  }
  uVar4 = *puVar10;
  if (uVar4 != 0x32) {
    if (uVar4 == 0x34) {
      ...
      if (uVar4 == 0) goto LAB_006bb36e;
      if (uVar4 != 1) {
        return (undefined4 *)0x0;
      }
    }
    FUN_006bb140(param_1);
    goto LAB_006bb36e;
  }
  ...
  *(int *)(param_1 + 0x48) = *(int *)(param_1 + 0x48) + *(int *)(puVar5 + 2) + -2;
  ...
  if (iVar8 == 1) {
    ...
    if (((cVar7 == 's') && (pcVar15[1] == 'P')) && (pcVar15[2] == '\0')) {
      uVar11 = FUN_006baeb0(param_1);
    }
    else {
      uVar11 = FUN_006bb140(param_1);
    }
    if (bVar6) {
      FUN_006b8b90(param_1,0x39,uVar11);
    }
    goto LAB_006bb36e;
  }
  if (iVar8 < 2) {
  ...
  if (iVar8 == 2) {
    if ((((char *)**(undefined8 **)(puVar10 + 4))[1] == 'c') &&
       ((cVar2 = *(char *)**(undefined8 **)(puVar10 + 4), (byte)(cVar2 + 0x9dU) < 2 ||
        ((byte)(cVar2 + 0x8eU) < 2)))) {
      uVar11 = FUN_006b9850(param_1);
    }
    else if (*pcVar15 == 'f') {
      uVar11 = FUN_006ba590(param_1);
    }
    ...
    if (((cVar7 == 'c') && (pcVar15[1] == 'l')) && (pcVar15[2] == '\0')) {
      uVar13 = FUN_006bb960(param_1,0x45);
    }
    else {
      if ((((cVar7 == 'd') && (pcVar15[1] == 't')) && (pcVar15[2] == '\0')) ||
        ...
        pcVar15 = *(char **)(param_1 + 0x18);
        if (*pcVar15 == 'g') {
          if (pcVar15[1] != 's') goto LAB_006bb80c;
        }
        else if ((*pcVar15 != 's') || (pcVar15[1] != 'r')) {
LAB_006bb80c:
          uVar13 = FUN_006ba730(param_1);
          if (**(char **)(param_1 + 0x18) == 'I') {
            *(char **)(param_1 + 0x18) = *(char **)(param_1 + 0x18) + 1;
            uVar14 = FUN_006baeb0(param_1);
            uVar13 = FUN_006b8b90(param_1,4,uVar13,uVar14);
          }
          goto LAB_006bb703;
        }
      }
      uVar13 = FUN_006bb140(param_1);
    }
LAB_006bb703:
    FUN_006b8b90(param_1,0x39,uVar11,uVar13);
    goto LAB_006bb36e;
  }
  if (iVar8 != 3) {
    return (undefined4 *)0x0;
...
LAB_006bb3ea:
    ...
    if (cVar7 == 'E') {
      ...
      *(char **)(param_1 + 0x18) = pcVar15 + 2;
      lVar12 = FUN_006bb960(param_1,0x45);
    }
    else {
      if (cVar7 != 'i') {
        return (undefined4 *)0x0;
  ...
  FUN_006b8b90(param_1,0x3c,uVar11,lVar12);
  FUN_006b8b90();
LAB_006bb36e:
  puVar9 = (undefined4 *)FUN_006b8b90();
  return puVar9;
}
