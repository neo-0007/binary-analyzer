...
bool FUN_00667bd0(long param_1,long param_2,long param_3)
...
LAB_00667cd2:
  ...
  *(undefined8 *)((long)ppuVar10 + lVar4 + -0x18) = 0x667cb3;
  uVar8 = (*pcVar2)(plVar1,param_1 + 0x84,param_2,param_2 + param_3 * 4,local_78,uVar15);
  if (uVar8 < 2) {
    local_60 = local_50;
    param_3 = local_50 - uVar15;
    *(undefined8 *)((long)ppuVar10 + lVar4 + -8) = 0x667d23;
    local_64 = uVar8;
    lVar9 = FUN_006c3f80(param_1 + 0x68,uVar15,param_3);
    puVar13 = (undefined1 *)((long)ppuVar10 + lVar4);
    if ((param_3 != lVar9) ||
       (puVar13 = (undefined1 *)((long)ppuVar10 + lVar4), (local_64 & 1) == 0)) goto LAB_00667cd2;
    plVar1 = *(long **)(param_1 + 200);
