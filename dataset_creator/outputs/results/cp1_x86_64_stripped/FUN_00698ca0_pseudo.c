...
undefined1  [16] FUN_00698ca0(long param_1,long param_2,ulong param_3,uint param_4)

{
  ...
  if (((param_2 == 0) || (lVar4 != 0)) && ((uVar1 & 0x18) != 0)) {
    ...
    if ((-1 < param_2) && (param_2 <= *(long *)(param_1 + 0x18) - lVar4 >> 2)) {
      if (param_4 != 0) {
        *(long *)(param_1 + 0x10) = *(long *)(param_1 + 8) + param_2 * 4;
      }
      if ((uVar1 & 0x10) != 0) {
        FUN_00698ae0(param_1,*(undefined8 *)(param_1 + 0x20),*(undefined8 *)(param_1 + 0x30),param_2
                    );
      }
