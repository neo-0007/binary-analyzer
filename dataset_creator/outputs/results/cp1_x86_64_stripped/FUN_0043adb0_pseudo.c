...
undefined8 FUN_0043adb0(undefined8 param_1,byte *param_2,byte *param_3,ulong param_4)

{
  ...
  lVar6 = FUN_004098f0();
  iVar4 = FUN_004098f0(param_1);
  uVar5 = FUN_00409fd0(param_1);
  ...
  if (uVar10 != 0) {
    ...
    pbVar12 = param_2;
    if (param_4 == 0) {
      FUN_0040a0a0(param_1,uVar5 & 0xf);
      return 1;
    }
    do {
      bVar2 = *param_3;
    ...
    FUN_0040a0a0(param_1,(uint)uVar10 & 0xf);
  }
  if (param_4 == 0) {
    return 1;
  }
  ...
  *puVar11 = *puVar7;
  ...
  if (uVar10 != 0) {
    iVar4 = FUN_005b1690(param_2,param_3,puVar11,uVar10);
    if (iVar4 == 0) {
      return 0;
    }
    param_4 = param_4 - uVar10;
    if (param_4 == 0) goto LAB_0043ae77;
  }
  FUN_0040a0a0(param_1,param_4 & 0xffffffff);
  FUN_005b0ef0();
  FUN_005b0f00(puVar11,puVar11,puVar11);
  FUN_005b0ef0();
  uVar8 = 0;
  do {
