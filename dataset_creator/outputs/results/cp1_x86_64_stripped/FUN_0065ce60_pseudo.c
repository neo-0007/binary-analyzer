...
undefined1  [16]
FUN_0065ce60(undefined8 param_1,long *param_2,ulong param_3,long param_4,undefined4 param_5,
            undefined8 *param_6)

{
  ...
  lVar6 = FUN_00625ba0(&DAT_009453d8);
  plVar2 = (long *)(*(long *)(*(long *)(param_4 + 0xd0) + 0x18) + lVar6 * 8);
  lVar7 = *plVar2;
  if (lVar7 == 0) {
                    /* try { // try from 0065d495 to 0065d499 has its CatchHandler @ 0065d679 */
    puVar8 = (undefined8 *)FUN_006c31f0(0xa0);
    *(undefined4 *)(puVar8 + 1) = 0;
    puVar8[2] = 0;
    puVar8[3] = 0;
    *puVar8 = &PTR_FUN_00933f98;
    ...
    *(undefined1 *)(puVar8 + 0x13) = 0;
                    /* try { // try from 0065d51d to 0065d521 has its CatchHandler @ 0065d670 */
    FUN_006a60e0(puVar8,param_4 + 0xd0);
  ...
  if (uVar18 != 0) {
    ...
    local_78 = 0;
    local_88 = &local_78;
                    /* try { // try from 0065cff3 to 0065d03a has its CatchHandler @ 0065d6ae */
    ...
    if (0 < (long)uVar14) {
      ...
      if (*(long *)(lVar7 + 0x18) == 0) {
                    /* try { // try from 0065d560 to 0065d598 has its CatchHandler @ 0065d6ae */
        ...
        if (local_80 < uVar11) {
                    ...
                    /* try { // try from 0065d66b to 0065d66f has its CatchHandler @ 0065d6ae */
    ...
    if (0 < iVar4) {
      ...
      if (uVar12 < uVar1) {
                    /* try { // try from 0065d5fa to 0065d5fe has its CatchHandler @ 0065d6ae */
      ...
      if ((long)uVar14 < 0) {
        ...
        if (0xfffffffffffffff - local_80 < uVar18) {
                    /* WARNING: Subroutine does not return */
                    /* try { // try from 0065d63e to 0065d64e has its CatchHandler @ 0065d6ae */
        ...
        if (0xfffffffffffffff - uVar1 < uVar18) {
          ...
          FUN_00403998("basic_string::append",piVar17);
                    ...
                    /* try { // try from 0065d445 to 0065d449 has its CatchHandler @ 0065d6ae */
    ...
    local_58 = 0;
    local_68 = &local_58;
                    /* try { // try from 0065d0fd to 0065d3b5 has its CatchHandler @ 0065d6a5 */
    ...
    do {
      ...
      case 1:
        if (bVar10) {
                    /* try { // try from 0065d472 to 0065d48a has its CatchHandler @ 0065d6a5 */
          FUN_006b6430(&local_68,local_60,0,uVar14 - uVar18,param_5);
        }
        else {
          uVar1 = local_60 + 1;
          ...
          if (uVar12 < uVar1) {
                    /* try { // try from 0065d620 to 0065d624 has its CatchHandler @ 0065d6a5 */
      ...
      case 3:
        if (local_f8 != 0) {
          ...
          if (uVar12 < uVar1) {
                    /* try { // try from 0065d5d0 to 0065d5d4 has its CatchHandler @ 0065d6a5 */
            FUN_006b5810(&local_68,local_60,0,0,1);
          }
...
LAB_0065d298:
    ...
    if (1 < local_f8) {
      if (0xfffffffffffffff - local_60 < local_f8 - 1) {
                    /* WARNING: Subroutine does not return */
                    /* try { // try from 0065d656 to 0065d65a has its CatchHandler @ 0065d6a5 */
