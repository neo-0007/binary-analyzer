...
undefined8 FUN_004791a0(long param_1,undefined8 *param_2,ulong param_3)

{
  ...
  if ((lVar6 != 0) && (uVar7 = 0x10 - lVar6, uVar7 <= param_3)) {
    thunk_FUN_00713a50(param_1 + 100 + lVar6,param_2,uVar7);
    uVar4 = 0x20;
    ...
    local_68 = local_78;
    uStack_60 = uStack_70;
    iVar2 = FUN_00478f40(param_1,param_1 + 0x80,&local_78,uVar4);
    if (iVar2 == 0) {
LAB_00479245:
      uVar4 = 0;
      goto LAB_00479247;
