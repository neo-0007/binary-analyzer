...
undefined8 * FUN_006ba590(long param_1)

{
      ...
      if (cVar11 == 'v') {
        ...
        *(uint *)(param_1 + 0x50) = (uint)(*(int *)(param_1 + 0x4c) == 0);
        ...
        if (*(int *)(param_1 + 0x50) == 0) {
          puVar6 = (undefined8 *)FUN_006b8b90(param_1,0x34,uVar8,0);
        }
        else {
          puVar6 = (undefined8 *)FUN_006b8b90(param_1,0x35,uVar8,0);
        }
  ...
  do {
    ...
    pcVar3 = (&PTR_DAT_00918540)[(long)iVar5 * 3];
    cVar1 = *pcVar3;
    ...
    if (bVar13) {
      ...
      if (bVar13) {
        ...
        *(undefined4 *)puVar6 = 0x32;
        puVar6[2] = &PTR_DAT_00918540 + (long)iVar5 * 3;
        return puVar6;
      }
    }
