...
undefined1  [16]
FUN_00479910(long param_1,long param_2,ulong param_3,undefined8 param_4,undefined8 param_5,
...

{
  ...
  *(undefined1 (*) [16])((long)puVar2 + 0x54) = (undefined1  [16])0x0;
  iVar5 = FUN_00538a80(*puVar2,0,0,(long)puVar2 + 0x34,0,0xffffffff);
  if (iVar5 != 0) {
    uVar6 = 1;
    ...
    iVar5 = FUN_00479390(param_1,param_2,param_3,param_6,param_7,param_4);
    auVar9._1_7_ = 0;
    auVar9[0] = iVar5 != 0;
