...
void FUN_0058c100(ulong *param_1,undefined1 (*param_2) [16],long param_3)

{
  ...
  uVar20 = param_1[7];
  do {
    auVar2 = vpshufb_avx(*param_2,_DAT_0058b100);
    auVar3 = vpshufb_avx(param_2[1],_DAT_0058b100);
    auVar4 = vpshufb_avx(param_2[2],_DAT_0058b100);
    auVar5 = vpshufb_avx(param_2[3],_DAT_0058b100);
    auVar6 = vpshufb_avx(param_2[4],_DAT_0058b100);
    auVar7 = vpshufb_avx(param_2[5],_DAT_0058b100);
    local_100 = vpaddq_avx(auVar2,_DAT_0058ac00);
    auVar8 = vpshufb_avx(param_2[6],_DAT_0058b100);
    local_f0 = vpaddq_avx(auVar3,_DAT_0058ac20);
    auVar9 = vpshufb_avx(param_2[7],_DAT_0058b100);
    local_e0 = vpaddq_avx(auVar4,_DAT_0058ac40);
    local_d0 = vpaddq_avx(auVar5,_DAT_0058ac60);
    local_c0 = vpaddq_avx(auVar6,_DAT_0058ac80);
    local_b0 = vpaddq_avx(auVar7,_DAT_0058aca0);
    local_a0 = vpaddq_avx(auVar8,_DAT_0058acc0);
    local_90 = vpaddq_avx(auVar9,_DAT_0058ace0);
    uVar16 = uVar14 ^ uVar12;
    pauVar15 = (undefined1 (*) [16])&DAT_0058ac80;
    do {
