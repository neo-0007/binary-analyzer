...
undefined4
FUN_0045d820(undefined8 *param_1,undefined8 param_2,long param_3,long param_4,ulong param_5,
...

{
  ...
  if ((param_4 == 0) && ((param_5 & 2) != 0)) {
    if (param_3 != 0) {
      ...
      if ((lVar3 == 0) ||
        ...
        uVar2 = 0;
        lVar4 = FUN_00456ff0(param_3,0x440,0,0xffffffff,&LAB_00457630);
        if (lVar4 != 0) {
  ...
  FUN_0051f420();
  FUN_0051f540("../providers/implementations/encode_decode/encode_key2any.c",0x57e,
