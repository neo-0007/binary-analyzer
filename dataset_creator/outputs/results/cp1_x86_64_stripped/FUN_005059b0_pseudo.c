...
undefined4
FUN_005059b0(long param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,long param_5)

{
  ...
  uVar2 = 0;
  if (lVar5 != 0) {
    FUN_004b84d0(&DAT_008016c0,0x42,uVar3);
    FUN_004b84d0(&DAT_00801702,0x42,uVar4);
    FUN_004b84d0(&DAT_00801744,0x42,lVar5);
    ...
    if (((iVar1 == 0) && (iVar1 = FUN_004b7840(uVar4,param_3), iVar1 == 0)) &&
      ...
      *(code **)(param_1 + 0x88) = FUN_005c2c70;
      uVar2 = FUN_0050d3d0(param_1,param_2,param_3,param_4,param_5);
    }
    else {
      FUN_0051f420();
      FUN_0051f540("../crypto/ec/ecp_nistp521.c",0x720,"ossl_ec_GFp_nistp521_group_set_curve");
