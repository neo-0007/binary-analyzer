...
int FUN_0061efd0(int *param_1,long *param_2,ulong param_3)

{
  ...
  if (*param_1 == 0) {
    if (param_3 < 5) {
      ...
      *(undefined1 *)((long)param_1 + 0x41) = puVar1[1];
      ...
      if (iVar2 == 0) {
        ...
        uVar5 = (ulong)uVar4;
        if (uVar5 <= uVar7) {
          iVar2 = FUN_00620780(param_1,puVar3,uVar5);
          if (iVar2 == 1) {
    ...
    FUN_0051f540("../crypto/ct/ct_oct.c",uVar6,"o2i_SCT_signature");
    FUN_0051f8f0(0x32,0x6b,0);
  }
  else {
    FUN_0051f420();
    FUN_0051f540("../crypto/ct/ct_oct.c",0x1f,"o2i_SCT_signature");
