...
int FUN_0045b0d0(undefined8 param_1,undefined8 param_2,undefined4 param_3,undefined8 param_4,
  ...
  if (*(int *)(param_7 + 0xc) == 0) {
    if ((param_5 == (code *)0x0) ||
      ...
      if (lVar2 == 0) {
        ...
        iVar1 = FUN_005ab890(param_1,lVar2);
      }
      FUN_004a2c30(lVar2);
    }
  }
  else {
    iVar1 = FUN_0045af50(param_1,param_2,param_3);
  }
