...
long FUN_0052b070(long param_1,undefined1 *param_2,undefined8 *param_3,uint param_4,int param_5)

{
  ...
  iVar12 = FUN_00429650(local_508,param_5 << 6);
  local_7a8 = (undefined8 **)0x0;
  if (iVar12 < 1) goto LAB_0052b4e2;
  bVar20 = (char)param_5 + 1;
  local_7b0 = param_4 >> (bVar20 & 0x1f);
  local_7ac = (param_4 + local_7b0) - (local_7b0 << (bVar20 & 0x1f));
  if ((local_7b0 < local_7ac) && ((local_7ac + 0x16 & 0x3f) < uVar32 - 1)) {
...
LAB_0052b978:
    local_7a0 = &local_6c8;
    FUN_00570d00(local_100,local_7a0,param_5);
    puVar27 = local_508;
    for (lVar23 = 0x80; lVar23 != 0; lVar23 = lVar23 + -1) {
      *puVar27 = 0;
      puVar27 = puVar27 + (ulong)bVar35 * -2 + 1;
    ...
    while( true ) {
      uVar30 = *puVar27;
      uVar31 = puVar27[1];
      ppuVar15[4] = (undefined1 *)((long)param_3 + (ulong)local_7b0);
      *ppuVar17 = (undefined8 *)((long)param_3 + (ulong)local_7b0);
      puVar29 = *ppuVar15 + ((local_7b0 + 0x24 & 0xfffffff0) + 0x15);
      ppuVar15[5] = puVar29;
...
LAB_0052b1f5:
    lVar23 = 0;
    uVar1 = *(undefined1 *)(param_1 + 0x1d9);
    uVar13 = *(undefined4 *)(param_1 + 0x1c4);
    local_7b4 = uVar32 - 1;
    uVar14 = *(uint *)(param_1 + 0x1b4);
    uVar33 = *(uint *)(param_1 + 0x1b8);
    uVar5 = *(undefined4 *)(param_1 + 0x1bc);
    ppuVar17 = &local_748;
    uVar2 = *(undefined1 *)(param_1 + 0x1da);
    uVar6 = *(undefined4 *)(param_1 + 0x1c0);
    uVar3 = *(undefined1 *)(param_1 + 0x1d8);
    puVar27 = local_508;
    ppuVar26 = ppuVar17;
    plVar21 = &local_6c8;
    while( true ) {
      ...
      *puVar27 = uVar31 >> 0x38 | (uVar31 & 0xff000000000000) >> 0x28 |
      ...
      uVar9 = local_7c0[1];
      *(undefined8 *)((long)puVar27 + 0xd) = *local_7c0;
      *(undefined8 *)((long)puVar27 + 0x15) = uVar9;
      uVar9 = local_7c0[3];
      *(undefined8 *)((long)puVar27 + 0x1d) = local_7c0[2];
      *(undefined8 *)((long)puVar27 + 0x25) = uVar9;
      uVar9 = local_7c0[5];
      *(undefined8 *)((long)puVar27 + 0x2d) = local_7c0[4];
      *(undefined8 *)((long)puVar27 + 0x35) = uVar9;
      *(undefined2 *)((long)puVar27 + 0x3d) = *(undefined2 *)(local_7c0 + 6);
      uVar4 = *(undefined1 *)((long)local_7c0 + 0x32);
      *plVar21 = (long)puVar27;
      *(uint *)(ppuVar26 + 1) = uVar22 - 0x33 >> 6;
      *(undefined1 *)((long)puVar27 + 0x3f) = uVar4;
      *ppuVar26 = (undefined8 *)((long)local_7c0 + 0x33);
      *(undefined4 *)(plVar21 + 1) = 1;
      if (uVar32 <= (uint)lVar23) break;
      local_7c0 = ppuVar26[2];
...
LAB_0052b578:
      ...
      do {
        local_7a8 = &local_748;
        FUN_00570d00(local_100,local_7a0,param_5);
        FUN_0048c980(&local_648,param_1,param_5);
        ppuVar17 = &local_648;
        plVar21 = local_7a0;
        if (param_5 != 0) {
          do {
            puVar8 = *local_7a8;
            *(int *)(local_7a8 + 1) = *(int *)(local_7a8 + 1) + -0x20;
            ppuVar26 = local_7a8 + 2;
            *ppuVar17 = *ppuVar17 + 0x100;
            *(undefined4 *)(plVar21 + 1) = 0x20;
            *local_7a8 = puVar8 + 0x100;
            ...
            *(undefined4 *)(ppuVar17 + 2) = 0x80;
            ...
            local_7a8 = ppuVar26;
            plVar21 = plVar21 + 2;
          } while (local_738 + (ulong)local_7b4 * 2 != ppuVar26);
        }
        uVar25 = uVar25 - 0x20;
        local_7c0._0_4_ = (int)local_7c0 + 0x800;
      } while (0x20 < uVar25);
    }
    local_7a0 = &local_6c8;
    local_770 = &local_648;
    local_7a8 = &local_748;
    FUN_00570d00(local_100,local_7a8,param_5);
    puVar27 = local_508;
    for (lVar23 = 0x80; lVar23 != 0; lVar23 = lVar23 + -1) {
      *puVar27 = 0;
      puVar27 = puVar27 + (ulong)bVar35 * -2 + 1;
    }
    if (param_5 == 0) goto LAB_0052b978;
    lVar23 = 0;
    puVar27 = local_508;
    uVar25 = 0;
    do {
      ...
      uVar33 = (-0x33 - (int)local_7c0) + *(int *)((long)local_740 + lVar23) * -0x40 + uVar25;
      lVar16 = thunk_FUN_00713a50(puVar27,(ulong)(uint)(*(int *)((long)local_740 + lVar23) * 0x40) +
                                          *(long *)((long)local_7a8 + lVar23),(ulong)uVar33);
      ...
      *(long *)((long)local_7a0 + lVar23) = lVar16;
      puVar27 = (ulong *)(lVar16 + 0x80);
      lVar23 = lVar23 + 0x10;
      uVar25 = uVar14 + 1;
    } while (uVar32 != uVar14 + 1);
    FUN_00570d00(local_100,local_7a0,param_5);
    uVar32 = *(uint *)(param_1 + 0x154);
    uVar25 = *(uint *)(param_1 + 0x158);
    puVar27 = local_508;
    for (lVar23 = 0x80; lVar23 != 0; lVar23 = lVar23 + -1) {
      *puVar27 = 0;
      puVar27 = puVar27 + (ulong)bVar35 * -2 + 1;
    }
    uVar33 = *(uint *)(param_1 + 0x15c);
    uVar22 = *(uint *)(param_1 + 0x160);
    uVar28 = *(uint *)(param_1 + 0x164);
    puVar18 = local_100;
    plVar21 = local_7a0;
    puVar27 = local_508;
    do {
      ...
      *(undefined4 *)(plVar21 + 1) = 1;
      ...
      plVar21 = plVar21 + 2;
      puVar27 = puVar27 + 0x10;
    } while (local_e0 + ((ulong)local_7b4 - 7) != puVar19);
    FUN_00570d00(local_100,local_7a0,param_5);
    local_7a8 = (undefined8 **)0x0;
    puVar18 = local_100;
    uVar32 = 0;
    do {
      ...
      thunk_FUN_00713a50(local_770[1],*local_770,uVar25 - (int)local_7c0);
      uVar33 = *puVar18;
      ...
      *puVar19 = uVar33 >> 0x18 | (uVar33 & 0xff0000) >> 8 | (uVar33 & 0xff00) << 8 | uVar33 << 0x18
      ...
      puVar18 = puVar18 + 1;
      *(uint *)(local_770 + 2) = (uint)((1 - (int)local_7c0) + iVar12) >> 4;
      ...
      *(ushort *)(param_2 + 3) = uVar11 * 0x100 | uVar11 >> 8;
      local_7a8 = (undefined8 **)((long)local_7a8 + (ulong)(iVar12 + 0x16));
  ...
  local_770 = &local_648;
  FUN_0048c980(local_770,param_1,param_5);
