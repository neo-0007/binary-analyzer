...
undefined1 * FUN_00720d80(undefined1 (*param_1) [32],undefined1 param_2,ulong param_3)
...
LAB_00720de0:
    ...
    if (param_3 <= (((ulong)param_1 | 0x1f) + 1) - (long)param_1) goto LAB_00720de0;
    if (uVar9 != 0) {
      uVar11 = 0;
      for (; (uVar9 & 1) == 0; uVar9 = uVar9 >> 1 | 0x80000000) {
        uVar11 = uVar11 + 1;
  ...
  if (uVar13 <= param_3 && uVar12 != 0) {
    ...
    if (bVar15 || uVar12 == 0) {
      ...
      uVar14 = uVar14 + 0x80;
      if (uVar11 != 0) goto LAB_00720f80;
      uVar11 = (int)uVar12 + 0x40;
      uVar13 = uVar14;
      if (uVar11 != 0 && SCARRY4((int)uVar12,0x40) == (int)uVar11 < 0) goto LAB_00720ff0;
      goto LAB_00720f2d;
    }
