...
void FUN_00587640(uint *param_1,undefined1 (*param_2) [16],long param_3)

{
  ...
  auVar8 = _DAT_005863c0;
  auVar7 = _DAT_005863a0;
  ...
  uVar18 = param_1[7];
  do {
    auVar2 = vpshufb_avx(*param_2,_DAT_00586380);
    auVar3 = vpshufb_avx(param_2[1],_DAT_00586380);
    auVar4 = vpshufb_avx(param_2[2],_DAT_00586380);
    local_c0 = vpaddd_avx(auVar2,_DAT_00586180);
    auVar5 = vpshufb_avx(param_2[3],_DAT_00586380);
    local_b0 = vpaddd_avx(auVar3,_DAT_005861a0);
    local_a0 = vpaddd_avx(auVar4,_DAT_005861c0);
    local_90 = vpaddd_avx(auVar5,_DAT_005861e0);
    uVar14 = uVar12 ^ uVar10;
    pauVar13 = (undefined1 (*) [16])&DAT_00586180;
    do {
