...
void FUN_006976c0(long *param_1,long *param_2)

{
  ...
  *plVar1 = param_2[5];
                    /* try { // try from 00697717 to 0069771b has its CatchHandler @ 006977e9 */
  ...
  *(undefined4 *)(param_1 + 0xb) = 0x18;
  ...
  param_1[0xc] = (long)(param_1 + 0xe);
                    /* try { // try from 006977d9 to 006977dd has its CatchHandler @ 006977f2 */
