...
void FUN_0069c370(long *param_1,long *param_2,long *param_3)

{
  ...
  *(long *)((long)param_1 + *(long *)(lVar1 + -0x18)) = lVar3;
  param_1[2] = param_2[9];
                    /* try { // try from 0069c471 to 0069c475 has its CatchHandler @ 0069c48f */
  FUN_00699e40(param_1 + 3,param_3 + 3);
