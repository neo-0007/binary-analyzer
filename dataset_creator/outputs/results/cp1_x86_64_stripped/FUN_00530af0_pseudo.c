...
undefined8 FUN_00530af0(long param_1,byte *param_2,byte *param_3,ulong param_4)
...
LAB_00530b8e:
    do {
      if (uVar8 < 0x400000040) {
        ...
        uVar7 = (ulong)uVar6;
        if (uVar7 < uVar4) goto LAB_00530b51;
LAB_00530baf:
        lVar5 = uVar4 * 0x40;
        FUN_004c7880(param_2,param_3,lVar5,lVar2,lVar2 + 0x20);
        ...
        *(uint *)(lVar2 + 0x20) = uVar6;
        ...
        uVar7 = (ulong)uVar6;
        if (0xfffffff < uVar7) goto LAB_00530baf;
LAB_00530b51:
  ...
  if ((param_4 & 0x3f) != 0) {
    ...
    *(undefined1 (*) [16])(lVar2 + 0x60) = (undefined1  [16])0x0;
    FUN_004c7880(lVar2 + 0x30,lVar2 + 0x30,0x40,lVar2,lVar2 + 0x20);
    uVar8 = 0;
    do {
