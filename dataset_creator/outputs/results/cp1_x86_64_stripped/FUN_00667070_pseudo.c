...
void FUN_00667070(long *param_1,long *param_2,long *param_3)

{
  ...
  *(long *)((long)param_1 + *(long *)(lVar3 + -0x18)) = lVar4;
  param_1[2] = param_2[9];
                    /* try { // try from 00667164 to 00667168 has its CatchHandler @ 00667182 */
  FUN_006658a0(param_1 + 3,param_3 + 3);
