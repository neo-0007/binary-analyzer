...
long * FUN_0068e6c0(long *param_1,undefined8 param_2)

{
  ...
  if (local_58[0] != '\0') {
    ...
    if (plVar1 == (long *)0x0) {
                    ...
                    /* try { // try from 0068e869 to 0068e872 has its CatchHandler @ 0068e873 */
      FUN_00403826();
    }
    if (*(char *)(lVar6 + 0xe1) == '\0') {
      ...
      if ((char)plVar2[7] == '\0') {
                    /* try { // try from 0068e813 to 0068e83c has its CatchHandler @ 0068e873 */
        FUN_0063d6f0(plVar2);
        iVar5 = 0x20;
        cVar4 = ' ';
      ...
      *(undefined1 *)(lVar6 + 0xe1) = 1;
      ...
      iVar5 = (int)*(char *)(lVar6 + 0xe0);
                    ...
                    /* try { // try from 0068e749 to 0068e74b has its CatchHandler @ 0068e873 */
    (**(code **)(*plVar1 + 0x20))
              (plVar1,*(long *)(lVar6 + 0xe8),*(long *)(lVar6 + 0xe8) == 0,lVar6,iVar5,param_2);
    if (extraout_DL != '\0') {
      lVar6 = *(long *)(*param_1 + -0x18) + (long)param_1;
                    /* try { // try from 0068e761 to 0068e765 has its CatchHandler @ 0068e87f */
