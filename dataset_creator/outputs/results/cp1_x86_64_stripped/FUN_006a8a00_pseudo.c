...
/* WARNING: Removing unreachable block (ram,0x006a8a5b) */
/* WARNING: Restarted to delay deadcode elimination for space: stack */

long * FUN_006a8a00(undefined8 param_1,long *param_2,char param_3,long param_4,undefined4 param_5,
                   long param_6)

{
  ...
  local_44 = FUN_006a83e0(&local_80,param_6,local_60,uVar12,local_49);
  ...
  if (*(char *)(lVar6 + 0x20) != '\0') {
    ...
    *(undefined1 **)(puVar9 + lVar14 + -0x10) = local_70 + (long)(0x28 - local_44) * 4;
    ...
    local_68 = local_60;
    *(undefined8 *)(puVar9 + lVar14 + -0x18) = 0x6a8c66;
  ...
  if (lVar14 < lVar6) {
    ...
    *(undefined8 *)(puVar9 + lVar14 + -0x18) = 0x6a8bce;
  ...
  *(undefined8 *)(param_4 + 0x10) = 0;
  if (param_3 == '\0') {
    ...
    *(undefined8 *)(puVar8 + -8) = 0x6a8b28;
    (*pcVar2)(param_2,puVar15,lVar14);
  }
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    *(undefined **)(puVar8 + -8) = &UNK_006a8cfd;
    FUN_00771f60();
  }
  return param_2;
}
