...
void FUN_006cd3e0(long param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  local_38 = param_3;
  FUN_006cc990(&local_228,&stack0x00000008,unaff_retaddr);
  ...
  *(undefined8 *)(param_1 + 0x18) = param_3;
  ...
  iVar1 = FUN_006ccc50(param_1,&local_138,&local_230);
  if (iVar1 == 7) {
    uVar2 = FUN_006cab00(&local_228,&local_138);
    uVar3 = uStack_a0;
    FUN_006cd030(local_a8,uStack_a0,uVar2);
    if (in_SSP != 0) {
      for (; 0xff < local_230; local_230 = local_230 - 0xff) {
      }
    }
    *(undefined8 *)(&stack0x00000000 + extraout_RDX) = uVar3;
                    /* WARNING: Could not recover jumptable at 0x006cd5b7. Too many branches */
