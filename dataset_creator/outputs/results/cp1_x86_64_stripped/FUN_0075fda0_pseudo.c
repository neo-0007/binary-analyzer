...
undefined1 * FUN_0075fda0(undefined1 (*param_1) [32],undefined8 param_2,ulong param_3)
...
LAB_0075fe00:
    ...
    if (param_3 <= 0x400 - uVar6) goto LAB_0075fe00;
    if (uVar7 != 0) {
      uVar6 = 0;
      for (; (uVar7 & 1) == 0; uVar7 = uVar7 >> 1 | 0x80000000) {
        uVar6 = uVar6 + 1;
  ...
  if (uVar12 <= param_3 && uVar11 != 0) {
    ...
    if (bVar15 || uVar11 == 0) {
      ...
      uVar6 = (uint)uVar3;
      pauVar13 = pauVar13 + 4;
      if (uVar6 != 0) goto LAB_0075ff90;
      uVar6 = (int)uVar11 + 0x10;
      if (uVar6 != 0 && SCARRY4((int)uVar11,0x10) == (int)uVar6 < 0) goto LAB_00760020;
      goto LAB_0075ff6e;
    }
