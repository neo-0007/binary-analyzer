...
undefined8 FUN_006cd040(undefined8 *param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  local_38 = param_3;
  FUN_006cc990(&local_3a8,&stack0x00000008,unaff_retaddr);
  ...
  while( true ) {
    do {
      do {
        puStack_220 = puVar4;
        uVar3 = FUN_006cc320(local_2b8,&local_1c8);
        if ((int)uVar3 == 5) {
          return uVar3;
        }
        if ((int)uVar3 != 0) {
        ...
        if (local_78 != (code *)0x0) {
          ...
          if (iVar1 == 6) {
            ...
            local_1d8 = local_2c8;
            uStack_1d0 = uStack_2c0;
            uVar3 = FUN_006ccb10(param_1,local_2b8,&local_1c8);
            if ((int)uVar3 == 7) {
              uVar3 = FUN_006cab00(&local_3a8,local_2b8);
              puVar4 = puStack_220;
              FUN_006cd030(local_228,puStack_220,uVar3);
              if (in_SSP != 0) {
                for (; 0xff < local_1c8; local_1c8 = local_1c8 - 0xff) {
                }
              }
              *(undefined8 **)(&stack0x00000000 + extraout_RDX) = puVar4;
                    /* WARNING: Could not recover jumptable at 0x006cd3dd. Too many branches */
        ...
        FUN_006cb630(local_2b8,&local_1c8);
        puVar4 = (undefined8 *)0x0;
      } while (aiStack_1c0[local_60 * 4] == 6);
      if (0x11 < (int)local_60) goto FUN_004046b2;
