...
undefined8 * FUN_004519d0(undefined8 *param_1)

{
  ...
  if (iVar2 != 0) {
    puVar3 = (undefined8 *)
             FUN_0041ad90(0xbc,"../providers/implementations/digests/md5_sha1_prov.c",0x3a);
    if (puVar3 != (undefined8 *)0x0) {
      ...
      *(undefined4 *)(puVar3 + 0x17) = *(undefined4 *)(param_1 + 0x17);
    }
  }
  return puVar3;
}
