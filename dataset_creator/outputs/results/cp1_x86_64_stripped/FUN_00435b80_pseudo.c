...
ulong FUN_00435b80(int *param_1,long param_2,uint param_3,int *param_4)
  ...
  if (param_1 != (int *)0x0) {
    ...
    if (iVar1 != 0) {
      if (*(long *)(param_1 + 6) == 0) {
        ...
        if (param_1[4] == 0) {
          if (1 < iVar1) {
            FUN_006e8e20(*(undefined8 *)(param_1 + 2),(long)iVar1,8);
          }
          param_1[4] = 1;
        }
        if (local_30 != 0) {
          if (param_4 == (int *)0x0) {
            uVar2 = FUN_00546310(&local_30,*(undefined8 *)(param_1 + 2),*param_1,8,
