...
void FUN_004ca3e0(undefined1 (*param_1) [64],undefined1 (*param_2) [64],ulong param_3,
...

{
  ...
  auVar33 = vpaddd_avx512f(auVar33,_DAT_004c7780);
  ...
  while( true ) {
    ...
    *param_1 = auVar9;
    ...
    auVar12 = vpbroadcastd_avx512f(ZEXT416((uint)s_expand_32_byte_k_004c7800._0_4_));
    auVar13 = vpbroadcastd_avx512f(ZEXT416((uint)s_expand_32_byte_k_004c7800._4_4_));
    auVar14 = vpbroadcastd_avx512f(ZEXT416((uint)s_expand_32_byte_k_004c7800._8_4_));
    auVar8 = vpbroadcastd_avx512f(ZEXT416((uint)s_expand_32_byte_k_004c7800._12_4_));
    auVar36 = vpaddd_avx512f(auVar36,_DAT_004c77c0);
