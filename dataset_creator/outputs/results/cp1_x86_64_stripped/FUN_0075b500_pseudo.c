...
undefined1  [16] FUN_0075b500(char *param_1,char *param_2,long param_3)
...
LAB_0075ba20:
          uVar7 = (uint)uVar8;
          if (uVar7 < 8) {
            if (uVar7 == 0) goto LAB_0075baf8;
          }
          else {
            if (uVar7 < 0x10) {
              if (uVar7 != 8) goto LAB_0075bae0;
            }
            else {
              if (uVar7 < 0x18) {
                if (uVar7 != 0x10) goto LAB_0075bad0;
              }
              else {
                if (uVar7 < 0x20) {
                  if (uVar7 != 0x18) goto LAB_0075bac0;
                }
                else {
                  if (uVar7 < 0x28) {
                    if (uVar7 != 0x20) goto LAB_0075bab0;
                  }
                  else {
                    if (uVar7 != 0x28) {
