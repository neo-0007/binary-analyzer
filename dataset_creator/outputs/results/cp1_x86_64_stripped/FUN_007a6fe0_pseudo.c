...
undefined1 (*) [32]
FUN_007a6fe0(undefined1 (*param_1) [32],undefined1 (*param_2) [32],ulong param_3)
...
LAB_007a74bc:
      ...
      uVar22 = (ulong)uVar17;
      if ((uint)param_3 <= uVar17) goto LAB_007a7904;
    }
    else {
      if (uVar19 == 0) {
        *param_1 = *param_2;
...
LAB_007a7475:
      ...
      uVar22 = (ulong)uVar19;
      if ((uint)param_3 <= uVar19) goto LAB_007a7904;
      goto LAB_007a72ce;
    }
    if (uVar17 != 0) goto LAB_007a7730;
    param_1[2] = auVar29;
    auVar28 = param_2[3];
    ...
    bVar26 = param_3 < 0x20;
    param_3 = uVar22 - 0x80;
    if (bVar26 || param_3 == 0) goto LAB_007a7470;
    if (uVar17 != 0) {
LAB_007a7400:
...
LAB_007a7820:
      if (uVar17 != 0) {
        ...
        uVar17 = (uint)(SUB321(auVar7 >> 7,0) & 1) | (uint)(SUB321(auVar7 >> 0xf,0) & 1) << 1 |
                 ...
                 (uint)(byte)(auVar7[0x1f] >> 7) << 0x1f;
        param_3 = uVar23 + 0x60;
        if (param_3 == 0 || SCARRY8(uVar23,0x60) != (long)param_3 < 0) goto LAB_007a7470;
        if (uVar17 != 0) goto LAB_007a73f0;
        auVar7 = vpcmpeqb_avx2(auVar27,auVar28);
        uVar17 = (uint)(SUB321(auVar7 >> 7,0) & 1) | (uint)(SUB321(auVar7 >> 0xf,0) & 1) << 1 |
                 (uint)(SUB321(auVar7 >> 0x17,0) & 1) << 2 |
                 (uint)(SUB321(auVar7 >> 0x1f,0) & 1) << 3 |
...
LAB_007a71c5:
  ...
  *pauVar21 = auVar29;
  ...
  pauVar16 = pauVar20;
  pauVar21 = param_1;
  if (bVar26 || uVar23 == 0) goto LAB_007a7820;
  goto joined_r0x007a71c3;
}
