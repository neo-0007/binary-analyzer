...
void FUN_004dc950(undefined8 param_1,long param_2,undefined8 param_3)

{
  ...
  FUN_004dfbe0(local_188,param_3,&DAT_007ebbe0);
  FUN_004dff60(local_188,local_188);
  local_19c = 0x12;
LAB_004dc9e2:
  ...
  do {
    ...
    FUN_004df0f0(local_148,&DAT_007ebc60,local_88);
    puVar5 = local_88;
    puVar8 = local_148;
    do {
      uVar4 = *puVar8;
    ...
    if ((iVar13 == 0) && (bVar15)) {
      FUN_004db670(param_1,&local_108);
    }
    else {
      FUN_004dc330(param_1,&local_108,iVar13 == 4 && bVar16);
      if (iVar13 + 1 == 5) break;
    }
  ...
  if (local_19c == 0) {
    FUN_004227b0(&local_108,0xc0);
    FUN_004227b0(local_188,0x38);
  ...
  FUN_004dbe80(param_1,param_1,0);
  goto LAB_004dc9e2;
}
