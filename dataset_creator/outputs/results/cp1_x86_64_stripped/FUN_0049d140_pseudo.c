...
undefined8 FUN_0049d140(byte *param_1,uint param_2,uint *param_3)

{
  ...
  if ((param_1 == (byte *)0x0) || (param_3 == (uint *)0x0)) {
    ...
    uVar20 = uVar14 ^ *(uint *)(&DAT_007e784c + lVar23);
    uVar15 = *(uint *)(&DAT_007e7848 + lVar23) ^ uVar12;
    uVar15 = *(uint *)(&DAT_007e6c40 + (long)(int)(uVar15 >> 8 & 0xff) * 4) ^
             *(uint *)(&DAT_007e7440 + (ulong)(uVar15 >> 0x18) * 4) ^
             *(uint *)(&DAT_007e6840 + (ulong)(uVar15 & 0xff) * 4) ^
             *(uint *)(&DAT_007e7040 + (ulong)(uVar15 >> 0x10 & 0xff) * 4);
    uVar26 = *(uint *)(&DAT_007e7440 + (ulong)(uVar22 >> 0x18) * 4) ^
             *(uint *)(&DAT_007e6840 + (ulong)(uVar22 & 0xff) * 4) ^
             *(uint *)(&DAT_007e7040 + (ulong)(uVar22 >> 0x10 & 0xff) * 4) ^
             *(uint *)(&DAT_007e6c40 + (long)(int)(uVar22 >> 8 & 0xff) * 4) ^ uVar15;
    uVar21 = *(uint *)(&DAT_007e7440 + (ulong)(uVar21 >> 0x18) * 4) ^
             *(uint *)(&DAT_007e6840 + (ulong)(uVar21 & 0xff) * 4) ^
             *(uint *)(&DAT_007e7040 + (ulong)(uVar21 >> 0x10 & 0xff) * 4) ^
             *(uint *)(&DAT_007e6c40 + (long)(int)(uVar21 >> 8 & 0xff) * 4) ^ uVar26;
    uVar22 = *(uint *)(&DAT_007e7440 + (ulong)(uVar20 >> 0x18) * 4) ^
             *(uint *)(&DAT_007e6840 + (ulong)(uVar20 & 0xff) * 4) ^
             *(uint *)(&DAT_007e7040 + (ulong)(uVar20 >> 0x10 & 0xff) * 4) ^
             *(uint *)(&DAT_007e6c40 + (long)(int)(uVar20 >> 8 & 0xff) * 4);
    ...
    uVar20 = local_58 ^ *(uint *)(&DAT_007e7858 + lVar23);
    uVar22 = *(uint *)(&DAT_007e7850 + lVar23) ^ uVar21;
    uVar15 = local_40 ^ *(uint *)(&DAT_007e7854 + lVar23);
    uVar28 = local_3c ^ *(uint *)(&DAT_007e785c + lVar23);
    uVar26 = *(uint *)(&DAT_007e6c40 + (ulong)(uVar20 >> 0x18) * 4) ^
             *(uint *)(&DAT_007e7040 + (ulong)(uVar20 & 0xff) * 4) ^
             *(uint *)(&DAT_007e6840 + (ulong)(uVar20 >> 0x10 & 0xff) * 4) ^
             *(uint *)(&DAT_007e7440 + (long)(int)(uVar20 >> 8 & 0xff) * 4);
    uVar27 = *(uint *)(&DAT_007e6c40 + (ulong)(uVar15 >> 0x18) * 4) ^
             *(uint *)(&DAT_007e7040 + (ulong)(uVar15 & 0xff) * 4) ^
             *(uint *)(&DAT_007e6840 + (ulong)(uVar15 >> 0x10 & 0xff) * 4) ^
             *(uint *)(&DAT_007e7440 + (long)(int)(uVar15 >> 8 & 0xff) * 4) ^ uVar26;
    uVar22 = *(uint *)(&DAT_007e6c40 + (ulong)(uVar22 >> 0x18) * 4) ^
             *(uint *)(&DAT_007e7040 + (ulong)(uVar22 & 0xff) * 4) ^
             *(uint *)(&DAT_007e6840 + (ulong)(uVar22 >> 0x10 & 0xff) * 4) ^
             *(uint *)(&DAT_007e7440 + (long)(int)(uVar22 >> 8 & 0xff) * 4) ^ uVar27;
    uVar15 = *(uint *)(&DAT_007e6c40 + (ulong)(uVar28 >> 0x18) * 4) ^
             *(uint *)(&DAT_007e7040 + (ulong)(uVar28 & 0xff) * 4) ^
             *(uint *)(&DAT_007e6840 + (ulong)(uVar28 >> 0x10 & 0xff) * 4) ^
             *(uint *)(&DAT_007e7440 + (long)(int)(uVar28 >> 8 & 0xff) * 4);
    ...
    uVar15 = *(uint *)(&DAT_007e7864 + lVar23) ^ uVar22;
    uVar20 = *(uint *)(&DAT_007e7868 + lVar23) ^ uVar24;
    uVar28 = *(uint *)(&DAT_007e7860 + lVar23) ^ uVar27;
    uVar26 = *(uint *)(&DAT_007e786c + lVar23) ^ uVar29;
    uVar20 = *(uint *)(&DAT_007e7440 + (ulong)(uVar20 >> 0x18) * 4) ^
             *(uint *)(&DAT_007e6840 + (ulong)(uVar20 & 0xff) * 4) ^
             *(uint *)(&DAT_007e7040 + (ulong)(uVar20 >> 0x10 & 0xff) * 4) ^
             *(uint *)(&DAT_007e6c40 + (long)(int)(uVar20 >> 8 & 0xff) * 4);
    uVar25 = *(uint *)(&DAT_007e7440 + (ulong)(uVar15 >> 0x18) * 4) ^
             *(uint *)(&DAT_007e6840 + (ulong)(uVar15 & 0xff) * 4) ^
             *(uint *)(&DAT_007e7040 + (ulong)(uVar15 >> 0x10 & 0xff) * 4) ^
             *(uint *)(&DAT_007e6c40 + (long)(int)(uVar15 >> 8 & 0xff) * 4) ^ uVar20;
    uVar28 = *(uint *)(&DAT_007e7440 + (ulong)(uVar28 >> 0x18) * 4) ^
             *(uint *)(&DAT_007e6840 + (ulong)(uVar28 & 0xff) * 4) ^
             *(uint *)(&DAT_007e7040 + (ulong)(uVar28 >> 0x10 & 0xff) * 4) ^
             *(uint *)(&DAT_007e6c40 + (long)(int)(uVar28 >> 8 & 0xff) * 4) ^ uVar25;
    uVar15 = *(uint *)(&DAT_007e7440 + (ulong)(uVar26 >> 0x18) * 4) ^
             *(uint *)(&DAT_007e6840 + (ulong)(uVar26 & 0xff) * 4) ^
             *(uint *)(&DAT_007e7040 + (ulong)(uVar26 >> 0x10 & 0xff) * 4) ^
             *(uint *)(&DAT_007e6c40 + (long)(int)(uVar26 >> 8 & 0xff) * 4);
