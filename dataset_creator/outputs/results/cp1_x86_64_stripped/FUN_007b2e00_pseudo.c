...
undefined8 FUN_007b2e00(char *param_1,long param_2)
...
LAB_007b2e70:
        *(char *)plVar4 = cVar6;
        ...
        cVar6 = cVar1;
LAB_007b2e7c:
        if (cVar6 == '\0') goto LAB_007b2eb0;
      }
      if (cVar1 == '.') {
        cVar2 = param_1[2];
        if (cVar2 == '.') {
          cVar2 = param_1[3];
          if ((cVar2 != '/') && (cVar2 != '\0')) goto LAB_007b2e93;
          do {
...
LAB_007b2e93:
      if ((plVar4 <= plVar9) || (*(char *)((long)plVar4 + -1) != '/')) goto LAB_007b2e70;
      param_1 = param_1 + 1;
      cVar6 = cVar1;
    } while (cVar1 != '\0');
LAB_007b2eb0:
    if ((plVar4 == plVar9) || (*(char *)((long)plVar4 + -1) != '/')) goto LAB_007b2ebe;
  }
  uVar5 = (long)plVar4 - (long)plVar9;
  if (uVar5 < 0x16) {
    if (uVar5 < 5) goto LAB_007b2f4a;
  }
  else {
