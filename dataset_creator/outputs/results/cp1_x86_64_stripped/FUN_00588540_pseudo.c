...
void FUN_00588540(int *param_1,long param_2,long param_3)

{
  ...
  *(BADSPACEBASE **)(uVar11 + 0x218) = register0x00000020;
  auVar4 = _DAT_005863c0;
  auVar3 = _DAT_005863a0;
  ...
  do {
    ...
    auVar25 = vpshufb_avx2(auVar21,_DAT_00586380);
    auVar22._0_16_ =
    ...
    auVar27 = vpshufb_avx2(auVar31,_DAT_00586380);
    auVar23._0_16_ =
    ...
    auVar28 = vpshufb_avx2(auVar22,_DAT_00586380);
    auVar21 = vpaddd_avx2(auVar25,_DAT_00586180);
    auVar29 = vpshufb_avx2(auVar23,_DAT_00586380);
    auVar31 = vpaddd_avx2(auVar27,_DAT_005861a0);
    auVar22 = vpaddd_avx2(auVar28,_DAT_005861c0);
    auVar23 = vpaddd_avx2(auVar29,_DAT_005861e0);
    *pauVar12 = auVar21;
    uVar5 = 0;
    pauVar12[1] = auVar31;
    *(undefined8 *)(pauVar12[-3] + 0x18) = *(undefined8 *)(pauVar12[2] + 0x18);
    ...
    pauVar12[-1] = auVar23;
    pauVar1 = pauVar12 + -2;
    pauVar12 = (undefined1 (*) [32])&DAT_00586200;
    do {
      pauVar13 = pauVar1;
