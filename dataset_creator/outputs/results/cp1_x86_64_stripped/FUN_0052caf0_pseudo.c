...
long FUN_0052caf0(long param_1,undefined1 *param_2,undefined8 *param_3,uint param_4,int param_5)

{
  ...
  iVar14 = FUN_00429650(local_568,param_5 << 6);
  local_818 = (undefined8 **)0x0;
  if (iVar14 < 1) goto LAB_0052d06f;
  bVar22 = (char)param_5 + 1;
  local_824 = param_4 >> (bVar22 & 0x1f);
  local_800 = (param_4 + local_824) - (local_824 << (bVar22 & 0x1f));
  if ((local_824 < local_800) && ((local_800 + 0x16 & 0x3f) < uVar34 - 1)) {
    local_824 = local_824 + 1;
    local_800 = local_800 + param_5 * -4 + 1;
  }
  local_7a8 = param_3;
  local_6a8 = param_3;
  ...
  *(ulong *)(param_2 + 0xd) = local_568[1];
  ...
  if ((int)uVar34 < 2) {
    ...
    local_830 = param_3;
    if (uVar34 != 0) goto LAB_0052cc85;
    FUN_0057d000(local_160,&local_728,param_5);
    if (0x83f < uVar26) {
      local_828 = 0xffffffff;
      goto LAB_0052d103;
    }
    FUN_0057d000(local_160,&local_7a8,param_5);
    puVar28 = local_568;
...
LAB_0052cffc:
    local_810 = &local_728;
    FUN_0057d000(local_160,local_810,param_5);
    puVar28 = local_568;
    for (lVar27 = 0x80; lVar27 != 0; lVar27 = lVar27 + -1) {
      *puVar28 = 0;
      puVar28 = puVar28 + (ulong)bVar37 * -2 + 1;
    ...
    while( true ) {
      uVar32 = *puVar28;
      uVar33 = puVar28[1];
      ppuVar17[4] = (undefined1 *)((long)param_3 + (ulong)local_824);
      *ppuVar19 = (undefined8 *)((long)param_3 + (ulong)local_824);
      puVar31 = *ppuVar17 + ((local_824 + 0x30 & 0xfffffff0) + 0x15);
      ppuVar17[5] = puVar31;
    ...
    local_830 = local_7a8;
LAB_0052cc85:
    uVar1 = *(undefined1 *)(param_1 + 0x205);
    ppuVar19 = &local_7a8;
    uVar16 = *(uint *)(param_1 + 0x1e8);
    lVar27 = 0;
    local_828 = uVar34 - 1;
    uVar35 = *(uint *)(param_1 + 0x1ec);
    uVar24 = *(uint *)(param_1 + 0x1d4);
    uVar29 = *(uint *)(param_1 + 0x1f0);
    uVar2 = *(undefined1 *)(param_1 + 0x204);
    uVar5 = *(uint *)(param_1 + 0x1d8);
    uVar6 = *(uint *)(param_1 + 0x1dc);
    uVar7 = *(uint *)(param_1 + 0x1e0);
    uVar8 = *(uint *)(param_1 + 0x1e4);
    uVar3 = *(undefined1 *)(param_1 + 0x206);
    puVar28 = local_568;
    puVar20 = local_160;
    ppuVar30 = ppuVar19;
    plVar23 = &local_728;
    while( true ) {
      ...
      *puVar28 = uVar33 >> 0x38 | (uVar33 & 0xff000000000000) >> 0x28 |
      ...
      uVar11 = local_830[1];
      *(undefined8 *)((long)puVar28 + 0xd) = *local_830;
      *(undefined8 *)((long)puVar28 + 0x15) = uVar11;
      uVar11 = local_830[3];
      *(undefined8 *)((long)puVar28 + 0x1d) = local_830[2];
      *(undefined8 *)((long)puVar28 + 0x25) = uVar11;
      uVar11 = local_830[5];
      *(undefined8 *)((long)puVar28 + 0x2d) = local_830[4];
      *(undefined8 *)((long)puVar28 + 0x35) = uVar11;
      *(undefined2 *)((long)puVar28 + 0x3d) = *(undefined2 *)(local_830 + 6);
      uVar4 = *(undefined1 *)((long)local_830 + 0x32);
      *plVar23 = (long)puVar28;
      *(uint *)(ppuVar30 + 1) = uVar10 - 0x33 >> 6;
      *(undefined1 *)((long)puVar28 + 0x3f) = uVar4;
      *(undefined4 *)(plVar23 + 1) = 1;
      *ppuVar30 = (undefined8 *)((long)local_830 + 0x33);
      if (uVar34 <= (uint)lVar27) break;
      local_830 = ppuVar30[2];
...
LAB_0052d103:
      ...
      do {
        local_818 = &local_7a8;
        FUN_0057d000(local_160,local_810,param_5);
        FUN_0048c980(&local_6a8,param_1,param_5);
        ppuVar19 = &local_6a8;
        plVar23 = local_810;
        if (param_5 != 0) {
          do {
            puVar9 = *local_818;
            *(int *)(local_818 + 1) = *(int *)(local_818 + 1) + -0x20;
            ppuVar30 = local_818 + 2;
            *ppuVar19 = *ppuVar19 + 0x100;
            *(undefined4 *)(plVar23 + 1) = 0x20;
            *local_818 = puVar9 + 0x100;
            ...
            *(undefined4 *)(ppuVar19 + 2) = 0x80;
            ...
            local_818 = ppuVar30;
            plVar23 = plVar23 + 2;
          } while (ppuVar30 != local_798 + (ulong)local_828 * 2);
        }
        uVar26 = uVar26 - 0x20;
        local_830._0_4_ = (int)local_830 + 0x800;
      } while (0x20 < uVar26);
    }
    local_7f0 = &local_6a8;
    local_810 = &local_728;
    local_818 = &local_7a8;
    FUN_0057d000(local_160,local_818,param_5);
    puVar28 = local_568;
    for (lVar27 = 0x80; lVar27 != 0; lVar27 = lVar27 + -1) {
      *puVar28 = 0;
      puVar28 = puVar28 + (ulong)bVar37 * -2 + 1;
    }
    if (param_5 == 0) goto LAB_0052cffc;
    lVar27 = 0;
    puVar28 = local_568;
    uVar26 = 0;
    do {
      ...
      uVar35 = (-0x33 - (int)local_830) + *(int *)((long)local_7a0 + lVar27) * -0x40 + uVar26;
      lVar18 = thunk_FUN_00713a50(puVar28,(ulong)(uint)(*(int *)((long)local_7a0 + lVar27) * 0x40) +
                                          *(long *)((long)local_818 + lVar27),(ulong)uVar35);
      *(undefined1 *)((long)local_568 + (ulong)uVar35 + (ulong)uVar16 * 0x80) = 0x80;
      ...
      uVar26 = uVar26 >> 0x18 | (uVar26 & 0xff0000) >> 8 | (uVar26 & 0xff00) << 8 |
               uVar26 * 0x1000000;
      if (uVar35 < 0x38) {
        *(uint *)(lVar18 + 0x3c) = uVar26;
        uVar15 = 1;
      }
      else {
        *(uint *)(lVar18 + 0x7c) = uVar26;
        uVar15 = 2;
      }
      *(undefined4 *)((long)local_720 + lVar27) = uVar15;
      *(long *)((long)local_810 + lVar27) = lVar18;
      puVar28 = (ulong *)(lVar18 + 0x80);
      lVar27 = lVar27 + 0x10;
      uVar26 = uVar16 + 1;
    } while (uVar34 != uVar16 + 1);
    FUN_0057d000(local_160,local_810,param_5);
    uVar34 = *(uint *)(param_1 + 0x174);
    puVar28 = local_568;
    for (lVar27 = 0x80; lVar27 != 0; lVar27 = lVar27 + -1) {
      *puVar28 = 0;
      puVar28 = puVar28 + (ulong)bVar37 * -2 + 1;
    }
    uVar26 = *(uint *)(param_1 + 0x164);
    uVar35 = *(uint *)(param_1 + 0x168);
    uVar24 = *(uint *)(param_1 + 0x16c);
    ...
    do {
      ...
      *(undefined4 *)(plVar23 + 1) = 1;
      ...
      plVar23 = plVar23 + 2;
      puVar28 = puVar28 + 0x10;
    } while (local_140 + ((ulong)local_828 - 7) != puVar21);
    FUN_0057d000(local_160,local_810,param_5);
    local_818 = (undefined8 **)0x0;
    puVar20 = local_160;
    uVar34 = 0;
    do {
      ...
      thunk_FUN_00713a50(local_7f0[1],*local_7f0,uVar26 - (int)local_830);
      uVar35 = *puVar20;
      ...
      *puVar21 = uVar35 >> 0x18 | (uVar35 & 0xff0000) >> 8 | (uVar35 & 0xff00) << 8 | uVar35 << 0x18
      ...
      puVar20 = puVar20 + 1;
      *(uint *)(local_7f0 + 2) = (uint)((1 - (int)local_830) + iVar14) >> 4;
      ...
      *(ushort *)(param_2 + 3) = uVar13 * 0x100 | uVar13 >> 8;
      local_818 = (undefined8 **)((long)local_818 + (ulong)(iVar14 + 0x16));
  ...
  local_7f0 = &local_6a8;
  FUN_0048c980(local_7f0,param_1,param_5);
  FUN_004227b0(local_568,0x400);
  FUN_004227b0(local_160,0x100);
LAB_0052d06f:
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    FUN_00771f60();
  }
  return (long)local_818;
}
