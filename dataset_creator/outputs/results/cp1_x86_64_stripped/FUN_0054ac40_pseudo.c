...
undefined8 FUN_0054ac40(long param_1,undefined8 *param_2,ulong param_3)

{
  ...
  *(uint *)(param_1 + 0x14) =
  ...
  if (uVar3 == 0) {
    if (param_3 < 0x40) goto LAB_0054aca0;
LAB_0054ad58:
    FUN_0054a690(param_1,param_2,param_3 >> 6);
    ...
    FUN_0054a690(param_1,param_1 + 0x18,1);
    ...
    *(undefined1 (*) [16])(param_1 + 0x48) = (undefined1  [16])0x0;
    if (0x3f < param_3) goto LAB_0054ad58;
  }
  if (param_3 == 0) {
    return 1;
  }
