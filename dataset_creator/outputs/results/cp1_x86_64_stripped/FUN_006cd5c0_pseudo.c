...
void FUN_006cd5c0(long param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  FUN_006cab00(&local_228,&local_138);
  uVar3 = uStack_a0;
  lVar2 = FUN_006cd030(local_a8,uStack_a0,0);
  if (in_SSP != 0) {
    for (; 0xff < local_230; local_230 = local_230 - 0xff) {
    }
  }
  *(undefined8 *)(&stack0x00000000 + lVar2) = uVar3;
                    /* WARNING: Could not recover jumptable at 0x006cd78b. Too many branches */
