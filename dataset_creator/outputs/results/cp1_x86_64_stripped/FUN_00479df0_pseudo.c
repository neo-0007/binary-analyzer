...
undefined8 FUN_00479df0(long param_1,undefined8 param_2)

{
  ...
  iVar2 = FUN_0043c6f0(lVar1,param_2,uVar3);
  if (iVar2 == 0) {
    return 0;
  }
  lVar4 = FUN_0043c7e0(lVar1);
  if (lVar4 != 0) {
    uVar5 = FUN_0040ac60(lVar4);
    if ((uVar5 & 2) != 0) {
      FUN_0051f420();
      FUN_0051f540("../providers/implementations/rands/drbg_hash.c",0x1d8,"drbg_hash_set_ctx_params"
                  );
