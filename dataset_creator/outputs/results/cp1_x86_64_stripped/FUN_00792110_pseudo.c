...
char * FUN_00792110(char *param_1,int param_2,ulong *param_3,long *param_4,long *param_5,
...

{
  ...
  *param_4 = 0;
  if (param_2 < 1) {
    ...
    FUN_006e2220("digcnt > 0","../stdlib/strtod_l.c",0x17b,"str_to_mpn");
  }
  uVar8 = 0;
  iVar7 = 0;
LAB_00792150:
...
LAB_0079216c:
      ...
      cVar2 = param_7[1];
      while (cVar2 != '\0') {
        if (param_1[lVar4] != cVar2) goto LAB_0079216c;
        lVar4 = lVar4 + 1;
        cVar2 = param_7[lVar4];
      }
      ...
      if (*param_4 == 0) {
        ...
        *param_3 = *param_3 + uVar8;
        ...
        if (uVar5 == 0) {
          ...
          if (0x35d < *param_4) {
                    /* WARNING: Subroutine does not return */
            FUN_006e2220("*nsize < MPNSIZE","../stdlib/strtod_l.c",0x18c,"str_to_mpn");
          }
  ...
  if (lVar4 == 0) {
    ...
    *param_3 = *param_3 + uVar8;
    ...
    if (uVar5 != 0) {
      ...
      if (0x35d < lVar4) {
                    /* WARNING: Subroutine does not return */
        FUN_006e2220("*nsize < MPNSIZE","../stdlib/strtod_l.c",0x1c4,"str_to_mpn");
      }
      *param_4 = lVar4 + 1;
      param_3[lVar4] = uVar5;
    }
