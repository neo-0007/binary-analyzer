...
undefined8 FUN_005009d0(long param_1,long param_2,long param_3)

{
  ...
  iVar1 = FUN_004fd8a0(&local_168,*(undefined8 *)(param_1 + 0x10));
  if (iVar1 != 0) {
    iVar1 = FUN_004fd8a0(&local_128,*(undefined8 *)(param_1 + 0x18));
    if (iVar1 != 0) {
      iVar1 = FUN_004fd8a0(&local_1e8,*(undefined8 *)(param_1 + 0x20));
      if (iVar1 != 0) {
        FUN_004febe0(local_1a8,&local_1e8);
        FUN_004fcc90(&local_208,local_1a8);
        FUN_004fcde0(&local_e8,&local_208);
        ...
        FUN_004fd280(&local_1e8,&local_e8);
        FUN_004fcc90(local_228,&local_168);
        FUN_004fcc90(&local_208,&local_1e8);
        FUN_004fcfa0(&local_e8,local_228,&local_208);
        ...
        FUN_004fd280(&local_168,&local_e8);
        FUN_004fd470(&local_248,&local_168);
        if (param_2 == 0) {
LAB_00500ce0:
          FUN_004fcc90(local_228,&local_1e8);
          FUN_004fcc90(&local_208,local_1a8);
          FUN_004fcfa0(&local_e8,local_228,&local_208);
          local_1e8 = local_e8 - 0x1000000010;
          local_1e0 = local_e0 + 0xfffffffff + (ulong)(0x100000000f < local_e8);
          ...
          local_1b0 = local_b0 + 0xfffffffff + (ulong)(0xfffffffef < local_b8);
          FUN_004fd280(&local_1e8,&local_e8);
          FUN_004fcc90(local_228,&local_128);
          FUN_004fcc90(&local_208,&local_1e8);
          FUN_004fcfa0(&local_e8,local_228,&local_208);
          ...
          local_118 = local_d8;
          FUN_004fd280(&local_128,&local_e8);
          FUN_004fd470(&local_208,&local_128);
          if (param_3 != 0) {
            local_68 = local_208;
            local_60 = local_200;
            local_58 = local_1f8;
            local_50 = local_1f0;
            lVar2 = FUN_004b8810(&local_68,0x20,param_3);
            if (lVar2 == 0) {
              FUN_0051f420();
              uVar3 = 0x7bf;
              goto LAB_00500f40;
        ...
        local_58 = local_238;
        local_50 = local_230;
        lVar2 = FUN_004b8810(&local_68,0x20,param_2);
        if (lVar2 != 0) goto LAB_00500ce0;
        FUN_0051f420();
        uVar3 = 0x7b4;
LAB_00500f40:
        FUN_0051f540("../crypto/ec/ecp_nistp256.c",uVar3,
