...
void FUN_0062a780(long param_1,long param_2)
  ...
  *(undefined4 *)(lVar13 + 0x28) = uVar4;
  if (*(int *)(lVar13 + 0x24) == 0) {
    ...
    *(undefined4 *)(lVar13 + 0x24) = 0x2e;
    ...
    pcVar7 = (char *)FUN_006e0b30(0x40008,param_2);
  ...
  local_50 = FUN_006e0b30(0x40001,param_2);
  pcVar7 = (char *)FUN_006e0b30(0x4000e,param_2);
  lVar13 = *(long *)(param_1 + 0x10);
  cVar2 = *pcVar7;
    ...
    *(undefined **)(lVar13 + 0x40) = &DAT_0081da5c;
    ...
    if (lVar8 == 0) {
      ...
      *(undefined1 **)(lVar13 + 0x10) = &DAT_0083e5c2;
      ...
      lVar13 = lVar8 + 1;
                    /* try { // try from 0062ab87 to 0062ab8b has its CatchHandler @ 0062ad3b */
...
LAB_0062aaf4:
    ...
    if (0x1ffffffffffffffe < uVar1) {
      lVar13 = -1;
                    ...
                    /* try { // try from 0062ab21 to 0062ab25 has its CatchHandler @ 0062ad17 */
    ...
    *(undefined **)(lVar13 + 0x50) = &DAT_0081da5c;
    ...
    if (0x1ffffffffffffffe < uVar1) {
      lVar13 = -1;
                    ...
                    /* try { // try from 0062abdd to 0062abe1 has its CatchHandler @ 0062ad2f */
    ...
    *(undefined **)(lVar13 + 0x30) = &DAT_0081da5c;
    ...
    if (0x1ffffffffffffffe < uVar1) {
      lVar13 = -1;
                    ...
                    /* try { // try from 0062ac4d to 0062ac51 has its CatchHandler @ 0062ad23 */
    puVar12 = (undefined *)thunk_FUN_006c31f0(lVar13);
  ...
  *(undefined8 *)(lVar13 + 0x38) = uVar6;
  pcVar7 = (char *)FUN_006e0b30(0x40009,param_2);
  cVar14 = *pcVar7;
  pcVar7 = (char *)FUN_006e0b30(0x4000a,param_2);
  cVar3 = *pcVar7;
  pcVar7 = (char *)FUN_006e0b30(0x4000d,param_2);
  lVar13 = *(long *)(param_1 + 0x10);
  uVar4 = FUN_00629390((int)cVar14,(int)cVar3,(int)*pcVar7);
  *(undefined4 *)(lVar13 + 100) = uVar4;
  pcVar7 = (char *)FUN_006e0b30(0x4000b,param_2);
  cVar14 = *pcVar7;
  pcVar7 = (char *)FUN_006e0b30(0x4000c,param_2);
  lVar13 = *(long *)(param_1 + 0x10);
