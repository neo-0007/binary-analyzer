...
void FUN_006c0770(undefined1 *param_1,undefined8 param_2,undefined4 *param_3)
...
LAB_006c07a3:
    FUN_006c06b0(param_1,0x11,param_3);
    return;
  case 0x22:
    lVar2 = *(long *)(param_1 + 0x100);
    if (lVar2 == 0xff) {
  ...
  case 0x23:
    lVar2 = *(long *)(param_1 + 0x100);
LAB_006c0a6f:
    if (lVar2 != 0xff) goto LAB_006c0a7b;
    param_1[0xff] = 0;
    (**(code **)(param_1 + 0x110))(param_1,0xff,*(undefined8 *)(param_1 + 0x118));
    *(long *)(param_1 + 0x140) = *(long *)(param_1 + 0x140) + 1;
    lVar1 = 1;
...
LAB_006c0aa7:
  ...
  case 0x2b:
    ...
    puVar6 = &DAT_008215bc;
    uVar4 = 0x3a;
    FUN_006c06b0(param_1,0x11,*(undefined8 *)(param_3 + 4));
    lVar2 = *(long *)(param_1 + 0x100);
    while( true ) {
      if (lVar2 == 0xff) {
        param_1[0xff] = 0;
...
LAB_006c0e40:
    ...
    if (lVar2 != 0) {
      ...
      *(long *)(param_1 + 0x100) = lVar3;
      ...
      param_1[0x108] = 0x28;
LAB_006c0e7d:
      FUN_006c06b0(param_1,0x11,lVar2);
      lVar2 = *(long *)(param_1 + 0x100);
      if (lVar2 == 0xff) {
        param_1[0xff] = 0;
        (**(code **)(param_1 + 0x110))(param_1,0xff,*(undefined8 *)(param_1 + 0x118));
