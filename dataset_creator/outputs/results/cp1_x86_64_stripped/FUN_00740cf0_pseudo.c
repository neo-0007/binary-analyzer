...
undefined1 (*) [32]
FUN_00740cf0(undefined1 (*param_1) [32],undefined1 (*param_2) [32],ulong param_3)
...
LAB_007411ac:
      ...
      uVar23 = (ulong)uVar18;
      if ((uint)param_3 <= uVar18) goto LAB_007415e4;
    }
    else {
      if (uVar20 == 0) {
        *param_1 = *param_2;
...
LAB_00741165:
      ...
      uVar23 = (ulong)uVar20;
      if ((uint)param_3 <= uVar20) goto LAB_007415e4;
      goto LAB_00740fd9;
    }
    if (uVar18 != 0) goto LAB_00741420;
    param_1[2] = auVar30;
    auVar29 = param_2[3];
    ...
    bVar27 = param_3 < 0x20;
    param_3 = uVar23 - 0x80;
    if (bVar27 || param_3 == 0) goto LAB_00741160;
    if (uVar18 != 0) {
LAB_007410f0:
...
LAB_00741510:
      if (uVar18 != 0) {
        ...
        uVar18 = (uint)(SUB321(auVar7 >> 7,0) & 1) | (uint)(SUB321(auVar7 >> 0xf,0) & 1) << 1 |
                 ...
                 (uint)(byte)(auVar7[0x1f] >> 7) << 0x1f;
        param_3 = uVar24 + 0x60;
        if (param_3 == 0 || SCARRY8(uVar24,0x60) != (long)param_3 < 0) goto LAB_00741160;
        if (uVar18 != 0) goto LAB_007410e0;
        auVar7 = vpcmpeqb_avx2(auVar28,auVar29);
        uVar18 = (uint)(SUB321(auVar7 >> 7,0) & 1) | (uint)(SUB321(auVar7 >> 0xf,0) & 1) << 1 |
                 (uint)(SUB321(auVar7 >> 0x17,0) & 1) << 2 |
                 (uint)(SUB321(auVar7 >> 0x1f,0) & 1) << 3 |
...
LAB_00740ed5:
  ...
  *pauVar16 = auVar30;
  ...
  pauVar22 = pauVar21;
  pauVar16 = param_1;
  if (bVar27 || uVar24 == 0) goto LAB_00741510;
  goto joined_r0x00740ed3;
}
