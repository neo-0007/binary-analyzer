...
ulong FUN_006ff980(uint *param_1)

{
  ...
  if (((*param_1 & 0x800) != 0) && (iVar5 = FUN_006ff780(param_1), iVar5 == -1)) {
    return 0xffffffff;
  }
  ...
  if (puVar2 <= puVar7) {
    ...
    if ((*param_1 & 0x100) != 0) {
      ...
      *puVar1 = puVar7;
      puVar1[1] = puVar8;
      if (puVar7 < puVar8) goto LAB_006ffa78;
    }
    if (*(long *)(param_1 + 0x18) == 0) {
      if (*(long *)(param_1 + 0x12) != 0) {
        FUN_007104f0(puVar1[8],puVar8);
    ...
    if (0x827 < lVar4 - 0x93f160U) {
      FUN_00703130();
                    ...
                    /* WARNING: Could not recover jumptable at 0x006ffa50. Too many branches */
