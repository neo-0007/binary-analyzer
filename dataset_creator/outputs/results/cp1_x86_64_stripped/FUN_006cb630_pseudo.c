...
void FUN_006cb630(undefined8 *param_1,long *param_2)

{
  ...
  if (((((ulong)param_1[0x18] >> 0x3e & 1) == 0) ||
    ...
    if (DAT_00945617 != '\b') goto thunk_FUN_00404713;
...
thunk_FUN_00404713:
    ...
    if (((local_68 & 0x4000000000000000) == 0) || (*(char *)((long)&uStack_50 + lVar4) == '\0')) {
      if ((&DAT_00945610)[lVar4] != '\b') goto thunk_FUN_00404713;
    ...
    lVar4 = FUN_006cae60(pbVar10,pbVar10 + uVar11,local_128,0);
  }
  pbVar10 = &DAT_00945610;
...
LAB_006cb870:
  ...
  case 1:
    ...
    goto joined_r0x006cb9a6;
  case 2:
    lVar7 = (long)(int)*plVar9;
    if (*(char *)((long)&uStack_50 + lVar7) == '\0') {
      puVar6 = (undefined8 *)local_128[lVar7];
      if (uVar15 == 0) goto LAB_006cb905;
      goto LAB_006cb9c1;
    }
    if (0x11 < (int)*plVar9) goto thunk_FUN_00404713;
    puVar6 = (undefined8 *)local_128[lVar7];
    if ((local_68 & 0x4000000000000000) == 0) {
      if ((&DAT_00945610)[lVar7] == '\b') {
        puVar6 = (undefined8 *)*puVar6;
        goto LAB_006cb8f6;
      }
      goto thunk_FUN_00404713;
    }
    goto LAB_006cb8f6;
  case 3:
    pbVar12 = (byte *)*plVar9;
    ...
    puVar6 = (undefined8 *)FUN_006cae60(pbVar12,pbVar12 + uVar11,local_128);
joined_r0x006cb9a6:
    if (uVar15 != 0) {
LAB_006cb9c1:
...
LAB_006cb8f6:
  ...
  case 5:
    ...
    uVar5 = FUN_006cae60(pbVar12,pbVar12 + uVar11,local_128,lVar4);
    if (8 < *pbVar10) goto thunk_FUN_00404713;
    *(undefined1 *)puVar14 = 1;
    *puVar13 = uVar5;
  }
  pbVar10 = pbVar10 + 1;
