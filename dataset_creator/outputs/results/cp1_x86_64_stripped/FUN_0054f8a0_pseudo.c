...
void FUN_0054f8a0(ulong *param_1,ulong *param_2,ulong *param_3,long param_4)

{
  ...
  do {
    ...
    *param_1 = uVar9 ^ uVar10;
    ...
    uVar12 = (uVar11 ^ (ulong)*(ushort *)(&LAB_00551380 + ((local_148[uVar5] ^ uVar9) & 0xff) * 2)
    ...
    uVar8 = (uVar12 ^ (ulong)*(ushort *)(&LAB_00551380 + ((local_148[uVar2] ^ uVar8) & 0xff) * 2) <<
    ...
    uVar7 = uVar3 >> 0x1c;
    uVar11 = (uVar8 ^ (ulong)*(ushort *)(&LAB_00551380 + ((local_148[uVar6] ^ uVar9) & 0xff) * 2) <<
    ...
    uVar2 = (uVar3 << 8) >> 0x1c;
    uVar8 = (uVar11 ^ (ulong)*(ushort *)(&LAB_00551380 + ((local_148[uVar5] ^ uVar10) & 0xff) * 2)
    ...
    uVar6 = (uVar3 << 0x10) >> 0x1c;
    uVar11 = (uVar8 ^ (ulong)*(ushort *)(&LAB_00551380 + ((local_148[uVar7] ^ uVar9) & 0xff) * 2) <<
    ...
    uVar8 = (uVar11 ^ (ulong)*(ushort *)(&LAB_00551380 + ((local_148[uVar2] ^ uVar10) & 0xff) * 2)
                      << 0x30) >> 8 ^ local_b8[uVar6] ^ *(ulong *)((long)param_2 + uVar4);
    ...
    uVar10 = (uVar11 ^ (ulong)*(ushort *)(&LAB_00551380 + ((local_148[uVar2] ^ uVar10) & 0xff) * 2)
                       << 0x30) >> 8 ^ local_b8[uVar5] ^ *(ulong *)((long)param_2 + uVar4);
    uVar4 = (uVar8 ^ uVar11 << 0x38) >> 4 ^ *(ulong *)((long)param_2 + (ulong)(uVar3 & 0xf0) + 8);
    uVar11 = (uVar10 ^ (ulong)*(ushort *)(&LAB_00551380 + ((local_148[uVar5] ^ uVar9) & 0xff) * 2)
    ...
    uVar9 = uVar11 ^ (ulong)*(ushort *)(&LAB_00551380 + (ulong)(byte)((char)uVar8 << 4) * 2) << 0x30
    ;
