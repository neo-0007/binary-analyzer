...
undefined8 FUN_00533fe0(long param_1,long param_2,long param_3,ulong param_4)

{
  ...
  if (0x3fffffffffffffff < param_4) {
    do {
      ...
      FUN_005704d0(lVar4,lVar3,0x4000000000000000,uVar2,param_1 + 0x28,uVar1);
  ...
  if (uVar5 != 0) {
    uVar1 = FUN_004098b0(param_1);
    uVar2 = FUN_004098f0(param_1);
    FUN_005704d0(local_48,local_50,uVar5,uVar2,param_1 + 0x28,uVar1);
  }
  return 1;
}
