...
undefined8 FUN_00479030(long param_1)

{
  ulong uVar1;
  long lVar2;
  
  lVar2 = FUN_0041bfc0(0xb0,"../providers/implementations/rands/drbg_ctr.c",0x24f);
  if (lVar2 != 0) {
  ...
  FUN_0051f420();
  FUN_0051f540("../providers/implementations/rands/drbg_ctr.c",0x251,"drbg_ctr_new");
