...
bool FUN_004607c0(undefined8 *param_1,undefined8 param_2,long param_3,long param_4,byte param_5,
...
LAB_004607ef:
    FUN_0051f420();
    FUN_0051f540("../providers/implementations/encode_decode/encode_key2any.c",0x5a4,
                 "ec_to_EC_pem_encode");
  ...
  if ((param_5 & 1) == 0) {
    if ((param_5 & 0x84) == 0) goto LAB_004607ef;
    if (param_3 == 0) goto LAB_00460910;
    lVar2 = FUN_0043bf50(*param_1);
    if (lVar2 == 0) goto LAB_00460880;
