...
bool FUN_007af030(long param_1,long param_2)

{
  ...
  if (lVar4 != 0) {
    ...
    uVar11 = lVar8 + 1;
    iVar6 = thunk_FUN_00712780(lVar3,*puVar7);
    if (iVar6 != 0) {
      return false;
    }
    if (lVar4 != 1) {
      ...
      if (lVar3 != 0) {
        lVar9 = thunk_FUN_007129d0();
        uVar11 = lVar8 + 2 + lVar9;
        iVar6 = thunk_FUN_00712780(lVar3,puVar7[1]);
        if (iVar6 != 0) {
          return false;
        }
        if (lVar4 == 2) goto LAB_007af38d;
        lVar3 = *(long *)(param_1 + 0x58);
        if (lVar3 != 0) {
          lVar8 = thunk_FUN_007129d0(lVar3);
          uVar11 = uVar11 + 1 + lVar8;
          iVar6 = thunk_FUN_00712780(lVar3,puVar7[2]);
          if (iVar6 != 0) {
            return false;
          }
          if (lVar4 == 3) goto LAB_007af38d;
          lVar3 = *(long *)(param_1 + 0x60);
          if (lVar3 != 0) {
            lVar8 = thunk_FUN_007129d0(lVar3);
            uVar11 = uVar11 + 1 + lVar8;
            iVar6 = thunk_FUN_00712780(lVar3,puVar7[3]);
            if (iVar6 != 0) {
              return false;
            }
            if (lVar4 == 4) goto LAB_007af38d;
            lVar3 = *(long *)(param_1 + 0x68);
            if (lVar3 != 0) {
              lVar8 = thunk_FUN_007129d0(lVar3);
              uVar11 = uVar11 + 1 + lVar8;
              iVar6 = thunk_FUN_00712780(lVar3,puVar7[4]);
              if (iVar6 != 0) {
                return false;
              }
              if (lVar4 == 5) goto LAB_007af38d;
              if (*(long *)(param_1 + 0x70) != 0) {
                iVar6 = thunk_FUN_00712780(*(long *)(param_1 + 0x70),puVar7[5]);
                if (iVar6 != 0) {
                  return false;
                }
                if (((lVar4 != 6) && (*(long *)(param_1 + 0x78) != 0)) &&
                   (iVar6 = thunk_FUN_00712780(*(long *)(param_1 + 0x78),puVar7[6]), iVar6 != 0)) {
                  return false;
                }
                goto LAB_007af38d;
              }
