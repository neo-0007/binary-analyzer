...
void FUN_00491cc0(undefined1 (*param_1) [16],long param_2,long param_3,undefined1 (*param_4) [16],
...

{
  ...
  uVar18 = param_6[6];
  uVar17 = param_6[7];
  auVar1 = *(undefined1 (*) [16])(&DAT_00490c20 + lVar21 * 8);
  auVar2 = *(undefined1 (*) [16])(&DAT_00490c30 + lVar21 * 8);
  auVar3 = *(undefined1 (*) [16])(&DAT_00490c40 + lVar21 * 8);
  auVar32 = *param_4;
  do {
    auVar29 = vpshufb_avx(*(undefined1 (*) [16])(param_7 + (long)param_1),_DAT_00490c00);
    auVar24 = vpshufb_avx(*(undefined1 (*) [16])(param_7 + 0x10 + (long)param_1),_DAT_00490c00);
    auVar25 = vpshufb_avx(*(undefined1 (*) [16])(param_7 + 0x20 + (long)param_1),_DAT_00490c00);
    local_c0 = vpaddd_avx(auVar29,_DAT_00490a00);
    auVar4 = vpshufb_avx(*(undefined1 (*) [16])(param_7 + 0x30 + (long)param_1),_DAT_00490c00);
    local_b0 = vpaddd_avx(auVar24,_DAT_00490a20);
    local_a0 = vpaddd_avx(auVar25,_DAT_00490a40);
    local_90 = vpaddd_avx(auVar4,_DAT_00490a60);
    uVar12 = uVar10 ^ uVar7;
    pauVar11 = (undefined1 (*) [16])&DAT_00490a00;
    do {
      pauVar14 = param_1;
