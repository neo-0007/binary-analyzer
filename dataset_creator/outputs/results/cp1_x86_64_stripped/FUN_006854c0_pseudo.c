...
undefined1  [16]
FUN_006854c0(undefined8 param_1,long *param_2,undefined8 param_3,long *param_4,undefined8 param_5,
...
LAB_00685576:
      ...
      if ((bVar24) || (*(char *)(lVar11 + 0x6f) == cVar6)) {
        ...
        if (((cVar8 != '\0') && (*(char *)(lVar11 + 0x49) == cVar6)) ||
           (*(char *)(lVar11 + 0x48) == cVar6)) goto LAB_00685679;
...
LAB_00685bd0:
          ...
          if (*(char *)(lVar11 + 0x72) == cVar6) {
            ...
            uVar22 = 8;
            uVar12 = local_68[2];
            if ((ulong)local_68[3] <= uVar12) goto LAB_00685950;
LAB_006856ff:
            local_68[2] = uVar12 + 1;
LAB_0068570f:
            local_60 = 0xffffffff;
...
LAB_006856ec:
            uVar12 = local_68[2];
            bVar15 = bVar21;
            if (uVar12 < (ulong)local_68[3]) goto LAB_006856ff;
LAB_00685950:
            (**(code **)(*local_68 + 0x50))();
            local_60 = 0xffffffff;
            if (local_68 != (long *)0x0) goto LAB_0068570f;
            bVar21 = true;
          }
...
joined_r0x00685758:
    ...
    uVar22 = 10;
    if (uVar23 != 8) goto LAB_0068554f;
    uVar22 = 0x10;
    cVar6 = FUN_00681960(&local_68);
    if (cVar6 == '\0') goto LAB_00685576;
    bVar24 = false;
    cVar8 = *(char *)(lVar11 + 0x20);
    uVar9 = 0;
    bVar15 = false;
...
LAB_006857ce:
      ...
      iVar10 = (int)cVar8;
      if (uVar23 < 0xb) {
        if ((cVar8 < '0') || ((char)(local_98 + '0') <= cVar8)) goto LAB_00685bc0;
      }
      else if (9 < (byte)(cVar8 - 0x30U)) goto LAB_006859bc;
      iVar10 = iVar10 + -0x30;
LAB_006857f2:
      if (uVar13 <= uVar12) goto LAB_006859d8;
LAB_006857fc:
      local_7b = 1;
      uVar18 = local_68[2];
      if ((ulong)local_68[3] <= uVar18) goto LAB_00685a08;
LAB_00685814:
      local_68[2] = uVar18 + 1;
      do {
        local_60 = 0xffffffff;
        bVar21 = false;
                    /* try { // try from 00685e69 to 00685e6b has its CatchHandler @ 00685f28 */
        if (((ulong)local_68[3] <= (ulong)local_68[2]) &&
        ...
        while( true ) {
          ...
          uVar9 = local_60;
          if ((local_60 != 0xffffffff) || (local_68 == (long *)0x0)) goto LAB_006857ce;
          if ((byte *)local_68[2] < (byte *)local_68[3]) {
            uVar9 = (uint)*(byte *)local_68[2];
            goto LAB_006857ce;
          }
                    /* try { // try from 00685ec7 to 00685ec9 has its CatchHandler @ 00685f28 */
          uVar9 = (**(code **)(*local_68 + 0x48))();
          if (uVar9 != 0xffffffff) goto LAB_006857ce;
          local_68 = (long *)0x0;
          if (uVar23 < 0xb) goto LAB_00685bc0;
          cVar8 = -1;
          iVar10 = -1;
LAB_006859bc:
          if (5 < (byte)(cVar8 + 0x9fU)) {
            if (5 < (byte)(cVar8 + 0xbfU)) goto LAB_00685bc0;
            iVar10 = iVar10 + -0x37;
            goto LAB_006857f2;
          }
          iVar10 = iVar10 + -0x57;
          if (uVar12 < uVar13) goto LAB_006857fc;
LAB_006859d8:
          ...
          uVar18 = local_68[2];
          local_80 = local_80 + 1;
          if (uVar18 < (ulong)local_68[3]) goto LAB_00685814;
LAB_00685a08:
                    /* try { // try from 00685a18 to 00685a1a has its CatchHandler @ 00685f28 */
          (**(code **)(*local_68 + 0x50))();
          local_60 = 0xffffffff;
    ...
    if ((cVar20 != '\0') && (*(char *)(lVar11 + 0x49) == (char)uVar9)) goto LAB_00685cd1;
LAB_00685c13:
    if (((char)uVar9 != *(char *)(lVar11 + 0x48)) &&
      ...
      local_7b = bVar5;
      uVar18 = local_68[2];
      if ((ulong)local_68[3] <= uVar18) goto LAB_00685d0a;
      do {
        local_68[2] = uVar18 + 1;
        while( true ) {
          local_60 = 0xffffffff;
...
LAB_00685b1a:
      if (cVar20 == '\0') {
        ...
        goto LAB_0068589e;
                    ...
                    /* try { // try from 00685ad5 to 00685d79 has its CatchHandler @ 00685f28 */
    FUN_006390c0(&local_48,(int)(char)local_80);
    cVar6 = FUN_006c6980(*(undefined8 *)(lVar11 + 0x10),*(undefined8 *)(lVar11 + 0x18),&local_48);
    if (cVar6 == '\0') {
      *param_7 = 4;
    }
    if (((local_80 != 0) || (bVar15)) || (*(long *)(local_48 + -0x18) != 0)) goto LAB_00685b1a;
  }
  *param_8 = 0;
  *param_7 = 4;
LAB_0068589e:
