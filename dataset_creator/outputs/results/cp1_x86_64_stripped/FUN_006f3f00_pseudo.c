...
void FUN_006f3f00(long param_1,long param_2,ulong param_3,long param_4)

{
  ...
  if ((param_3 & 1) != 0) {
    lVar7 = param_3 - 1;
    if (lVar7 < 0x20) {
      FUN_006f3db0(param_1,param_2,lVar7);
    }
    else {
      FUN_006f3f00(param_1,param_2,lVar7);
    }
    puVar1 = (undefined8 *)(param_2 + lVar7 * 8);
    lVar12 = lVar7 * 8 + param_1;
    uVar6 = FUN_00791fe0(lVar12,param_2,lVar7,*puVar1);
    *(undefined8 *)(param_1 + lVar7 * 0x10) = uVar6;
    uVar6 = FUN_00791fe0(lVar12,param_2,param_3,*puVar1);
  ...
  if ((long)uVar11 < 0x20) {
    FUN_006f3db0(plVar2,lVar7,uVar11);
  }
  else {
    FUN_006f3f00(plVar2,lVar7,uVar11);
  }
  iVar5 = FUN_006f2ee0(lVar7,param_2,uVar11);
  if (iVar5 < 0) {
    FUN_006f44e0(param_1,param_2,lVar7,uVar11);
  }
  else {
    FUN_006f44e0(param_1,lVar7,param_2,uVar11);
  }
  if ((long)uVar11 < 0x20) {
    FUN_006f3db0(param_4,param_1,uVar11);
    if (0 < (long)uVar11) goto LAB_006f404a;
    puVar10 = (ulong *)(param_1 + (uVar11 + param_3) * 8);
    local_50 = FUN_006f2e30(plVar2,plVar2,puVar10,uVar11);
    lVar7 = FUN_006f44e0(param_1 + lVar12,param_1 + lVar12,param_4,param_3);
    local_50 = local_50 - lVar7;
LAB_006f42a0:
    FUN_006f3db0(param_4,param_2,uVar11);
    lVar7 = FUN_006f2e30(param_1 + lVar12,param_1 + lVar12,param_4,param_3);
...
LAB_006f42d5:
    ...
    if ((long)uVar11 < 1) goto LAB_006f41b1;
  }
  else {
    FUN_006f3f00(param_4,param_1,uVar11,param_4 + lVar3);
LAB_006f404a:
    ...
    puVar10 = (ulong *)(param_1 + (uVar11 + param_3) * 8);
    local_50 = FUN_006f2e30(plVar2,plVar2,puVar10,uVar11);
    lVar7 = FUN_006f44e0(lVar13,lVar13,param_4,param_3);
    local_50 = local_50 - lVar7;
    if ((long)uVar11 < 0x20) goto LAB_006f42a0;
    FUN_006f3f00(param_4,param_2,uVar11,lVar3 + param_4);
    lVar7 = FUN_006f2e30(lVar13,lVar13,param_4,param_3);
    uVar8 = lVar7 + local_50;
    if ((uVar8 != 0) && (uVar4 = *puVar10, *puVar10 = *puVar10 + uVar8, CARRY8(uVar4,uVar8)))
    goto LAB_006f42d5;
  }
...
LAB_006f41b1:
  lVar7 = FUN_006f2e30(param_1 + lVar12,param_1 + lVar12,lVar12 + param_4,uVar11);
