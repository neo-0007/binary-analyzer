...
undefined8 FUN_0054b1a0(undefined4 *param_1,undefined4 *param_2)

{
  ...
  uVar2 = param_2[0x16];
  *(undefined1 *)((long)param_2 + (ulong)uVar2 + 0x18) = 0x80;
  uVar3 = (ulong)uVar2 + 1;
  if (uVar3 < 0x39) {
    uVar6 = 0x38 - uVar3;
  ...
  *(undefined8 *)(param_2 + 0x14) = *(undefined8 *)(param_2 + 4);
  FUN_00603630(param_2,puVar1,1);
  param_2[0x16] = 0;
