...
undefined8 FUN_0040cc20(long param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if (piVar1 != (int *)0x0) {
    if (((*piVar1 == 0x100) && (*(long *)(piVar1 + 0xc) != 0)) && (*(long *)(piVar1 + 10) != 0)) {
      UNRECOVERED_JUMPTABLE = *(code **)(*(long *)(piVar1 + 10) + 0x90);
      if (UNRECOVERED_JUMPTABLE == (code *)0x0) {
        FUN_0051f420();
        FUN_0051f540("../crypto/evp/m_sigver.c",0x1c0,"EVP_DigestVerifyUpdate");
        FUN_0051f8f0(6,0xc0101,0);
        return 0;
      }
                    /* WARNING: Could not recover jumptable at 0x0040cc69. Too many branches */
