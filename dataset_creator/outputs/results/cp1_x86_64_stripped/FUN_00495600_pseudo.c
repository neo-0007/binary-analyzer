...
undefined8
FUN_00495600(uint *param_1,undefined1 (*param_2) [16],ulong param_3,uint *param_4,int param_5)
  ...
  if (param_3 != 0) {
    ...
    if (param_5 == 0) {
      if (0x7f < param_3) {
        ...
        while( true ) {
          FUN_004954f0(uVar4,param_1,param_2,param_3 - 0x80,param_4);
          uVar4 = *param_4;
      ...
      if (0x7f < param_3) {
        ...
        uVar26 = *(undefined8 *)(param_1 + 0x1e);
        param_1 = param_1 + 0x20;
        while (FUN_004953e0(param_1,param_2,param_3 - 0x80,param_4), param_3 = extraout_RDX,
              0x7f < extraout_RDX) {
          *(undefined8 *)*param_2 = uVar5;
          *(undefined8 *)(*param_2 + 8) = uVar11;
          uVar5 = *(undefined8 *)param_1;
