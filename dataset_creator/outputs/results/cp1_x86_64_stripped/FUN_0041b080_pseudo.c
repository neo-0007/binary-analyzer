...
void FUN_0041b080(long param_1,int param_2,long param_3)
    ...
    if ((bVar1 >> (ulong)uVar3 & 1) == 0) {
      *pbVar2 = bVar1 | (byte)(1L << (sbyte)uVar3);
      return;
                    ...
                    /* WARNING: Subroutine does not return */
    FUN_00418e30("assertion failed: !TESTBIT(table, bit)","../crypto/mem_sec.c",0x15d);
  }
                    /* WARNING: Subroutine does not return */
  FUN_00418e30("assertion failed: bit > 0 && bit < sh.bittable_size","../crypto/mem_sec.c",0x15c);
}
