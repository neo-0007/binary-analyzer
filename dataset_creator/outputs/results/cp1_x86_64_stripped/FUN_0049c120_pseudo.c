...
undefined8 FUN_0049c120(undefined8 param_1,undefined8 param_2,undefined1 (*param_3) [16])

{
  ...
  auVar6 = pshufb(_DAT_0049ca10,in_XMM0 & in_XMM9);
  auVar5 = pshufb(_DAT_0049ca20,auVar5);
  uVar4 = ((long)puVar3 << 4 ^ 0x30U) & 0x30;
  auVar5 = auVar5 ^ auVar6 ^ *param_3;
  param_3 = param_3 + 1;
  auVar6 = _DAT_0049c8a0;
  puVar2 = &DAT_0049ca50 + uVar4;
  while( true ) {
    ...
    auVar9 = pshufb(_DAT_0049ca30,auVar8);
    auVar7 = pshufb(_DAT_0049ca40,auVar5);
    auVar11 = pshufb(_DAT_0049ca50,auVar8);
    auVar7 = pshufb(*param_3 ^ auVar9 ^ auVar7,auVar6);
    auVar9 = pshufb(_DAT_0049ca60,auVar5);
    auVar10 = pshufb(_DAT_0049ca70,auVar8);
    auVar7 = pshufb(auVar7 ^ auVar11 ^ auVar9,auVar6);
    auVar9 = pshufb(_DAT_0049ca80,auVar5);
    auVar8 = pshufb(_DAT_0049ca90,auVar8);
    auVar7 = pshufb(auVar7 ^ auVar10 ^ auVar9,auVar6);
    auVar5 = pshufb(_DAT_0049caa0,auVar5);
    param_3 = param_3 + 1;
  ...
  auVar7 = pshufb(_DAT_0049cab0,auVar8);
  auVar6 = pshufb(_DAT_0049cac0,auVar5);
  auVar6 = pshufb(auVar6 ^ auVar7 ^ *param_3,*(undefined1 (*) [16])(&DAT_0049c8f0 + uVar4));
  return auVar6._0_8_;
}
