...

{
  ...
  auVar2 = in_RCX[1];
  auVar3 = *in_R8;
  auVar4 = vpshufd_avx(s_expand_32_byte_k_004c7800._0_16_,0);
  auVar5 = vpshufd_avx(s_expand_32_byte_k_004c7800._0_16_,0x55);
  auVar6 = vpshufd_avx(s_expand_32_byte_k_004c7800._0_16_,0xaa);
  auVar7 = vpshufd_avx(s_expand_32_byte_k_004c7800._0_16_,0xff);
  ...
  vpaddd_avx(auVar2,_DAT_004c7660);
