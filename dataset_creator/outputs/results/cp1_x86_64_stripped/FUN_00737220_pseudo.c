...
ulong FUN_00737220(undefined1 (*param_1) [16],undefined1 (*param_2) [16],ulong param_3)

{
  ...
  if (uVar22 != uVar20) {
    ...
    uVar21 = (*(code *)(&DAT_0082bd70 + *(int *)(&DAT_0082bd70 + ((uVar21 + 0xf) - uVar24) * 4)))
...
LAB_00739740:
  ...
  return (ulong)(uint)(*(int *)(&DAT_00831080 + (ulong)(byte)(*param_1)[uVar21] * 4) -
                      *(int *)(&DAT_00831080 + (ulong)(byte)(*param_2)[uVar21] * 4));
}
