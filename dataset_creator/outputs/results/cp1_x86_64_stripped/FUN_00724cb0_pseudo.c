...
undefined8 * FUN_00724cb0(undefined8 *param_1,undefined8 *param_2,ulong param_3)

{
  ...
  if (param_2 <= param_1) {
    ...
    if (0x4f < param_3) {
        ...
        if (((ulong)(lVar27 - lVar30) < uVar21) && ((ulong)(lVar27 - lVar30) < uVar29)) {
          ...
          puVar19 = (undefined8 *)
                    (*(code *)((long)&switchD_00724ce4::switchdataD_0082b030 +
                              (long)(int)(&switchD_00724ce4::switchdataD_0082b030)[uVar29]))
                              (lVar27,lVar30,
                               (code *)((long)&switchD_00724ce4::switchdataD_0082b030 +
                                       (long)(int)(&switchD_00724ce4::switchdataD_0082b030)[uVar29])
                              );
      ...
      uVar29 = uVar20 & 0xf;
      if (uVar29 != 0) {
        lVar30 = (long)*(int *)(&DAT_0082b1b0 + uVar29 * 4);
        switch(uVar29) {
        case 1:
          UNRECOVERED_JUMPTABLE_00 = (code *)((long)&UINT_0082b1d8 + lVar30);
          if (DAT_0093d718 <= uVar21) {
            UNRECOVERED_JUMPTABLE_00 = (code *)((long)&UINT_0082b1d0 + lVar30 + 1);
          }
                    /* WARNING: Could not recover jumptable at 0x007252bb. Too many branches */
                    /* WARNING: Treating indirect jump as call */
          puVar19 = (undefined8 *)
                    (*UNRECOVERED_JUMPTABLE_00)
                              (uVar25,uVar20,uVar21 - 0x40,DAT_0093d718,puVar19,
                               UNRECOVERED_JUMPTABLE_00);
          return puVar19;
        case 2:
          UNRECOVERED_JUMPTABLE_00 = (code *)((long)&UINT_0082b1d8 + lVar30);
  ...
  if (uVar29 != 0) {
    lVar30 = (long)*(int *)(&DAT_0082b170 + uVar29 * 4);
    switch(uVar29) {
    case 1:
      UNRECOVERED_JUMPTABLE_00 = (code *)((long)&UINT_0082b198 + lVar30);
      if (DAT_0093d718 <= param_3) {
        UNRECOVERED_JUMPTABLE_00 = (code *)((long)&UINT_0082b190 + lVar30 + 1);
      }
                    /* WARNING: Could not recover jumptable at 0x0072520b. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      puVar19 = (undefined8 *)
                (*UNRECOVERED_JUMPTABLE_00)
                          (puVar19,param_2,param_3 - 0x40,DAT_0093d718,param_1,
                           UNRECOVERED_JUMPTABLE_00);
      return puVar19;
    case 2:
      UNRECOVERED_JUMPTABLE_00 = (code *)((long)&UINT_0082b198 + lVar30);
    ...
    case 7:
      ...
      break;
    case 8:
      UNRECOVERED_JUMPTABLE_00 = (code *)((long)&UINT_0082b194 + lVar30 + 2);
      if (DAT_0093d718 <= param_3) {
        UNRECOVERED_JUMPTABLE_00 = (code *)((long)&UINT_0082b18c + lVar30 + 3);
      }
