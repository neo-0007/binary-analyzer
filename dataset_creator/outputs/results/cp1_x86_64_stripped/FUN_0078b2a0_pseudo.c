...
undefined8
FUN_0078b2a0(undefined4 param_1,undefined8 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  UNRECOVERED_JUMPTABLE =
       (code *)FUN_007ba770(unaff_retaddr,param_15,param_16,auStack_3a8 + 1,&local_10);
  uVar6 = auStack_3a8[3];
  uVar5 = auStack_3a8[2];
  uVar7 = auStack_3a8[1];
  if (local_10 < 0) {
                    /* WARNING: Could not recover jumptable at 0x0078b3a6. Too many branches */
  ...
  uVar2 = puVar10[4];
  uVar3 = puVar10[5];
  *(undefined8 *)((long)auStack_3a8 + lVar4) = 0x78b3d4;
  ...
  *(unkbyte10 *)(puVar9 + 0xffffffffffffffea) = in_ST1;
  puVar10 = local_8;
  puVar9[0xffffffffffffffe1] = 0x78b408;
  FUN_0078f3f0(unaff_retaddr,param_15,puVar10);
  return *puVar8;
}
