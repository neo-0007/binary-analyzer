...
ulong FUN_007067b0(uint *param_1)

{
  ...
  if (0x827 < lVar1 - 0x93f160U) {
    FUN_00703130();
                    ...
                    /* WARNING: Could not recover jumptable at 0x0070687b. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  uVar4 = (**(code **)(lVar1 + 0x28))(param_1);
  return uVar4;
}
