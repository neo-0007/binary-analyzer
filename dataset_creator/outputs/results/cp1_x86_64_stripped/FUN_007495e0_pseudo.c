...
void FUN_007495e0(char *param_1,undefined1 (*param_2) [16])
...
LAB_00749853:
  ...
  if (((ulong)param_2 & 0x3f) < 0x21) {
    ...
    if (uVar31 != 0) {
      for (; (uVar31 >> lVar27 & 1) == 0; lVar27 = lVar27 + 1) {
                    ...
                    /* WARNING: Could not recover jumptable at 0x00749b5b. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&DAT_0082c084 + *(int *)(&DAT_0082c084 + lVar27 * 4)))
              (pauVar37,param_2,lVar27,&DAT_0082c084 + *(int *)(&DAT_0082c084 + lVar27 * 4));
    return;
  }
  ...
  if (uVar3 != 0) {
    ...
    if (uVar3 != 0) {
      for (; (uVar3 >> lVar27 & 1) == 0; lVar27 = lVar27 + 1) {
                    ...
                    /* WARNING: Could not recover jumptable at 0x00749b36. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&DAT_0082c084 + *(int *)(&DAT_0082c084 + lVar27 * 4)))
              (pauVar37,pcVar33 + uVar31,lVar27,&DAT_0082c084 + *(int *)(&DAT_0082c084 + lVar27 * 4)
              );
    return;
  }
  ...
  if (uVar3 != 0) {
    ...
    lVar27 = (lVar27 + 0x10) - uVar31;
                    /* WARNING: Could not recover jumptable at 0x00749b7d. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&DAT_0082c084 + *(int *)(&DAT_0082c084 + lVar27 * 4)))
              (pauVar37,pcVar33 + uVar31,lVar27,&DAT_0082c084 + *(int *)(&DAT_0082c084 + lVar27 * 4)
              );
  ...
  *(undefined8 *)((long)pauVar37 + (0x18 - uVar31)) = uVar26;
            ...
            if (uVar32 == 0) {
              ...
              *(byte *)((long)pauVar37 + (0x7f - uVar31)) = bVar123;
              ...
              if (uVar3 != 0) {
                ...
                if (uVar3 != 0) {
                  for (; (uVar3 >> lVar27 & 1) == 0; lVar27 = lVar27 + 1) {
                    ...
                    /* WARNING: Could not recover jumptable at 0x00749b93. Too many branches */
                    /* WARNING: Treating indirect jump as call */
                (*(code *)(&DAT_0082c084 + *(int *)(&DAT_0082c084 + lVar27 * 4)))();
                return;
              }
              if (uVar4 != 0) {
                ...
                *pbVar36 = bVar123;
                ...
                pbVar36[0xe] = bVar165;
                pbVar36[0xf] = bVar168;
                    /* WARNING: Could not recover jumptable at 0x00749bbf. Too many branches */
                    /* WARNING: Treating indirect jump as call */
                (*(code *)(&DAT_0082c084 + *(int *)(&DAT_0082c084 + lVar27 * 4)))
                          (pbVar36 + 0x10,pbVar35 + 0x10,lVar27,
                           &DAT_0082c084 + *(int *)(&DAT_0082c084 + lVar27 * 4));
                return;
              }
              ...
              if (uVar3 != 0) {
                ...
                *pbVar36 = bVar123;
                ...
                pbVar36[0x1f] = bVar170;
                    /* WARNING: Could not recover jumptable at 0x00749bf4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
                (*(code *)(&DAT_0082c084 + *(int *)(&DAT_0082c084 + lVar27 * 4)))
              ...
              *pbVar36 = bVar123;
              ...
              pbVar36[0x2f] = bVar122;
                    /* WARNING: Could not recover jumptable at 0x00749ac1. Too many branches */
                    /* WARNING: Treating indirect jump as call */
              (*(code *)(&DAT_0082c084 + *(int *)(&DAT_0082c084 + lVar27 * 4)))
  ...
  if (uVar32 != 0) {
    for (; (uVar32 >> lVar1 & 1) == 0; lVar1 = lVar1 + 1) {
                    ...
                    /* WARNING: Could not recover jumptable at 0x00749b19. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)(&DAT_0082c084 + *(int *)(&DAT_0082c084 + lVar1 * 4)))
            ((long)pauVar37 + (lVar27 - uVar31),uVar34 + lVar27,lVar1,
             &DAT_0082c084 + *(int *)(&DAT_0082c084 + lVar1 * 4));
  return;
}
