...
undefined8 FUN_005f6ae0(ulong *param_1,ulong *param_2,ulong *param_3)

{
  ...
  Var1 = (unkuint9)(ulong)Var2 + (unkuint9)uVar81 +
         (unkuint9)((char)((unkuint9)Var1 >> 0x40) != '\0');
  uVar78 = (ulong)Var1;
  uVar77 = (ulong)(uVar84 < DAT_005f60c8 || uVar84 - DAT_005f60c8 < (ulong)(uVar82 < DAT_005f60c0));
  uVar83 = (ulong)(uVar75 < DAT_005f60d0 || uVar75 - DAT_005f60d0 < uVar77);
  uVar74 = (uVar78 - DAT_005f60d8) - uVar83;
  uVar80 = (uVar84 - DAT_005f60c8) - (ulong)(uVar82 < DAT_005f60c0);
  uVar73 = uVar82 - DAT_005f60c0;
  uVar77 = (uVar75 - DAT_005f60d0) - uVar77;
  if (uVar79 + uVar76 + uVar81 + (ulong)((char)((unkuint9)Var2 >> 0x40) != '\0') +
      (ulong)((char)((unkuint9)Var1 >> 0x40) != '\0') <
      (ulong)(uVar78 < DAT_005f60d8 || uVar78 - DAT_005f60d8 < uVar83)) {
    uVar74 = uVar78;
    uVar80 = uVar84;
    uVar73 = uVar82;
    uVar77 = uVar75;
