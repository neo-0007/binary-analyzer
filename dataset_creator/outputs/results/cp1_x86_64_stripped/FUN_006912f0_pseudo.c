...
long * FUN_006912f0(long *param_1,undefined1 param_2)

{
  ...
  if (local_48[0] != '\0') {
    ...
    if (plVar1 == (long *)0x0) {
                    ...
                    /* try { // try from 0069144e to 00691457 has its CatchHandler @ 00691458 */
      FUN_00403826();
    }
    if (*(char *)(lVar7 + 0xe4) == '\0') {
      ...
      if (plVar2 == (long *)0x0) {
        ...
        FUN_00403826();
                    ...
                    /* try { // try from 00691404 to 00691406 has its CatchHandler @ 00691458 */
      ...
      *(undefined1 *)(lVar7 + 0xe4) = 1;
      ...
      uVar6 = *(undefined4 *)(lVar7 + 0xe0);
                    ...
                    /* try { // try from 00691378 to 0069137a has its CatchHandler @ 00691458 */
    (**(code **)(*plVar1 + 0x10))
              (plVar1,*(long *)(lVar7 + 0xe8),*(long *)(lVar7 + 0xe8) == 0,lVar7,uVar6,param_2);
    if (extraout_DL != '\0') {
      lVar7 = *(long *)(*param_1 + -0x18) + (long)param_1;
                    /* try { // try from 00691390 to 00691394 has its CatchHandler @ 00691464 */
