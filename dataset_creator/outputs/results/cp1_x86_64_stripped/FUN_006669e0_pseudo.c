...
void FUN_006669e0(long *param_1,long *param_2,long *param_3)

{
  ...
  *(long *)((long)param_1 + *(long *)(lVar3 + -0x18)) = lVar1;
                    /* try { // try from 00666a97 to 00666a9b has its CatchHandler @ 00666ab4 */
  FUN_006658a0(param_1 + 2,param_3 + 2);
