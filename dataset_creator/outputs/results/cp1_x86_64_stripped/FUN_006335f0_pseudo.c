...
void FUN_006335f0(long *param_1,long param_2)

{
  ...
  *(undefined1 *)(param_2 + 0x98) = 1;
  ...
  lVar3 = *(long *)(local_48 + -0x18);
                    /* try { // try from 0063367f to 00633696 has its CatchHandler @ 00633977 */
  ...
  *(long *)(param_2 + 0x18) = lVar3;
  ...
  if (lVar3 + 1U < 0x1fffffffffffffff) {
    lVar7 = (lVar3 + 1U) * 4;
                    /* try { // try from 006336ef to 00633706 has its CatchHandler @ 0063396e */
    ...
    *(long *)(param_2 + 0x38) = lVar3;
    ...
    if (lVar3 + 1U < 0x1fffffffffffffff) {
      lVar7 = (lVar3 + 1U) * 4;
                    /* try { // try from 00633762 to 00633779 has its CatchHandler @ 0063398b */
      lVar5 = thunk_FUN_006c31f0(lVar7);
      FUN_0063a420(&local_48,lVar5,lVar3,0);
      ...
      *(long *)(param_2 + 0x48) = lVar3;
      ...
      if (lVar3 + 1U < 0x1fffffffffffffff) {
        lVar7 = (lVar3 + 1U) * 4;
                    /* try { // try from 006337d5 to 006337ec has its CatchHandler @ 00633985 */
        lVar5 = thunk_FUN_006c31f0(lVar7);
        FUN_0063a420(&local_48,lVar5,lVar3,0);
        ...
        *(undefined4 *)(param_2 + 0x68) = uVar4;
        ...
        FUN_00771f60();
                    ...
                    /* try { // try from 00633980 to 00633984 has its CatchHandler @ 00633985 */
      uVar6 = FUN_00403cf5();
                    /* catch() { ... } // from try @ 006337d5 with catch @ 00633985
                       catch() { ... } // from try @ 00633980 with catch @ 00633985 */
      goto LAB_00633972;
    }
  }
  else {
                    /* try { // try from 00633964 to 00633968 has its CatchHandler @ 0063396e */
    FUN_00403cf5();
  }
                    /* try { // try from 00633969 to 0063396d has its CatchHandler @ 0063398b */
  uVar6 = FUN_00403cf5();
LAB_00633972:
