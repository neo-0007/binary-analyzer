...
/* WARNING: Removing unreachable block (ram,0x006a86cb) */
/* WARNING: Restarted to delay deadcode elimination for space: stack */

long * FUN_006a8670(undefined8 param_1,long *param_2,char param_3,long param_4,undefined4 param_5,
                   long param_6)

{
  ...
  local_44 = FUN_006a83e0(&local_80,lVar9,local_58,uVar14,bVar8);
  ...
  if (*(char *)(lVar6 + 0x20) != '\0') {
    ...
    *(undefined4 **)(puVar11 + lVar9 + -0x10) = puVar13;
    local_60 = local_58;
    *(undefined8 *)(puVar11 + lVar9 + -0x18) = 0x6a8929;
...
LAB_006a879c:
    ...
    puVar13 = puVar17;
    if (lVar9 <= lVar16) goto LAB_006a87a8;
  }
  else {
    if (-1 < param_6) {
      if ((uVar14 & 0x800) != 0) {
  ...
  *(undefined8 *)(puVar11 + lVar6 + -0x18) = 0x6a888b;
...
LAB_006a87a8:
  *(undefined8 *)(param_4 + 0x10) = 0;
  if (param_3 == '\0') {
    ...
    *(undefined8 *)(puVar10 + -8) = 0x6a87c5;
    (*pcVar2)(param_2,puVar17,lVar16);
  }
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    *(undefined **)(puVar10 + -8) = &UNK_006a89be;
    FUN_00771f60();
  }
  return param_2;
}
