...
undefined8
FUN_0054bb40(undefined1 (*param_1) [16],long param_2,ulong param_3,long param_4,undefined8 *param_5,
...

{
  ...
  if (0x5f < param_3) {
    uVar6 = *param_5;
    pauVar10 = (undefined1 (*) [16])&DAT_0054c240;
    pauVar8 = param_6 + 4;
    auVar13 = vpshufb_avx(*param_6,_DAT_0054c240);
    ...
    uVar9 = 0;
    auVar1 = param_1[2];
    vpshufb_avx(param_1[5],_DAT_0054c240);
    auVar2 = param_1[1];
    auVar4 = vpshufb_avx(param_1[4],_DAT_0054c240);
    auVar3 = *param_1;
    auVar5 = vpshufb_avx(param_1[3],_DAT_0054c240);
    *(undefined1 (*) [16])(puVar7 + 0x30) = auVar4;
    auVar1 = vpshufb_avx(auVar1,_DAT_0054c240);
    *(undefined1 (*) [16])(puVar7 + 0x40) = auVar5;
    auVar2 = vpshufb_avx(auVar2,_DAT_0054c240);
    *(undefined1 (*) [16])(puVar7 + 0x50) = auVar1;
    auVar1 = vpshufb_avx(auVar3,_DAT_0054c240);
    *(undefined1 (*) [16])(puVar7 + 0x60) = auVar2;
    *(undefined1 (*) [16])(puVar7 + 0x70) = auVar1;
    *(undefined8 *)(puVar7 + -8) = 0x54bc25;
    FUN_0054b5c0((long)DAT_0054c240,uVar6,param_1,param_2,param_3 >> 4);
