...
ulong FUN_00701350(uint *param_1,long param_2,long param_3)

{
  ...
  if (param_3 != 0) {
    ...
    if ((*(undefined1 **)(param_1 + 0xc) == puVar7) && (puVar7 != puVar8)) {
      uVar4 = FUN_00704f80(param_1,puVar8,(long)puVar7 - (long)puVar8);
      if ((int)uVar4 == -1) goto LAB_007014a0;
      puVar7 = *(undefined1 **)(param_1 + 10);
      puVar8 = *(undefined1 **)(param_1 + 8);
    }
    while( true ) {
      ...
      local_60 = puVar7;
      iVar2 = FUN_00701db0(uVar5,*(long *)(param_1 + 0x28) + 0x58,param_2,param_2 + param_3 * 4,
                           &local_68,puVar7,puVar3,&local_60);
      uVar4 = FUN_00704f80(param_1,puVar8,(long)local_60 - (long)puVar8);
      if ((int)uVar4 == -1) goto LAB_007014a0;
      ...
      if ((iVar2 != 0) && ((local_68 == param_2 || (iVar2 != 1)))) {
        ...
        *puVar6 = uVar5;
        ...
        puVar6[2] = uVar5;
        puVar6[3] = uVar5;
        if ((*param_1 & 0x202) == 0) goto LAB_00701498;
        goto LAB_0070149c;
      }
      if (param_3 == 0) break;
      puVar7 = *(undefined1 **)(param_1 + 10);
