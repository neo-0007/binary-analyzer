...
void FUN_0058d2c0(long *param_1,long param_2,long param_3)

{
  ...
  *(BADSPACEBASE **)(uVar8 + 0x518) = register0x00000020;
  ...
  do {
    ...
    auVar23 = vpshufb_avx2(auVar19,_DAT_0058b100);
    auVar21._0_16_ =
    ...
    auVar25 = vpshufb_avx2(auVar20,_DAT_0058b100);
    auVar22._0_16_ =
    ...
    auVar26 = vpshufb_avx2(auVar21,_DAT_0058b100);
    auVar28._0_16_ =
    ...
    auVar27 = vpshufb_avx2(auVar22,_DAT_0058b100);
    auVar29._0_16_ =
    ...
    auVar28 = vpshufb_avx2(auVar28,_DAT_0058b100);
    auVar30._0_16_ =
    ...
    auVar29 = vpshufb_avx2(auVar29,_DAT_0058b100);
    auVar31._0_16_ =
    ...
    auVar19 = vpaddq_avx2(auVar23,_DAT_0058ac00);
    auVar30 = vpshufb_avx2(auVar30,_DAT_0058b100);
    auVar20 = vpaddq_avx2(auVar25,_DAT_0058ac20);
    auVar31 = vpshufb_avx2(auVar31,_DAT_0058b100);
    auVar21 = vpaddq_avx2(auVar26,_DAT_0058ac40);
    auVar22 = vpaddq_avx2(auVar27,_DAT_0058ac60);
    *pauVar9 = auVar19;
    auVar19 = vpaddq_avx2(auVar28,_DAT_0058ac80);
    pauVar9[1] = auVar20;
    auVar20 = vpaddq_avx2(auVar29,_DAT_0058aca0);
    pauVar9[2] = auVar21;
    auVar21 = vpaddq_avx2(auVar30,_DAT_0058acc0);
    pauVar9[3] = auVar22;
    *(undefined8 *)(pauVar9[-5] + 0x18) = *(undefined8 *)(pauVar9[4] + 0x18);
    auVar22 = vpaddq_avx2(auVar31,_DAT_0058ace0);
    pauVar9[-4] = auVar19;
    uVar18 = 0;
    pauVar9[-3] = auVar20;
    pauVar9[-2] = auVar21;
    ...
    pauVar9[-1] = auVar22;
    pauVar1 = pauVar9 + -4;
    pauVar9 = (undefined1 (*) [32])&DAT_0058ad80;
    do {
      pauVar10 = pauVar1;
