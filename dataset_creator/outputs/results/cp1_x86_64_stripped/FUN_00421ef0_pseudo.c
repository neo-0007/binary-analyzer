...
void FUN_00421ef0(undefined8 *param_1)

{
  ...
  if (param_1[3] == 0) {
    ...
    FUN_0041e290(&local_58,"st-phase",*param_1,0);
    param_1[4] = local_58;
    param_1[5] = uStack_50;
    param_1[6] = local_48;
    param_1[7] = uStack_40;
    param_1[8] = local_38;
    FUN_0041e290(&local_58,"st-type",param_1[1],0);
    param_1[9] = local_58;
    param_1[10] = uStack_50;
    param_1[0xb] = local_48;
    param_1[0xc] = uStack_40;
    param_1[0xd] = local_38;
    FUN_0041e290(&local_58,"st-desc",param_1[2],0);
