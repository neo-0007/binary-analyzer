...
ulong FUN_0052a510(long param_1,undefined8 *param_2,undefined8 *param_3,ulong param_4)
...
LAB_0052a570:
  ...
  uVar17 = FUN_004098b0(param_1);
  local_b8 = param_2;
  if ((int)uVar17 == 0) {
    if (uVar30 == 0xffffffffffffffff) {
      FUN_00498270(param_3,param_2,param_4,lVar16,param_1 + 0x28,0);
      FUN_0052a460(lVar16 + 0x1b4,param_2,param_4);
      uVar17 = 1;
      goto LAB_0052a572;
    }
    if (CONCAT11(*(undefined1 *)(lVar16 + 0x21c + uVar30),*(undefined1 *)(lVar16 + 0x21d + uVar30))
        < 0x302) {
      if (param_4 < 0x15) goto LAB_0052a572;
    }
    else {
      if (param_4 < 0x25) goto LAB_0052a572;
      local_b8 = param_2 + 2;
      uVar3 = *param_3;
      uVar4 = param_3[1];
    ...
    lVar28 = lVar16 + 0x1d0;
    FUN_00498270(param_3,local_b8,param_4,lVar16,param_1 + 0x28,0);
    ...
    *(undefined8 *)(lVar16 + 0x20c) = uVar10;
    FUN_0052a460(lVar21,lVar16 + 0x220,uVar30);
    if (uVar17 < 0x140) {
...
LAB_0052a7c3:
      ...
      FUN_0052a460(lVar21,local_b8,lVar23);
      uVar30 = 0;
      local_60[0] = 0;
      local_60[1] = 0;
      uVar18 = *(uint *)(lVar16 + 0x210);
    ...
    if (uVar18 < 0x40) {
      ...
      lVar23 = -0x49 - lVar20;
      if (0x38 < uVar18) goto LAB_0052add7;
    }
    else {
      lVar23 = -0x49 - lVar20;
LAB_0052add7:
    ...
    *(undefined8 *)(lVar16 + 0x20c) = *(undefined8 *)(lVar16 + 0x1ac);
    FUN_0052a460(lVar21,local_60,0x14);
    FUN_00434750(local_60,lVar21);
    uVar18 = 0;
...
LAB_0052aae5:
      ...
      if (0x3f < uVar29) {
        FUN_0052a460(lVar16 + 0x1b4,puVar31,uVar17);
        FUN_0048e080(param_3,param_2,uVar29 >> 6,lVar16,param_1 + 0x28,lVar16 + 0x1b4,
                     uVar27 + (long)param_3);
    ...
    FUN_0052a460(lVar16 + 0x1b4,param_3,param_4);
  }
  else {
    if ((uVar30 + 0x24 & 0xfffffffffffffff0) != param_4) goto LAB_0052a570;
    uVar27 = (ulong)(0x301 < *(uint *)(lVar16 + 0x220));
    lVar28 = uVar27 * 0x10;
    puVar31 = param_3 + uVar27 * 2;
    uVar27 = lVar28 + uVar17;
    if (lVar28 + uVar17 < uVar30) goto LAB_0052aae5;
LAB_0052ab0e:
    local_a8 = param_1 + 0x28;
    lVar21 = lVar16 + 0x1b4;
    FUN_0052a460(lVar21,puVar31,uVar30 - lVar28);
    if (param_4 != uVar30) {
      if (param_3 != param_2) {
        thunk_FUN_00713a50(local_b8,local_b0 + (long)param_3,uVar30 - local_b0);
      }
      lVar28 = (long)param_2 + uVar30;
      FUN_00434750(lVar28,lVar21);
      *(undefined8 *)(lVar16 + 0x1b4) = *(undefined8 *)(lVar16 + 0x154);
      *(undefined8 *)(lVar16 + 0x1bc) = *(undefined8 *)(lVar16 + 0x15c);
      *(undefined8 *)(lVar16 + 0x1c4) = *(undefined8 *)(lVar16 + 0x164);
      *(undefined8 *)(lVar16 + 0x1cc) = *(undefined8 *)(lVar16 + 0x16c);
      ...
      *(undefined8 *)(lVar16 + 0x204) = *(undefined8 *)(lVar16 + 0x1a4);
      *(undefined8 *)(lVar16 + 0x20c) = *(undefined8 *)(lVar16 + 0x1ac);
      FUN_0052a460(lVar21,lVar28,0x14);
      FUN_00434750(lVar28,lVar21);
      uVar17 = uVar30 + 0x14;
      if (uVar17 < param_4) {
        thunk_FUN_00713720(uVar17 + (long)param_2,((uint)param_4 - 1) - (int)uVar17 & 0xff,
                           (param_4 - 0x14) - uVar30);
      }
      FUN_00498270(local_b8,local_b8,local_a0,lVar16,local_a8,1);
      uVar17 = 1;
      goto LAB_0052a572;
    }
  ...
  local_a8 = param_1 + 0x28;
  FUN_00498270(param_3,local_b8,local_a0,lVar16,local_a8,1);
  uVar17 = 1;
LAB_0052a572:
