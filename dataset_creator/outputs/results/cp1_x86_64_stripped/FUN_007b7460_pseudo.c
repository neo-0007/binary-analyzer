...
uint * FUN_007b7460(undefined8 param_1,uint *param_2,undefined8 *param_3,uint param_4,byte param_5,
...

{
  ...
  if (((((*(long *)(param_6 + 2) == 0) && (bVar6 != 6)) && (*(short *)((long)param_6 + 6) != -0xf))
     ...
     ((param_6 != param_2 &&
      (iVar4 = thunk_FUN_00712780((ulong)*param_6 + param_8,param_1), iVar4 != 0)))) {
    return (uint *)0x0;
  }
  ...
  if (param_3 == (undefined8 *)0x0) {
    ...
    if ((param_3[2] != 0) && (iVar4 = FUN_007b93e0(param_3[2],param_9), iVar4 != 0)) {
                    /* WARNING: Subroutine does not return */
      FUN_006e2220("version->filename == NULL || ! _dl_name_match_p (version->filename, map)",
    ...
    if ((iVar4 != *(int *)(param_3 + 1)) ||
       (iVar5 = thunk_FUN_00712780(*puVar1,*param_3), iVar5 != 0)) {
