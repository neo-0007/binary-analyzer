...
long * FUN_0068f280(long *param_1)

{
  ...
  if (local_58[0] != '\0') {
    ...
    if (plVar1 == (long *)0x0) {
                    ...
                    /* try { // try from 0068f428 to 0068f431 has its CatchHandler @ 0068f432 */
      FUN_00403826();
    }
    if (*(char *)(lVar6 + 0xe1) == '\0') {
      ...
      if ((char)plVar2[7] == '\0') {
                    /* try { // try from 0068f3d3 to 0068f3fc has its CatchHandler @ 0068f432 */
        FUN_0063d6f0(plVar2);
        iVar5 = 0x20;
        cVar4 = ' ';
      ...
      *(undefined1 *)(lVar6 + 0xe1) = 1;
      ...
      iVar5 = (int)*(char *)(lVar6 + 0xe0);
                    ...
                    /* try { // try from 0068f30e to 0068f310 has its CatchHandler @ 0068f432 */
    (**(code **)(*plVar1 + 0x40))
              (plVar1,*(long *)(lVar6 + 0xe8),*(long *)(lVar6 + 0xe8) == 0,lVar6,iVar5,in_R9,
               in_stack_00000008);
    if ((char)extraout_RDX != '\0') {
      lVar6 = *(long *)(*param_1 + -0x18) + (long)param_1;
                    /* try { // try from 0068f328 to 0068f32c has its CatchHandler @ 0068f43e */
      FUN_0066ec40(lVar6,*(uint *)(lVar6 + 0x20) | 1,extraout_RDX,in_stack_00000010);
    }
  }
  plVar1 = local_50;
