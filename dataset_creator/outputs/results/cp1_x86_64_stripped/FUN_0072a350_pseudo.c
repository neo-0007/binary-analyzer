...
undefined1 (*) [16]
FUN_0072a350(undefined1 (*param_1) [16],undefined1 (*param_2) [16],ulong param_3)
...
switchD_0072a37e_caseD_6f:
    ...
    default:
      if (DAT_0093d710 * 2 < param_3) {
        ...
        if ((param_3 <= uVar133 - lVar131) || (DAT_0093d708 < uVar133 - lVar131)) {
          uVar129 = DAT_0093d708;
          ...
          if (0x1000 < param_3) {
            ...
            if (uVar129 < 0x80) goto LAB_0072bf3f;
          }
          param_3 = param_3 + uVar129;
        }
        uVar136 = param_3 - 0x80;
        ...
        *(undefined8 *)(puVar130 + -8) = uVar110;
        ...
        pauVar126 = (undefined1 (*) [16])
                    (*(code *)((long)&switchD_0072a37e::switchdataD_0082b6f0 +
                              (long)(int)(&switchD_0072a37e::switchdataD_0082b6f0)[lVar127]))
...
switchD_0072a3a1_caseD_60:
  ...
  if (((ulong)puVar128 & 0xf) == 0) {
    if ((param_3 >> 8) + param_3 < DAT_0093d718) {
      do {
        uVar133 = param_3;
...
LAB_0072bc10:
    ...
    *(undefined8 *)(uVar133 + 0x18) = uVar110;
    ...
    if ((param_3 <= (ulong)((long)puVar128 - (long)puVar134)) ||
       (DAT_0093d708 < (ulong)((long)puVar128 - (long)puVar134))) {
...
LAB_0072bd91:
    ...
    pauVar126 = (undefined1 (*) [16])
                (*(code *)((long)&switchD_0072a3a1::switchdataD_0082b930 +
                          (long)(int)(&switchD_0072a3a1::switchdataD_0082b930)[lVar131]))
                          ((long)puVar134 + lVar131,(long)puVar128 + lVar131,
                           (code *)((long)&switchD_0072a3a1::switchdataD_0082b930 +
                                   (long)(int)(&switchD_0072a3a1::switchdataD_0082b930)[lVar131]));
    return pauVar126;
  }
  if (DAT_0093d710 <= param_3) goto LAB_0072bc10;
  param_3 = param_3 - 0x80;
