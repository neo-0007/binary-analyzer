...
/* WARNING: Removing unreachable block (ram,0x006d08b0) */
/* WARNING: Removing unreachable block (ram,0x006d070d) */
/* WARNING: Removing unreachable block (ram,0x006d0862) */
/* WARNING: Removing unreachable block (ram,0x006d06d8) */

uint FUN_006d05c0(int param_1,uint param_2,undefined1 *param_3,undefined1 *param_4)

{
  ...
  bVar15 = DAT_0094aec8 == 0xf;
  bVar16 = DAT_0094aecc == 6;
  do {
    bVar13 = (byte)param_2;
    if (bVar13 == 0x40) {
      *param_4 = 1;
      ...
      if ((param_2 & 0xff) == 0xff) {
        ...
        if (iVar6 != 2) {
          ...
          FUN_006e2220("offset == 2","../sysdeps/x86/dl-cacheinfo.h",0xb7,"intel_check_word");
        }
        ...
        while( true ) {
          ...
          if (bVar13 == bVar2) {
            if (pbVar1[3] == uVar14) {
              ...
              if (iVar6 != 2) {
                    /* WARNING: Subroutine does not return */
                FUN_006e2220("offset == 2","../sysdeps/x86/dl-cacheinfo.h",0xe7,"intel_check_word");
              }
            ...
            goto joined_r0x006d06b3;
          }
          if (bVar2 <= bVar13) break;
          if (uVar4 <= uVar10) goto joined_r0x006d06b3;
