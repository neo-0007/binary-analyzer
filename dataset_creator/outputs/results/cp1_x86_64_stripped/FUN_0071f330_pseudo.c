...
/* WARNING: Removing unreachable block (ram,0x007202dd) */

ulong FUN_0071f330(byte *param_1,byte *param_2,ulong param_3)
  ...
  if (uVar3 != uVar1) {
    if (uVar3 <= uVar1) {
      ...
      uVar9 = (ulong)uVar1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0071f3e9. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    uVar2 = (*(code *)(&DAT_0082ae30 + *(int *)(&DAT_0082ae30 + ((uVar2 + 0xf) - uVar9) * 4)))();
    return uVar2;
  }
