...
undefined1  [16]
FUN_006a77a0(undefined8 param_1,long *param_2,ulong param_3,long param_4,undefined4 param_5,
            undefined8 *param_6)

{
  ...
  lVar7 = FUN_00625ba0(&DAT_00945550);
  plVar13 = (long *)(*(long *)(*(long *)(param_4 + 0xd0) + 0x18) + lVar7 * 8);
  lVar9 = *plVar13;
  if (lVar9 == 0) {
                    /* try { // try from 006a7cbd to 006a7cc1 has its CatchHandler @ 006a7e7a */
    ...
    *(undefined1 *)(puVar10 + 0x13) = 0;
                    /* try { // try from 006a7d45 to 006a7d49 has its CatchHandler @ 006a7e71 */
    FUN_006a60e0(puVar10,param_4 + 0xd0);
  ...
  if (lVar7 != 0) {
    local_58 = &DAT_009452d8;
                    /* try { // try from 006a790c to 006a79d2 has its CatchHandler @ 006a7e4d */
    ...
    if (0 < lVar12) {
      ...
      if (*(long *)(lVar9 + 0x18) == 0) {
                    /* try { // try from 006a7d79 to 006a7e43 has its CatchHandler @ 006a7e4d */
    ...
    if (0 < iVar5) {
                    /* try { // try from 006a7c5f to 006a7c7c has its CatchHandler @ 006a7e4d */
    ...
    local_50 = &DAT_009452d8;
                    /* try { // try from 006a7a30 to 006a7c37 has its CatchHandler @ 006a7e44 */
...
LAB_006a7ad3:
        ...
        break;
      case '\x01':
        if (bVar11) goto LAB_006a7ad3;
                    /* try { // try from 006a7c8f to 006a7cae has its CatchHandler @ 006a7e44 */
