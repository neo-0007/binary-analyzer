...
ulong FUN_0072d5e0(undefined1 (*param_1) [16],undefined1 (*param_2) [16])

{
  ...
  if (uVar24 != uVar22) {
    ...
    uVar23 = (*(code *)(&DAT_0082bc20 + *(int *)(&DAT_0082bc20 + ((uVar23 + 0xf) - uVar25) * 4)))
