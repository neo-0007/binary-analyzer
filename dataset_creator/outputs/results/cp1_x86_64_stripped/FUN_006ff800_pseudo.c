...
ulong FUN_006ff800(uint *param_1)

{
  ...
  if (((*param_1 & 0x800) != 0) && (iVar4 = FUN_006ff780(param_1), iVar4 == -1)) {
    return 0xffffffff;
  }
  ...
  if (puVar2 <= puVar6) {
    ...
    if ((*param_1 & 0x100) != 0) {
      ...
      *param_1 = *param_1 & 0xfffffeff;
      ...
      if (puVar6 < puVar7) goto LAB_006ff8f8;
      *plVar1 = (long)puVar6;
    }
    if (*(long *)(param_1 + 0x18) == 0) {
      if (plVar1[8] != 0) {
        FUN_007104f0(plVar1[8],puVar7);
    ...
    if (0x827 < lVar3 - 0x93f160U) {
      FUN_00703130();
                    ...
                    /* WARNING: Could not recover jumptable at 0x006ff8d0. Too many branches */
