...
uint FUN_00460020(undefined8 *param_1,undefined8 param_2,long param_3,long param_4,uint param_5,
...
LAB_0046004f:
    FUN_0051f420();
    FUN_0051f540("../providers/implementations/encode_decode/encode_key2any.c",0x524,
  ...
  uVar6 = param_5 & 1;
  if ((param_5 & 1) == 0) {
    if ((param_5 & 0x84) == 0) goto LAB_0046004f;
    if (param_3 == 0) goto LAB_00460150;
    lVar2 = FUN_0043bf50(*param_1);
    if (lVar2 == 0) goto LAB_004600d4;
    pcVar5 = FUN_004ea7e0;
    pcVar4 = (code *)0x0;
