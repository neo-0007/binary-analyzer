...
long FUN_007aa6d0(int *param_1,code *param_2,long *param_3)

{
  ...
  lVar2 = (long)(int)(*(ushort *)
                       (&DAT_00840b00 + ((long)(int)((uVar5 & 0xc) + iVar13) + uVar15 * 0xd) * 2) -
                     1) + (long)param_1[3];
  ...
  lVar12 = lVar9;
  local_d0 = lVar9;
  while (lVar17 = lVar6, lVar10 = FUN_007aa530(param_2,&local_d0,&local_b8), lVar6 = local_d0,
        lVar10 != 0) {
    ...
    if (lVar11 == 0) {
      bVar22 = uVar4 == 0;
      if ((bVar22 == (local_98 == 0)) || ((int)(local_98 | uVar4) < 0)) goto LAB_007aaa48;
      iVar13 = 0x92c70;
      goto LAB_007aabf8;
    }
    if ((lVar12 == local_d0) && (lVar17 != local_d0)) {
      if ((int)local_98 < 0) goto LAB_007aaa48;
      if ((int)uVar4 < 0) {
        if (bVar22 <= (local_98 != 0)) goto LAB_007aaa48;
      }
      else if ((uVar4 != 0) != (local_98 != 0)) goto LAB_007aaa48;
    }
    iVar13 = iVar13 + -1;
    if (iVar13 == 0) goto LAB_007aaaf0;
    bVar22 = local_98 != 0;
    lVar12 = lVar17;
...
LAB_007aaa48:
  *param_3 = lVar10 - (lVar9 + -local_138);
  if (iVar3 != local_b8) {
    ...
    local_d0 = lVar10;
    if (bVar22) goto LAB_007aaaf0;
    local_78 = lVar10;
    lVar19 = (*param_2)(&local_78,&local_b8);
    if (lVar19 == 0) goto LAB_007aad60;
  }
  ...
  *(undefined8 *)(param_1 + 10) = uStack_90;
  ...
  while( true ) {
    ...
    if (!SCARRY8((long)iVar13,lVar6)) {
      lVar12 = FUN_007aa530(param_2,&local_c8,&local_78);
      if (lVar12 == 0) goto LAB_007aad60;
      if ((bVar22 == (local_58 == 0)) || (local_58 < 0)) {
        ...
        if (lVar12 != 0) goto LAB_007aaa48;
        if (*(int *)(in_FS_OFFSET + -0x58) != 0x4b) goto LAB_007aad60;
      }
    }
