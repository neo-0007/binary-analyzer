...
void FUN_004d1eb0(uint *param_1,uint *param_2)

{
  ...
  while( true ) {
    ...
    uVar6 = *(uint *)(&DAT_007eaa40 + (ulong)(uVar1 >> 6 & 3 | uVar1 >> 7 & 0x3c) * 4) |
            *(uint *)(&DAT_007eab40 + (ulong)(uVar1 >> 0xd & 0xf | uVar1 >> 0xe & 0x30) * 4) |
            *(uint *)(&DAT_007ea940 + (ulong)(uVar6 & 0x3f) * 4) |
            *(uint *)(&DAT_007eac40 +
                     (ulong)(uVar1 >> 0x14 & 1 | uVar1 >> 0x15 & 6 | uVar1 >> 0x16 & 0x38) * 4);
    uVar4 = *(uint *)(&DAT_007eaf40 + (ulong)(uVar3 >> 0xf & 0x3f) * 4) |
            *(uint *)(&DAT_007ead40 + (ulong)(uVar4 & 0x3f) * 4) |
            *(uint *)(&DAT_007eae40 + (ulong)(uVar3 >> 7 & 3 | uVar3 >> 8 & 0x3c) * 4) |
            *(uint *)(&DAT_007eb040 + (ulong)(uVar3 >> 0x15 & 0xf | uVar3 >> 0x16 & 0x30) * 4);
    *param_2 = (uVar4 << 0x10) >> 0x1e | (uVar6 & 0xffff | uVar4 << 0x10) << 2;
    param_2[1] = uVar4 >> 0x1a | (uVar4 & 0xffff0000 | uVar6 >> 0x10) << 6;
    if (piVar5 == (int *)&DAT_007ea940) break;
    iVar2 = *piVar5;
    piVar5 = piVar5 + 1;
    param_2 = param_2 + 2;
  }
