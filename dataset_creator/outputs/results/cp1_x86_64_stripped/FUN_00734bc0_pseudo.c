...
ulong FUN_00734bc0(undefined1 (*param_1) [16],undefined1 (*param_2) [16],ulong param_3)

{
  ...
  if (uVar22 != uVar20) {
    ...
    uVar21 = (*(code *)(&DAT_0082bd30 + *(int *)(&DAT_0082bd30 + ((uVar21 + 0xf) - uVar24) * 4)))
