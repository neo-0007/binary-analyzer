...

{
  ...
  if ((byte)(cVar8 + 0x9fU) < 0x1a) {
    ...
    piVar4 = (int *)FUN_006ba590(param_1);
    ...
    if ((piVar4 != (int *)0x0) && (*piVar4 == 0x32)) {
      ...
      *(int *)(param_1 + 0x48) =
      ...
      if ((*pcVar10 == 'l') && ((pcVar10[1] == 'i' && (pcVar10[2] == '\0')))) {
        uVar6 = FUN_006b9510(param_1);
        piVar4 = (int *)FUN_006b8b90(param_1,0x37,piVar4,uVar6);
        cVar8 = **(char **)(param_1 + 0x18);
        pcVar9 = *(char **)(param_1 + 0x18);
        goto joined_r0x006ba892;
      }
...
LAB_006ba9ec:
        ...
        *(char **)(param_1 + 0x18) = pcVar10 + 1;
        if (pcVar10[1] == '_') {
          ...
          iVar3 = FUN_006b8cc0(param_1);
          pcVar10 = *(char **)(param_1 + 0x18);
          cVar8 = *pcVar10;
          iVar3 = iVar3 + 1;
          if ((iVar3 < 0) || (cVar8 != '_')) goto LAB_006ba9ec;
          pcVar9 = pcVar10 + 1;
        }
        *(char **)(param_1 + 0x18) = pcVar9;
        iVar2 = *(int *)(param_1 + 0x28);
  ...
  if (cVar8 == 'B') {
    ...
    do {
      *(char **)(param_1 + 0x18) = pcVar9 + 1;
      uVar5 = FUN_006b9510(param_1);
      piVar4 = (int *)FUN_006b8b90(param_1,0x4d,piVar4,uVar5);
      pcVar9 = *(char **)(param_1 + 0x18);
    } while (*pcVar9 == 'B');
