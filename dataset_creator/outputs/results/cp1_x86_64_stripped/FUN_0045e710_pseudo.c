...
undefined4
FUN_0045e710(undefined8 *param_1,undefined8 param_2,long param_3,long param_4,ulong param_5,
...

{
  ...
  if ((param_4 == 0) && ((param_5 & 1) != 0)) {
    if (param_3 != 0) {
      ...
      if ((lVar3 == 0) ||
        ...
        uVar2 = FUN_00456e70(lVar3,param_3,0x74,"DSA PRIVATE KEY",FUN_00459550,FUN_00457360,param_1)
        ;
      }
      FUN_004ab560(lVar3);
      return uVar2;
  ...
  FUN_0051f420();
  FUN_0051f540("../providers/implementations/encode_decode/encode_key2any.c",0x55f,
