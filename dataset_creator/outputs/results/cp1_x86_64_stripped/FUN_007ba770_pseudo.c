...
code * FUN_007ba770(long *param_1,ulong param_2,undefined8 param_3,undefined8 param_4,
                   undefined8 *param_5)

{
  ...
  if ((int)uVar4 != 7) {
    ...
    FUN_006e2220("ELFW(R_TYPE)(reloc->r_info) == ELF_MACHINE_JMP_SLOT","dl-runtime.c",0xfa,
                 "_dl_profile_fixup");
  }
  if ((*(byte *)((long)local_30[0] + 5) & 3) == 0) {
    ...
    plVar5 = (long *)FUN_007b82e0(lVar3 + lVar6 + (ulong)*local_30[0],param_1,local_30,param_1[0x73]
                                  ,lVar9,1);
    if (*(int *)(in_FS_OFFSET + 0x18) != 0) {
      LOCK();
