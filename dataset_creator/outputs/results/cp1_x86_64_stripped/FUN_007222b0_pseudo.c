...
long FUN_007222b0(undefined8 *param_1,undefined8 *param_2,long param_3)

{
  ...
  if ((char)param_2 <= (char)param_1) {
    ...
    if (DAT_0093d708 < uVar24) {
      ...
      *(undefined8 *)(uVar29 - 8) = uVar7;
      ...
      lVar19 = (*(code *)((long)&switchD_007222f1::switchdataD_0082ae70 +
                         (long)(int)(&switchD_007222f1::switchdataD_0082ae70)[uVar20]))
                         (lVar27,lVar19,
    ...
    uVar30 = uVar20 & 0xf;
    if (uVar30 != 0) {
      lVar19 = (long)*(int *)(&DAT_0082aff0 + uVar30 * 4);
      switch(uVar30) {
      case 1:
        UNRECOVERED_JUMPTABLE_00 = (code *)((long)&UINT_0082b018 + lVar19);
        if (DAT_0093d718 <= uVar24) {
          UNRECOVERED_JUMPTABLE_00 = (code *)((long)&UINT_0082b010 + lVar19 + 1);
        }
                    /* WARNING: Could not recover jumptable at 0x007228db. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        lVar19 = (*UNRECOVERED_JUMPTABLE_00)
                           (uVar29,uVar20,uVar24 - 0x40,DAT_0093d718,puVar25,
      ...
      case 0xf:
        ...
        return lVar19;
                    ...
                    /* WARNING: Treating indirect jump as call */
      lVar19 = (*UNRECOVERED_JUMPTABLE_00)
                         (uVar29,uVar20,uVar24 - 0x40,DAT_0093d718,puVar25,UNRECOVERED_JUMPTABLE_00)
      ;
      return lVar19;
    }
    uVar30 = uVar24 - 0x10;
      ...
      if (-0x41 < (long)(uVar24 - 0x80)) {
        ...
        *(undefined8 *)(lVar28 + -0xb8) = uVar6;
        lVar27 = lVar28 + -0xc0;
                    ...
                    /* WARNING: Treating indirect jump as call */
      lVar19 = (*(code *)((long)&switchD_007222f1::switchdataD_0082ae70 +
                         (long)(int)(&switchD_007222f1::switchdataD_0082ae70)[uVar24]))
                         (lVar27,lVar19,
                          (code *)((long)&switchD_007222f1::switchdataD_0082ae70 +
                                  (long)(int)(&switchD_007222f1::switchdataD_0082ae70)[uVar24]));
      return lVar19;
  ...
  if (uVar29 != 0) {
    lVar19 = (long)*(int *)(&DAT_0082afb0 + uVar29 * 4);
    switch(uVar29) {
    case 1:
      UNRECOVERED_JUMPTABLE_00 = (code *)((long)&UINT_0082afd8 + lVar19);
      if (DAT_0093d718 <= uVar20) {
        UNRECOVERED_JUMPTABLE_00 = (code *)((long)&UINT_0082afd0 + lVar19 + 1);
      }
      break;
    case 2:
      UNRECOVERED_JUMPTABLE_00 = (code *)((long)&UINT_0082afd8 + lVar19);
      if (DAT_0093d718 <= uVar20) {
        UNRECOVERED_JUMPTABLE_00 = (code *)((long)&UINT_0082afd0 + lVar19 + 1);
                    ...
                    /* WARNING: Treating indirect jump as call */
      lVar19 = (*UNRECOVERED_JUMPTABLE_00)
                         (puVar25,param_2,uVar20 - 0x40,DAT_0093d718,param_1,
                          UNRECOVERED_JUMPTABLE_00);
      return lVar19;
    case 3:
      UNRECOVERED_JUMPTABLE_00 = (code *)((long)&UINT_0082afd8 + lVar19);
    ...
    case 7:
      ...
      return lVar19;
    case 8:
      UNRECOVERED_JUMPTABLE_00 = (code *)((long)&UINT_0082afd4 + lVar19 + 2);
      if (DAT_0093d718 <= uVar20) {
        UNRECOVERED_JUMPTABLE_00 = (code *)((long)&UINT_0082afcc + lVar19 + 3);
      }
    ...
    case 0xf:
      ...
      return lVar19;
                    ...
                    /* WARNING: Treating indirect jump as call */
    lVar19 = (*UNRECOVERED_JUMPTABLE_00)
                       (puVar25,param_2,uVar20 - 0x40,DAT_0093d718,param_1,UNRECOVERED_JUMPTABLE_00)
    ;
    return lVar19;
  }
  uVar29 = uVar20 - 0x10;
