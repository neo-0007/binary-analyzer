...
int FUN_00534c10(int *param_1,int param_2)

{
  ...
  if ((param_1 == (int *)0x0) || (*param_1 != 0x800)) {
  ...
  else if (param_2 + 1U < 3) {
    FUN_0041cea0(&local_b8,"ecdh-cofactor-mode",&local_7c);
    local_58 = local_98;
    local_78 = local_b8;
    uStack_70 = uStack_b0;
    local_68 = local_a8;
    ...
    if (iVar1 == -2) {
      FUN_0051f420();
      FUN_0051f540("../crypto/evp/ec_ctrl.c",0x42,"EVP_PKEY_CTX_set_ecdh_cofactor_mode");
      FUN_0051f8f0(6,0x93,0);
    }
  }
  else {
