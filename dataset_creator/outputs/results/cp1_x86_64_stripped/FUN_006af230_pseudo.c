...
undefined1  [16]
FUN_006af230(undefined8 param_1,long *param_2,undefined8 param_3,long *param_4,undefined8 param_5,
...
LAB_006af2e6:
      ...
      if ((bVar24) || (*(int *)(lVar11 + 0xe4) == iVar8)) {
        ...
        if (((cVar7 != '\0') && (*(int *)(lVar11 + 0x4c) == iVar8)) ||
           (*(int *)(lVar11 + 0x48) == iVar8)) goto LAB_006af3f9;
...
LAB_006af940:
          ...
          if (*(int *)(lVar11 + 0xf0) == iVar8) {
            ...
            uVar9 = 8;
            uVar12 = local_68[2];
            if ((ulong)local_68[3] <= uVar12) goto LAB_006af6e0;
LAB_006af488:
            local_68[2] = uVar12 + 4;
LAB_006af498:
            local_60 = -1;
...
LAB_006af475:
            uVar12 = local_68[2];
            bVar20 = bVar21;
            if (uVar12 < (ulong)local_68[3]) goto LAB_006af488;
LAB_006af6e0:
            (**(code **)(*local_68 + 0x50))();
            local_60 = -1;
            if (local_68 != (long *)0x0) goto LAB_006af498;
            bVar21 = true;
          }
...
joined_r0x006af4ea:
    ...
    uVar9 = 10;
    if (uVar23 != 8) goto LAB_006af2bf;
    uVar9 = 0x10;
    cVar6 = FUN_006aa060(&local_68);
    if (cVar6 == '\0') goto LAB_006af2e6;
    bVar24 = false;
    cVar7 = *(char *)(lVar11 + 0x20);
    iVar8 = 0;
    bVar20 = false;
...
LAB_006af55f:
      if (uVar23 < 0xb) {
        if ((iVar8 < 0x30) || ((int)(uVar23 + 0x30) <= iVar8)) goto LAB_006af930;
        uVar9 = iVar8 - 0x30;
LAB_006af580:
        if (uVar12 < uVar13) goto LAB_006af58a;
LAB_006af768:
        ...
        uVar18 = local_68[2];
        local_80 = local_80 + 1;
        if ((ulong)local_68[3] <= uVar18) goto LAB_006af798;
LAB_006af5a2:
        local_68[2] = uVar18 + 4;
LAB_006af5b2:
        local_60 = -1;
        if ((int *)local_68[2] < (int *)local_68[3]) {
          iVar8 = *(int *)local_68[2];
                    ...
                    /* try { // try from 006afc15 to 006afc2f has its CatchHandler @ 006afc98 */
          iVar8 = (**(code **)(*local_68 + 0x48))();
        }
        bVar21 = false;
        if (iVar8 == -1) {
        ...
        uVar9 = iVar8 - 0x57;
        if (uVar13 <= uVar12) goto LAB_006af768;
LAB_006af58a:
        local_7b = 1;
        uVar18 = local_68[2];
        if (uVar18 < (ulong)local_68[3]) goto LAB_006af5a2;
LAB_006af798:
                    /* try { // try from 006af7a8 to 006afb09 has its CatchHandler @ 006afc98 */
        (**(code **)(*local_68 + 0x50))();
        local_60 = -1;
        if (local_68 != (long *)0x0) goto LAB_006af5b2;
        bVar21 = true;
      }
      bVar19 = local_78 != (long *)0x0 && (int)local_70 == -1;
      bVar16 = (int)local_70 == -1;
        ...
        if ((local_60 == -1) && (local_68 != (long *)0x0)) {
          if ((int *)local_68[2] < (int *)local_68[3]) {
            iVar8 = *(int *)local_68[2];
                    ...
                    /* try { // try from 006afc5e to 006afc60 has its CatchHandler @ 006afc98 */
            iVar8 = (**(code **)(*local_68 + 0x48))();
          }
          if (iVar8 == -1) {
            local_68 = (long *)0x0;
    ...
    if ((cVar22 != '\0') && (*(int *)(lVar11 + 0x4c) == iVar8)) goto LAB_006afa47;
LAB_006af986:
    if ((iVar8 != *(int *)(lVar11 + 0x48)) &&
      ...
      local_7b = bVar5;
      uVar18 = local_68[2];
      if ((ulong)local_68[3] <= uVar18) goto LAB_006afa81;
      do {
        local_68[2] = uVar18 + 4;
        while( true ) {
          local_60 = -1;
...
LAB_006af8a2:
    ...
    if (((local_80 != 0) || (bVar20)) || (*(long *)(local_48 + -0x18) != 0)) goto LAB_006af8a2;
  }
  *param_8 = 0;
  *param_7 = 4;
LAB_006af639:
