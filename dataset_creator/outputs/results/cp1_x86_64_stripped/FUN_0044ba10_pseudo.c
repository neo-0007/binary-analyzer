...
ulong FUN_0044ba10(long param_1,undefined8 *param_2,long param_3,ulong param_4)

{
  ...
  uVar14 = 0;
  if (param_4 < 0x10) goto LAB_0044bac9;
  if (param_4 == 0x10) {
...
LAB_0044ba84:
    ...
    *(undefined1 (*) [16])(param_1 + 0x94) = (undefined1  [16])0x0;
    ...
    if (iVar7 != 0) {
      lVar15 = FUN_00771fb0(local_68,puVar13 + 2,uVar14,0x10);
      if (uVar14 != 0x10) {
