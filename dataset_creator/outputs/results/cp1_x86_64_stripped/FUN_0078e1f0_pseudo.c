...
long FUN_0078e1f0(undefined8 param_1,undefined8 param_2,byte *param_3)

{
  ...
  uStack_40 = param_2;
  local_28 = param_3;
  iVar2 = FUN_0078dc90(local_58,&local_50,&local_59,FUN_0078df50,&local_48);
