...
undefined1 * FUN_00760400(undefined1 (*param_1) [32],undefined8 param_2,ulong param_3)
...
LAB_00760460:
    ...
    if (param_3 <= 0x400 - uVar3) goto LAB_00760460;
    if (uVar4 != 0) {
      uVar3 = 0;
      for (; (uVar4 & 1) == 0; uVar4 = uVar4 >> 1 | 0x80000000) {
        uVar3 = uVar3 + 1;
  ...
  if (uVar9 <= param_3 && uVar7 != 0) {
    ...
    if (bVar10 || uVar7 == 0) {
      ...
      uVar3 = (uint)uVar1;
      uVar8 = uVar8 + 0x80;
      if (uVar3 != 0) goto LAB_00760600;
      uVar3 = (int)uVar7 + 0x10;
      if (uVar3 != 0 && SCARRY4((int)uVar7,0x10) == (int)uVar3 < 0) goto LAB_007606b0;
      goto LAB_007605d9;
    }
