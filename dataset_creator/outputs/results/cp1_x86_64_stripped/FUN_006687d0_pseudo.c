...
void FUN_006687d0(long *param_1,long *param_2,long *param_3)

{
  ...
  *(long *)((long)param_1 + *(long *)(lVar3 + -0x18)) = lVar1;
                    /* try { // try from 00668898 to 0066889c has its CatchHandler @ 006688b5 */
  FUN_00667650(param_1 + 2,param_3 + 2);
