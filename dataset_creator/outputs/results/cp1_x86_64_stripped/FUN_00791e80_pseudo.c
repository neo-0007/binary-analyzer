...
/* WARNING: Removing unreachable block (ram,0x00791fcf) */

undefined1  [16] FUN_00791e80(long param_1)

{
  ...
  if (UNRECOVERED_JUMPTABLE != (code *)*in_SSP) {
                    /* WARNING: Could not recover jumptable at 0x00791fa3. Too many branches */
