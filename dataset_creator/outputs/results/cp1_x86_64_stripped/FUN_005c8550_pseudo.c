...
void FUN_005c8550(uint *param_1,uint *param_2,long param_3,undefined8 param_4,uint *param_5,
                 int param_6)
  ...
  if (param_6 == 0) {
    ...
    if (uVar13 != 0xfffffffffffffff8) {
      ...
      case 0xfffffffffffffff9:
        goto switchD_005c885f_caseD_fffffff9;
      case 0xfffffffffffffffa:
        puVar15 = puVar6;
        goto LAB_005c8893;
      case 0xfffffffffffffffb:
        goto switchD_005c885f_caseD_fffffffb;
      ...
      puVar6[-1] = (char)uVar4;
      puVar6 = puVar6 + -1;
switchD_005c885f_caseD_fffffffb:
      puVar6[-1] = (char)(uVar4 >> 8);
      puVar15 = puVar6 + -1;
LAB_005c8893:
      puVar6 = puVar15 + -1;
      puVar15[-1] = (char)(uVar4 >> 0x10);
switchD_005c885f_caseD_fffffff9:
...
LAB_005c8798:
  ...
  uVar9 = uVar7;
  if (uVar13 == 0xfffffffffffffff8) goto LAB_005c8798;
  lVar19 = (long)local_70 + uVar13 + 8;
  local_48 = (uint)uVar11;
  switch(uVar13) {
  default:
    goto switchD_005c8695_default;
  case 0xfffffffffffffff9:
    uVar9 = 0;
    goto LAB_005c8900;
  case 0xfffffffffffffffa:
