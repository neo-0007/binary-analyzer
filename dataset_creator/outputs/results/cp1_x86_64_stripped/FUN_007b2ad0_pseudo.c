...
void FUN_007b2ad0(long *param_1,undefined4 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  *(byte *)((long)param_1 + 0x31c) = bVar2 | 8;
  if (*pcVar6 == '\0') {
    ...
    if (((byte)DAT_0094b0e4 & 2) == 0) goto LAB_007b2b0d;
    pcVar6 = *(char **)PTR_PTR_0093adf8;
    if (pcVar6 == (char *)0x0) {
      pcVar6 = "<main program>";
    }
  }
  else if (((byte)DAT_0094b0e4 & 2) == 0) goto LAB_007b2b0d;
  FUN_00787060("\ncalling init: %s\n\n",pcVar6);
LAB_007b2b0d:
  if (param_1[0x14] != 0) {
