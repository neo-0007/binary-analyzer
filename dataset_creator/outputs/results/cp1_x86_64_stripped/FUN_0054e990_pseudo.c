...
undefined8 FUN_0054e990(long param_1,ulong *param_2,ulong *param_3,ulong param_4)

{
  ...
  *(ulong *)(param_1 + 0x38) = uVar7;
  ...
  if (*(int *)(param_1 + 0x174) == 0) {
    ...
    puVar10 = param_3;
    if (param_4 == 0) goto LAB_0054ece8;
    do {
      uVar7 = *param_2;
      ...
      *(byte *)puVar10 = (byte)uVar7 ^ *(byte *)(param_1 + 0x10 + (ulong)uVar9);
      uVar9 = uVar9 + 1 & 0xf;
      if (uVar9 == 0) goto LAB_0054ea8d;
      puVar10 = param_3;
    } while (param_4 != 0);
    if (uVar9 != 0) goto LAB_0054ece8;
LAB_0054ea8d:
