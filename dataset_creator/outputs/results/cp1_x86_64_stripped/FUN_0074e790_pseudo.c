...
undefined1 * FUN_0074e790(undefined8 *param_1,undefined8 *param_2,ulong param_3)

{
  ...
  if (DAT_0093d6f8 < param_3) {
    ...
    if (uVar57 < param_3) goto LAB_0074e9c0;
    if (param_3 < DAT_00945828) {
      if ((_DAT_00945820 & 1) == 0) {
        ...
        if (0xffffffc0 < (uint)uVar57) goto LAB_0074e93c;
        uVar23 = param_2[4];
        uVar24 = param_2[5];
        uVar25 = param_2[6];
        uVar26 = param_2[7];
...
LAB_0074eaed:
      if (param_3 <= -uVar57) {
        ...
        *param_1 = uVar19;
        ...
        if (((~(uint)-uVar57 & 0xf00) == 0) || (DAT_00945830 <= param_3 >> 4)) {
