...
undefined8 FUN_00406600(long param_1)

{
  ...
  if (piVar1 != (int *)0x0) {
    if ((((*piVar1 - 0x80U & 0xffffff7f) == 0) && (*(long *)(piVar1 + 0xc) != 0)) &&
       (*(code **)(*(long *)(piVar1 + 10) + 0xd8) != (code *)0x0)) {
                    /* WARNING: Could not recover jumptable at 0x00406636. Too many branches */
  ...
  if ((lVar2 != 0) && (*(long *)(lVar2 + 0xc0) != 0)) {
                    /* WARNING: Could not recover jumptable at 0x00406657. Too many branches */
                    /* WARNING: Treating indirect jump as call */
