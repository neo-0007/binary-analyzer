...
void FUN_006f43c0(undefined8 param_1,long param_2,long param_3,long param_4)

{
  ...
  if (param_2 == param_3) {
    if (param_4 < 0x20) {
      FUN_006f3db0(param_1,param_2,param_4);
    }
    else {
      ...
      *(undefined8 *)(puVar6 + lVar1 + -8) = 0x6f44bf;
      FUN_006f3f00(param_1,param_2,param_4,(ulong)(puVar6 + lVar1 + 0xf) & 0xfffffffffffffff0);
    }
  }
    ...
    *(undefined8 *)(puVar3 + lVar1 + -8) = 0x6f4442;
    FUN_006f3850();
    puVar5 = puVar3 + lVar1;
  }
  if (local_10 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    *(undefined **)(puVar5 + -8) = &UNK_006f44da;
    FUN_00771f60();
  }
  return;
}
