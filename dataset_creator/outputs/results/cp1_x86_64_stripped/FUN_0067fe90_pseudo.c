...
/* WARNING: Removing unreachable block (ram,0x0067feeb) */
/* WARNING: Restarted to delay deadcode elimination for space: stack */

long * FUN_0067fe90(undefined8 param_1,long *param_2,char param_3,long param_4,undefined4 param_5,
                   long param_6)

{
  ...
  local_44 = FUN_0067fc00(local_78,lVar7,lVar5 + 0x4a,uVar12,local_51);
  ...
  if (*(char *)(lVar5 + 0x20) != '\0') {
    ...
    *(undefined8 *)(puVar14 + lVar7 + -0x18) = 0x680137;
...
LAB_0067ffaf:
    ...
    puVar11 = puVar14;
    if (lVar7 <= lVar13) goto LAB_0067ffbb;
  }
  else {
    if (-1 < param_6) {
      if ((uVar12 & 0x800) != 0) {
  ...
  *(undefined8 *)(puVar9 + lVar5 + -0x18) = 0x68009d;
...
LAB_0067ffbb:
  *(undefined8 *)(param_4 + 0x10) = 0;
  if (param_3 == '\0') {
    ...
    *(undefined8 *)(puVar8 + -8) = 0x67ffd8;
    (*pcVar2)(param_2,puVar14,lVar13);
  }
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    *(undefined **)(puVar8 + -8) = &UNK_006801cf;
    FUN_00771f60();
  }
  return param_2;
}
