...
long * FUN_006bba50(long param_1,long *param_2,uint param_3)

{
  ...
  do {
    ...
    *(byte **)(param_1 + 0x18) = pbVar7 + 1;
    ...
    lVar6 = FUN_006b8b90(param_1,iVar5,0,lVar6);
    *plVar1 = lVar6;
    if (lVar6 == 0) {
      return (long *)0x0;
    }
