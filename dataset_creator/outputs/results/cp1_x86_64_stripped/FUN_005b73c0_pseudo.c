...
undefined8 FUN_005b73c0(undefined8 *param_1,int *param_2)

{
  ...
  if (param_2[1] == 0x17) {
    ...
    if (param_2[1] != 0x18) goto LAB_005b7530;
    uVar4 = *(ulong *)(param_2 + 4);
    local_94 = 6;
    local_9c = 7;
  ...
  if (iVar7 <= iVar2) {
    ...
    iVar7 = 0;
    do {
      iVar8 = FUN_00546750((int)cVar6);
      if (((iVar8 == 0) || (cVar6 = *pcVar13, iVar2 == iVar7 + 1)) ||
         (iVar8 = FUN_00546750((int)pcVar13[1]), iVar8 == 0)) break;
      iVar8 = iVar7 + 2;
      ...
      if ((iVar9 < *(int *)(&DAT_0080e9e0 + (long)iVar16 * 4)) ||
         (*(int *)(&DAT_0080e9a0 + (long)iVar16 * 4) < iVar9)) break;
      switch(iVar16) {
      case 0:
      ...
      case 3:
        if (local_68._0_4_ == 1) {
          ...
          if (iVar16 < iVar9) goto LAB_005b7530;
          iVar12 = iVar12 + -0x12;
LAB_005b77bf:
          ...
          if (*(int *)(&DAT_0080e960 + (long)(int)local_68._0_4_ * 4) < iVar9) goto LAB_005b7530;
          uVar17 = local_68._4_4_ + 0x76c;
          iVar12 = *(int *)(&DAT_0080e920 + (long)(int)local_68._0_4_ * 4) + iVar9 + -1;
          if ((int)local_68._0_4_ < 2) goto LAB_005b77bf;
          iVar16 = (int)uVar17 % 100;
          iVar20 = *(int *)(&DAT_0080e920 + (long)(int)local_68._0_4_ * 4) + iVar9;
         ...
         (((bVar21 && (local_94 == iVar14)) && (((cVar6 - 0x2bU & 0xfd) == 0 || (cVar6 == 'Z'))))))
      {
        if ((iVar3 == 0x18) && (cVar6 == '.')) {
          ...
          if (cVar6 == 'Z') goto LAB_005b7a00;
          if (bVar21) goto LAB_005b77f0;
        }
        break;
      }
      pcVar13 = pcVar13 + 2;
...
LAB_005b77f0:
  if (((cVar6 - 0x2bU & 0xfd) == 0) && (iVar8 + 5 == iVar2)) {
    ...
    iVar7 = local_9c;
    do {
      iVar14 = FUN_00546750((int)pcVar5[lVar15 + -2]);
      if (iVar14 == 0) goto LAB_005b7530;
      cVar1 = pcVar5[lVar15 + -2];
      iVar14 = FUN_00546750((int)pcVar5[lVar15 + -1]);
      if (iVar14 == 0) goto LAB_005b7530;
      iVar14 = pcVar5[lVar15 + -1] + -0x30 + (cVar1 + -0x30) * 10;
      lVar10 = (long)(int)((uint)(param_2[1] == 0x17) + iVar7);
      if ((iVar14 < *(int *)(&DAT_0080e9e0 + lVar10 * 4)) ||
         (*(int *)(&DAT_0080e9a0 + lVar10 * 4) < iVar14)) goto LAB_005b7530;
    ...
    if ((local_80 == 0) ||
       (iVar7 = FUN_00602a80(local_78,0,
                             (long)(int)(local_80 * (((cVar6 == '-') - 1) + (uint)(cVar6 == '-')))),
       iVar7 != 0)) goto LAB_005b7918;
  }
  goto LAB_005b7530;
LAB_005b79c9:
  iVar14 = FUN_00546750((int)*pcVar13);
  if (iVar14 != 0) {
    iVar8 = iVar8 + 1;
    pcVar13 = pcVar13 + 1;
    if (iVar2 == iVar8) goto LAB_005b7530;
    goto LAB_005b79c9;
  }
  if ((iVar2 == iVar8) || (iVar7 == iVar8)) goto LAB_005b7530;
  cVar6 = pcVar5[iVar8];
  if (cVar6 != 'Z') goto LAB_005b77f0;
LAB_005b7a00:
  iVar8 = iVar8 + 1;
LAB_005b7918:
  if (iVar8 == iVar2) {
