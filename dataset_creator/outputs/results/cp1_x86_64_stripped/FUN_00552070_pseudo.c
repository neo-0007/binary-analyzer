...
undefined8 FUN_00552070(undefined8 *param_1,ulong *param_2,ulong *param_3,ulong param_4)
  ...
  if ((param_4 < 0x10) || (param_1[4] == 0)) {
    while (uVar10 = uVar10 + 1, uVar10 <= uVar1) {
      ...
      if ((uVar10 & 1) == 0) {
        ...
        puVar6 = (ulong *)FUN_005515c0(param_1,iVar8);
      }
      else {
        puVar6 = (ulong *)FUN_005515c0(param_1,0);
      }
      if (puVar6 == (ulong *)0x0) goto LAB_0055223e;
      uVar7 = param_1[0x12];
      uVar2 = *puVar6;
      uVar3 = param_1[0x13];
      uVar4 = puVar6[1];
    ...
    lVar9 = FUN_005515c0(param_1,lVar9);
    if (lVar9 == 0) {
LAB_0055223e:
      uVar5 = 0;
      goto LAB_00552131;
  ...
  if ((param_4 & 0xf) != 0) {
    ...
    FUN_00771fb0(local_58,param_3,uVar10,0x10);
