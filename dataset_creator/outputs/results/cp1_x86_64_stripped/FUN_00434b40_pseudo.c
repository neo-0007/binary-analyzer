...
undefined8 FUN_00434b40(long param_1,undefined8 *param_2,ulong param_3)

{
  ...
  *(uint *)(param_1 + 0x24) =
  ...
  if (uVar3 == 0) {
    if (param_3 < 0x40) goto LAB_00434ba0;
LAB_00434c58:
    ...
    FUN_00584f80(param_1,param_1 + 0x28,1);
    ...
    *(undefined1 (*) [16])(param_1 + 0x58) = (undefined1  [16])0x0;
    if (0x3f < param_3) goto LAB_00434c58;
  }
  if (param_3 == 0) {
    return 1;
  }
