...
undefined8 FUN_00618590(long *param_1,long *param_2,uint *param_3)

{
  ...
  if (param_2 == param_1) {
    ...
    lVar6 = FUN_004b8240(param_1,(int)param_2[1]);
    if (lVar6 == 0) {
      return 0;
    }
  ...
  if (iVar13 < iVar12) {
    do {
      while( true ) {
        ...
        iVar12 = iVar12 + -1;
LAB_00618654:
        if (iVar12 <= iVar13) goto LAB_00618710;
      }
      puVar10[iVar12] = 0;
      uVar9 = param_3[1];
      puVar4 = param_3 + 2;
      ...
      if ((uVar1 & 0x3f) == 0) goto LAB_00618654;
