...
/* WARNING: Removing unreachable block (ram,0x0061a6d1) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_0061a680(undefined1 (*param_1) [16],ulong param_2,ulong param_3,ulong param_4,ulong param_5
                 )

{
  ...
  if ((_DAT_0094b598 >> 0x21 & 1) == 0) {
    auVar10 = FUN_0061a3b0();
    uVar7 = auVar10._8_8_;
    auVar11 = FUN_0061a3b0();
    auVar12 = FUN_0061a3b0();
