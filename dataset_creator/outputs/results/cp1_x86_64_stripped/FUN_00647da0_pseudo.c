...
undefined1  [16]
FUN_00647da0(undefined8 param_1,long *param_2,ulong param_3,long param_4,char param_5,
            undefined8 *param_6)

{
  ...
  lVar6 = FUN_00625ba0(&DAT_00945350);
  plVar2 = (long *)(*(long *)(*(long *)(param_4 + 0xd0) + 0x18) + lVar6 * 8);
  lVar9 = *plVar2;
  if (lVar9 == 0) {
                    /* try { // try from 00648405 to 00648409 has its CatchHandler @ 00648600 */
    puVar10 = (undefined8 *)FUN_006c31f0(0x70);
    *(undefined4 *)(puVar10 + 1) = 0;
    puVar10[2] = 0;
    puVar10[3] = 0;
    *puVar10 = &PTR_FUN_00933f38;
    ...
    *(undefined1 *)((long)puVar10 + 0x6f) = 0;
                    /* try { // try from 00648486 to 0064848a has its CatchHandler @ 006485f7 */
    FUN_0067d120(puVar10,param_4 + 0xd0);
  ...
  if (*pbVar14 == *(byte *)(lVar9 + 100)) {
    ...
    if (param_6[1] == 0) goto LAB_00647e89;
    pbVar14 = pbVar14 + 1;
  }
  else {
  ...
  if (pbVar14 < pbVar14 + param_6[1]) {
    ...
    if (uVar18 != 0) {
      ...
      local_78 = 0;
      local_88 = &local_78;
                    /* try { // try from 00647f38 to 00647f79 has its CatchHandler @ 006485be */
      ...
      if (0 < (long)uVar16) {
        ...
        if (*(long *)(lVar9 + 0x18) == 0) {
                    /* try { // try from 006484bd to 006484e8 has its CatchHandler @ 006485be */
          ...
          if (local_80 < (ulong)((long)puVar7 - (long)local_88)) {
                    ...
                    /* try { // try from 00648587 to 0064858b has its CatchHandler @ 006485be */
      ...
      if (0 < iVar4) {
        ...
        if (uVar8 < uVar1) {
                    /* try { // try from 00648543 to 00648547 has its CatchHandler @ 006485be */
        ...
        if ((long)uVar16 < 0) {
          ...
          if (0x3fffffffffffffff - uVar1 < uVar18) {
                    /* WARNING: Subroutine does not return */
                    /* try { // try from 0064859f to 006485b4 has its CatchHandler @ 006485be */
            FUN_00403998("basic_string::append",pbVar14);
          }
        }
                    /* try { // try from 00648368 to 0064836c has its CatchHandler @ 006485be */
      ...
      local_58 = 0;
      local_68 = &local_58;
                    /* try { // try from 0064802a to 0064826b has its CatchHandler @ 006485b5 */
      ...
      do {
        ...
        case 1:
          if (bVar11) {
            ...
            if (uVar8 < uVar1) {
                    /* try { // try from 00648565 to 00648569 has its CatchHandler @ 006485b5 */
        ...
        case 3:
          if (local_108 != 0) {
            ...
            if (uVar8 < uVar1) {
                    /* try { // try from 0064851f to 00648523 has its CatchHandler @ 006485b5 */
              FUN_0069e300(&local_68,local_60,0,0,1);
            }
...
LAB_006481e8:
      ...
      if (1 < local_108) {
        if (0x3fffffffffffffff - local_60 < local_108 - 1) {
                    /* WARNING: Subroutine does not return */
                    /* try { // try from 00648593 to 00648597 has its CatchHandler @ 006485b5 */
          FUN_00403998("basic_string::append",local_f0 + 1);
        }
                    /* try { // try from 006483a9 to 006483f6 has its CatchHandler @ 006485b5 */
