...
void FUN_005c71a0(undefined8 *param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  if ((DAT_0094b5a0 & 0x80100) == 0x80100) {
    uVar9 = FUN_005c7860(param_1,param_2,*param_1);
    FUN_005c7520(uVar9);
  }
  else {
    uVar9 = FUN_005c76c0(param_1,param_3);
    FUN_005c7420(uVar9);
  }
