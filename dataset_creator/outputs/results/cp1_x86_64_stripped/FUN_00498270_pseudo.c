...
void FUN_00498270(undefined1 (*param_1) [16],undefined1 (*param_2) [16],ulong param_3,
...

{
  ...
  if (param_6 != 0) {
    auVar18 = *param_5;
    uVar13 = param_3;
    if (param_3 < 0x10) goto code_r0x00498315;
    uVar13 = param_3 - 0x10;
    pauVar12 = param_1;
    while( true ) {
      do {
...
LAB_00498806:
    ...
    if ((DAT_0094b59c & 0x4400000) == 0x400000) {
      ...
      *pauVar12 = local_20;
      ...
      if (param_3 == 0 || SCARRY8(uVar13,0x70) != (long)param_3 < 0) goto LAB_00498b7e;
      *pauVar12 = local_20;
      param_2 = param_2 + 8;
      if (0x50 < param_3) goto LAB_00498806;
    }
  }
  auVar19 = *param_1;
  uVar13 = param_3 - 0x10;
