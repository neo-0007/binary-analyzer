...
undefined1 * FUN_0074e040(undefined1 (*param_1) [32],undefined1 param_2,ulong param_3)
...
LAB_0074e080:
    ...
    if (param_3 <= (((ulong)param_1 | 0x1f) + 1) - (long)param_1) goto LAB_0074e080;
    if (uVar9 != 0) {
      uVar11 = 0;
      for (; (uVar9 & 1) == 0; uVar9 = uVar9 >> 1 | 0x80000000) {
        uVar11 = uVar11 + 1;
  ...
  if (param_3 < uVar13 || uVar12 == 0) goto LAB_0074e1d0;
  if (uVar11 != 0) {
    uVar9 = 0;
  ...
  if (bVar15 && uVar12 != 0) {
    ...
    while( true ) {
      ...
      bVar15 = uVar12 < 0x80;
      uVar12 = uVar12 - 0x80;
      if (bVar15 || uVar12 == 0) goto code_r0x0074e1c5;
    }
    uVar9 = (uint)(SUB321(auVar1 >> 7,0) & 1) | (uint)(SUB321(auVar1 >> 0xf,0) & 1) << 1 |
            (uint)(SUB321(auVar1 >> 0x17,0) & 1) << 2 | (uint)(SUB321(auVar1 >> 0x1f,0) & 1) << 3 |
            (uint)(SUB321(auVar1 >> 0x27,0) & 1) << 4 | (uint)(SUB321(auVar1 >> 0x2f,0) & 1) << 5 |
  ...
  uVar11 = (uint)(SUB321(auVar1 >> 7,0) & 1) | (uint)(SUB321(auVar1 >> 0xf,0) & 1) << 1 |
           ...
           (uint)(SUB321(auVar1 >> 0xf7,0) & 1) << 0x1e | (uint)(byte)(auVar1[0x1f] >> 7) << 0x1f;
  uVar14 = uVar14 + 0x80;
  if (uVar11 != 0) goto LAB_0074e230;
  uVar11 = (int)uVar12 + 0x40;
  uVar13 = uVar14;
  if (uVar11 != 0 && SCARRY4((int)uVar12,0x40) == (int)uVar11 < 0) goto LAB_0074e2a0;
LAB_0074e1dd:
  puVar10 = (undefined1 *)0x0;
  if (uVar11 == 0xffffffe0 || SCARRY4(uVar11,0x20) != (int)(uVar11 + 0x20) < 0) goto LAB_0074e0cc;
