...
undefined8 FUN_0059bd60(char *param_1,char *param_2,long param_3,char *param_4,uint param_5)

{
  ...
  if (((param_5 & 0x8000) == 0) || (param_2 <= param_4)) {
    if (param_4 == param_2) goto LAB_0059bdc5;
  }
  else {
    pcVar1 = param_1;
    do {
        ...
        do {
          ...
          if (cVar2 != cVar4) {
            if ((byte)(cVar2 + 0xbfU) < 0x1a) {
              cVar2 = cVar2 + ' ';
              if ((byte)(cVar4 + 0xbfU) < 0x1a) goto LAB_0059be0d;
            }
            else {
