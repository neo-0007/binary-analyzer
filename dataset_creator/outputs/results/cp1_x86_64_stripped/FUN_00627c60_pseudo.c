...
void FUN_00627c60(long param_1,long param_2)
    ...
    *(undefined1 *)(*(long *)(param_1 + 0x10) + 0x22) = *puVar6;
      ...
      *(undefined1 *)(lVar12 + 0x22) = 0x2c;
      ...
      if (lVar13 == 0) {
        ...
        *(undefined1 **)(lVar12 + 0x10) = &DAT_0083e5c2;
                    ...
                    /* try { // try from 0062802c to 00628030 has its CatchHandler @ 00628115 */
    ...
    if (lVar12 == 0) {
      ...
      *(undefined1 **)(lVar13 + 0x38) = &DAT_0083e5c2;
                    ...
                    /* try { // try from 00627fd1 to 00627fd5 has its CatchHandler @ 00628121 */
    ...
    *(long *)(lVar13 + 0x40) = lVar12;
      ...
      *(char **)(lVar13 + 0x48) = "()";
      ...
      if (lVar12 == 0) {
        *(undefined1 **)(lVar13 + 0x48) = &DAT_0083e5c2;
                    ...
                    /* try { // try from 00628067 to 0062806b has its CatchHandler @ 00628139 */
        uVar7 = thunk_FUN_006c31f0(lVar12 + 1);
    ...
    if (lVar12 == 0) {
      *(undefined1 **)(lVar13 + 0x28) = &DAT_0083e5c2;
                    ...
                    /* try { // try from 00627f47 to 00627f4b has its CatchHandler @ 0062812d */
      uVar7 = thunk_FUN_006c31f0(lVar12 + 1);
