...
undefined1 * FUN_00751e20(undefined1 (*param_1) [32],undefined8 param_2,ulong param_3)
...
LAB_00751e80:
    ...
    if (param_3 <= 0x1000 - (uVar10 & 0xfff)) goto LAB_00751e80;
    if (uVar7 != 0) {
      uVar10 = 0;
      for (; (uVar7 & 1) == 0; uVar7 = uVar7 >> 1 | 0x80000000) {
        uVar10 = uVar10 + 1;
  ...
  if (uVar12 <= param_3 && uVar11 != 0) {
    ...
    if (bVar14 || uVar11 == 0) {
      ...
      param_1 = param_1 + 4;
      if (uVar10 != 0) goto LAB_00752000;
      uVar10 = (int)uVar11 + 0x40;
      if (uVar10 != 0 && SCARRY4((int)uVar11,0x40) == (int)uVar10 < 0) goto LAB_00752090;
      goto LAB_00751fd6;
    }
