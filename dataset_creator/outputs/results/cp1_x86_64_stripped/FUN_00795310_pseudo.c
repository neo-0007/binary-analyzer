...
undefined1 * FUN_00795310(undefined8 param_1,undefined1 *param_2)

{
  ...
  puVar8 = local_18;
  puVar2 = (undefined1 *)FUN_00795230(param_1,puVar8);
  if (puVar8 <= puVar2) goto LAB_0079543e;
  puVar3 = puVar2 + 1;
...
LAB_007953d5:
    ...
    if (uVar7 != uVar6) {
      uVar4 = uVar7 - uVar6;
      if (6 < (uVar7 - uVar6) - 1) goto LAB_007953bb;
      goto LAB_007953d5;
    }
  }
