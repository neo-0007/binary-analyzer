...
undefined1 * FUN_007a7a20(undefined1 (*param_1) [16],undefined1 (*param_2) [16])
...
LAB_007a7b32:
        puVar1 = (undefined1 *)FUN_007a7970();
        return puVar1;
      }
    }
    else {
      auVar8 = pshufb(*(undefined1 (*) [16])((ulong)param_2 & 0xfffffffffffffff0),
                      *(undefined1 (*) [16])(&DAT_0082c110 + (int)uVar5));
      ...
      if (iVar2 == iVar4) {
        ...
        if (0x10 < iVar2 + iVar4) goto LAB_007a7b32;
        if (iVar4 != 0) {
          auVar8 = *param_2;
        }
      }
