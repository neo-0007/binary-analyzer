...
undefined1  [16]
FUN_00514bf0(long param_1,undefined8 param_2,undefined8 param_3,long param_4,undefined8 param_5,
            undefined8 *param_6)

{
  ...
  if (lVar2 != 0) {
    ...
    if (auVar4._0_4_ != 0) {
      if (param_1 == 0) {
        auVar5 = FUN_00417730(*param_6,0xb,&DAT_00904060);
        uVar3 = auVar5._8_8_;
        param_1 = auVar5._0_8_;
        if (param_1 == 0) goto LAB_00514cbc;
      }
      puVar1 = PTR_FUN_0093aef0;
