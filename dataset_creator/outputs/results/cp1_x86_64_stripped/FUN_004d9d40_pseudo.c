...
int FUN_004d9d40(long param_1,int param_2,uint param_3,undefined8 *param_4)

{
  ...
  if (param_2 < 0xe) {
    ...
    case 1:
      ...
      if (((((iVar2 == 0x40) || (iVar2 = FUN_0040aaf0(param_4), iVar2 == 0x74)) ||
           ((iVar2 = FUN_0040aaf0(param_4), iVar2 == 0x42 ||
      ...
      uVar3 = 0xa2;
LAB_004d9ebf:
      FUN_0051f540("../crypto/dsa/dsa_pmeth.c",uVar3,"pkey_dsa_ctrl");
      FUN_0051f8f0(10,0x6a,0);
      return 0;
    case 2:
      FUN_0051f420();
      FUN_0051f540("../crypto/dsa/dsa_pmeth.c",0xb2,"pkey_dsa_ctrl");
      FUN_0051f8f0(10,0x96,0);
      return -2;
    case 5:
    case 7:
    case 0xb:
    ...
    if (param_2 == 0x1003) {
      iVar2 = FUN_0040aaf0(param_4);
      if (((iVar2 == 0x40) || (iVar2 = FUN_0040aaf0(param_4), iVar2 == 0x2a3)) ||
         (iVar2 = FUN_0040aaf0(param_4), iVar2 == 0x2a0)) {
