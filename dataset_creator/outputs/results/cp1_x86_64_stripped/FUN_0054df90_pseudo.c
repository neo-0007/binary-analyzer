...
void FUN_0054df90(undefined8 *param_1,undefined8 param_2,code *param_3)

{
  ...
  *param_1 = 0;
  ...
  else if ((DAT_0094b59c >> 0x16 & 0x41) == 0x41) {
    FUN_00550a20(param_1 + 0xc,puVar1);
    pcVar6 = thunk_FUN_00550304;
    pcVar3 = FUN_00550be0;
  }
  else {
    FUN_005500a0();
