...
void FUN_005f7b20(long *param_1,ulong *param_2)

{
  ...
  uVar18 = (ulong)(uVar15 < DAT_005f6008 || uVar15 - DAT_005f6008 < (ulong)(lVar14 != -1));
  uVar1 = (ulong)(uVar19 < uVar18);
  bVar21 = DAT_005f6018 <= uVar12;
  uVar13 = uVar12 - DAT_005f6018;
  bVar2 = uVar1 <= uVar13;
  uVar17 = (uVar15 - DAT_005f6008) - (ulong)(lVar14 != -1);
  lVar11 = lVar14 + 1;
  if (!bVar21 || !bVar2) {
    uVar17 = uVar15;
    lVar11 = lVar14;
