...
undefined1  [16]
FUN_0067c520(undefined8 param_1,long *param_2,ulong param_3,long *param_4,int param_5,int *param_6,
...

{
  ...
  while( true ) {
    ...
    if (cVar1 == '\0') {
      ...
      if (cVar1 == '*') goto LAB_0067c689;
      *(char *)((long)plVar4 + (long)(int)uVar8 + 0x139) = cVar1;
    }
    if (9 < (byte)(cVar1 - 0x30U)) goto LAB_0067c689;
  ...
  if (uVar11 == param_9) goto LAB_0067c6a1;
LAB_0067c689:
