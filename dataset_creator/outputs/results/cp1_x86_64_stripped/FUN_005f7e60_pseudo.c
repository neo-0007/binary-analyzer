...
void FUN_005f7e60(undefined1 (*param_1) [32],undefined1 (*param_2) [32],uint param_3)

{
  ...
  lVar15 = 8;
  auVar7 = _DAT_005f6040;
  auVar8 = _DAT_005f6060;
  do {
    auVar6 = *param_2;
    pauVar1 = param_2 + 1;
    pauVar2 = param_2 + 2;
    ...
    auVar7 = vpaddd_avx2(auVar7,_DAT_005f6060);
    auVar8 = vpaddd_avx2(auVar8,_DAT_005f6060);
    param_2 = param_2 + 6;
