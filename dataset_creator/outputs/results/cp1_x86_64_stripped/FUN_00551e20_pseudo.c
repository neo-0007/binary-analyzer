...
undefined8 FUN_00551e20(undefined8 *param_1,ulong *param_2,ulong *param_3,ulong param_4)
  ...
  if ((param_4 < 0x10) || (param_1[4] == 0)) {
    while (uVar11 = uVar11 + 1, uVar11 <= uVar1) {
      ...
      if ((uVar11 & 1) == 0) {
        ...
        puVar7 = (ulong *)FUN_005515c0(param_1,iVar9);
      }
      else {
        puVar7 = (ulong *)FUN_005515c0(param_1,0);
      }
      if (puVar7 == (ulong *)0x0) goto LAB_00551fde;
      uVar8 = param_1[0x12];
      uVar2 = *puVar7;
      uVar3 = param_1[0x13];
      uVar4 = puVar7[1];
    ...
    lVar10 = FUN_005515c0(param_1,lVar10);
    if (lVar10 == 0) {
LAB_00551fde:
      uVar6 = 0;
      goto LAB_00551ee1;
  ...
  if ((param_4 & 0xf) != 0) {
    ...
    FUN_00771fb0(local_58,param_2,uVar11,0x10);
