...
undefined1 * FUN_0075c360(undefined1 (*param_1) [32],undefined4 param_2,ulong param_3)
...
LAB_0075c3c0:
    ...
    if (param_3 <= ((int)((ulong)param_1 | 0x1f) + 1) - uVar11 >> 2) goto LAB_0075c3c0;
    if (uVar8 != 0) {
      uVar11 = 0;
      for (; (uVar8 & 1) == 0; uVar8 = uVar8 >> 1 | 0x80000000) {
        uVar11 = uVar11 + 1;
  ...
  if (uVar14 <= param_3 && uVar12 != 0) {
    ...
    if (uVar12 < 0x20 || lVar13 == 0) {
      ...
      iVar10 = (int)lVar13 * 4;
      uVar15 = uVar15 + 0x80;
      if (uVar11 != 0) goto LAB_0075c580;
      uVar11 = iVar10 + 0x40;
      uVar14 = uVar15;
      if (uVar11 != 0 && SCARRY4(iVar10,0x40) == (int)uVar11 < 0) goto LAB_0075c5f0;
      goto LAB_0075c520;
    }
