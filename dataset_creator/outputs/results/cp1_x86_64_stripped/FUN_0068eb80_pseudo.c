...
long * FUN_0068eb80(long *param_1,undefined8 param_2)

{
  ...
  if (local_58[0] != '\0') {
    ...
    if (plVar1 == (long *)0x0) {
                    ...
                    /* try { // try from 0068ed29 to 0068ed32 has its CatchHandler @ 0068ed33 */
      FUN_00403826();
    }
    if (*(char *)(lVar6 + 0xe1) == '\0') {
      ...
      if ((char)plVar2[7] == '\0') {
                    /* try { // try from 0068ecd3 to 0068ecfc has its CatchHandler @ 0068ed33 */
        FUN_0063d6f0(plVar2);
        iVar5 = 0x20;
        cVar4 = ' ';
      ...
      *(undefined1 *)(lVar6 + 0xe1) = 1;
      ...
      iVar5 = (int)*(char *)(lVar6 + 0xe0);
                    ...
                    /* try { // try from 0068ec09 to 0068ec0b has its CatchHandler @ 0068ed33 */
    (**(code **)(*plVar1 + 0x28))
              (plVar1,*(long *)(lVar6 + 0xe8),*(long *)(lVar6 + 0xe8) == 0,lVar6,iVar5,param_2);
    if (extraout_DL != '\0') {
      lVar6 = *(long *)(*param_1 + -0x18) + (long)param_1;
                    /* try { // try from 0068ec21 to 0068ec25 has its CatchHandler @ 0068ed3f */
