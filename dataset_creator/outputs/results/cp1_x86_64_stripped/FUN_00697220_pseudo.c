...
void FUN_00697220(long *param_1,long *param_2,long *param_3)

{
  ...
  *(long *)((long)param_1 + *(long *)(lVar1 + -0x18)) = lVar2;
                    /* try { // try from 006972c5 to 006972c9 has its CatchHandler @ 006972e2 */
  FUN_00695600(param_1 + 1,param_3 + 1);
