...
ulong FUN_006d7770(long param_1,ulong *param_2,ulong *param_3,uint *param_4,ulong *param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (param_8 == 0) goto LAB_006d7878;
    puVar9 = (uint *)param_2[4];
    if ((*puVar9 & 7) == 0) goto LAB_006d7878;
    if (param_5 != (ulong *)0x0) {
    ...
    if (4 < (*puVar9 & 7)) {
                    /* WARNING: Subroutine does not return */
      FUN_006e2220("(state->__count & 7) <= sizeof (state->__value)","../iconv/loop.c",0x18a,
                   "internal_ascii_loop_single");
    }
    local_44 = CONCAT31(local_44._1_3_,(byte)puVar9[1]);
    if ((*puVar9 & 6) == 0) {
      if ((uint *)((long)puVar11 + 3U) <= param_4) {
        if (puVar1 <= puVar18) goto LAB_006d7b18;
        lVar17 = 1;
LAB_006d7e1a:
        local_b0 = lVar17 + 1;
...
LAB_006d7e95:
        if (local_44 < 0x80) {
          ...
          *puVar18 = (char)local_44;
          ...
          if (local_58 != &local_44) goto LAB_006d7eeb;
LAB_006d8041:
          puVar11 = (uint *)*param_3;
        }
        else {
...
LAB_006d80d8:
                ...
                uVar3 = FUN_006dd390(param_1,param_2,puVar11,&local_58,pbVar15,&local_50,plVar7);
                uVar16 = (ulong)uVar3;
                if (uVar3 != 6) {
                  if (local_58 == &local_44) {
                    ...
                    /* WARNING: Subroutine does not return */
                        FUN_006e2220("inend != &bytebuf[MAX_NEEDED_INPUT]","../iconv/loop.c",0x1e2,
                                     "internal_ascii_loop_single");
                      }
                    ...
                    /* WARNING: Subroutine does not return */
                        FUN_006e2220("inend - inptr > (state->__count & ~7)","../iconv/loop.c",0x1ec
                                     ,"internal_ascii_loop_single");
                      }
                      if (4 < local_b0) {
                    /* WARNING: Subroutine does not return */
                        FUN_006e2220("inend - inptr <= sizeof (state->__value.__wchb)",
...
LAB_006d7eeb:
                ...
                if ((uVar5 & 2) == 0) {
                  ...
                  local_58 = puVar11;
                  *plVar7 = *plVar7 + 1;
                  if (puVar11 != &local_44) goto LAB_006d80d8;
                }
              }
            }
            uVar16 = 6;
...
LAB_006d7eee:
          ...
          if (lVar17 <= (long)uVar16) {
                    /* WARNING: Subroutine does not return */
            FUN_006e2220("inptr - bytebuf > (state->__count & 7)","../iconv/loop.c",0x1d0,
                         "internal_ascii_loop_single");
          }
            ...
            do {
              ...
              if (param_4 < puVar8) {
                ...
                *param_3 = (ulong)puVar9;
                if (param_5 == (ulong *)0x0) goto LAB_006d7914;
                goto LAB_006d79e2;
              }
              if (puVar1 <= puVar12) {
                uVar16 = 5;
              ...
              if (uVar3 < 0x80) {
                ...
                *puVar12 = (char)uVar3;
                ...
                if (uVar3 >> 7 != 0x1c00) {
                  if (plVar7 != (long *)0x0) {
                    if ((param_2[2] & 8) != 0) {
                      uVar3 = FUN_006dd390(param_1,param_2,*param_3,&local_58,param_4,&local_50,
                                           plVar7);
                      uVar16 = (ulong)uVar3;
                      puVar9 = local_58;
                      puVar12 = local_50;
...
LAB_006d7d27:
                  ...
                  while( true ) {
                    puVar9 = puVar11 + 1;
                    if (param_4 < puVar9) goto LAB_006d7d16;
                    ...
                    if (uVar3 < 0x80) {
                      ...
                      *puVar12 = (char)uVar3;
                      ...
                      if (plVar7 == (long *)0x0) goto LAB_006d7d16;
                      if (((param_2[2] & 8) == 0) ||
                         (iVar4 = FUN_006dd390(param_1,param_2,*param_3,&local_58,param_4,&local_50,
                                               plVar7), puVar12 = local_50, puVar11 = local_58,
                         iVar4 == 6)) {
                        if ((uVar16 & 2) == 0) goto LAB_006d7d16;
                        local_58 = puVar11 + 1;
                        *plVar7 = *plVar7 + 1;
                        puVar9 = puVar11 + 1;
                      }
                  ...
                  *param_3 = (ulong)puVar11;
                  if (puVar12 != local_60) goto LAB_006d7d27;
                  if (puVar18 == puVar12) {
                    *(int *)((long)param_2 + 0x14) = *(int *)((long)param_2 + 0x14) + -1;
                  }
                }
            ...
            if (uVar5 != 5) goto LAB_006d79a2;
          }
          else {
LAB_006d79a2:
            if (uVar5 != 0) goto LAB_006d7df6;
          }
...
LAB_006d80fe:
                    /* WARNING: Subroutine does not return */
        FUN_006e2220("inlen_after <= sizeof (state->__value.__wchb)","../iconv/loop.c",0x1a7,
                     "internal_ascii_loop_single");
      }
      if (pbVar15 < pbVar14) {
...
LAB_006d81a5:
      ...
      if ((*puVar9 & 7) < 3) {
        ...
        lVar17 = 2;
        if (puVar18 < puVar1) goto LAB_006d7e1a;
      }
      else {
        ...
        if ((*puVar9 & 4) == 0) {
          ...
          if (param_4 < puVar11) {
            *param_3 = (ulong)param_4;
            if ((byte *)0x4 < (byte *)((long)param_4 + (4 - (long)puVar11))) goto LAB_006d80fe;
            goto LAB_006d81a5;
          }
        }
      }
    ...
    *(undefined8 *)param_2[4] = 0;
    if ((param_2[2] & 1) == 0) {
      ...
      if (local_40[0] == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x006d7de3. Too many branches */
