...
void FUN_0078b4b0(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  *(undefined8 *)(&stack0x00000200 + lVar1) = 0;
  *(undefined8 *)(&stack0x00000208 + lVar1) = 0;
  ...
  *(undefined8 *)(&stack0x00000238 + lVar1) = 0;
  xsave((long)&stack0x00000000 + lVar1,0x200);
  *(undefined8 *)((long)auStack_48 + lVar1) = 0x78b53e;
  UNRECOVERED_JUMPTABLE = (code *)FUN_007ba5a0(unaff_retaddr,param_7);
  xrstor((long)&stack0x00000000 + lVar1,0x200);
                    /* WARNING: Could not recover jumptable at 0x0078b57a. Too many branches */
