...
undefined8 FUN_006ce7d0(ulong *param_1,ulong param_2,ulong *param_3)
...
LAB_006ce80d:
  ...
  else if ((param_1[4] == DAT_0093d6e8) && (DAT_00945648 == param_1[5])) {
    if (DAT_00945650 == (ulong *)0x0) goto LAB_006ce80d;
    uVar24 = *DAT_00945650;
    uVar10 = DAT_00945650[1];
    local_80 = (ulong *)0x0;
    puVar23 = DAT_00945650;
    while( true ) {
      if ((uVar24 <= *param_3) && (*param_3 < uVar10)) {
        uVar19 = puVar23[2];
        piVar22 = (int *)puVar23[3];
        if (puVar23 != DAT_00945650) {
          DAT_00945650 = puVar23;
    ...
    puVar16 = &DAT_00945690;
    DAT_0093d6e8 = param_1[4];
    DAT_00945648 = param_1[5];
    do {
      puVar16[-6] = 0;
      puVar16[-5] = 0;
      puVar16[-1] = puVar16;
      puVar16 = puVar16 + 6;
    } while (puVar16 != &DAT_00945810);
    puVar23 = (ulong *)0x0;
    _DAT_009457d8 = 0;
    DAT_00945650 = &DAT_00945660;
...
LAB_006ceb7b:
    ...
    if (bVar13 != 0x20) {
      if (bVar13 < 0x21) {
        if ((bVar7 & 0x60) != 0) goto code_r0x004046ea;
      }
      else {
        if (bVar13 == 0x30) {
          uVar19 = param_3[2];
...
LAB_006ceaa8:
  uVar9 = FUN_006cdb90(bVar7,uVar19,pcVar20 + 4,&local_78);
  bVar7 = pcVar20[2];
  if ((bVar7 != 0xff) && (pcVar20[3] == ';')) {
    ...
    if (bVar13 == 0x20) {
      ...
      if (bVar13 < 0x21) {
        ...
        if (bVar13 != 0x50) {
                    /* WARNING: Subroutine does not return */
          thunk_FUN_00404713(bVar7);
        }
      }
      uVar19 = 0;
    }
LAB_006cebc7:
    piVar11 = (int *)FUN_006cdb90(bVar7,uVar19,uVar9,&local_70);
    ...
    if (((ulong)piVar11 & 3) == 0) {
      ...
      bVar7 = FUN_006cdce0(pcVar25 + (4 - (long)*(int *)(pcVar25 + 4)));
      if (bVar7 == 0xff) {
        lVar17 = 8;
      }
      else {
        ...
        if (bVar13 == 2) {
          ...
          if (bVar13 < 3) {
            ...
            lVar17 = 0xc;
            if (bVar13 == 3) goto LAB_006cec97;
            if (bVar13 != 4) goto code_r0x004046ea;
          }
          lVar17 = 0x10;
        }
      }
LAB_006cec97:
      FUN_006cdb90(bVar7 & 0xf,0,pcVar25 + lVar17,&local_68);
  ...
  local_60 = uVar19;
  local_58 = uVar24;
  uVar10 = FUN_006ce4b0(&local_68,local_78,*param_3);
  param_3[4] = uVar10;
  if (uVar10 == 0) {
    return 1;
  }
  bVar7 = FUN_006cdce0((uVar10 + 4) - (long)*(int *)(uVar10 + 4));
  if (bVar7 == 0xff) {
LAB_006ceb58:
    uVar19 = 0;
  }
...
code_r0x004046ea:
        ...
        uVar19 = uVar24;
        if (bVar13 == 0x30) goto LAB_006ceb5a;
        if (bVar13 != 0x50) {
                    /* WARNING: Subroutine does not return */
          thunk_FUN_00404713();
        }
...
LAB_006ceb5a:
  FUN_006cdb90(bVar7,uVar19,uVar10 + 8,&local_70);
LAB_006ceb69:
