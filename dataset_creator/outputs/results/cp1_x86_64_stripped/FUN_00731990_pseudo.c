...
ulong FUN_00731990(undefined1 (*param_1) [16],undefined1 (*param_2) [16])
  ...
  if (bVar11) {
    ...
    if (bVar10) {
      return (ulong)(uint)(*(int *)(&DAT_00831080 +
                                   (ulong)(byte)param_1[-1][(ulong)uVar5 + lVar9] * 4) -
                          *(int *)(&DAT_00831080 +
                                  (ulong)(byte)param_2[-1][(ulong)uVar5 + lVar9] * 4));
    }
    return 0;
  }
...
LAB_00733500:
  ...
  return (ulong)(uint)(*(int *)(&DAT_00831080 + (ulong)(byte)(*param_1)[lVar8] * 4) -
                      *(int *)(&DAT_00831080 + (ulong)(byte)(*param_2)[lVar8] * 4));
}
