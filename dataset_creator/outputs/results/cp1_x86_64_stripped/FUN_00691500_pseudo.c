...
long * FUN_00691500(long *param_1,undefined8 param_2)

{
  ...
  if (local_48[0] != '\0') {
    ...
    if (plVar1 == (long *)0x0) {
                    ...
                    /* try { // try from 0069165e to 00691667 has its CatchHandler @ 00691668 */
      FUN_00403826();
    }
    if (*(char *)(lVar7 + 0xe4) == '\0') {
      ...
      if (plVar2 == (long *)0x0) {
        ...
        FUN_00403826();
                    ...
                    /* try { // try from 00691614 to 00691616 has its CatchHandler @ 00691668 */
      ...
      *(undefined1 *)(lVar7 + 0xe4) = 1;
      ...
      uVar6 = *(undefined4 *)(lVar7 + 0xe0);
                    ...
                    /* try { // try from 00691586 to 00691588 has its CatchHandler @ 00691668 */
    (**(code **)(*plVar1 + 0x28))
              (plVar1,*(long *)(lVar7 + 0xe8),*(long *)(lVar7 + 0xe8) == 0,lVar7,uVar6,param_2);
    if (extraout_DL != '\0') {
      lVar7 = *(long *)(*param_1 + -0x18) + (long)param_1;
                    /* try { // try from 0069159e to 006915a2 has its CatchHandler @ 00691674 */
