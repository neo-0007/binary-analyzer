...
void FUN_0078b580(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  *(undefined8 *)((long)auStack_48 + lVar1) = 0x78b5fe;
  UNRECOVERED_JUMPTABLE = (code *)FUN_007ba5a0(unaff_retaddr,param_7);
  xrstor((long)&stack0x00000000 + lVar1,0x200);
                    /* WARNING: Could not recover jumptable at 0x0078b63a. Too many branches */
