...
bool FUN_007bfd00(undefined8 *param_1,long param_2)

{
  ...
  pbVar2 = (byte *)*param_1;
  plVar7 = *(long **)(DAT_0094b488 + (ulong)*pbVar2 * 8);
  if (plVar7 == (long *)0x0) {
    return true;
  }
  pbVar8 = (byte *)0x0;
  ...
  do {
    ...
    while (pbVar3 = pbVar3 + 1, bVar1 != 0) {
      if (*puVar5 == 0) goto LAB_007bfd72;
      if ((uint)bVar1 != *puVar5) goto LAB_007bfd89;
      puVar5 = puVar5 + 1;
      bVar1 = pbVar3[1];
    }
    if (*puVar5 == 0) {
