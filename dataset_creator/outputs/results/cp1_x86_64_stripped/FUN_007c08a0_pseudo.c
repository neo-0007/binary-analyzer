...
undefined8
FUN_007c08a0(undefined8 param_1,undefined8 param_2,undefined4 param_3,undefined8 *param_4,
...

{
  ...
  if (lVar5 == 0) {
    ...
    *param_6 = 0xffffffff;
    ...
    do {
      sVar2 = *psVar8;
      iVar3 = FUN_007c4580(lVar5,param_1,1,(long)sVar2,local_58,0x14,&local_60,0,0,0,0);
      puVar9 = local_60;
      if (iVar3 < 1) {
LAB_007c09c0:
        puVar9 = local_58;
        ...
        iVar3 = FUN_007c8480(local_60 + 0xc,puVar1);
        if (-1 < iVar3) {
          puVar9 = puVar9 + (long)iVar3 + 0x10;
          for (; uVar10 != 0; uVar10 = uVar10 - 1) {
            iVar3 = FUN_007c8480(puVar9,puVar1);
            if ((iVar3 < 0) ||
               (puVar6 = (ushort *)(puVar9 + iVar3), (long)puVar1 - (long)puVar6 < 10))
            goto LAB_007c0aa8;
            uVar7 = (ulong)(ushort)(*puVar6 << 8 | *puVar6 >> 8);
            if ((long)sVar2 == uVar7) {
              iVar3 = FUN_007c8450(local_60,puVar1,puVar9,param_2,param_3);
              puVar9 = local_60;
              if (iVar3 < 0) {
                if (*(int *)(in_FS_OFFSET + -0x58) != 0x5a) goto LAB_007c0aa8;
                uVar11 = 0xfffffffe;
                *param_5 = 0x22;
            ...
            if ((uVar7 != 5) || (puVar6[1] != 0x100)) goto LAB_007c0aa8;
            uVar7 = (ulong)(ushort)(puVar6[4] << 8 | puVar6[4] >> 8);
            if ((long)puVar1 - (long)(puVar6 + 5) < (long)uVar7) goto LAB_007c0aa8;
