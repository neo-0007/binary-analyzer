...
void FUN_00629540(long param_1,long param_2)
    ...
    *(undefined1 *)(*(long *)(param_1 + 0x10) + 0x21) = *puVar7;
      ...
      *(undefined1 *)(lVar13 + 0x22) = 0x2c;
      ...
      if (lVar14 == 0) {
        ...
        *(undefined1 **)(lVar13 + 0x10) = &DAT_0083e5c2;
                    ...
                    /* try { // try from 0062991c to 00629920 has its CatchHandler @ 00629a25 */
    ...
    if (lVar13 == 0) {
      ...
      *(undefined1 **)(lVar14 + 0x38) = &DAT_0083e5c2;
                    ...
                    /* try { // try from 006298dd to 006298e1 has its CatchHandler @ 00629a31 */
    ...
    *(long *)(lVar14 + 0x40) = lVar13;
      ...
      *(char **)(lVar14 + 0x48) = "()";
      ...
      if (lVar13 == 0) {
        *(undefined1 **)(lVar14 + 0x48) = &DAT_0083e5c2;
                    ...
                    /* try { // try from 00629957 to 0062995b has its CatchHandler @ 00629a49 */
        uVar9 = thunk_FUN_006c31f0(lVar13 + 1);
    ...
    if (lVar13 == 0) {
      *(undefined1 **)(lVar14 + 0x28) = &DAT_0083e5c2;
                    ...
                    /* try { // try from 00629857 to 0062985b has its CatchHandler @ 00629a3d */
      uVar9 = thunk_FUN_006c31f0(lVar13 + 1);
