...
/* WARNING: Removing unreachable block (ram,0x0071db82) */

ulong FUN_0071c360(byte *param_1,byte *param_2,ulong param_3)
  ...
  if (uVar53 != uVar51) {
    ...
    if (uVar53 <= uVar51) {
      ...
      pcVar59 = pcVar57;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0071c419. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    uVar52 = (*(code *)(&DAT_0082adb0 + *(int *)(&DAT_0082adb0 + ((uVar52 + 0xf) - uVar54) * 4)))
