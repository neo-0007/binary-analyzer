...
void FUN_004e12b0(long param_1,long param_2)
...
LAB_004e12f8:
    ...
    pcVar9 = pcVar8;
    do {
      if (0xff < iVar10) goto LAB_004e12f8;
      cVar3 = *pcVar9;
      if (cVar3 != '\0') {
        do {
          cVar4 = pcVar8[-1];
          ...
          if (0xf < cVar4 + iVar7) {
            if (cVar4 - iVar7 < -0xf) goto LAB_004e1380;
            pcVar1 = pcVar9 + 1;
            pcVar8[-1] = cVar4 - (char)iVar7;
            while (*pcVar9 != '\0') {
              *pcVar9 = '\0';
              pcVar9 = pcVar9 + 1;
              if (pcVar9 == pcVar1 + (0xff - iVar10)) goto LAB_004e1361;
            }
            *pcVar9 = '\x01';
            goto LAB_004e1361;
          }
