...
undefined1  [16]
FUN_0078aa80(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  UNRECOVERED_JUMPTABLE =
       (code *)FUN_007ba770(unaff_retaddr,param_7,param_8,auStack_3c8 + 1,&local_10);
  ...
  if (-1 < local_10) {
    ...
    uVar8 = puVar16[4];
    uVar9 = puVar16[5];
    *(undefined8 *)((long)auStack_3c8 + lVar10) = 0x78adc8;
    ...
    *(unkbyte10 *)(puVar15 + 0xffffffffffffffe6) = in_ST1;
    puVar16 = local_8;
    puVar15[0xffffffffffffffdd] = 0x78ae20;
    FUN_0078f3f0(unaff_retaddr,param_7,puVar16);
    ...
    return *pauVar14;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0078ad9a. Too many branches */
