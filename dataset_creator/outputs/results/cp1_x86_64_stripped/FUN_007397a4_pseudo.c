...
/* WARNING: Removing unreachable block (ram,0x0073b70a) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

ulong FUN_007397a4(undefined1 (*param_1) [16],undefined1 (*param_2) [16],ulong param_3,long *param_4
                  )

{
  ...
  if ((*(uint *)(*param_4 + 0x278) & 1) != 0) {
    if ((param_1 == param_2) || (param_3 == 0)) {
      ...
      uVar7 = 0;
      do {
        uVar3 = *(int *)(param_4[0xe] + (ulong)(byte)(*param_1)[uVar7] * 4) -
                *(int *)(param_4[0xe] + (ulong)(byte)(*param_2)[uVar7] * 4);
        uVar2 = (ulong)uVar3;
        if (uVar3 != 0) {
          return uVar2;
        }
  ...
  uVar1 = (uint)param_1;
  cVar30 = DAT_0082bbf0;
  cVar31 = DAT_0082bbf0._1_1_;
  cVar32 = DAT_0082bbf0._2_1_;
  cVar33 = DAT_0082bbf0._3_1_;
  cVar34 = DAT_0082bbf0._4_1_;
  cVar35 = DAT_0082bbf0._5_1_;
  cVar36 = DAT_0082bbf0._6_1_;
  cVar37 = DAT_0082bbf0._7_1_;
  cVar38 = DAT_0082bbf0._8_1_;
  cVar39 = DAT_0082bbf0._9_1_;
  cVar40 = DAT_0082bbf0._10_1_;
  cVar41 = DAT_0082bbf0._11_1_;
  cVar42 = DAT_0082bbf0._12_1_;
  cVar43 = DAT_0082bbf0._13_1_;
  cVar44 = DAT_0082bbf0._14_1_;
  cVar45 = DAT_0082bbf0._15_1_;
  cVar50 = DAT_0082bc00;
  cVar69 = DAT_0082bc00._15_1_;
  cVar55 = DAT_0082bc00._1_1_;
  cVar56 = DAT_0082bc00._2_1_;
  cVar57 = DAT_0082bc00._3_1_;
  cVar58 = DAT_0082bc00._4_1_;
  cVar59 = DAT_0082bc00._5_1_;
  cVar60 = DAT_0082bc00._6_1_;
  cVar61 = DAT_0082bc00._7_1_;
  cVar62 = DAT_0082bc00._8_1_;
  cVar63 = DAT_0082bc00._9_1_;
  cVar64 = DAT_0082bc00._10_1_;
  cVar65 = DAT_0082bc00._11_1_;
  cVar66 = DAT_0082bc00._12_1_;
  cVar67 = DAT_0082bc00._13_1_;
  cVar68 = DAT_0082bc00._14_1_;
  if (((uVar3 & 0x3f) < 0x31) && ((uVar1 & 0x3f) < 0x31)) {
    ...
    auVar11 = auVar11 | auVar46 & auVar51 & _DAT_0082bc10;
    auVar29 = auVar29 | auVar70 & auVar74 & _DAT_0082bc10;
  ...
  if (uVar3 != uVar1) {
    if (uVar3 <= uVar1) {
      ...
      uVar7 = (ulong)uVar1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x007398c9. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    uVar2 = (*(code *)(&DAT_0082bdb0 + *(int *)(&DAT_0082bdb0 + ((uVar2 + 0xf) - uVar7) * 4)))();
    return uVar2;
  }
  auVar11 = *param_2;
  cVar10 = auVar11[0];
  ...
  auVar11 = auVar11 | auVar47 & auVar52 & _DAT_0082bc10;
  auVar29 = auVar29 | auVar71 & auVar75 & _DAT_0082bc10;
  ...
  if (uVar4 == 0) {
    ...
    while( true ) {
      ...
      uVar3 = pcmpistri(auVar11 | auVar48 & auVar53 & _DAT_0082bc10,
                        auVar29 | auVar72 & auVar76 & _DAT_0082bc10,0x1a);
      lVar6 = lVar5 + 0x10;
      uVar7 = uVar2;
      ...
      uVar3 = pcmpistri(auVar11 | auVar49 & auVar54 & _DAT_0082bc10,
                        auVar29 | auVar73 & auVar77 & _DAT_0082bc10,0x1a);
      lVar6 = lVar5 + 0x20;
    ...
    return (ulong)(uint)(*(int *)(&DAT_00831080 + (ulong)(byte)param_1[-1][uVar2 + lVar6] * 4) -
                        *(int *)(&DAT_00831080 + (ulong)(byte)param_2[-1][uVar2 + lVar6] * 4));
  }
...
LAB_0073b710:
  ...
  return (ulong)(uint)(*(int *)(&DAT_00831080 + (ulong)(byte)(*param_1)[uVar2] * 4) -
                      *(int *)(&DAT_00831080 + (ulong)(byte)(*param_2)[uVar2] * 4));
}
