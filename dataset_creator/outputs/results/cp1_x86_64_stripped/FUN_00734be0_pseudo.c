...
/* WARNING: Removing unreachable block (ram,0x007371c2) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

ulong FUN_00734be0(undefined1 (*param_1) [16],undefined1 (*param_2) [16],ulong param_3,long *param_4
                  )
  ...
  if (uVar21 != uVar19) {
    ...
    if (uVar21 <= uVar19) {
      ...
      param_1 = param_2;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00734d09. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    uVar20 = (*(code *)(&DAT_0082bd30 + *(int *)(&DAT_0082bd30 + ((uVar20 + 0xf) - uVar23) * 4)))
