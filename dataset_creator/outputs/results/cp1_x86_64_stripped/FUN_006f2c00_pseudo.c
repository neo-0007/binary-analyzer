...
/* WARNING: Removing unreachable block (ram,0x006f2d0a) */
/* WARNING: Removing unreachable block (ram,0x006f2e18) */

undefined1  [16]
FUN_006f2c00(long param_1,long param_2,undefined8 param_3,undefined8 param_4,undefined8 param_5,
            undefined8 param_6)
  ...
  if (*(long *)(in_FS_OFFSET + 0x78) != 0) {
    ...
    *(undefined8 *)(param_1 + 0x3b0) = *(undefined8 *)(in_FS_OFFSET + 0x78);
    ...
    if (UNRECOVERED_JUMPTABLE != (code *)*in_SSP) {
                    /* WARNING: Could not recover jumptable at 0x006f2dec. Too many branches */
