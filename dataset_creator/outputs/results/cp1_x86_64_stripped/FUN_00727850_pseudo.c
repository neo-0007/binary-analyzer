...
undefined1 (*) [16]
FUN_00727850(undefined1 (*param_1) [16],undefined1 (*param_2) [16],uint *param_3,uint *param_4)

{
  ...
  if (param_4 < param_3) {
    pcVar141 = "buffer overflow detected";
    FUN_00771f80();
    if (extraout_EDX < 1) {
      ...
      if ((uVar128 & 0x8000) == 0) {
        ...
        piVar142 = *(int **)(param_4 + 0x22);
        if (*(long *)(piVar142 + 2) != lVar132) {
          LOCK();
          iVar2 = *piVar142;
          if (iVar2 == 0) {
            *piVar142 = 1;
          ...
          piVar142 = *(int **)(param_4 + 0x22);
          uVar128 = *param_4;
          *(long *)(piVar142 + 2) = lVar132;
        }
        piVar142[1] = piVar142[1] + 1;
      }
      *param_4 = uVar128 & 0xffffffdf;
      ...
      pauVar138 = (undefined1 (*) [16])FUN_006fe490(param_4,pcVar141,pauVar127,10,1);
      uVar129 = *param_4;
      if (pauVar138 == (undefined1 (*) [16])0x0) {
        ...
        (*pauVar138)[(long)*(undefined1 (*) [16])pcVar141] = 0;
        uVar129 = *param_4;
        pauVar127 = (undefined1 (*) [16])pcVar141;
      }
