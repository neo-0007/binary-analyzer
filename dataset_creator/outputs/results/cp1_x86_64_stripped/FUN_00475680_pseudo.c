...
undefined8 FUN_00475680(long param_1,undefined8 param_2)

{
  ...
  if (lVar2 != 0) {
    ...
    FUN_0044fd20(param_1 + 0xf0);
  }
  lVar2 = thunk_FUN_0041cdd0(param_2,"key");
  if (lVar2 != 0) {
    uVar3 = FUN_00475560(param_1,*(undefined8 *)(lVar2 + 0x10),*(undefined8 *)(lVar2 + 0x18));
    if ((int)uVar3 == 0) goto LAB_00475702;
  }
  ...
  if (lVar2 != 0) {
    ...
    FUN_0044fd40(param_1 + 0xf0,*(undefined8 *)(lVar2 + 0x10));
  }
  lVar2 = thunk_FUN_0041cdd0(param_2,"salt");
  uVar3 = 1;
  if (lVar2 != 0) {
    if (*(ulong *)(lVar2 + 0x18) < 0x11) {
      FUN_0044fd70(param_1 + 0xf0,*(undefined8 *)(lVar2 + 0x10),*(ulong *)(lVar2 + 0x18));
      uVar3 = 1;
    }
    else {
      FUN_0051f420();
