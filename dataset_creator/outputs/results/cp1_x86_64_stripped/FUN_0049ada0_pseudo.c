...
void FUN_0049ada0(undefined1 (*param_1) [16],undefined1 (*param_2) [16],ulong param_3,long param_4,
...

{
  ...
  *(undefined8 *)(local_78 + lVar4 + -8) = 0x49adf5;
  puVar10 = (ulong *)FUN_0049a440();
  *puVar10 = in_XMM7_Qa ^ in_XMM6_Qa;
  ...
  while( true ) {
    ...
    *(undefined1 (*) [16])(auStack_f8 + lVar4) = auVar44;
    ...
    auVar17 = auVar17 ^ auVar29 & _DAT_0049bef0;
    ...
    *(undefined1 (*) [16])((long)auStack_e8 + lVar4) = auVar17;
    ...
    auVar18._0_8_ = lVar5;
    iVar43 = -(uint)((int)lVar5 < 0);
    auVar18 = auVar18 ^ auVar45 & _DAT_0049bef0;
    auVar29 = *param_1;
    ...
    *(undefined1 (*) [16])(auStack_d8 + lVar4) = auVar18;
    ...
    auVar19._0_8_ = lVar5;
    iVar43 = -(uint)((int)lVar5 < 0);
    auVar19 = auVar19 ^ auVar30 & _DAT_0049bef0;
    ...
    *(undefined1 (*) [16])(auStack_c8 + lVar4) = auVar19;
    ...
    in_XMM3._0_8_ = lVar5;
    iVar43 = -(uint)((int)lVar5 < 0);
    in_XMM3 = in_XMM3 ^ auVar31 & _DAT_0049bef0;
    ...
    *(undefined1 (*) [16])(auStack_a8 + lVar4) = auVar20;
    ...
    in_XMM5._0_8_ = lVar5;
    iVar43 = -(uint)((int)lVar5 < 0);
    in_XMM5 = in_XMM5 ^ auVar33 & _DAT_0049bef0;
    auVar45 = param_1[4];
    ...
    *(undefined1 (*) [16])((long)auStack_98 + lVar4) = in_XMM5;
    ...
    auVar21 = auVar21 ^ auVar34 & _DAT_0049bef0;
    ...
    *(undefined8 *)((long)&uStack_100 + lVar4) = 0x49afc5;
    auVar45 = FUN_004992c0(auVar17._0_8_ ^ uVar14,auVar18._0_8_ ^ uVar15);
    ...
    *(ulong *)(param_2[6] + 8) = extraout_XMM1_Qb ^ uVar15;
    ...
    bVar2 = lVar5 < 0;
    bVar3 = lVar6 < 0;
    auVar44 = auVar44 ^ auVar35 & _DAT_0049bef0;
    uVar14 = uVar9;
  }
  if (uVar9 != 0xffffffffffffff80) {
    ...
    *(undefined1 (*) [16])(auStack_f8 + lVar4) = auVar44;
    ...
    auVar22._0_8_ = lVar5;
    iVar43 = -(uint)((int)lVar5 < 0);
    auVar22 = auVar22 ^ auVar36 & _DAT_0049bef0;
    ...
    *(undefined1 (*) [16])((long)auStack_e8 + lVar4) = auVar22;
    ...
    auVar23._0_8_ = lVar5;
    iVar43 = -(uint)((int)lVar5 < 0);
    auVar23 = auVar23 ^ auVar37 & _DAT_0049bef0;
    auVar29 = *param_1;
    uVar15 = auVar23._0_8_;
    if (uVar9 == 0xffffffffffffff90) {
      local_58[0] = auVar29 ^ auVar44;
      param_1 = param_1 + 1;
      *(undefined8 *)((long)&uStack_100 + lVar4) = 0x49b4cf;
      FUN_00489fa0(local_58,local_58,param_4);
      ...
      *(undefined1 (*) [16])(auStack_d8 + lVar4) = auVar23;
      ...
      if (uVar9 == 0xffffffffffffffa0) {
        auVar44 = auVar44 ^ auVar29;
        param_1 = param_1 + 2;
        *(undefined8 *)((long)&uStack_100 + lVar4) = 0x49b47f;
        uVar15 = FUN_004992c0(uVar14 ^ uVar16,uVar15);
        uVar14 = *(ulong *)((long)auStack_e8 + lVar4);
        ...
        *(undefined1 (*) [16])(auStack_c8 + lVar4) = auVar24;
        ...
        if (uVar9 == 0xffffffffffffffb0) {
          param_1 = param_1 + 3;
          *(undefined8 *)((long)&uStack_100 + lVar4) = 0x49b41f;
          uVar15 = FUN_004992c0(uVar14 ^ uVar16,uVar15 ^ uVar7);
          uVar14 = *(ulong *)((long)auStack_e8 + lVar4);
          uVar9 = *(ulong *)((long)auStack_e8 + lVar4 + 8);
          *param_2 = auVar44 ^ *(undefined1 (*) [16])(auStack_f8 + lVar4);
          auVar44 = *(undefined1 (*) [16])(auStack_d8 + lVar4);
          ...
          *(undefined1 (*) [16])(auStack_b8 + lVar4) = auVar25;
          ...
          if (uVar9 == 0xffffffffffffffc0) {
            param_1 = param_1 + 4;
            *(undefined8 *)((long)&uStack_100 + lVar4) = 0x49b3bf;
            uVar15 = FUN_004992c0(uVar14,uVar15 ^ uVar7,auVar24._0_8_ ^ auVar29._0_8_);
            uVar14 = *(ulong *)((long)auStack_e8 + lVar4);
            uVar9 = *(ulong *)((long)auStack_e8 + lVar4 + 8);
            *param_2 = auVar44 ^ *(undefined1 (*) [16])(auStack_f8 + lVar4);
            auVar44 = *(undefined1 (*) [16])(auStack_d8 + lVar4);
            ...
            *(undefined1 (*) [16])(auStack_a8 + lVar4) = auVar26;
            ...
            if (uVar9 == 0xffffffffffffffd0) {
              ...
              *(undefined8 *)((long)&uStack_100 + lVar4) = 0x49b34f;
              uVar15 = FUN_004992c0(uVar14,uVar15,auVar24._0_8_,auVar25._0_8_,uVar16);
              uVar14 = *(ulong *)((long)auStack_e8 + lVar4);
              uVar9 = *(ulong *)((long)auStack_e8 + lVar4 + 8);
              *param_2 = auVar44 ^ *(undefined1 (*) [16])(auStack_f8 + lVar4);
              auVar44 = *(undefined1 (*) [16])(auStack_d8 + lVar4);
              ...
              *(undefined1 (*) [16])((long)auStack_98 + lVar4) = auVar27;
              ...
              if (uVar9 == 0xffffffffffffffe0) {
                auVar25 = auVar25 ^ auVar45;
                param_1 = param_1 + 6;
                *(undefined8 *)((long)&uStack_100 + lVar4) = 0x49b2cf;
                uVar15 = FUN_004992c0(uVar14,uVar15,auVar24._0_8_,auVar25._0_8_,uVar16 ^ uVar7);
                uVar14 = *(ulong *)((long)auStack_e8 + lVar4);
                uVar9 = *(ulong *)((long)auStack_e8 + lVar4 + 8);
                *param_2 = auVar44 ^ *(undefined1 (*) [16])(auStack_f8 + lVar4);
                auVar44 = *(undefined1 (*) [16])(auStack_d8 + lVar4);
                ...
                *(undefined8 *)((long)&uStack_100 + lVar4) = 0x49b23f;
                auVar45 = FUN_004992c0(uVar14,uVar15,auVar24._0_8_,auVar25._0_8_,uVar16 ^ uVar7);
                uVar14 = *(ulong *)((long)auStack_e8 + lVar4);
                uVar9 = *(ulong *)((long)auStack_e8 + lVar4 + 8);
                *param_2 = auVar44 ^ *(undefined1 (*) [16])(auStack_f8 + lVar4);
                auVar44 = *(undefined1 (*) [16])(auStack_d8 + lVar4);
  ...
  if ((param_3 & 0xf) != 0) {
    ...
    *(undefined8 *)((long)&uStack_100 + lVar4) = 0x49b52a;
    FUN_00489fa0(local_58,local_58,param_4);
