...
undefined8 FUN_0070c2b0(undefined8 param_1)
    ...
    *local_11e8 = 0;
    ...
    do {
      if ((lVar14 != 10) && (*(long *)(pauVar8[1] + 8) != 0)) {
        FUN_007954a0(param_1,"  <size from=\"%zu\" to=\"%zu\" total=\"%zu\" count=\"%zu\"/>\n",
    ...
    if (lStack_1010 != 0) {
      FUN_007954a0(param_1,"  <unsorted from=\"%zu\" to=\"%zu\" total=\"%zu\" count=\"%zu\"/>\n",
    ...
    if (local_11e8 == &DAT_0093e160) {
      ...
      local_1178 = DAT_0093e9e8;
      FUN_006fdb20("</heap>\n",param_1);
      local_11e8 = (int *)PTR_DAT_0093e9d0;
      lVar15 = local_1178;
    }
    else {
      FUN_007954a0(param_1,
    ...
    if (local_11e8 == &DAT_0093e160) {
      FUN_007954a0(param_1,
                   ...
                   ,local_11b8,local_11b0,local_11a8,local_11a0,DAT_0093e0fc,DAT_0093e110,local_1198
                   ,local_1190,local_1188,local_1180);
