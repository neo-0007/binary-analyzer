...
void FUN_006f3db0(ulong *param_1,ulong *param_2,ulong param_3)
  ...
  if (1 < (long)param_3) {
    ...
    do {
      if (param_2[uVar4] < 2) {
        uVar2 = 0;
        if (param_2[uVar4] == 1) {
          uVar2 = FUN_006f2e30(param_1,param_1,param_2,param_3);
        }
      }
      else {
        uVar2 = FUN_00791fe0(param_1,param_2,param_3);
      }
      uVar4 = uVar4 + 1;
