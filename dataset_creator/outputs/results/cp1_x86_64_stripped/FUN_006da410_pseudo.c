...
ulong FUN_006da410(long param_1,ulong *param_2,ulong *param_3,undefined1 *param_4,ulong *param_5,
...

{
  ...
  if (param_7 == 0) {
    ...
    if (param_8 == 0) goto LAB_006da500;
    puVar9 = (uint *)param_2[4];
    uVar16 = *puVar9;
    uVar4 = uVar16 & 7;
    if (uVar4 == 0) goto LAB_006da500;
    if (param_5 != (ulong *)0x0) {
              ...
              if ((uVar3 & 2) == 0) {
                if (plVar6 == (long *)0x0) {
                  do {
                    ...
                    if (param_4 == puVar7) goto LAB_006da9fa;
                    if (param_4 < puVar7 + 2) goto LAB_006da710;
                    puVar1 = puVar7 + 2;
                    puVar8 = puVar9 + 1;
                  ...
                  do {
                    puVar9 = puVar8;
                    puVar7 = puVar1;
                    if ((ushort)(*(ushort *)(puVar7 + -2) + 0x2800) < 0x800) goto LAB_006da5f0;
                    puVar9[-1] = (uint)*(ushort *)(puVar7 + -2);
                    if (param_4 == puVar7) goto LAB_006da9fa;
                    if (param_4 < puVar7 + 2) goto LAB_006da710;
                    puVar1 = puVar7 + 2;
                ...
                if (plVar6 != (long *)0x0) {
                  ...
                  do {
                    ...
                    if (param_4 == puVar7) goto LAB_006da600;
                    if (param_4 < puVar7 + 2) {
                      uVar16 = 7;
                      goto LAB_006da600;
                    }
    ...
    *(undefined8 *)param_2[4] = 0;
    if ((param_2[2] & 1) == 0) {
      ...
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x006daa89. Too many branches */
...
LAB_006dae09:
  ...
  if (puVar9 <= puVar14) goto LAB_006da6c6;
...
LAB_006daba9:
          ...
          if ((param_2[2] & 2) == 0) {
            if (plVar6 == (long *)0x0) {
              do {
                puVar18 = puVar1;
                puVar17 = puVar10;
                if ((ushort)(*(ushort *)(puVar18 + -2) + 0x2800) < 0x800) goto LAB_006dabec;
                puVar17[-1] = (uint)*(ushort *)(puVar18 + -2);
                puVar7 = puVar18;
                puVar9 = puVar17;
                if ((param_4 == puVar18) || (param_4 < puVar18 + 2)) goto LAB_006dab99;
                puVar10 = puVar17 + 1;
                puVar1 = puVar18 + 2;
            ...
            do {
              ...
              if ((((ushort)(*(ushort *)(puVar18 + -2) + 0x2800) < 0x800) ||
                  ...
                  , param_4 == puVar18)) || (param_4 < puVar18 + 2)) goto LAB_006dab99;
              puVar1 = puVar18 + 2;
              puVar10 = puVar17 + 1;
            } while (puVar17 + 1 <= local_48);
          }
        ...
        *param_3 = (ulong)puVar18;
        if (puVar17 != puVar8) goto LAB_006daba9;
        if (puVar17 == puVar14) {
          *(int *)((long)param_2 + 0x14) = *(int *)((long)param_2 + 0x14) + -1;
        }
      }
    }
    if (uVar3 != 0) goto LAB_006da6c6;
  }
