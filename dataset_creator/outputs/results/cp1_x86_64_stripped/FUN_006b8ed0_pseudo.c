...
void FUN_006b8ed0(long param_1,undefined4 *param_2)
...
LAB_006b8f54:
      *(int *)(param_1 + 0x134) = iVar1 + 1;
      FUN_006b8ed0(param_1,piVar2);
      FUN_006b8ed0(param_1,*(undefined8 *)(param_2 + 6));
