...
ulong FUN_0052d520(undefined8 param_1,undefined4 param_2,int param_3,undefined8 *param_4)
  ...
  case 0x16:
    if (param_3 == 0xd) {
      ...
      if (iVar4 == 0) {
        ...
        *(undefined4 *)(lVar6 + 600) = *(undefined4 *)(param_4 + 1);
        uVar1 = *(undefined1 *)((long)param_4 + 0xc);
        *(undefined8 *)(lVar6 + 0x248) = 0xd;
        *(undefined1 *)(lVar6 + 0x25c) = uVar1;
        goto LAB_0052d578;
      }
      *(ulong *)(lVar6 + 0x248) = (ulong)uVar9;
...
LAB_0052d830:
      ...
      *(undefined8 *)(lVar6 + 0x23c) = *(undefined8 *)(lVar6 + 0x15c);
      FUN_0052be60(lVar6 + 0x1d4,param_4,0xd);
      uVar7 = (ulong)((uVar10 + 0x30 & 0xfffffff0) - uVar10);
      goto LAB_0052d578;
    }
    break;
  case 0x17:
    ...
    if (-1 < param_3) {
      ...
      if (param_3 < 0x41) {
        ...
        FUN_00434ae0(lVar2);
        FUN_0052be60(lVar2,param_4,(long)param_3);
        FUN_00434d50(local_88,lVar2);
      }
      do {
        *pbVar8 = *pbVar8 ^ 0x36;
        pbVar8 = pbVar8 + 1;
      ...
      FUN_00434ae0(lVar2);
      FUN_0052be60(lVar2,local_88,0x40);
      do {
        *pbVar11 = *pbVar11 ^ 0x6a;
        pbVar11 = pbVar11 + 1;
      } while (pbVar11 != local_48);
      FUN_00434ae0(lVar6 + 0x164);
      FUN_0052be60(lVar6 + 0x164,local_88,0x40);
    ...
    if (0x1f < param_3) {
      ...
      if ((iVar4 != 0) &&
        ...
        if (uVar9 == 0) {
          ...
          if (uVar9 < 0x1000) goto LAB_0052d830;
          if (uVar9 < 0x2000) {
            iVar4 = 4;
            bVar12 = 2;
          }
        ...
        *(undefined8 *)(lVar6 + 0x234) = *(undefined8 *)(lVar6 + 0x154);
        *(undefined8 *)(lVar6 + 0x23c) = *(undefined8 *)(lVar6 + 0x15c);
        FUN_0052be60(lVar6 + 0x1d4,lVar2,0xd);
        ...
        *(int *)(param_4 + 3) = iVar4;
        ...
        uVar7 = (ulong)(((uVar10 + 0x30 & 0xfffffff0) + 0x15 + (iVar4 << (bVar12 & 0x1f))) - iVar4);
        goto LAB_0052d578;
      }
    }
    break;
  case 0x1a:
    uVar7 = FUN_0052caf0(lVar6,*param_4,param_4[1],param_4[2],*(uint *)(param_4 + 3) >> 2);
    goto LAB_0052d578;
  case 0x1c:
    uVar7 = (ulong)((param_3 + 0x30U & 0xfffffff0) + 0x15);
    goto LAB_0052d578;
  }
  uVar7 = 0xffffffff;
LAB_0052d578:
