...
void FUN_0054f780(ulong *param_1,long param_2)

{
  ...
  while( true ) {
    ...
    uVar6 = uVar7 >> 4 ^ *(ulong *)(param_2 + uVar6) ^ *(ulong *)(&DAT_00551300 + (uVar4 & 0xf) * 8)
    ;
    ...
    uVar7 = uVar6 >> 4 ^ *(ulong *)(param_2 + uVar5) ^ *(ulong *)(&DAT_00551300 + (uVar3 & 0xf) * 8)
    ;
    uVar5 = uVar4 ^ uVar6 << 0x3c;
  }
  uVar4 = uVar4 >> 4 ^ *(ulong *)(param_2 + 8 + uVar5);
  uVar3 = uVar6 >> 4 ^ *(ulong *)(param_2 + uVar5) ^ *(ulong *)(&DAT_00551300 + (uVar3 & 0xf) * 8);
  ...
  uVar4 = uVar3 >> 4 ^ *(ulong *)(param_2 + (uVar2 & 0xfffffffffffffff0)) ^
          *(ulong *)(&DAT_00551300 + (uVar4 & 0xf) * 8);
