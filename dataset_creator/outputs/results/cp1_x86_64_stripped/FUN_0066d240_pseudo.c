...
void FUN_0066d240(long *param_1,long *param_2,undefined8 param_3,undefined4 param_4)

{
  ...
  *plVar1 = param_2[5];
                    /* try { // try from 0066d29b to 0066d29f has its CatchHandler @ 0066d356 */
  ...
  *(long *)((long)param_1 + *(long *)(lVar3 + -0x18)) = lVar4;
  param_1[2] = param_2[9];
                    /* try { // try from 0066d2e0 to 0066d2e4 has its CatchHandler @ 0066d34d */
  FUN_006674c0(plVar1);
                    /* try { // try from 0066d2f3 to 0066d33a has its CatchHandler @ 0066d344 */
