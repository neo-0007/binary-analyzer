...
undefined8 FUN_00434550(long param_1,undefined8 *param_2,ulong param_3)

{
  ...
  *(uint *)(param_1 + 0x18) =
  ...
  if (uVar3 == 0) {
    if (param_3 < 0x40) goto LAB_004345b0;
LAB_00434668:
    ...
    FUN_00578400(param_1,param_1 + 0x1c,1);
    ...
    *(undefined1 (*) [16])(param_1 + 0x4c) = (undefined1  [16])0x0;
    if (0x3f < param_3) goto LAB_00434668;
  }
  if (param_3 == 0) {
    return 1;
  }
