...
int FUN_0077f070(undefined8 *param_1,undefined4 *param_2,undefined8 param_3,ulong param_4,
                undefined4 *param_5)
  ...
  if (cVar2 == '(') {
    ...
    if (cVar2 != '\0') {
      while ((uVar3 & 0x2000) == 0) {
        pcVar6 = pcVar8 + 1;
        if (pcVar8[1] == '\0') {
          if (pcVar6 == pcVar9) goto LAB_0077f118;
          *param_2 = 1;
...
joined_r0x0077f168:
  if (cVar2 == ',') goto LAB_0077f18c;
  if (cVar2 == '\0') goto LAB_0077f118;
  cVar2 = *pcVar10;
  pcVar6 = pcVar10;
  pcVar10 = pcVar10 + 1;
  goto joined_r0x0077f168;
LAB_0077f18c:
  ...
  if (param_4 < (ulong)((long)pcVar10 - (long)pcVar9)) {
    *param_5 = 0x22;
    return -2;
  }
  pcVar5 = (char *)thunk_FUN_00713a50(param_3);
  *param_2 = 0;
  ...
  *(char **)(param_2 + 4) = pcVar8;
  pcVar5[((long)pcVar10 - (long)pcVar9) - 1] = '\0';
