...
void FUN_00509df0(long param_1,long param_2,long param_3,long param_4,code *UNRECOVERED_JUMPTABLE,
                 code *param_6,code *param_7,code *param_8,code *param_9,code *param_10,
                 code *param_11)
  ...
  if (1 < iVar1) {
    ...
    do {
      while( true ) {
        ...
        (*param_7)(lVar6);
        lVar8 = lVar6;
        if (iVar3 == iVar1) goto LAB_00509efc;
      }
      iVar3 = iVar3 + 1;
  ...
  if (-1 < iVar1 + -1) {
    ...
    if (iVar1 == 0) {
      ...
      (*param_11)(param_2,param_2);
                    /* WARNING: Could not recover jumptable at 0x0050a102. Too many branches */
