...
undefined8
FUN_004c3540(long param_1,undefined8 *param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  *(BADSPACEBASE **)(uVar14 + 0x28) = register0x00000020;
  ...
  if ((DAT_0094b5a0 & 0x80108) == 0x80108) {
    *(undefined8 *)(uVar14 - 8) = 0x4c36c5;
    FUN_004c47b7(0,param_1,param_4,-uVar13,(long)puVar9 + uVar13);
    *(undefined8 *)(uVar14 - 8) = 0x4c36ca;
    FUN_004c4ae0();
    pauVar10 = (undefined1 (*) [16])(uVar14 + 0x30);
  }
  else {
    *(undefined8 *)(uVar14 - 8) = 0x4c36e5;
    FUN_004c3159();
    *(undefined8 *)(uVar14 - 8) = 0x4c36ea;
    FUN_004c34a0();
    pauVar10 = (undefined1 (*) [16])(uVar14 + 0x30);
  }
  do {
