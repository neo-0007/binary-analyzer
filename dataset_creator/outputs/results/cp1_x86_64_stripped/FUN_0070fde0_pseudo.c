...
long * FUN_0070fde0(undefined4 *param_1,ulong param_2,long param_3)

{
  ...
  if (param_3 < 0) {
    ...
    *(undefined4 *)(in_FS_OFFSET + -0x58) = 0xc;
    ...
    plVar3 = (long *)FUN_0070eae0(param_1,uVar6 + 0x20 + param_2);
    if (plVar3 != (long *)0x0) {
      plVar1 = plVar3 + -2;
      plVar7 = plVar1;
      ...
      if (((plVar7[1] & 2U) == 0) && (uVar4 = plVar7[1] & 0xfffffffffffffff8, uVar6 + 0x20 < uVar4))
      {
        *(ulong *)((long)plVar7 + uVar6 + 8) =
             uVar4 - uVar6 | (ulong)(param_1 != &DAT_0093e160) << 2 | 1;
        plVar7[1] = (uint)plVar7[1] & 7 | uVar6;
        FUN_0070cb80(param_1,(long)plVar7 + uVar6,1);
      }
    }
  }
  return plVar3;
