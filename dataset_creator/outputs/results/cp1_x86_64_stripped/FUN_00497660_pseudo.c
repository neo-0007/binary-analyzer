...
undefined8
FUN_00497660(undefined8 param_1,undefined8 *param_2,undefined8 *param_3,ulong param_4,long param_5,
            ulong param_6,undefined1 (*param_7) [16],undefined1 (*param_8) [16],undefined8 *param_9)

{
  ...
  if ((param_6 & 1) == 0) {
    ...
    *param_3 = uVar2;
    ...
    if (param_4 == 0) goto LAB_00497859;
  }
  lVar1 = 0;
  if (param_6 + 1 != 0) {
