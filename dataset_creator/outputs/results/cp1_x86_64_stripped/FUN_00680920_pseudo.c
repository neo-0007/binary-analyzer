...
/* WARNING: Removing unreachable block (ram,0x0068097b) */
/* WARNING: Restarted to delay deadcode elimination for space: stack */

long * FUN_00680920(undefined8 param_1,long *param_2,char param_3,long param_4,undefined4 param_5,
                   long param_6)

{
  ...
  local_44 = FUN_0067fcc0(local_78,param_6,lVar5 + 0x4a,uVar11,local_55);
  ...
  if (*(char *)(lVar5 + 0x20) != '\0') {
    ...
    *(undefined8 *)(puVar10 + lVar12 + -0x18) = 0x680b74;
  ...
  if (lVar12 < lVar5) {
    ...
    *(undefined8 *)(puVar8 + lVar12 + -0x18) = 0x680adf;
  ...
  *(undefined8 *)(param_4 + 0x10) = 0;
  if (param_3 == '\0') {
    ...
    *(undefined8 *)(puVar7 + -8) = 0x680a38;
    (*pcVar2)(param_2,puVar13,lVar12);
  }
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    *(undefined **)(puVar7 + -8) = &UNK_00680c0e;
    FUN_00771f60();
  }
  return param_2;
}
