...
int FUN_007c3dd0(byte *param_1,byte *param_2,byte *param_3,byte *param_4,long param_5)
      ...
      do {
        if ((uVar5 & 0xc0) == 0) {
          if (((0x3f < uVar5) ||
             ...
             (uVar2 = (ulong)uVar5, (long)param_2 - (long)pbVar4 <= (long)uVar2)) goto LAB_007c3e90;
          *pbVar3 = (byte)uVar5;
          iVar8 = iVar8 + uVar5 + 1;
          pbVar9 = pbVar3 + 1;
          if (uVar5 < 8) {
          ...
          if (((char)(uVar5 & 0xc0) != -0x40) || (param_2 <= pbVar4)) goto LAB_007c3e90;
          if (iVar7 < 0) {
            iVar7 = ((int)pbVar4 - (int)param_3) + 1;
          }
          lVar1 = (long)(int)((uVar5 & 0x3f) << 8 | (uint)pbVar9[1]);
          if ((long)param_2 - (long)param_1 <= lVar1) goto LAB_007c3e90;
          iVar8 = iVar8 + 2;
          pbVar9 = param_1 + lVar1;
          if ((long)param_2 - (long)param_1 <= (long)iVar8) goto LAB_007c3e90;
        }
        uVar5 = (uint)*pbVar9;
        pbVar4 = pbVar9 + 1;
      } while (*pbVar9 != 0);
