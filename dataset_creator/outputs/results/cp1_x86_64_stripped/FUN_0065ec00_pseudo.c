...
undefined1  [16]
FUN_0065ec00(undefined8 param_1,long *param_2,ulong param_3,long *param_4,int param_5,int *param_6,
...

{
  ...
  while( true ) {
    ...
    if (bVar8) break;
    if (bVar9 == (param_5 == -1)) goto LAB_0065edb0;
LAB_0065ecba:
    if (param_9 <= uVar12) goto LAB_0065edb0;
    uVar10 = uVar7;
    ...
    if (9 < (byte)(cVar2 - 0x30U)) goto LAB_0065ee1f;
  ...
  local_58 = plVar1;
  if (bVar9 != (iVar3 == -1 && bVar8)) goto LAB_0065ecba;
LAB_0065edb0:
  if (uVar12 == param_9) {
    *param_6 = iVar11;
    goto LAB_0065ee38;
