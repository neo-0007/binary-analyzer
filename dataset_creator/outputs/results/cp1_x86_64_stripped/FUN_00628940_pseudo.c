...
void FUN_00628940(long param_1,long param_2)
    ...
    *(undefined **)(lVar13 + 0x40) = &DAT_0081da5c;
    ...
    if (lVar8 == 0) {
      ...
      *(undefined1 **)(lVar13 + 0x10) = &DAT_0083e5c2;
      ...
      lVar13 = lVar8 + 1;
                    /* try { // try from 00628d47 to 00628d4b has its CatchHandler @ 00628efb */
...
LAB_00628cb4:
    ...
    if (0x1ffffffffffffffe < uVar1) {
      lVar13 = -1;
                    ...
                    /* try { // try from 00628ce1 to 00628ce5 has its CatchHandler @ 00628ed7 */
    ...
    *(undefined **)(lVar13 + 0x50) = &DAT_0081da5c;
    ...
    if (0x1ffffffffffffffe < uVar1) {
      lVar13 = -1;
                    ...
                    /* try { // try from 00628d9d to 00628da1 has its CatchHandler @ 00628eef */
    ...
    *(undefined **)(lVar13 + 0x30) = &DAT_0081da5c;
    ...
    if (0x1ffffffffffffffe < uVar1) {
      lVar13 = -1;
                    ...
                    /* try { // try from 00628e0d to 00628e11 has its CatchHandler @ 00628ee3 */
    puVar12 = (undefined *)thunk_FUN_006c31f0(lVar13);
