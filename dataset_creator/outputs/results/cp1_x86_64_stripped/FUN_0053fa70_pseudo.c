...
long * FUN_0053fa70(undefined4 param_1,long param_2,long param_3)

{
  ...
  plVar2 = (long *)FUN_0041aec0(0x90,"../crypto/evp/mac_meth.c",0x31);
  if (plVar2 != (long *)0x0) {
    lVar3 = FUN_00422240();
    plVar2[5] = lVar3;
    if (lVar3 != 0) {
...
joined_r0x0053fc8e:
      ...
      FUN_0053f9f0(plVar2);
      FUN_0051f420();
      FUN_0051f540("../crypto/evp/mac_meth.c",0x9f,"evp_mac_from_algorithm");
  ...
  FUN_0053f9f0(plVar2);
  FUN_0051f420();
  FUN_0051f540("../crypto/evp/mac_meth.c",0x45,"evp_mac_from_algorithm");
