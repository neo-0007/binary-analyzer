...
undefined1  [16]
FUN_0078ae90(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  UNRECOVERED_JUMPTABLE =
       (code *)FUN_007ba770(unaff_retaddr,param_7,param_8,auStack_3a8 + 1,&local_10);
  uVar6 = auStack_3a8[3];
  uVar5 = auStack_3a8[2];
  uVar7 = auStack_3a8[1];
  if (local_10 < 0) {
                    /* WARNING: Could not recover jumptable at 0x0078b1ba. Too many branches */
  ...
  uVar2 = puVar10[4];
  uVar3 = puVar10[5];
  *(undefined8 *)((long)auStack_3a8 + lVar4) = 0x78b1e8;
  ...
  *(unkbyte10 *)(puVar9 + 0xffffffffffffffe6) = in_ST1;
  puVar10 = local_8;
  puVar9[0xffffffffffffffdd] = 0x78b239;
  FUN_0078f3f0(unaff_retaddr,param_7,puVar10);
  return *pauVar8;
}
