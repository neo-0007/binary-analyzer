...
void FUN_0057b2f0(uint *param_1,undefined1 (*param_2) [16],long param_3)

{
  ...
  auVar17 = vpshufb_avx2(auVar20,_DAT_0057ccc0);
  ...
  auVar19 = vpshufb_avx2(auVar24,_DAT_0057ccc0);
  ...
  auVar24 = vpshufb_avx2(auVar25,_DAT_0057ccc0);
  auVar25 = vpshufb_avx2(auVar23,_DAT_0057ccc0);
  local_300 = vpaddd_avx2(auVar17,_DAT_0057cc40);
  local_2e0 = vpaddd_avx2(auVar19,_DAT_0057cc40);
  local_2c0 = vpaddd_avx2(auVar24,_DAT_0057cc40);
  local_2a0 = vpaddd_avx2(auVar25,_DAT_0057cc40);
  ...
  local_280 = vpaddd_avx2(auVar30,_DAT_0057cc40);
  ...
  local_260 = vpaddd_avx2(auVar29,_DAT_0057cc60);
  ...
  local_240 = vpaddd_avx2(auVar27,_DAT_0057cc60);
  ...
  local_220 = vpaddd_avx2(auVar23,_DAT_0057cc60);
  auVar20 = _DAT_0057cc60;
  do {
    ...
    uVar6 = uVar5 + local_2c0._12_4_ + (uVar8 & uVar12 ^ ~uVar8 & uVar13) +
            (uVar10 >> 0x1b | uVar10 * 0x20);
    auVar32 = vpaddd_avx2(auVar24,_DAT_0057cc80);
    uVar11 = uVar6 >> 2 | uVar6 * 0x40000000;
    ...
    uVar10 = uVar11 + local_280._0_4_ + (uVar6 & uVar13 ^ ~uVar6 & uVar5) +
             (uVar8 >> 0x1b | uVar8 * 0x20);
    auVar1 = vpaddd_avx2(auVar17,_DAT_0057cc80);
    uVar9 = uVar10 >> 2 | uVar10 * 0x40000000;
    ...
    uVar7 = uVar8 >> 2 | uVar8 * 0x40000000;
    auVar30 = vpaddd_avx2(auVar25,_DAT_0057cc80);
    ...
    uVar12 = uVar6 >> 2 | uVar6 * 0x40000000;
    auVar29 = vpaddd_avx2(auVar2,_DAT_0057cc80);
    ...
    uVar13 = uVar8 >> 2 | uVar8 * 0x40000000;
    auVar27 = vpaddd_avx2(auVar3,_DAT_0057cc80);
    ...
    uVar5 = uVar10 >> 2 | uVar10 * 0x40000000;
    auVar23 = vpaddd_avx2(auVar4,_DAT_0057cca0);
    ...
    uVar9 = uVar10 >> 2 | uVar10 * 0x40000000;
    auVar26 = vpaddd_avx2(auVar18,_DAT_0057cca0);
    ...
    uVar7 = uVar8 >> 2 | uVar8 * 0x40000000;
    auVar2 = vpaddd_avx2(auVar19,_DAT_0057cca0);
    ...
    uVar12 = uVar6 >> 2 | uVar6 * 0x40000000;
    auVar3 = vpaddd_avx2(auVar21,_DAT_0057cca0);
    ...
    uVar13 = uVar8 >> 2 | uVar8 * 0x40000000;
    auVar4 = vpaddd_avx2(auVar22,_DAT_0057cca0);
    ...
    *param_1 = uVar8;
    ...
    auVar17 = vpshufb_avx2(auVar18,_DAT_0057ccc0);
    uVar5 = uVar10 >> 2 | uVar10 * 0x40000000;
    ...
    auVar19 = vpshufb_avx2(auVar19,_DAT_0057ccc0);
    local_300 = vpaddd_avx2(auVar17,_DAT_0057cc40);
    uVar11 = uVar6 >> 2 | uVar6 * 0x40000000;
    ...
    auVar24 = vpshufb_avx2(auVar21,_DAT_0057ccc0);
    local_2e0 = vpaddd_avx2(auVar19,_DAT_0057cc40);
    ...
    auVar25 = vpshufb_avx2(auVar22,_DAT_0057ccc0);
    local_2c0 = vpaddd_avx2(auVar24,_DAT_0057cc40);
