...
/* WARNING: Removing unreachable block (ram,0x0072f7e2) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

ulong FUN_0072d600(undefined1 (*param_1) [16],undefined1 (*param_2) [16],long *param_3)
  ...
  if (uVar23 != uVar21) {
    ...
    if (uVar23 <= uVar21) {
      ...
      param_1 = param_2;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0072d709. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    uVar22 = (*(code *)(&DAT_0082bc20 + *(int *)(&DAT_0082bc20 + ((uVar22 + 0xf) - uVar24) * 4)))
