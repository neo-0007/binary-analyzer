...
long FUN_006f4590(ulong *param_1,ulong *param_2,long param_3,ulong param_4)
  ...
  if ((uVar15 & 1) == 0) {
    ...
    if ((long)uVar15 < 0) {
      ...
      while( true ) {
        ...
        uVar16 = (ulong)(uVar19 < auVar13._0_8_);
...
LAB_006f4641:
      ...
      auVar13._8_8_ =
           auVar5._8_8_ +
           (ulong)(CARRY8(uVar20,uVar18) || CARRY8(uVar20 + uVar18,(ulong)(uVar19 < uVar17)));
      auVar13._0_8_ = uVar20 + uVar18 + (ulong)(uVar19 < uVar17);
    }
    uVar19 = (ulong)(*param_1 < auVar13._0_8_);
  ...
  return (uVar15 & 0xffffffff) + auVar13._8_8_ + (ulong)(uVar19 < auVar13._0_8_);
}
