...
ulong FUN_00702600(byte param_1,uint *param_2)
  ...
  if ((param_2[0x1d] & 0x80) != 0) {
    if ((*param_2 & 0x8000) == 0) {
      ...
      if (*(long *)(piVar5 + 2) != lVar3) {
        ...
        UNLOCK();
        if (iVar1 != 0) {
                    /* try { // try from 00702720 to 00702724 has its CatchHandler @ 0070272a */
          FUN_00709590();
        }
        piVar5 = *(int **)(param_2 + 0x22);
        *(long *)(piVar5 + 2) = lVar3;
    ...
    if (pbVar2 < *(byte **)(param_2 + 0xc)) {
      ...
      *pbVar2 = param_1;
                    ...
                    /* try { // try from 007026e5 to 007026e9 has its CatchHandler @ 0070272a */
