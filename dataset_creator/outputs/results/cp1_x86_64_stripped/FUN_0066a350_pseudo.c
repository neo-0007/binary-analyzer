...
void FUN_0066a350(long *param_1,long *param_2,undefined8 *param_3,undefined4 param_4)

{
  ...
  *plVar1 = param_2[5];
                    /* try { // try from 0066a3ab to 0066a3af has its CatchHandler @ 0066a466 */
  ...
  *(long *)((long)param_1 + *(long *)(lVar3 + -0x18)) = lVar4;
  param_1[2] = param_2[9];
                    /* try { // try from 0066a3f0 to 0066a3f4 has its CatchHandler @ 0066a45d */
  FUN_00665720(plVar1);
                    /* try { // try from 0066a403 to 0066a44a has its CatchHandler @ 0066a454 */
