...
undefined8 FUN_004c5a60(int param_1,uint *param_2,ulong *param_3)

{
  ...
  *(uint *)((long)param_3 + 0xc) = uVar20;
  ...
  uVar2 = DAT_004c6264;
  uVar8 = DAT_004c6260;
  uVar1 = DAT_004c6244 ^ uVar11;
  uVar7 = DAT_004c6240 ^ uVar18;
  uVar6 = *(uint *)(&DAT_004c6a84 + (ulong)(uVar1 >> 8 & 0xff) * 8) ^
          *(uint *)((long)&DAT_004c6280 + (ulong)(uVar1 & 0xff) * 8 + 4) ^
          *(uint *)(&DAT_004c6280 + (uVar1 >> 0x18)) ^
          *(uint *)(&DAT_004c6a80 + (ulong)(uVar1 >> 0x10 & 0xff) * 8);
  uVar1 = *(uint *)(&DAT_004c6280 + (uVar7 & 0xff)) ^
          *(uint *)((long)&DAT_004c6280 + (ulong)(uVar7 >> 8 & 0xff) * 8 + 4) ^
          *(uint *)(&DAT_004c6a84 + (ulong)(uVar7 >> 0x10 & 0xff) * 8) ^
          *(uint *)(&DAT_004c6a80 + (ulong)(uVar7 >> 0x18) * 8) ^ uVar6;
  uVar20 = uVar20 ^ uVar1;
  uVar7 = uVar26 ^ uVar1 ^ (uVar6 >> 8 | uVar6 << 0x18);
  uVar26 = DAT_004c624c ^ uVar20;
  uVar6 = DAT_004c6248 ^ uVar7;
  uVar1 = *(uint *)(&DAT_004c6a84 + (ulong)(uVar26 >> 8 & 0xff) * 8) ^
          *(uint *)((long)&DAT_004c6280 + (ulong)(uVar26 & 0xff) * 8 + 4) ^
          *(uint *)(&DAT_004c6280 + (uVar26 >> 0x18)) ^
          *(uint *)(&DAT_004c6a80 + (ulong)(uVar26 >> 0x10 & 0xff) * 8);
  uVar26 = *(uint *)(&DAT_004c6280 + (uVar6 & 0xff)) ^
           *(uint *)((long)&DAT_004c6280 + (ulong)(uVar6 >> 8 & 0xff) * 8 + 4) ^
           *(uint *)(&DAT_004c6a84 + (ulong)(uVar6 >> 0x10 & 0xff) * 8) ^
           *(uint *)(&DAT_004c6a80 + (ulong)(uVar6 >> 0x18) * 8) ^ uVar1;
  uVar6 = uVar18 ^ uVar26 ^ (uVar1 >> 8 | uVar1 << 0x18) ^ (uint)*param_3;
  uVar1 = uVar11 ^ uVar26 ^ *(uint *)((long)param_3 + 4);
  uVar11 = DAT_004c6254 ^ uVar1;
  uVar26 = DAT_004c6250 ^ uVar6;
  uVar18 = *(uint *)(&DAT_004c6a84 + (ulong)(uVar11 >> 8 & 0xff) * 8) ^
           *(uint *)((long)&DAT_004c6280 + (ulong)(uVar11 & 0xff) * 8 + 4) ^
           *(uint *)(&DAT_004c6280 + (uVar11 >> 0x18)) ^
           *(uint *)(&DAT_004c6a80 + (ulong)(uVar11 >> 0x10 & 0xff) * 8);
  uVar11 = *(uint *)(&DAT_004c6280 + (uVar26 & 0xff)) ^
           *(uint *)((long)&DAT_004c6280 + (ulong)(uVar26 >> 8 & 0xff) * 8 + 4) ^
           *(uint *)(&DAT_004c6a84 + (ulong)(uVar26 >> 0x10 & 0xff) * 8) ^
           *(uint *)(&DAT_004c6a80 + (ulong)(uVar26 >> 0x18) * 8) ^ uVar18;
  uVar26 = uVar20 ^ *(uint *)((long)param_3 + 0xc) ^ uVar11;
  uVar7 = uVar7 ^ (uint)param_3[1] ^ uVar11 ^ (uVar18 >> 8 | uVar18 << 0x18);
  uVar11 = DAT_004c625c ^ uVar26;
  uVar20 = DAT_004c6258 ^ uVar7;
  uVar18 = *(uint *)(&DAT_004c6a84 + (ulong)(uVar11 >> 8 & 0xff) * 8) ^
           *(uint *)((long)&DAT_004c6280 + (ulong)(uVar11 & 0xff) * 8 + 4) ^
           *(uint *)(&DAT_004c6280 + (uVar11 >> 0x18)) ^
           *(uint *)(&DAT_004c6a80 + (ulong)(uVar11 >> 0x10 & 0xff) * 8);
  uVar11 = *(uint *)(&DAT_004c6280 + (uVar20 & 0xff)) ^
           *(uint *)((long)&DAT_004c6280 + (ulong)(uVar20 >> 8 & 0xff) * 8 + 4) ^
           *(uint *)(&DAT_004c6a84 + (ulong)(uVar20 >> 0x10 & 0xff) * 8) ^
           *(uint *)(&DAT_004c6a80 + (ulong)(uVar20 >> 0x18) * 8) ^ uVar18;
  uVar1 = uVar1 ^ uVar11;
  ...
  if (param_1 == 0x80) {
    ...
    *(uint *)((long)param_3 + 0x3c) = uVar26;
    ...
    uVar2 = uVar2 ^ uVar1;
    uVar8 = uVar8 ^ uVar11;
    uVar20 = *(uint *)(&DAT_004c6a84 + (ulong)(uVar2 >> 8 & 0xff) * 8) ^
             *(uint *)((long)&DAT_004c6280 + (ulong)(uVar2 & 0xff) * 8 + 4) ^
             *(uint *)(&DAT_004c6280 + (uVar2 >> 0x18)) ^
             *(uint *)(&DAT_004c6a80 + (ulong)(uVar2 >> 0x10 & 0xff) * 8);
    uVar18 = *(uint *)(&DAT_004c6280 + (uVar8 & 0xff)) ^
             *(uint *)((long)&DAT_004c6280 + (ulong)(uVar8 >> 8 & 0xff) * 8 + 4) ^
             *(uint *)(&DAT_004c6a84 + (ulong)(uVar8 >> 0x10 & 0xff) * 8) ^
             *(uint *)(&DAT_004c6a80 + (ulong)(uVar8 >> 0x18) * 8) ^ uVar20;
    uVar8 = uVar26 ^ *(uint *)((long)param_3 + 0x2c) ^ uVar18;
    uVar2 = uVar7 ^ (uint)param_3[5] ^ uVar18 ^ (uVar20 >> 8 | uVar20 << 0x18);
    uVar18 = DAT_004c626c ^ uVar8;
    uVar26 = DAT_004c6268 ^ uVar2;
    uVar20 = *(uint *)(&DAT_004c6a84 + (ulong)(uVar18 >> 8 & 0xff) * 8) ^
             *(uint *)((long)&DAT_004c6280 + (ulong)(uVar18 & 0xff) * 8 + 4) ^
             *(uint *)(&DAT_004c6280 + (uVar18 >> 0x18)) ^
             *(uint *)(&DAT_004c6a80 + (ulong)(uVar18 >> 0x10 & 0xff) * 8);
    uVar18 = *(uint *)(&DAT_004c6280 + (uVar26 & 0xff)) ^
             *(uint *)((long)&DAT_004c6280 + (ulong)(uVar26 >> 8 & 0xff) * 8 + 4) ^
             *(uint *)(&DAT_004c6a84 + (ulong)(uVar26 >> 0x10 & 0xff) * 8) ^
             *(uint *)(&DAT_004c6a80 + (ulong)(uVar26 >> 0x18) * 8) ^ uVar20;
    uVar1 = uVar1 ^ uVar18;
