...
undefined8 FUN_0041d9c0(long param_1,ulong param_2)
...
LAB_0041da2d:
        local_10[0] = param_2;
        uVar2 = FUN_0041cb10(param_1,local_10,8);
        return uVar2;
      }
      if (param_2 >> 0x20 == 0) {
LAB_0041db0a:
      ...
      *(undefined8 *)(param_1 + 0x20) = 8;
      ...
      if (*(long *)(param_1 + 0x18) == 4) {
        if (param_2 < 0x80000000) goto LAB_0041db0a;
      }
      else {
        if (*(long *)(param_1 + 0x18) != 8) goto LAB_0041da2d;
        if (-1 < (long)param_2) {
          *puVar3 = param_2;
          return 1;
        }
