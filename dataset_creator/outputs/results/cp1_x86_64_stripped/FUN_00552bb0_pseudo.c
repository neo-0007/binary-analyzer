...
undefined8 FUN_00552bb0(ulong *param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  *param_1 = uVar2 >> 0x38 | (uVar2 & 0xff000000000000) >> 0x28 | (uVar2 & 0xff0000000000) >> 0x18 |
  ...
  lVar6 = FUN_0053f1e0(param_1[6]);
  if (lVar6 != 0) {
    iVar4 = FUN_0053f330(lVar6,param_2,param_3);
    if (iVar4 != 0) {
      iVar4 = FUN_0053f650(lVar6,&local_48,&local_50,0x10);
