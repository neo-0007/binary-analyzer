...
undefined8 FUN_00410190(int *param_1,int *param_2)

{
  ...
  if ((param_1 != (int *)0x0) && (param_2 != (int *)0x0)) {
    if ((*(long *)(param_1 + 0x18) == 0) && (*(long *)(param_2 + 0x18) == 0)) {
      ...
      if (lVar1 != 0) {
        if (*(code **)(lVar1 + 0x90) != (code *)0x0) {
          ...
          if (0 < (int)uVar2) {
            if (*(code **)(*(long *)(param_1 + 2) + 0x30) != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00410210. Too many branches */
        ...
        if (*(code **)(lVar1 + 0x30) != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00410239. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    ...
    uVar2 = FUN_0040ff10(param_1,param_2,7);
    return uVar2;
  }
  return 0;
}
