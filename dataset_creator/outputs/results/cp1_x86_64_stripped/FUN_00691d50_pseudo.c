...
long * FUN_00691d50(long *param_1,undefined8 param_2)

{
  ...
  if (local_48[0] != '\0') {
    ...
    if (plVar1 == (long *)0x0) {
                    ...
                    /* try { // try from 00691eae to 00691eb7 has its CatchHandler @ 00691eb8 */
      FUN_00403826();
    }
    if (*(char *)(lVar7 + 0xe4) == '\0') {
      ...
      if (plVar2 == (long *)0x0) {
        ...
        FUN_00403826();
                    ...
                    /* try { // try from 00691e64 to 00691e66 has its CatchHandler @ 00691eb8 */
      ...
      *(undefined1 *)(lVar7 + 0xe4) = 1;
      ...
      uVar6 = *(undefined4 *)(lVar7 + 0xe0);
                    ...
                    /* try { // try from 00691dd6 to 00691dd8 has its CatchHandler @ 00691eb8 */
    (**(code **)(*plVar1 + 0x48))
              (plVar1,*(long *)(lVar7 + 0xe8),*(long *)(lVar7 + 0xe8) == 0,lVar7,uVar6,param_2);
    if (extraout_DL != '\0') {
      lVar7 = *(long *)(*param_1 + -0x18) + (long)param_1;
                    /* try { // try from 00691dee to 00691df2 has its CatchHandler @ 00691ec4 */
