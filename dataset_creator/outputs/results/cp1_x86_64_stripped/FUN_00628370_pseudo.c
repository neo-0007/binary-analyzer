...
void FUN_00628370(long param_1,long param_2)
    ...
    *(undefined **)(lVar13 + 0x40) = &DAT_0081da5c;
    ...
    if (lVar8 == 0) {
      ...
      *(undefined1 **)(lVar13 + 0x10) = &DAT_0083e5c2;
      ...
      lVar13 = lVar8 + 1;
                    /* try { // try from 00628777 to 0062877b has its CatchHandler @ 0062892b */
...
LAB_006286e4:
    ...
    if (0x1ffffffffffffffe < uVar1) {
      lVar13 = -1;
                    ...
                    /* try { // try from 00628711 to 00628715 has its CatchHandler @ 00628907 */
    ...
    *(undefined **)(lVar13 + 0x50) = &DAT_0081da5c;
    ...
    if (0x1ffffffffffffffe < uVar1) {
      lVar13 = -1;
                    ...
                    /* try { // try from 006287cd to 006287d1 has its CatchHandler @ 0062891f */
    ...
    *(undefined **)(lVar13 + 0x30) = &DAT_0081da5c;
    ...
    if (0x1ffffffffffffffe < uVar1) {
      lVar13 = -1;
                    ...
                    /* try { // try from 0062883d to 00628841 has its CatchHandler @ 00628913 */
    puVar12 = (undefined *)thunk_FUN_006c31f0(lVar13);
