...
/* WARNING: Removing unreachable block (ram,0x0049c472) */
/* WARNING: Removing unreachable block (ram,0x0049c465) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

ulong FUN_0049c461(void)

{
  ...
  return auVar1._0_8_ ^ auVar4._0_8_ ^ in_XMM7_Qa << 0x20 ^ in_XMM7_Qa ^ (ulong)DAT_0049c940;
}
