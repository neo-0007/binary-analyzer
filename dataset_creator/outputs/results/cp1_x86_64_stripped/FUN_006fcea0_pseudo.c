...
ulong FUN_006fcea0(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  uVar3 = FUN_006fcc10(param_9,param_10,&local_e8,0);
  if ((*param_9 & 0x8000) == 0) {
    piVar4 = *(int **)(param_9 + 0x22);
    iVar1 = piVar4[1];
    piVar4[1] = iVar1 + -1;
