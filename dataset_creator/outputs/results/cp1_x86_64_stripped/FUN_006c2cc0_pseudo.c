...
long FUN_006c2cc0(long *param_1,undefined8 param_2,long *param_3,long param_4)

{
  ...
  if (param_1 != (long *)0x0) {
    ...
    if ((*(long **)(*plVar4 + -8) == plVar1) &&
       ...
       local_48 != 0)) {
      lVar3 = local_48;
      if (((uint)local_38 & 6) == 6) goto LAB_006c2d80;
      if (((uint)local_40 & local_40._4_4_ & 6) == 6) goto LAB_006c2d80;
      if (((local_40._4_4_ & 5) != 4) && ((uint)local_38 == 0)) {
        if (param_4 < 0) {
          if (param_4 != -2) {
            ...
            lVar3 = local_48;
            if ((uVar2 & 6) == 6) goto LAB_006c2d80;
          }
        }
        else if (param_1 == (long *)(local_48 + param_4)) goto LAB_006c2d80;
      }
    }
  }
  lVar3 = 0;
