...
int FUN_0077b780(undefined8 param_1,undefined8 param_2,undefined8 param_3,ulong param_4,int *param_5
                )
  ...
  if (param_4 < 2) {
    *param_5 = 0x22;
    ...
    do {
      ...
      if (iVar2 != 0) break;
      uVar3 = FUN_0077b480(param_3,param_2,param_3,param_4,param_5);
