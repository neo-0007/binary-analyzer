...
undefined1 * FUN_00752450(undefined1 (*param_1) [32],undefined1 (*param_2) [32],ulong param_3)

{
  ...
  if (DAT_0093d6f8 < param_3) {
    ...
    if (uVar8 < param_3) goto LAB_007526a5;
...
LAB_007527b7:
    ...
    if (DAT_0093d6f8 <= param_3) goto LAB_007527ed;
  }
  else {
    if (param_3 < 0x101) {
      auVar17 = vmovdqu64_avx512vl(param_2[1]);
...
LAB_007527ed:
      if (param_3 <= -uVar8) {
        ...
        *param_1 = auVar16;
        ...
        if (((~(uint)-uVar8 & 0xf00) != 0) && (param_3 >> 4 < DAT_00945830)) {
