...
void FUN_00790b20(undefined8 *param_1,ulong param_2,ulong param_3,code *param_4,undefined8 param_5)

{
  ...
  if (param_2 == 0) goto LAB_00790f3e;
  uVar14 = param_3 * 4;
  ...
  if (puVar24 <= puVar15) {
    ...
    do {
      ...
      if ((puVar25 != puVar24) && (puVar24 <= local_4b0)) {
        ...
        puVar17 = local_4b0;
        puVar23 = local_4b0;
        if (puVar22 < puVar25) goto LAB_00790fcc;
        do {
          do {
            puVar18 = puVar10;
          ...
          *(undefined1 *)puVar18 = uVar21;
          while( true ) {
            puVar23 = (undefined8 *)((long)puVar23 + -1);
            if (puVar23 == (undefined8 *)((long)puVar24 + -1)) goto LAB_00790f2b;
