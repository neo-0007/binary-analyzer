...
long FUN_00442670(long param_1,undefined1 *param_2,undefined8 *param_3,uint param_4,int param_5)

{
  ...
  iVar14 = FUN_00429580(*(undefined8 *)(param_1 + 0xb8),local_568,param_5 << 6,0);
  if (iVar14 < 1) goto LAB_00442b68;
...
LAB_00442bfb:
      ...
      do {
        local_820 = &local_7a8;
        FUN_0057d000(local_160,local_818,param_5);
        FUN_0048c980(&local_6a8,param_1 + 0xc0,param_5);
        ppuVar19 = &local_6a8;
        plVar23 = local_818;
        if (param_5 != 0) {
          do {
    ...
    local_800 = &local_6a8;
    local_820 = &local_7a8;
    FUN_0057d000(local_160,local_820,param_5);
    puVar28 = local_568;
    for (lVar27 = 0x80; lVar27 != 0; lVar27 = lVar27 + -1) {
      *puVar28 = 0;
      puVar28 = puVar28 + (ulong)bVar37 * -2 + 1;
    }
    if (param_5 == 0) goto LAB_004430ad;
    lVar27 = 0;
    puVar28 = local_568;
    uVar26 = 0;
    do {
      ...
      *(long *)((long)local_818 + lVar27) = lVar18;
    ...
    do {
      ...
      thunk_FUN_00713a50(local_800[1],*local_800,uVar26 - (int)local_840);
      uVar35 = *puVar20;
  ...
  local_800 = &local_6a8;
  FUN_0048c980(local_800,param_1 + 0xc0,param_5);
