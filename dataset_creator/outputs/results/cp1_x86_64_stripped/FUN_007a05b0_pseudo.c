...
long FUN_007a05b0(long param_1,uint param_2,uint *param_3,ulong *param_4)
  ...
  do {
    ...
    case 0x20:
      *(byte *)(param_3 + 3) = (byte)param_3[3] | 0x10;
      break;
    default:
      goto switchD_007a061a_caseD_21;
    case 0x23:
...
LAB_007a0c1f:
      if (((uVar5 != 0) && (bVar11 == 0x24)) && (uVar5 != 0xffffffff)) {
        ...
        local_30[0] = pbVar4 + 1;
        *param_4 = uVar6;
        if (-1 < (int)(uVar5 - 1)) goto LAB_007a0c60;
      }
    }
    param_3[0xb] = param_2;
    param_2 = param_2 + 1;
...
LAB_007a0e20:
        if (((uVar5 != 0) && (bVar11 == 0x24)) && (uVar5 != 0xffffffff)) {
          ...
          local_30[0] = pbVar4 + 1;
          *param_4 = uVar6;
          if (-1 < (int)(uVar5 - 1)) goto LAB_007a0691;
        }
      }
      param_3[10] = param_2;
      param_2 = param_2 + 1;
...
LAB_007a0691:
  ...
  if (((lVar9 != 0) && (*(long *)(lVar9 + (ulong)*local_30[0] * 8) != 0)) &&
     (iVar2 = FUN_007bfd00(local_30,param_3), pbVar7 = local_30[0], iVar2 == 0)) goto LAB_007a0af7;
  local_30[0] = pbVar7 + 1;
  pbVar4 = local_30[0];
  switch(*pbVar7) {
  case 0x4c:
...
LAB_007a06d4:
  ...
  case 0x6c:
    *(byte *)(param_3 + 3) = (byte)param_3[3] | 4;
    if (pbVar7[1] != 0x6c) goto LAB_007a06d4;
    local_30[0] = pbVar7 + 2;
LAB_007a0af3:
...
LAB_007a0af7:
  ...
  local_30[0] = pbVar4;
  if ((bVar13) && (pcVar1 = *(code **)(DAT_0094b5d8 + uVar10 * 8), pcVar1 != (code *)0x0)) {
    iVar2 = (*pcVar1)(param_3,1,param_3 + 0xd,param_3 + 0x10);
    uVar5 = param_3[2];
    uVar10 = (ulong)uVar5;
    lVar9 = (long)iVar2;
    *(long *)(param_3 + 0xe) = lVar9;
    if (iVar2 < 0) goto LAB_007a06fe;
    if ((param_3[0xc] != 0xffffffff) || (lVar9 == 0)) goto LAB_007a09c0;
    goto LAB_007a0a0f;
  }
LAB_007a06fe:
  uVar5 = (uint)uVar10;
...
LAB_007a0a02:
    param_3[0xd] = uVar8;
    if (param_3[0xc] == 0xffffffff) goto LAB_007a0a0a;
    goto LAB_007a09c0;
  case 0x6e:
    uVar8 = 0x800;
    break;
...
LAB_007a09c0:
  ...
  *(byte **)(param_3 + 6) = local_30[0];
  uVar3 = thunk_FUN_00714230(local_30[0],0x25);
