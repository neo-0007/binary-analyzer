...
undefined1  [16] FUN_0048a620(ulong *param_1,int param_2,ulong *param_3)
  ...
  if ((param_1 == (ulong *)0x0) || (param_3 == (ulong *)0x0)) {
    ...
    *param_3 = uVar4;
    ...
    while( true ) {
      ...
      uVar1 = (uint)uVar4 ^ (uint)*(byte *)((long)&DAT_0048b880 + (uVar5 & 0xff)) << 0x18 ^
              (uint)*(byte *)((long)&DAT_0048b880 + (uVar5 >> 8 & 0xff)) ^
              (uint)*(byte *)((long)&DAT_0048b880 + ((ulong)param_3 & 0xff)) << 8 ^
              (uint)*(byte *)((long)&DAT_0048b880 + (uVar5 >> 0x18)) << 0x10 ^
              (&DAT_0048bc80)[uVar2];
      *(uint *)(puVar8 + 2) = uVar1;
    ...
    *param_3 = uVar4;
    ...
    while( true ) {
      ...
      uVar1 = (uint)uVar4 ^ (uint)*(byte *)((long)&DAT_0048b880 + (uVar6 & 0xff)) << 0x18 ^
              (uint)*(byte *)((long)&DAT_0048b880 + (uVar6 >> 8 & 0xff)) ^
              (uint)*(byte *)((long)&DAT_0048b880 + ((ulong)param_3 & 0xff)) << 8 ^
              (uint)*(byte *)((long)&DAT_0048b880 + (uVar6 >> 0x18)) << 0x10 ^
              (&DAT_0048bc80)[uVar2];
      *(uint *)(puVar8 + 3) = uVar1;
      uVar1 = uVar1 ^ *(uint *)((long)puVar8 + 4);
    ...
    *param_3 = uVar4;
    ...
    while( true ) {
      ...
      uVar2 = (uint)uVar4 ^ (uint)*(byte *)((long)&DAT_0048b880 + (uVar7 & 0xff)) << 0x18 ^
              (uint)*(byte *)((long)&DAT_0048b880 + (uVar7 >> 8 & 0xff)) ^
              (uint)*(byte *)((long)&DAT_0048b880 + ((ulong)param_3 & 0xff)) << 8 ^
              (uint)*(byte *)((long)&DAT_0048b880 + (uVar7 >> 0x18)) << 0x10 ^
              (&DAT_0048bc80)[uVar5];
      *(uint *)(puVar8 + 4) = uVar2;
      ...
      *(uint *)((long)puVar8 + 0x2c) = uVar2;
      ...
      uVar2 = (uint)puVar8[2] ^ (uint)*(byte *)((long)&DAT_0048b880 + (ulong)(uVar2 & 0xff)) ^
              (uint)*(byte *)((long)&DAT_0048b880 + (ulong)(uVar2 >> 8 & 0xff)) << 8 ^
              (uint)*(byte *)((long)&DAT_0048b880 + (ulong)(uVar2 >> 0x10 & 0xff)) << 0x10 ^
              (uint)*(byte *)((long)&DAT_0048b880 + (ulong)(uVar2 >> 0x18)) << 0x18;
      *(uint *)(puVar8 + 6) = uVar2;
    ...
    *(uint *)(puVar8 + 6) = 0xe;
    ...
    param_3 = (ulong *)(ulong)DAT_0048b960;
  }
