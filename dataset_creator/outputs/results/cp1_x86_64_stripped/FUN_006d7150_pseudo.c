...
ulong FUN_006d7150(long param_1,ulong *param_2,long *param_3,byte *param_4,ulong *param_5,
    ...
    *(undefined8 *)param_2[4] = 0;
    if ((param_2[2] & 1) == 0) {
      ...
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x006d758f. Too many branches */
...
LAB_006d721f:
  ...
  if ((uVar2 & 2) == 0) {
    if (plVar7 == (long *)0x0) {
      ...
      do {
        puVar11 = puVar4;
        if ((char)*pbVar10 < '\0') goto LAB_006d728b;
        pbVar8 = pbVar10 + 1;
        puVar11[-1] = (uint)*pbVar10;
        if (param_4 == pbVar8) goto LAB_006d7428;
        pbVar10 = pbVar8;
        puVar4 = puVar11 + 1;
      } while (puVar11 + 1 <= puVar3);
    }
    ...
    do {
      ...
      if (param_4 == pbVar8) goto LAB_006d7295;
      puVar12 = puVar11;
      puVar4 = puVar11 + 1;
      pbVar10 = pbVar8;
    } while (puVar11 + 1 <= puVar3);
...
joined_r0x006d7360:
  ...
  *(int *)((long)param_2 + 0x14) = *(int *)((long)param_2 + 0x14) + 1;
  ...
  if (puVar11 <= puVar17) goto LAB_006d73da;
...
LAB_006d74c2:
          ...
          if ((param_2[2] & 2) == 0) {
            if (plVar7 == (long *)0x0) {
              do {
                ...
                bVar1 = *pbVar16;
                puVar11 = puVar14 + -1;
                if ((char)bVar1 < '\0') goto LAB_006d74b6;
                pbVar16 = pbVar16 + 1;
                puVar14[-1] = (uint)bVar1;
                puVar11 = puVar14;
                if (param_4 == pbVar16) goto LAB_006d74b6;
                puVar12 = puVar14 + 1;
        ...
        *param_3 = (long)pbVar16;
        if (puVar14 != puVar4) goto LAB_006d74c2;
        if (puVar14 == puVar17) {
          *(int *)((long)param_2 + 0x14) = *(int *)((long)param_2 + 0x14) + -1;
        }
      }
    }
    if (uVar5 != 0) goto LAB_006d73da;
  }
