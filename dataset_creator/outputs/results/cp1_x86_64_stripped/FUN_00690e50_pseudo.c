...
long * FUN_00690e50(long *param_1,undefined8 param_2)

{
  ...
  if (local_48[0] != '\0') {
    ...
    if (plVar1 == (long *)0x0) {
                    ...
                    /* try { // try from 00690fae to 00690fb7 has its CatchHandler @ 00690fb8 */
      FUN_00403826();
    }
    if (*(char *)(lVar7 + 0xe4) == '\0') {
      ...
      if (plVar2 == (long *)0x0) {
        ...
        FUN_00403826();
                    ...
                    /* try { // try from 00690f64 to 00690f66 has its CatchHandler @ 00690fb8 */
      ...
      *(undefined1 *)(lVar7 + 0xe4) = 1;
      ...
      uVar6 = *(undefined4 *)(lVar7 + 0xe0);
                    ...
                    /* try { // try from 00690ed6 to 00690ed8 has its CatchHandler @ 00690fb8 */
    (**(code **)(*plVar1 + 0x18))
              (plVar1,*(long *)(lVar7 + 0xe8),*(long *)(lVar7 + 0xe8) == 0,lVar7,uVar6,param_2);
    if (extraout_DL != '\0') {
      lVar7 = *(long *)(*param_1 + -0x18) + (long)param_1;
                    /* try { // try from 00690eee to 00690ef2 has its CatchHandler @ 00690fc4 */
