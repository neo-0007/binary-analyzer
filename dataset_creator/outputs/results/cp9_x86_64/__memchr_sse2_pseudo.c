...
char * __memchr_sse2(char *param_1,char param_2,ulong param_3)

{
  ...
  if ((uVar4 & 0x3f) < 0x31) {
    ...
    uVar8 = uVar7 - 0x40;
    pcVar9 = param_1;
    if (0x3f < uVar7 && uVar8 != 0) goto LAB_00716ee0;
  }
  else {
    uVar4 = uVar4 & 0xf;
...
LAB_007170d0:
      ...
      if (((ulong)param_1 & 0x3f) != 0) {
        bVar10 = uVar8 < 0x40;
        uVar8 = uVar8 - 0x40;
        if (bVar10 || uVar8 == 0) goto LAB_00717040;
