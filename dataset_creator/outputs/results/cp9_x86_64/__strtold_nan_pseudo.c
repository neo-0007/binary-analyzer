...

{
  ...
  if ((bVar1 == param_3) &&
     (uVar2 = ____strtoul_l_internal(param_1,&local_40,0,0,_nl_C_locobj), local_40 == pbVar4)) {
    uStack_34 = (uint)((unkuint10)(longdouble)DAT_0081b16c >> 0x20);
    uVar3 = uStack_34 & 0xc0000000;
    uStack_30 = (undefined2)((unkuint10)(longdouble)DAT_0081b16c >> 0x40);
