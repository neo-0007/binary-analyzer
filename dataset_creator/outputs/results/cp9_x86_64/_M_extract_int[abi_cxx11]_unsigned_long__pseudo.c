...

{
  ...
  lVar24 = *plVar2;
  if (lVar24 == 0) {
                    /* try { // try from 00654795 to 00654799 has its CatchHandler @ 00654b56 */
    ...
    *(undefined8 *)(this + 0x48) = 0;
    this[0x148] = (__numpunct_cache<wchar_t>)0x0;
                    /* try { // try from 00654802 to 00654806 has its CatchHandler @ 00654b4d */
  ...
  if (bVar7 == bVar20) {
    ...
    bVar25 = false;
LAB_00654058:
    if (uVar23 == 0x10) goto LAB_00653f51;
LAB_00654062:
...
LAB_00653f80:
      ...
      do {
        ...
        if (*(wchar_t *)(lVar24 + 0xf0) == __c) {
          ...
          iVar26 = 0;
          uVar23 = 8;
          if (piVar12 <= piVar15) goto LAB_00654270;
LAB_00654004:
          piVar15 = piVar15 + 1;
          param_2[2] = (long)piVar15;
          if (piVar15 < piVar12) goto LAB_00654015;
LAB_00654298:
...
LAB_00653ff3:
          ...
          piVar12 = (int *)param_2[3];
          bVar25 = bVar7;
          if (piVar15 < piVar12) goto LAB_00654004;
LAB_00654270:
          (**(code **)(*param_2 + 0x50))(param_2);
          piVar15 = (int *)param_2[2];
          if ((int *)param_2[3] <= piVar15) goto LAB_00654298;
LAB_00654015:
          iVar10 = *piVar15;
        }
        if (iVar10 == -1) {
    ...
    bVar25 = false;
    local_c0 = L'\xffffffff';
    if (uVar23 != 0x10) goto LAB_00654062;
LAB_00653f51:
    local_98 = 0x16;
    uVar18 = 0x16;
  }
...
LAB_006540f0:
      if (uVar18 < 0xb) {
        if ((__c < L'0') || ((int)local_98 + L'0' <= __c)) goto LAB_006544e0;
        uVar23 = __c + L'\xffffffd0';
LAB_00654111:
        if (uVar11 < uVar13) goto LAB_0065411c;
LAB_00654330:
        ...
        iVar26 = iVar26 + 1;
        if (piVar15 <= piVar12) goto LAB_0065435d;
LAB_00654132:
        piVar12 = piVar12 + 1;
...
LAB_0065413a:
        ...
        if ((iVar10 == -1) == bVar20) goto code_r0x00654179;
        if (param_2 == (long *)0x0) {
          __c = L'\xffffffff';
        }
        else {
          if ((wchar_t *)param_2[2] < (wchar_t *)param_2[3]) {
            __c = *(wchar_t *)param_2[2];
                    ...
                    /* try { // try from 00654978 to 0065498b has its CatchHandler @ 00654b44 */
            __c = (**(code **)(*param_2 + 0x48))(param_2);
          }
          if (__c == L'\xffffffff') {
            param_2 = (long *)0x0;
      ...
      uVar23 = __c + L'\xffffffd0';
      if (uVar23 < 10) goto LAB_00654111;
      if ((uint)(__c + L'\xffffff9f') < 6) {
        uVar23 = __c + L'\xffffffa9';
        if (uVar13 <= uVar11) goto LAB_00654330;
LAB_0065411c:
        piVar12 = (int *)param_2[2];
        piVar15 = (int *)param_2[3];
        bVar3 = 1;
        if (piVar12 < piVar15) goto LAB_00654132;
LAB_0065435d:
                    /* try { // try from 00654364 to 006546d6 has its CatchHandler @ 00654b44 */
        (**(code **)(*param_2 + 0x50))(param_2);
        piVar12 = (int *)param_2[2];
        piVar15 = (int *)param_2[3];
        goto LAB_0065413a;
    ...
    if (bVar7 == false) {
      ...
      do {
        ...
        if ((bVar5 == 0) || (*(wchar_t *)(lVar24 + 0x4c) != __c)) {
          ...
          piVar15 = (int *)param_2[2];
          bVar3 = bVar4;
          if (piVar12 <= piVar15) goto LAB_00654606;
LAB_0065458d:
          piVar15 = piVar15 + 1;
          param_2[2] = (long)piVar15;
        }
          ...
          if (uVar16 < uVar1) {
                    /* try { // try from 006548d2 to 00654954 has its CatchHandler @ 00654b44 */
...
LAB_00654580:
          piVar15 = (int *)param_2[2];
          piVar12 = (int *)param_2[3];
          if (piVar15 < piVar12) goto LAB_0065458d;
LAB_00654606:
          (**(code **)(*param_2 + 0x50))(param_2);
          piVar15 = (int *)param_2[2];
          piVar12 = (int *)param_2[3];
        ...
        if (piVar15 < piVar12) {
          iVar10 = *piVar15;
                    ...
                    /* try { // try from 00654a22 to 00654a34 has its CatchHandler @ 00654b44 */
          iVar10 = (**(code **)(*param_2 + 0x48))(param_2);
        }
        if (iVar10 == -1) {
          param_2 = (long *)0x0;
        ...
        if (bVar20 == (iVar10 == -1)) goto code_r0x006545d0;
        if (param_2 == (long *)0x0) {
          __c = L'\xffffffff';
        }
        else {
...
LAB_00654457:
    ...
    if (((iVar26 != 0) || (bVar25)) || (local_60 != 0)) goto LAB_00654457;
  }
  *param_8 = 0;
  *param_7 = 4;
LAB_006541c5:
