...
ulong _dl_strtoul(byte *param_1,undefined8 *param_2)

{
  ...
  bVar2 = *param_1;
  if (bVar2 != 0x20) goto LAB_007afb7c;
  do {
    do {
      bVar2 = param_1[1];
      param_1 = param_1 + 1;
      ...
      while( true ) {
        ...
        if (((char)bVar2 < '0') || ('9' < (char)bVar2)) {
          if ((byte)(bVar2 + 0x9f) < 6) {
            ...
            if (5 < (byte)(bVar2 + 0xbf)) goto LAB_007afcbd;
            cVar3 = bVar2 - 0x37;
          }
        }
        else {
...
LAB_007afc1a:
  ...
  for (; (bVar2 = *param_1, '/' < (char)bVar2 && (bVar2 <= bVar6)); param_1 = param_1 + 1) {
    if ((ulong)~(long)(char)(bVar2 - 0x30) / uVar5 <= uVar4) goto LAB_007afc1a;
