...
byte * __strstr_sse2_unaligned(byte *param_1,byte *param_2)

{
  ...
  bVar2 = param_2[1];
  if (bVar2 == 0) {
    pbVar6 = (byte *)__strchr_sse2(param_1,bVar1);
    return pbVar6;
  }
...
LAB_007423c3:
          ...
          if (param_2[2] == pbVar6[1]) {
            ...
            do {
              lVar7 = lVar12 + 3;
              if (param_2[lVar7] == 0) goto LAB_007423c3;
              lVar8 = lVar12 + 2;
              lVar12 = lVar12 + 1;
            } while (param_2[lVar7] == pbVar6[lVar8]);
          }
...
LAB_00742273:
      ...
      if (param_2[2] == pbVar9[1]) {
        do {
          lVar5 = lVar8 + 3;
          if (param_2[lVar5] == 0) goto LAB_00742273;
          lVar7 = lVar8 + 1;
          lVar4 = lVar8 + 2;
          lVar8 = lVar7;
      ...
      if ((long)pbVar6 - (long)param_1 < lVar12) {
        pbVar6 = (byte *)__strstr_sse2(pbVar6);
        return pbVar6;
      }
      uVar10 = uVar10 & uVar10 - 1;
    } while (uVar10 != 0);
