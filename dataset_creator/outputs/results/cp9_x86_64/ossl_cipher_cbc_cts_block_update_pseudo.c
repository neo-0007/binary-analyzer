...
LAB_00449a87:
    ...
    if ((*(byte *)(param_1 + 0x3c) & 8) == 0) {
      ...
      if ((*(byte *)(param_1 + 0x3c) & 2) != 0) {
        if (iVar6 != 0) {
          if (iVar6 == 1) {
            if ((param_6 & 0xf) == 0) goto LAB_00449c72;
          }
          else if (iVar6 != 2) goto LAB_00449a08;
          uVar8 = cts128_cs3_encrypt(param_1,param_5,param_2,param_6);
          goto LAB_00449a7e;
        }
        uVar8 = param_6 & 0xfffffffffffffff0;
        iVar6 = (**(code **)(*(long *)(param_1 + 0xa8) + 8))(param_1,param_2,param_5,uVar8);
        if (iVar6 == 0) goto LAB_00449a08;
        if ((param_6 & 0xf) != 0) {
          local_58 = (undefined1  [16])0x0;
          uVar9 = __memcpy_chk(local_58,param_5 + uVar8,(uint)param_6 & 0xf,0x10);
...
LAB_00449c72:
          ...
          *(undefined1 (*) [16])(param_1 + 0x94) = (undefined1  [16])0x0;
          ...
          if (iVar6 != 0) {
            lVar10 = __memcpy_chk(local_68,param_5,uVar14,0x10);
        ...
        uVar8 = cts128_cs3_decrypt(param_1,param_5,param_2,param_6);
LAB_00449a7e:
        if (uVar8 != 0) goto LAB_00449a83;
      }
    }
  }
LAB_00449a08:
