...
undefined1 * __mempcpy_avx_unaligned_erms(undefined8 *param_1,undefined8 *param_2,ulong param_3)

{
  ...
  if (__x86_rep_movsb_threshold < param_3) {
    ...
    if (uVar57 < param_3) goto LAB_00743370;
