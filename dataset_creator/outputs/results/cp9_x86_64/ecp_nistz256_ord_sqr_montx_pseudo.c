...

{
  ...
  do {
    ...
    uVar60 = uVar59 * DAT_005eb0e0;
    auVar17._8_8_ = 0;
    auVar17._0_8_ = uVar60;
    auVar43._8_8_ = 0;
    auVar43._0_8_ = DAT_005eb0c0;
    ...
    uVar64 = (ulong)(uVar63 < DAT_005eb0c8 || uVar63 - DAT_005eb0c8 < (ulong)(uVar60 < DAT_005eb0c0)
                    );
    uVar61 = (ulong)(uVar69 < DAT_005eb0d0 || uVar69 - DAT_005eb0d0 < uVar64);
    uVar62 = (ulong)(uVar68 < DAT_005eb0d8 || uVar68 - DAT_005eb0d8 < uVar61);
    if (uVar62 <= uVar59) {
      uVar68 = (uVar68 - DAT_005eb0d8) - uVar61;
      uVar63 = (uVar63 - DAT_005eb0c8) - (ulong)(uVar60 < DAT_005eb0c0);
      uVar60 = uVar60 - DAT_005eb0c0;
      uVar69 = (uVar69 - DAT_005eb0d0) - uVar64;
    }
    param_3 = param_3 + -1;
  } while (param_3 != 0);
  *param_1 = uVar60;
