...

{
  ...
  auVar2 = vpaddd_avx2(_DAT_005ba2e0,_DAT_005ba320);
  auVar7 = vpcmpeqd_avx2(_DAT_005ba2e0,auVar26);
  auVar3 = vpaddd_avx2(_DAT_005ba300,_DAT_005ba320);
  auVar8 = vpcmpeqd_avx2(_DAT_005ba300,auVar26);
  auVar4 = vpaddd_avx2(auVar2,_DAT_005ba320);
  auVar9 = vpcmpeqd_avx2(auVar2,auVar26);
  auVar2 = vpaddd_avx2(auVar3,_DAT_005ba320);
  auVar10 = vpcmpeqd_avx2(auVar3,auVar26);
  auVar3 = vpaddd_avx2(auVar4,_DAT_005ba320);
