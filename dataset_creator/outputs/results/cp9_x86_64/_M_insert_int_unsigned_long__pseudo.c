...
/* WARNING: Removing unreachable block (ram,0x0069b9ab) */
...

{
  ...
  local_44 = __int_to_char<wchar_t,unsigned_long>(&local_80,param_6,local_60,uVar11,local_49);
  ...
  if (*(char *)(lVar5 + 0x20) != '\0') {
    ...
    *(undefined1 **)(puVar8 + lVar13 + -0x10) = local_70 + (long)(0x28 - local_44) * 4;
    ...
    local_68 = local_60;
    local_60 = pwVar14;
    *(undefined8 *)(puVar8 + lVar13 + -0x18) = 0x69bbb6;
  ...
  if (lVar13 < lVar5) {
    ...
    *(undefined8 *)(puVar8 + lVar13 + -0x18) = 0x69bb1e;
  ...
  *(undefined8 *)(param_4 + 0x10) = 0;
  if (param_3 == '\0') {
    ...
    *(undefined8 *)(puVar7 + -8) = 0x69ba78;
    (*pcVar2)(param_2,pwVar14,lVar13);
  }
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    *(undefined **)(puVar7 + -8) = &UNK_0069bc4d;
