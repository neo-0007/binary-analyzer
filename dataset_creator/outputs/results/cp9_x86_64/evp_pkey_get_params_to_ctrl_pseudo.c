...
undefined4 evp_pkey_get_params_to_ctrl(undefined8 param_1,ulong *param_2)

{
  ...
  if (param_2 != (ulong *)0x0) {
    for (; uVar1 = *param_2, uVar1 != 0; param_2 = param_2 + 5) {
      ...
      piVar3 = (int *)lookup_translation(&local_118,evp_pkey_translations,0x27);
...
LAB_005173cf:
      ...
      local_b8 = param_1;
      local_a8 = param_2;
      if (local_d0 != 1) goto LAB_005173cf;
