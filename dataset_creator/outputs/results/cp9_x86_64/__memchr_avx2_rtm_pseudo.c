...
undefined1 * __memchr_avx2_rtm(undefined1 (*param_1) [32],undefined1 param_2,ulong param_3)
...
LAB_00744680:
    ...
    if (param_3 <= (((ulong)param_1 | 0x1f) + 1) - (long)param_1) goto LAB_00744680;
    if (uVar9 != 0) {
      uVar11 = 0;
      for (; (uVar9 & 1) == 0; uVar9 = uVar9 >> 1 | 0x80000000) {
        uVar11 = uVar11 + 1;
  ...
  if (param_3 < uVar13 || uVar12 == 0) goto LAB_007447d0;
  if (uVar11 != 0) {
    uVar9 = 0;
    for (; (uVar11 & 1) == 0; uVar11 = uVar11 >> 1 | 0x80000000) {
      uVar9 = uVar9 + 1;
    }
    puVar10 = (undefined1 *)((ulong)uVar9 + uVar14 + 1);
    goto LAB_007446cc;
  }
  ...
  if (uVar11 != 0) {
    ...
    puVar10 = (undefined1 *)((ulong)uVar9 + uVar14 + 0x21);
    goto LAB_007446cc;
  }
  ...
  if (uVar11 != 0) {
    ...
    puVar10 = (undefined1 *)((ulong)uVar9 + uVar14 + 0x41);
    goto LAB_007446cc;
  }
  ...
  if (uVar11 != 0) {
    ...
    puVar10 = (undefined1 *)((ulong)uVar9 + uVar14 + 0x61);
    goto LAB_007446cc;
  }
  bVar15 = 0x7f < uVar12;
  uVar12 = uVar12 - 0x80;
  if (bVar15 && uVar12 != 0) {
    ...
    while( true ) {
      ...
      bVar15 = uVar12 < 0x80;
      uVar12 = uVar12 - 0x80;
      if (bVar15 || uVar12 == 0) goto code_r0x007447c5;
    }
    uVar9 = (uint)(SUB321(auVar1 >> 7,0) & 1) | (uint)(SUB321(auVar1 >> 0xf,0) & 1) << 1 |
            (uint)(SUB321(auVar1 >> 0x17,0) & 1) << 2 | (uint)(SUB321(auVar1 >> 0x1f,0) & 1) << 3 |
            (uint)(SUB321(auVar1 >> 0x27,0) & 1) << 4 | (uint)(SUB321(auVar1 >> 0x2f,0) & 1) << 5 |
    ...
    if (uVar9 != 0) {
      ...
      puVar10 = (undefined1 *)((ulong)uVar11 + uVar13 + 1);
      goto LAB_007446cc;
    }
    ...
    puVar10 = (undefined1 *)(lVar7 + uVar13 + 0x41);
    goto LAB_007446cc;
  }
  ...
  uVar11 = (uint)(SUB321(auVar1 >> 7,0) & 1) | (uint)(SUB321(auVar1 >> 0xf,0) & 1) << 1 |
           ...
           (uint)(SUB321(auVar1 >> 0xf7,0) & 1) << 0x1e | (uint)(byte)(auVar1[0x1f] >> 7) << 0x1f;
  uVar14 = uVar14 + 0x80;
  if (uVar11 != 0) goto LAB_00744830;
  uVar11 = (int)uVar12 + 0x40;
  uVar13 = uVar14;
  if (uVar11 != 0 && SCARRY4((int)uVar12,0x40) == (int)uVar11 < 0) goto LAB_007448a0;
LAB_007447dd:
  puVar10 = (undefined1 *)0x0;
  if (uVar11 == 0xffffffe0 || SCARRY4(uVar11,0x20) != (int)(uVar11 + 0x20) < 0) goto LAB_007446cc;
...
LAB_007448a0:
      ...
      if (uVar9 == 0) {
        ...
        if (uVar9 == 0) {
          ...
          puVar10 = (undefined1 *)((ulong)uVar11 + uVar13 + 0x41);
        }
      }
      else {
LAB_00744870:
        ...
        puVar10 = (undefined1 *)((ulong)uVar11 + uVar13 + 0x21);
      }
      goto LAB_007446cc;
    }
    goto LAB_007447dd;
