...
long __mempcpy_chk_ssse3(undefined8 *param_1,undefined8 *param_2,ulong param_3,ulong param_4)

{
  ...
  if ((char)param_2 <= (char)param_1) {
    ...
    uVar23 = (long)param_1 + param_3 & 0xf;
    uVar25 = (long)param_1 + param_3 ^ uVar23;
    uVar29 = param_3 - uVar23;
    uVar23 = (long)param_2 + (param_3 - uVar23);
    if (__x86_shared_cache_size_half < uVar29) {
      uVar6 = *(undefined8 *)(uVar23 - 0x10);
      ...
      *(undefined8 *)(uVar25 - 8) = uVar7;
      ...
      do {
        ...
        lVar19 = lVar22 + -0x80;
        *(undefined8 *)(lVar28 + -0x10) = *(undefined8 *)(lVar22 + -0x10);
      ...
      if (-0x41 < (long)(uVar23 - 0x80)) {
        ...
        lVar19 = lVar22 + -0xc0;
        *(undefined8 *)(lVar28 + -0x90) = *(undefined8 *)(lVar22 + -0x90);
    ...
    if (uVar30 != 0) {
      ...
      case 1:
        ...
        lVar19 = (*UNRECOVERED_JUMPTABLE_00)
                           (uVar25,uVar23,uVar29 - 0x40,__x86_data_cache_size_half,puVar24,
    ...
    uVar30 = uVar29 - 0x10;
    uVar6 = *(undefined8 *)(uVar23 - 8);
    lVar19 = uVar23 - 0x10;
    *(undefined8 *)(uVar25 - 0x10) = *(undefined8 *)(uVar23 - 0x10);
    ...
    *puVar24 = uVar4;
    ...
    if (uVar30 < 0x81) {
      if (0x3f < uVar30) {
        uVar4 = *(undefined8 *)(uVar23 - 0x18);
        uVar5 = *(undefined8 *)(uVar23 - 0x30);
        uVar6 = *(undefined8 *)(uVar23 - 0x28);
        uVar7 = *(undefined8 *)(uVar23 - 0x40);
        uVar8 = *(undefined8 *)(uVar23 - 0x38);
        uVar9 = *(undefined8 *)(uVar23 - 0x50);
        uVar10 = *(undefined8 *)(uVar23 - 0x48);
        *(undefined8 *)(uVar25 - 0x20) = *(undefined8 *)(uVar23 - 0x20);
    ...
    if (uVar30 < __x86_data_cache_size_half) {
      do {
        ...
        *(undefined8 *)(lVar28 + -0x38) = uVar10;
        ...
        lVar19 = lVar22 + -0x80;
        *(undefined8 *)(lVar28 + -0x50) = *(undefined8 *)(lVar22 + -0x50);
      ...
      if (-0x41 < (long)(uVar29 - 0x80)) {
        ...
        *(undefined8 *)(lVar28 + -0x98) = uVar6;
        ...
        lVar19 = lVar22 + -0xc0;
        *(undefined8 *)(lVar28 + -0xb0) = *(undefined8 *)(lVar22 + -0xb0);
    ...
    if (0x1f < uVar29) {
      ...
      lVar19 = lVar19 + -0x20;
      *(undefined8 *)(lVar27 + -0x10) = *puVar24;
  ...
  param_3 = param_3 + ((long)param_1 - (long)puVar24);
    ...
    case 2:
      ...
      if (__x86_data_cache_size_half <= param_3) {
        UNRECOVERED_JUMPTABLE_00 = (code *)((long)&UINT_00820db0 + lVar19 + 1);
                    ...
                    /* WARNING: Treating indirect jump as call */
      lVar19 = (*UNRECOVERED_JUMPTABLE_00)
                         (puVar24,param_2,param_3 - 0x40,__x86_data_cache_size_half,param_1,
                          UNRECOVERED_JUMPTABLE_00);
      return lVar19;
    case 3:
      UNRECOVERED_JUMPTABLE_00 = (code *)((long)&UINT_00820db8 + lVar19);
  ...
  *param_1 = uVar4;
  ...
  if (uVar29 < 0x81) {
    ...
    lVar19 = (*(code *)((long)&switchD_007188f1::switchdataD_00820c50 +
                       (long)(int)(&switchD_007188f1::switchdataD_00820c50)[uVar29]))
                       ((long)puVar24 + uVar29,(long)puVar21 + uVar29,
                        (code *)((long)&switchD_007188f1::switchdataD_00820c50 +
                                (long)(int)(&switchD_007188f1::switchdataD_00820c50)[uVar29]));
    return lVar19;
  }
  ...
  if (uVar29 < __x86_data_cache_size_half) {
    ...
    if (-0x41 < (long)(uVar29 - 0x80)) {
      ...
      *puVar24 = *puVar21;
      ...
      puVar26[0x14] = puVar20[0x14];
      puVar26[0x15] = uVar4;
      puVar26[0x16] = uVar5;
      puVar26[0x17] = uVar6;
      puVar24 = puVar26 + 0x18;
    }
