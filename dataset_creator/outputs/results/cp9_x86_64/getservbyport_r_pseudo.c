...
int getservbyport_r(int __port,char *__proto,servent *__result_buf,char *__buf,size_t __buflen,
                   servent **__result)

{
  ...
  if (__nss_not_use_nscd_services < 1) {
    if (__nss_not_use_nscd_services == 0) goto LAB_007a3aea;
  }
  else {
...
LAB_007a3aea:
      if ((__nss_database_custom[0xe] == '\0') &&
         (local_64 = __nscd_getservbyport_r(__port,__proto,__result_buf,__buf,__buflen,__result),
         -1 < local_64)) goto LAB_007a3b28;
    }
  }
  iVar3 = __nss_services_lookup2(&local_50,"getservbyport_r",0,&local_48);
  if (iVar3 == 0) {
    bVar2 = false;
    local_70 = (void *)0x0;
    lVar1 = *in_FS_OFFSET;
    do {
      ...
      uVar4 = (*local_48)(__port,__proto,__result_buf,__buf,__buflen,lVar1 + -0x58);
      if (uVar4 == 0xfffffffe) {
...
LAB_007a3b50:
        if (((*(uint *)(local_50 + 8) >> ((char)uVar4 * '\x02' + 4U & 0x1f) & 3) == 2) &&
           (uVar4 == 1)) goto LAB_007a3ab6;
        bVar2 = false;
      }
LAB_007a3a28:
      iVar3 = __nss_next2(&local_50,"getservbyport_r",0,&local_48,uVar4,0);
    } while (iVar3 == 0);
    free(local_70);
    local_64 = 0;
    if (uVar4 == 1) {
    ...
    *__result = (servent *)0x0;
    if (1 < uVar4) {
      ...
      if ((local_64 != 0x22) || (uVar4 == 0xfffffffe)) goto LAB_007a3b28;
      goto LAB_007a3bdb;
    }
  }
  else {
    *__result = (servent *)0x0;
    local_64 = (int)in_FS_OFFSET[-0xb];
    if (local_64 != 0x22) goto LAB_007a3b28;
LAB_007a3bdb:
    local_64 = 0x16;
  }
