...

{
  ...
  uVar3 = *param_2;
  if ((((uVar3 & 1) != 0) && (iVar1 = ossl_isdigit(uVar2 & 0xffffffff), iVar1 == 0)) &&
     (param_1 != 0x20)) {
    uVar3 = uVar3 & 0xfffffffffffffffe;
  }
  if ((uVar3 & 2) != 0) {
    iVar1 = ossl_ctype_check(uVar2 & 0xffffffff,0x800);
    if (iVar1 == 0) {
  ...
  if ((uVar3 & 0x2000) != 0) {
    if ((param_1 < 0x110000) && (0x7ff < param_1 - 0xd800)) goto LAB_006118ff;
