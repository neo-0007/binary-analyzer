...

{
  ...
  uVar11 = (ulong)(uVar7 < DAT_005eb008 ||
                  uVar7 - DAT_005eb008 < (ulong)(uVar3 != 0xffffffffffffffff));
  uVar1 = (ulong)(uVar9 < uVar11);
  uVar13 = (uVar12 - DAT_005eb018) - uVar1;
  uVar10 = (uVar7 - DAT_005eb008) - (ulong)(uVar3 != 0xffffffffffffffff);
  uVar14 = uVar3 + 1;
  uVar11 = uVar9 - uVar11;
  if ((CARRY8(uVar2,uVar2) || CARRY8(uVar2 * 2,uVar8)) <
      (uVar12 < DAT_005eb018 || uVar12 - DAT_005eb018 < uVar1)) {
    uVar13 = uVar12;
    uVar10 = uVar7;
    uVar14 = uVar3;
    uVar11 = uVar9;
  ...
  uVar14 = uVar11 + uVar8;
  uVar1 = (ulong)(uVar7 < DAT_005eb008 || uVar7 - DAT_005eb008 < (ulong)(lVar6 != -1));
  uVar2 = (ulong)(uVar10 < uVar1);
  uVar3 = uVar14 - DAT_005eb018;
  bVar4 = (CARRY8(uVar13,param_2[3]) || CARRY8(uVar11,uVar8)) <
          (uVar14 < DAT_005eb018 || uVar3 < uVar2);
  uVar8 = (uVar7 - DAT_005eb008) - (ulong)(lVar6 != -1);
  lVar5 = lVar6 + 1;
  if (bVar4) {
    uVar8 = uVar7;
    lVar5 = lVar6;
