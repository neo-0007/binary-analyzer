...
ulong __gconv_transform_internal_ucs4
        ...
        if (puVar12 < param_4) {
          if ((uVar4 & 4) == 0) {
            ...
            *(undefined1 *)((long)puVar3 + uVar9 + 4) = *puVar12;
            if (param_4 <= puVar12 + 1) goto LAB_006cbf3b;
            if (uVar10 != 4) {
              uVar10 = uVar9 + 2;
              *param_3 = (ulong)(puVar12 + 2);
              *(undefined1 *)((long)puVar3 + uVar9 + 5) = puVar12[1];
              if (param_4 <= puVar12 + 2) goto LAB_006cbf3b;
              if (uVar10 == 3) {
...
LAB_006cbf3b:
    ...
    while( true ) {
      ...
      *(int *)((long)param_2 + 0x14) = *(int *)((long)param_2 + 0x14) + 1;
      ...
      if (puVar15 <= puVar11) goto LAB_006cbd56;
      local_48 = (undefined1 *)*param_2;
      _dl_mcount_wrapper_check(UNRECOVERED_JUMPTABLE);
      uVar4 = (*UNRECOVERED_JUMPTABLE)(param_1 + 0x68,puVar1,&local_48,puVar15,0,param_6,0,param_8);
      if (uVar4 == 4) {
        if (uVar14 != 5) goto LAB_006cbd56;
      }
      else {
        if (local_48 != puVar15) {
          lVar6 = 0;
...
LAB_006cc06e:
            ...
            if (puVar7 != local_48) goto LAB_006cc06e;
            if (puVar7 == puVar11) {
              *(int *)((long)param_2 + 0x14) = *(int *)((long)param_2 + 0x14) + -1;
            }
          }
...
LAB_006cbd56:
    ...
    *(undefined8 *)param_2[4] = 0;
    if ((*(byte *)(param_2 + 2) & 1) == 0) {
      _dl_mcount_wrapper_check(UNRECOVERED_JUMPTABLE,puVar1,0);
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x006cbfda. Too many branches */
