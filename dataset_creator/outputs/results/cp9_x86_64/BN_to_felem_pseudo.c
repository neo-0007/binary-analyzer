...
undefined8 BN_to_felem(ulong *param_1,undefined8 param_2)

{
  ...
  if (iVar1 == 0) {
    uVar2 = 0;
    iVar1 = BN_bn2lebinpad(param_2,&local_68,0x42);
    if (iVar1 < 0) {
      ERR_new();
      ERR_set_debug("../crypto/ec/ecp_nistp521.c",0xba,"BN_to_felem");
      ERR_set_error(0x10,0x90,0);
    }
    else {
      uVar2 = 1;
    ...
    ERR_new();
    uVar2 = 0;
    ERR_set_debug("../crypto/ec/ecp_nistp521.c",0xb5,"BN_to_felem");
    ERR_set_error(0x10,0x90,0);
  }
