...

{
  ...
  __stream = (FILE *)__nss_files_fopen("/etc/shadow");
...
LAB_007752ce:
          ...
          uVar3 = _nss_files_parse_spent(param_3,param_2,param_3,param_4,param_5);
          iVar2 = __nss_parse_line_result(__stream,local_48,uVar3);
          if (iVar2 != 0) {
            if (iVar2 != 0x16) goto LAB_007752ce;
            goto LAB_00775280;
          }
          *(undefined4 *)(in_FS_OFFSET + -0x58) = uVar1;
