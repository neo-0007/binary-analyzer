...
void sub_niels_from_pt(ulong *param_1,long param_2,int param_3)
  ...
  do {
    if (lVar3 == 4) {
      ...
      if ((int)lVar3 == 7) {
        ...
        gf_mul(local_108,param_2 + 0x40,puVar2);
        lVar3 = 0;
        do {
        ...
        local_108[8] = (local_108[8] & 0xffffffffffffff) + uVar10;
        gf_mul(puVar1,param_2,puVar2);
        puVar4 = local_108 + 0x10;
        gf_mul(param_1,param_2 + 0x80);
        lVar3 = 0;
        do {
              ...
              do {
                if (lVar3 == 4) {
                  ...
                  if ((int)lVar3 == 7) {
                    ...
                    gf_mul(param_1 + 0x10,local_108,puVar1);
                    gf_mul(param_1,puVar1,puVar2);
                    gf_mul(puVar1,local_108,puVar4);
                    if (param_3 == 0) {
                      gf_mul(param_1 + 0x18,puVar2,puVar4);
                    }
