...
undefined1 (*) [32]
__strncpy_evex(undefined1 (*param_1) [32],undefined1 (*param_2) [32],ulong param_3)
...
LAB_0074bb5c:
      ...
      uVar9 = (ulong)uVar7;
      if ((uint)param_3 <= uVar7) goto LAB_0074bfe6;
    }
    else {
      if ((int)uVar4 == 0) {
...
LAB_0074bb15:
    ...
    if ((int)uVar4 != 0) goto LAB_0074bde0;
    auVar21 = vmovdqu64_avx512vl(auVar21);
    param_1[2] = auVar21;
    ...
    bVar17 = param_3 < 0x20;
    param_3 = uVar14 - 0x80;
    if (bVar17 || param_3 == 0) goto LAB_0074bb10;
    if ((int)uVar4 != 0) {
LAB_0074baa0:
...
LAB_0074ba90:
    ...
    if ((int)uVar4 == 0) {
      ...
      if (bVar17 || param_3 == 0) goto LAB_0074bb10;
      if ((int)uVar4 != 0) goto LAB_0074baa0;
      auVar21 = vmovdqu64_avx512vl(auVar22);
      param_1[7] = auVar21;
...
LAB_0074bef0:
      if (lVar16 != 0) {
        ...
        lVar16 = CONCAT44(uVar11,(int)uVar4);
        param_3 = uVar15 + 0x60;
        if (param_3 == 0 || SCARRY8(uVar15,0x60) != (long)param_3 < 0) goto LAB_0074bb10;
        if ((int)uVar4 != 0) goto LAB_0074ba90;
        uVar4 = vpcmpb_avx512vl(auVar27,auVar22,0);
        lVar16 = CONCAT44(uVar11,(int)uVar4);
        auVar21 = vmovdqu64_avx512vl(auVar21);
        *param_1 = auVar21;
...
LAB_0074b844:
  ...
  *pauVar5 = auVar21;
  ...
  pauVar13 = pauVar12;
  pauVar5 = param_1;
  if (bVar17 || uVar15 == 0) goto LAB_0074bef0;
  goto joined_r0x0074b842;
}
