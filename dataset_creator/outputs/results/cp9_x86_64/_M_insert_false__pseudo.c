...
_M_insert<false>(undefined8 param_1,long *param_2,ulong param_3,long param_4,wchar_t param_5,
                undefined8 *param_6)

{
  ...
  uVar6 = locale::id::_M_id((id *)&moneypunct<wchar_t,false>::id);
  plVar12 = (long *)(*(long *)(*(long *)(param_4 + 0xd0) + 0x18) + uVar6 * 8);
  lVar9 = *plVar12;
  if (lVar9 == 0) {
                    /* try { // try from 0069ac0d to 0069ac11 has its CatchHandler @ 0069adca */
    ...
    *(undefined4 *)(this + 0x68) = 0;
    this[0x98] = (__moneypunct_cache<wchar_t,false>)0x0;
                    /* try { // try from 0069ac95 to 0069ac99 has its CatchHandler @ 0069adc1 */
    __moneypunct_cache<wchar_t,false>::_M_cache(this,(locale *)(param_4 + 0xd0));
  ...
  if (uVar6 != 0) {
    local_58 = (wchar_t *)&DAT_00938298;
                    /* try { // try from 0069a85c to 0069a922 has its CatchHandler @ 0069ad9d */
    ...
    if (0 < (long)uVar11) {
      ...
      if (*(long *)(lVar9 + 0x18) == 0) {
                    /* try { // try from 0069acc9 to 0069ad93 has its CatchHandler @ 0069ad9d */
    ...
    if (0 < iVar4) {
                    /* try { // try from 0069abaf to 0069abcc has its CatchHandler @ 0069ad9d */
    ...
    local_50 = &DAT_00938298;
                    /* try { // try from 0069a980 to 0069ab87 has its CatchHandler @ 0069ad94 */
...
LAB_0069aa23:
        ...
        break;
      case '\x01':
        if (bVar10) goto LAB_0069aa23;
                    /* try { // try from 0069abdf to 0069abfe has its CatchHandler @ 0069ad94 */
