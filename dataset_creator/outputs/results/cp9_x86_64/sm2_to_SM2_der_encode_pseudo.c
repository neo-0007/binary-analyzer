...
LAB_0045de6f:
    ERR_new();
    ERR_set_debug("../providers/implementations/encode_decode/encode_key2any.c",0x5a6,
  ...
  uVar5 = param_5 & 1;
  if ((param_5 & 1) == 0) {
    if ((param_5 & 0x84) == 0) goto LAB_0045de6f;
    if (param_3 == 0) goto LAB_0045df70;
    a = (BIO *)ossl_bio_new_from_core_bio(*param_1);
    if (a == (BIO *)0x0) goto LAB_0045def4;
