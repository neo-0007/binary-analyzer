...
wostream * __thiscall std::wostream::_M_insert<unsigned_long>(wostream *this,ulong param_1)

{
  ...
  if (local_48[0] != (sentry)0x0) {
    ...
    if (plVar1 == (long *)0x0) {
                    ...
                    /* try { // try from 0068e07e to 0068e087 has its CatchHandler @ 0068e088 */
      __throw_bad_cast();
    }
    if (pwVar8[0xe4] == (wostream)0x0) {
      ...
      if (plVar3 == (long *)0x0) {
        ...
        __throw_bad_cast();
                    ...
                    /* try { // try from 0068e034 to 0068e036 has its CatchHandler @ 0068e088 */
      ...
      *(undefined4 *)(pwVar8 + 0xe0) = uVar6;
      ...
      uVar6 = *(undefined4 *)(pwVar8 + 0xe0);
                    ...
                    /* try { // try from 0068dfa6 to 0068dfa8 has its CatchHandler @ 0068e088 */
    (**(code **)(*plVar1 + 0x20))
              (plVar1,*(long *)(pwVar8 + 0xe8),*(long *)(pwVar8 + 0xe8) == 0,pwVar8,uVar6,param_1);
    if (extraout_DL != '\0') {
                    /* try { // try from 0068dfbe to 0068dfc2 has its CatchHandler @ 0068e094 */
