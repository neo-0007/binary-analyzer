...
undefined1 (*) [32]
__stpncpy_avx2_rtm(undefined1 (*param_1) [32],undefined1 (*param_2) [32],ulong param_3)

{
  ...
  if (param_3 == 0) goto LAB_0079e54e;
  uVar18 = (uint)param_2;
...
LAB_0079e6ec:
      if (uVar20 != 0) {
        ...
        uVar23 = (ulong)uVar18;
        if (uVar18 < (uint)param_3) goto LAB_0079e4fe;
      }
LAB_0079eb64:
      uVar18 = (uint)param_3;
      if (uVar18 == 0x41) {
...
LAB_0079e6a5:
        ...
        uVar23 = (ulong)uVar20;
        if (uVar20 < (uint)param_3) goto LAB_0079e4fe;
      }
      goto LAB_0079eb64;
    }
    if (uVar18 != 0) goto LAB_0079e980;
    pauVar22[2] = auVar30;
    auVar29 = param_2[3];
    ...
    bVar27 = param_3 < 0x20;
    param_3 = uVar23 - 0x80;
    if (bVar27 || param_3 == 0) goto LAB_0079e6a0;
    if (uVar18 != 0) {
LAB_0079e630:
...
LAB_0079ea80:
      if (uVar18 != 0) {
        ...
        uVar18 = (uint)(SUB321(auVar7 >> 7,0) & 1) | (uint)(SUB321(auVar7 >> 0xf,0) & 1) << 1 |
                 ...
                 (uint)(byte)(auVar7[0x1f] >> 7) << 0x1f;
        param_3 = uVar24 + 0x60;
        if (param_3 == 0 || SCARRY8(uVar24,0x60) != (long)param_3 < 0) goto LAB_0079e6a0;
        if (uVar18 != 0) goto LAB_0079e620;
        auVar7 = vpcmpeqb_avx2(auVar28,auVar29);
        uVar18 = (uint)(SUB321(auVar7 >> 7,0) & 1) | (uint)(SUB321(auVar7 >> 0xf,0) & 1) << 1 |
                 (uint)(SUB321(auVar7 >> 0x17,0) & 1) << 2 |
                 (uint)(SUB321(auVar7 >> 0x1f,0) & 1) << 3 |
        ...
        *pauVar22 = auVar30;
        ...
        if (uVar18 == 0) {
          ...
          if (uVar18 == 0) {
            ...
            uVar23 = (ulong)uVar18;
            if ((uint)param_3 <= uVar18) goto LAB_0079eb64;
            goto LAB_0079e4fe;
          }
          pauVar22[2] = auVar31;
        }
    ...
    *pauVar21 = auVar28;
    ...
    if (SCARRY8(uVar23 - 0x80,0x40) == lVar26 < 0) {
      *pauVar22 = auVar28;
      ...
      lVar25 = uVar23 - 0x60;
      pauVar21 = pauVar22 + 2;
      if (lVar26 < 0x20) goto LAB_0079ea30;
      pauVar22[2] = auVar28;
      pauVar21 = pauVar22 + 3;
    }
    else {
      lVar25 = uVar23 - 0x20;
      pauVar21 = pauVar22;
      if (SCARRY8(lVar26,0x20) != lVar25 < 0) goto LAB_0079ea30;
      *pauVar22 = auVar28;
      pauVar21 = pauVar22 + 1;
    }
  }
...
LAB_0079e3f5:
  ...
  *pauVar17 = auVar30;
  ...
  pauVar16 = pauVar21;
  pauVar17 = pauVar22;
  if (bVar27 || uVar24 == 0) goto LAB_0079ea80;
  goto joined_r0x0079e3f3;
}
