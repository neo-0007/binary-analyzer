              ...
              do {
                if (lVar4 == 4) {
                  ...
                  if ((int)lVar4 == 7) {
                    ...
                    gf_mul(param_1,local_148,puVar3);
                    gf_mul(param_1 + 0x10,puVar2,local_148);
                    gf_mul(param_1 + 8,puVar2,local_88);
                    if (param_3 == 0) {
                      gf_mul(puVar2,puVar3,local_88);
                    }
