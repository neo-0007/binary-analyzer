...
ulong __wcsnlen_avx2(undefined1 (*param_1) [32],ulong param_2)

{
  ...
  if ((uVar8 & 0xfff) < 0xfe1) {
    ...
    if (param_2 <= ((int)((ulong)param_1 | 0x1f) + 1) - uVar8 >> 2) {
      return param_2;
    }
  }
  ...
  if (uVar8 <= param_2) {
    ...
    if (uVar9 != 0) {
      ...
      return (ulong)(iVar6 + -0x81 + uVar8 * 4 >> 2);
    }
    ...
    if (uVar9 != 0) {
      ...
      return (ulong)(iVar6 + -0x61 + uVar8 * 4 >> 2);
    }
    ...
    if (uVar9 != 0) {
      ...
      return (ulong)(iVar6 + -0x41 + uVar8 * 4 >> 2);
    }
    ...
    if (uVar9 != 0) {
      ...
      return (ulong)(iVar6 + -0x21 + uVar8 * 4 >> 2);
    }
    if (uVar10 < 0x20) {
      uVar12 = uVar12 + 0x80;
    }
      ...
      while (bVar14 = 0x1f < uVar10, uVar10 = uVar10 - 0x20, bVar14) {
        ...
        if (uVar8 != 0) {
          ...
          if (uVar9 != 0) {
            ...
            return (ulong)uVar8 + lVar13 + -0x7f >> 2;
          }
          ...
          if (uVar9 != 0) {
            ...
            return (ulong)uVar8 + lVar13 + -0x5f >> 2;
          }
          ...
          return (ulong)(lVar7 + lVar13 + -0x3f) >> 2;
        }
      }
    }
    auVar3 = vpcmpeqd_avx2(auVar15,*(undefined1 (*) [32])(uVar12 + 1));
  ...
  if ((uVar9 & 0x40) == 0) {
    ...
    if (uVar8 == 0) {
      if (0x1f < uVar9) {
        ...
        if (uVar5 <= uVar9 - 0x20) {
          return (ulong)(uVar5 + 0x21) + (uVar12 - (long)param_1) >> 2;
        }
      }
    }
    else {
      ...
      if (uVar5 <= uVar9) {
        return (ulong)(uVar5 + 1) + (uVar12 - (long)param_1) >> 2;
      }
    }
  }
  else {
    if (uVar8 != 0) {
      ...
      return (ulong)(iVar6 + 1) + (uVar12 - (long)param_1) >> 2;
    }
    auVar3 = vpcmpeqd_avx2(auVar15,*(undefined1 (*) [32])(uVar12 + 0x21));
    uVar8 = (uint)(SUB321(auVar3 >> 7,0) & 1) | (uint)(SUB321(auVar3 >> 0xf,0) & 1) << 1 |
            (uint)(SUB321(auVar3 >> 0x17,0) & 1) << 2 | (uint)(SUB321(auVar3 >> 0x1f,0) & 1) << 3 |
    ...
    if (uVar8 != 0) {
      ...
      return (ulong)(iVar6 + 0x21) + (uVar12 - (long)param_1) >> 2;
    }
    uVar9 = uVar9 & 0x7f;
    auVar3 = vpcmpeqd_avx2(auVar15,*(undefined1 (*) [32])(uVar12 + 0x41));
    uVar8 = (uint)(SUB321(auVar3 >> 7,0) & 1) | (uint)(SUB321(auVar3 >> 0xf,0) & 1) << 1 |
    ...
    if (uVar8 != 0) {
      ...
      return (ulong)(uVar5 + 0x41) + (uVar12 - (long)param_1) >> 2;
    }
    if (0x5f < uVar9) {
      ...
      if (uVar5 <= uVar9 - 0x60) {
        return (ulong)(uVar5 + 0x61) + (uVar12 - (long)param_1) >> 2;
      }
    }
  }
  return param_2;
