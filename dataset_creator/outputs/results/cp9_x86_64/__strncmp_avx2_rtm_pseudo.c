...
int __strncmp_avx2_rtm(undefined1 (*param_1) [32],undefined1 (*param_2) [32],ulong param_3)
...
LAB_007473b0:
                    ...
                    uVar13 = 0x1f;
                    if (uVar14 == 0) {
                      if (lVar9 + 0x80U < uVar16) goto LAB_00747206;
                    }
                    else {
                      lVar8 = 0;
...
LAB_00747206:
                  ...
                  bVar17 = 0x7f < uVar16;
                  uVar16 = uVar16 - 0x80;
                  if (bVar17 && uVar16 != 0) goto code_r0x007471ed;
                }
              }
            }
            else {
      ...
      if (uVar10 < 0xfe1) {
        do {
          ...
          uVar12 = (uint)(SUB321(auVar2 >> 7,0) & 1) | (uint)(SUB321(auVar2 >> 0xf,0) & 1) << 1 |
                   ...
                   (uint)(SUB321(auVar2 >> 0xf7,0) & 1) << 0x1e |
                   (uint)(byte)(auVar2[0x1f] >> 7) << 0x1f;
          if (uVar12 != 0) goto LAB_00747490;
          uVar13 = (ulong)((int)uVar13 + 0x20);
          uVar10 = uVar10 + 0x20;
          if (param_3 <= uVar13) goto LAB_00747470;
...
LAB_00747527:
        ...
        if (uVar13 < param_3) {
          ...
          if ((*param_1)[uVar13] == 0) {
            ...
            do {
              iVar11 = uVar10 - uVar12;
              if (iVar11 != 0) goto LAB_007470d4;
              uVar10 = (int)uVar13 + 1;
              uVar13 = (ulong)uVar10;
              if (uVar10 == 0x80) goto LAB_007471a6;
              if (param_3 <= uVar13) goto LAB_00747470;
              uVar10 = (uint)(byte)(*param_1)[uVar13];
              uVar12 = (uint)(byte)(*param_2)[uVar13];
