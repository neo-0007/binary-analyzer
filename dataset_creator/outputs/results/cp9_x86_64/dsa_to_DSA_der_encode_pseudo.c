...
LAB_0045ed1a:
    ERR_new();
    ERR_set_debug("../providers/implementations/encode_decode/encode_key2any.c",0x59f,
  ...
  if ((param_5 & 1) == 0) {
    uVar5 = param_5 & 2;
    if ((param_5 & 2) == 0) {
      if ((param_5 & 0x84) == 0) goto LAB_0045ed1a;
      if (param_3 != 0) {
...
LAB_0045eea0:
    ...
    if (param_3 == 0) goto LAB_0045eea0;
    pBVar2 = (BIO *)ossl_bio_new_from_core_bio(*param_1);
    if ((pBVar2 == (BIO *)0x0) ||
       ((param_6 != 0 &&
