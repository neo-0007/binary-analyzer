...
/* WARNING: Removing unreachable block (ram,0x0069bd3b) */
...

{
  ...
  local_44 = __int_to_char<wchar_t,unsigned_long_long>(&local_80,lVar8,local_58,uVar13,bVar7);
  ...
  if (*(char *)(lVar5 + 0x20) != '\0') {
    ...
    *(wchar_t **)(puVar10 + lVar8 + -0x10) = pwVar12;
    ...
    local_60 = local_58;
    local_58 = pwVar12;
    *(undefined8 *)(puVar10 + lVar8 + -0x18) = 0x69bf99;
...
LAB_0069be0c:
    ...
    pwVar12 = pwVar16;
    if (lVar8 <= lVar15) goto LAB_0069be18;
  }
  else {
    if (-1 < param_6) {
      if ((uVar13 & 0x800) != 0) {
  ...
  *(undefined8 *)(puVar10 + lVar5 + -0x18) = 0x69befb;
...
LAB_0069be18:
  *(undefined8 *)(param_4 + 0x10) = 0;
  if (param_3 == '\0') {
    ...
    *(undefined8 *)(puVar9 + -8) = 0x69be35;
    (*pcVar2)(param_2,pwVar16,lVar15);
  }
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    *(undefined **)(puVar9 + -8) = &UNK_0069c02e;
