...

{
  ...
  if (*(code **)(param_1 + 0x18) != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x004a7eeb. Too many branches */
...
LAB_004a7f74:
    ...
    if (param_7 < 1) {
      ...
      if ((-1 < (char)param_2) || (uVar2 == 6)) {
                    /* WARNING: Could not recover jumptable at 0x004a7f72. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        uVar1 = (**(code **)(param_1 + 0x10))();
        return uVar1;
      }
      if (0x7fffffff < *param_8) goto LAB_004a7f74;
      uVar1 = (**(code **)(param_1 + 0x10))();
      if ((long)uVar1 < 1) {
        return uVar1;
      }
