...
void malloc_printerr(undefined8 param_1)

{
    ...
    if (uVar5 != 0) {
      do {
        if ((uVar5 & 0xf) != 0) {
          ...
          malloc_printerr("int_mallinfo(): unaligned fastbin chunk detected");
        }
  ...
  *plVar6 = lVar2 + *plVar6;
  ...
  lVar11 = DAT_00931130;
  if (puVar9 == &main_arena) {
    lVar8 = (long)DAT_0093111c;
    plVar6[5] = 0;
    plVar6[9] = uVar5;
    plVar6[3] = lVar8;
    plVar6[4] = lVar11;
