...
/* WARNING: Removing unreachable block (ram,0x00422069) */
/* WARNING: Removing unreachable block (ram,0x0042201d) */
...

{
  ...
  if (0x11f < param_3) {
    ...
    uVar80 = *param_5;
    pauVar81 = (undefined1 (*) [16])&DAT_00422140;
    ...
    *(undefined8 *)(puVar78 + -8) = 0x421d7e;
    auVar84._0_8_ = _aesni_ctr32_6x(_DAT_00422140,uVar80,param_1,param_2,param_3 >> 4);
