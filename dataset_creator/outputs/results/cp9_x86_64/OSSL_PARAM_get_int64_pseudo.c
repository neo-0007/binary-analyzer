...
undefined8 OSSL_PARAM_get_int64(long param_1,ulong *param_2)
  ...
  if (iVar2 == 1) {
    if (*(long *)(param_1 + 0x18) == 4) {
      *param_2 = (long)**(int **)(param_1 + 0x10);
      ...
      if (*(long *)(param_1 + 0x18) != 8) goto LAB_0041bf74;
...
LAB_0041bf74:
        uVar3 = general_get_int(param_1,param_2,8);
        return uVar3;
      }
