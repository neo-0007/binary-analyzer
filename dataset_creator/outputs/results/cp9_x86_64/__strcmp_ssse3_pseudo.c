...
/* WARNING: Removing unreachable block (ram,0x007124d2) */
  ...
  if (uVar55 != uVar53) {
    ...
    if (uVar55 <= uVar53) {
      ...
      param_1 = param_2;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00711339. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    uVar54 = (*(code *)(&DAT_00820b50 + *(int *)(&DAT_00820b50 + ((uVar54 + 0xf) - uVar56) * 4)))
