...

{
  ...
  if (local_48[0] != (sentry)0x0) {
    ...
    if (plVar1 == (long *)0x0) {
                    ...
                    /* try { // try from 0068e4be to 0068e4c7 has its CatchHandler @ 0068e4c8 */
      __throw_bad_cast();
    }
    if (pwVar8[0xe4] == (wostream)0x0) {
      ...
      if (plVar3 == (long *)0x0) {
        ...
        __throw_bad_cast();
                    ...
                    /* try { // try from 0068e474 to 0068e476 has its CatchHandler @ 0068e4c8 */
      ...
      *(undefined4 *)(pwVar8 + 0xe0) = uVar6;
      ...
      uVar6 = *(undefined4 *)(pwVar8 + 0xe0);
                    ...
                    /* try { // try from 0068e3e6 to 0068e3e8 has its CatchHandler @ 0068e4c8 */
    (**(code **)(*plVar1 + 0x28))
              (plVar1,*(long *)(pwVar8 + 0xe8),*(long *)(pwVar8 + 0xe8) == 0,pwVar8,uVar6,param_1);
    if (extraout_DL != '\0') {
                    /* try { // try from 0068e3fe to 0068e402 has its CatchHandler @ 0068e4d4 */
