  ...
  if (bVar11) {
    ...
    if (bVar10) {
      return (ulong)(uint)(*(int *)(_nl_C_LC_CTYPE_tolower +
                                   (ulong)(byte)param_1[-1][(ulong)uVar5 + lVar8] * 4 + 0x200) -
                          *(int *)(_nl_C_LC_CTYPE_tolower +
                                  (ulong)(byte)param_2[-1][(ulong)uVar5 + lVar8] * 4 + 0x200));
    }
    return 0;
  }
...
LAB_00729b00:
  ...
  return (ulong)(uint)(*(int *)(_nl_C_LC_CTYPE_tolower + (ulong)(byte)(*param_1)[lVar9] * 4 + 0x200)
                      - *(int *)(_nl_C_LC_CTYPE_tolower + (ulong)(byte)(*param_2)[lVar9] * 4 + 0x200
                                ));
}
