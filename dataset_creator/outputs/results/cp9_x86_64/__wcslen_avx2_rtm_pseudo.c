...
ulong __wcslen_avx2_rtm(undefined1 (*param_1) [32])

{
  ...
  if ((uVar7 & 0xfff) < 0xfe1) {
    auVar3 = vpcmpeqd_avx2(auVar13,*param_1);
    ...
    auVar3 = vpcmpeqd_avx2(auVar13,*(undefined1 (*) [32])(((ulong)param_1 | 0x1f) - 0x1f));
  ...
  auVar3 = vpcmpeqd_avx2(auVar13,*(undefined1 (*) [32])(uVar10 + 1));
  uVar8 = (uint)(SUB321(auVar3 >> 7,0) & 1) | (uint)(SUB321(auVar3 >> 0xf,0) & 1) << 1 |
          (uint)(SUB321(auVar3 >> 0x17,0) & 1) << 2 | (uint)(SUB321(auVar3 >> 0x1f,0) & 1) << 3 |
          (uint)(SUB321(auVar3 >> 0x27,0) & 1) << 4 | (uint)(SUB321(auVar3 >> 0x2f,0) & 1) << 5 |
          (uint)(SUB321(auVar3 >> 0x37,0) & 1) << 6 | (uint)(SUB321(auVar3 >> 0x3f,0) & 1) << 7 |
  ...
  iVar9 = (int)uVar10;
  if (uVar8 == 0) {
    auVar3 = vpcmpeqd_avx2(auVar13,*(undefined1 (*) [32])(uVar10 + 0x21));
    uVar8 = (uint)(SUB321(auVar3 >> 7,0) & 1) | (uint)(SUB321(auVar3 >> 0xf,0) & 1) << 1 |
            (uint)(SUB321(auVar3 >> 0x17,0) & 1) << 2 | (uint)(SUB321(auVar3 >> 0x1f,0) & 1) << 3 |
            (uint)(SUB321(auVar3 >> 0x27,0) & 1) << 4 | (uint)(SUB321(auVar3 >> 0x2f,0) & 1) << 5 |
            (uint)(SUB321(auVar3 >> 0x37,0) & 1) << 6 | (uint)(SUB321(auVar3 >> 0x3f,0) & 1) << 7 |
            ...
            (uint)(SUB321(auVar3 >> 0xf7,0) & 1) << 0x1e | (uint)(byte)(auVar3[0x1f] >> 7) << 0x1f;
    if (uVar8 == 0) {
      auVar3 = vpcmpeqd_avx2(auVar13,*(undefined1 (*) [32])(uVar10 + 0x41));
      uVar8 = (uint)(SUB321(auVar3 >> 7,0) & 1) | (uint)(SUB321(auVar3 >> 0xf,0) & 1) << 1 |
              (uint)(SUB321(auVar3 >> 0x17,0) & 1) << 2 | (uint)(SUB321(auVar3 >> 0x1f,0) & 1) << 3
              | (uint)(SUB321(auVar3 >> 0x27,0) & 1) << 4 |
      ...
      ;
      if (uVar8 == 0) {
        auVar3 = vpcmpeqd_avx2(auVar13,*(undefined1 (*) [32])(uVar10 + 0x61));
        uVar8 = (uint)(SUB321(auVar3 >> 7,0) & 1) | (uint)(SUB321(auVar3 >> 0xf,0) & 1) << 1 |
                (uint)(SUB321(auVar3 >> 0x17,0) & 1) << 2 |
                (uint)(SUB321(auVar3 >> 0x1f,0) & 1) << 3 |
                (uint)(SUB321(auVar3 >> 0x27,0) & 1) << 4 |
        ...
        if (uVar8 == 0) {
          ...
          do {
            ...
            auVar3 = vpcmpeqd_avx2(auVar13,auVar3);
          ...
          auVar3 = vpcmpeqd_avx2(auVar13,*pauVar1);
          uVar8 = (uint)(SUB321(auVar3 >> 7,0) & 1) | (uint)(SUB321(auVar3 >> 0xf,0) & 1) << 1 |
                  (uint)(SUB321(auVar3 >> 0x17,0) & 1) << 2 |
                  (uint)(SUB321(auVar3 >> 0x1f,0) & 1) << 3 |
                  (uint)(SUB321(auVar3 >> 0x27,0) & 1) << 4 |
          ...
          if (uVar8 == 0) {
            auVar3 = vpcmpeqd_avx2(auVar13,auVar4);
            uVar8 = (uint)(SUB321(auVar3 >> 7,0) & 1) | (uint)(SUB321(auVar3 >> 0xf,0) & 1) << 1 |
                    (uint)(SUB321(auVar3 >> 0x17,0) & 1) << 2 |
                    (uint)(SUB321(auVar3 >> 0x1f,0) & 1) << 3 |
                    (uint)(SUB321(auVar3 >> 0x27,0) & 1) << 4 |
                    ...
                    (uint)(byte)(auVar3[0x1f] >> 7) << 0x1f;
            if (uVar8 == 0) {
              auVar13 = vpcmpeqd_avx2(auVar13,*pauVar2);
              lVar6 = 0;
              ...
              uVar10 = (ulong)(lVar6 + lVar11 + -0x3f) >> 2;
            }
            else {
              uVar7 = 0;
              for (; (uVar8 & 1) == 0; uVar8 = uVar8 >> 1 | 0x80000000) {
              ...
              uVar10 = (ulong)uVar7 + lVar11 + -0x5f >> 2;
            }
          }
          else {
            uVar7 = 0;
            ...
            uVar10 = (ulong)uVar7 + lVar11 + -0x7f >> 2;
          }
        }
        else {
          iVar5 = 0;
          ...
          uVar10 = (ulong)(iVar5 + (iVar9 - uVar7) + 0x61 >> 2);
        }
      }
      else {
        iVar5 = 0;
        ...
        uVar10 = (ulong)(iVar5 + (iVar9 - uVar7) + 0x41 >> 2);
      }
    }
    else {
      iVar5 = 0;
      ...
      uVar10 = (ulong)(iVar5 + (iVar9 - uVar7) + 0x21 >> 2);
    }
  }
  else {
    iVar5 = 0;
    ...
    uVar10 = (ulong)(iVar5 + (iVar9 - uVar7) + 1 >> 2);
  }
LAB_00754fc1:
  bVar12 = (bool)xtest();
  if (bVar12) {
