...
undefined4
res_nquerydomain(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined4 param_4,
  ...
  if (lVar2 == 0) {
    ...
    *(undefined4 *)(in_FS_OFFSET + -0x18) = 0xffffffff;
    ...
    uVar1 = __res_context_querydomain
                      (lVar2,param_2,param_3,param_4,param_5,param_6,param_7,0,0,0,0,0);
