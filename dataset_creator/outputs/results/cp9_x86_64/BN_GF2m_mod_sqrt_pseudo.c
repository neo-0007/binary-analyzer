...

{
  ...
  iVar1 = iVar1 + 1;
  ptr = CRYPTO_malloc(iVar1 * 4,"../crypto/bn/bn_gf2m.c",0x3d6);
  if (ptr == (void *)0x0) {
    ERR_new();
    iVar2 = 0;
    ERR_set_debug("../crypto/bn/bn_gf2m.c",0x3d8,"BN_GF2m_mod_sqrt");
    ...
    if ((iVar2 == 0) || (iVar1 < iVar2)) {
      ERR_new();
      ERR_set_debug("../crypto/bn/bn_gf2m.c",0x3dd,"BN_GF2m_mod_sqrt");
