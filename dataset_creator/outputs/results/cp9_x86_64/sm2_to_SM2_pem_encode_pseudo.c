...
LAB_0045e7cf:
    ERR_new();
    ERR_set_debug("../providers/implementations/encode_decode/encode_key2any.c",0x5a7,
  ...
  if ((param_5 & 1) == 0) {
    if ((param_5 & 0x84) == 0) goto LAB_0045e7cf;
    if (param_3 == (void *)0x0) goto LAB_0045e8f0;
    bp = (BIO *)ossl_bio_new_from_core_bio(*param_1);
    if (bp == (BIO *)0x0) goto LAB_0045e860;
    u = (undefined8 *)0x0;
