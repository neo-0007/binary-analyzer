...

{
  ...
  CRYPTO_clear_free(param_1[0xd],param_1[0xe],"../providers/implementations/kdfs/hkdf.c",0x7a);
  CRYPTO_clear_free(param_1[7],param_1[8],"../providers/implementations/kdfs/hkdf.c",0x7b);
  OPENSSL_cleanse(param_1 + 0xf,param_1[0x10f]);
  param_1[0x10f] = 0;
