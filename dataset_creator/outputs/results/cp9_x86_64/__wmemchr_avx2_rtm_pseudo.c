...
undefined1 * __wmemchr_avx2_rtm(undefined1 (*param_1) [32],undefined4 param_2,ulong param_3)
...
LAB_007553a0:
    ...
    if (param_3 <= ((int)((ulong)param_1 | 0x1f) + 1) - uVar11 >> 2) goto LAB_007553a0;
    if (uVar8 != 0) {
      uVar11 = 0;
      for (; (uVar8 & 1) == 0; uVar8 = uVar8 >> 1 | 0x80000000) {
        uVar11 = uVar11 + 1;
  ...
  if (param_3 < uVar14 || uVar12 == 0) goto LAB_007554f0;
  if (uVar11 != 0) {
    uVar8 = 0;
  ...
  if (0x1f < uVar12 && lVar13 != 0) {
    ...
    while( true ) {
      ...
      bVar16 = uVar12 < 0x20;
      uVar12 = uVar12 - 0x20;
      if (bVar16 || uVar12 == 0) goto code_r0x007554e2;
    }
    uVar8 = (uint)(SUB321(auVar1 >> 7,0) & 1) | (uint)(SUB321(auVar1 >> 0xf,0) & 1) << 1 |
            (uint)(SUB321(auVar1 >> 0x17,0) & 1) << 2 | (uint)(SUB321(auVar1 >> 0x1f,0) & 1) << 3 |
            (uint)(SUB321(auVar1 >> 0x27,0) & 1) << 4 | (uint)(SUB321(auVar1 >> 0x2f,0) & 1) << 5 |
  ...
  iVar10 = (int)lVar13 * 4;
  uVar15 = uVar15 + 0x80;
  if (uVar11 != 0) goto LAB_00755560;
  uVar11 = iVar10 + 0x40;
  uVar14 = uVar15;
  if (uVar11 != 0 && SCARRY4(iVar10,0x40) == (int)uVar11 < 0) goto LAB_007555d0;
LAB_00755500:
  puVar9 = (undefined1 *)0x0;
  if (uVar11 == 0xffffffe0 || SCARRY4(uVar11,0x20) != (int)(uVar11 + 0x20) < 0) goto LAB_007553ef;
