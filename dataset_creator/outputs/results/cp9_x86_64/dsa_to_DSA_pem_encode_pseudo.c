...
LAB_0045ef1a:
    ERR_new();
    ERR_set_debug("../providers/implementations/encode_decode/encode_key2any.c",0x5a0,
  ...
  if ((param_5 & 1) == 0) {
    bVar3 = param_5 & 2;
    if ((param_5 & 2) == 0) {
      if ((param_5 & 0x84) == 0) goto LAB_0045ef1a;
      if (param_3 != (void *)0x0) {
...
LAB_0045f0c0:
    ...
    if (param_3 == (void *)0x0) goto LAB_0045f0c0;
    pBVar2 = (BIO *)ossl_bio_new_from_core_bio(*param_1);
    if ((pBVar2 == (BIO *)0x0) ||
       ((param_6 != 0 &&
