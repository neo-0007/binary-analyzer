...
/* WARNING: Removing unreachable block (ram,0x00727f42) */
  ...
  if (uVar24 != uVar22) {
    ...
    if (uVar24 <= uVar22) {
      ...
      param_1 = param_2;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00725f59. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    uVar23 = (*(code *)(&DAT_00821a40 + *(int *)(&DAT_00821a40 + ((uVar23 + 0xf) - uVar25) * 4)))
