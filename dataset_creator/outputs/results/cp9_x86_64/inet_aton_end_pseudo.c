...
undefined8 inet_aton_end(char *param_1,uint *param_2,undefined8 *param_3)

{
  ...
  *(undefined4 *)(in_FS_OFFSET + -0x58) = 0;
  ...
  if ((int)*param_1 - 0x30U < 10) {
    ...
    while (uVar4 = strtouq(param_1,&local_50,0), uVar4 < 0x100000000) {
      cVar1 = *local_50;
      if (cVar1 != '.') {
        if ((((cVar1 == '\0') ||
             ((-1 < cVar1 &&
            ...
            (local_50 != param_1)) &&
           (uVar3 = (uint)uVar4, uVar3 <= (uint)(&max_0)[(long)puVar6 - (long)local_44])) {
          if (param_2 != (uint *)0x0) {
