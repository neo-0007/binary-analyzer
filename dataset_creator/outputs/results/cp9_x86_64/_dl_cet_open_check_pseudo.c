...
/* WARNING: Removing unreachable block (ram,0x00783bd0) */
/* WARNING: Removing unreachable block (ram,0x00783be4) */
/* WARNING: Removing unreachable block (ram,0x00783be7) */

void _dl_cet_open_check(long param_1)

{
  ...
  bVar8 = _dl_x86_feature_control & 3;
  bVar1 = _dl_x86_feature_control >> 2 & 3;
  bVar4 = bVar8 == 1 && bVar1 == 1;
  if (bVar4) {
    *(uint *)(in_FS_OFFSET + 0x48) = _dl_x86_feature_1;
    return;
  }
  if ((_dl_x86_feature_1 & 3) == 0) {
    return;
  }
  bVar17 = (byte)(_dl_x86_feature_1 >> 1) & 1;
  local_49 = (byte)_dl_x86_feature_1 & 1;
  uVar10 = bVar8 != 2 & _dl_x86_feature_1;
  uVar12 = (uint)(bVar1 != 2) & _dl_x86_feature_1 >> 1;
  bVar9 = (byte)uVar10;
  bVar11 = (byte)uVar12;
  bVar7 = bVar9 | bVar11;
  if (bVar7 != 0) {
    ...
    if (*(int *)(param_1 + 0x2c8) != 0) {
      ...
      if ((bVar8 != 3) && (bVar4 != false)) {
        ...
        _dl_signal_error(0,*(undefined8 *)(*(long *)(lVar5 + uVar13 * 8) + 8),"dlopen",
                         "rebuild shared object with IBT support enabled");
      }
      if (bVar1 != 3) {
        if (bVar16 != 0) {
                    /* WARNING: Subroutine does not return */
          _dl_signal_error(0,*(undefined8 *)(*(long *)(lVar5 + uVar6 * 8) + 8),"dlopen",
...
LAB_00783b7f:
  ...
  if (bVar4 == false) {
    ...
    lVar5 = *(long *)(*(long *)(param_1 + 0x3d0) + uVar13 * 8);
                    ...
                    /* WARNING: Subroutine does not return */
  _dl_signal_error(0xffffff62,*(undefined8 *)(lVar5 + 8),"dlopen","can\'t disable CET");
}
