...
LAB_0069e569:
      ...
      if ((local_7a) || (*(wchar_t *)(lVar10 + 0xe4) == __c)) {
        ...
        if (((cVar7 != '\0') && (*(wchar_t *)(lVar10 + 0x4c) == __c)) ||
           (*(wchar_t *)(lVar10 + 0x48) == __c)) goto LAB_0069e679;
...
LAB_0069ec00:
          ...
          if (*(wchar_t *)(lVar10 + 0xf0) == __c) {
            ...
            if (*(ulong *)(local_68 + 0x18) <= uVar16) goto LAB_0069e980;
LAB_0069e708:
...
LAB_0069e6f5:
            uVar16 = *(ulong *)(local_68 + 0x10);
            bVar18 = bVar17;
            if (uVar16 < *(ulong *)(local_68 + 0x18)) goto LAB_0069e708;
LAB_0069e980:
            (**(code **)(*(long *)local_68 + 0x50))();
            local_60 = L'\xffffffff';
            if (local_68 != (wstreambuf *)0x0) goto LAB_0069e718;
            bVar17 = true;
          }
...
joined_r0x0069e76a:
    ...
    uVar8 = 10;
    if (uVar21 != 8) goto LAB_0069e542;
    uVar8 = 0x10;
    cVar5 = istreambuf_iterator<wchar_t,std::char_traits<wchar_t>>::equal
                      ((istreambuf_iterator<wchar_t,std::char_traits<wchar_t>> *)&local_68,
                       (istreambuf_iterator *)&local_78);
    if (cVar5 == '\0') goto LAB_0069e569;
    local_7a = false;
    cVar7 = *(char *)(lVar10 + 0x20);
    __c = L'\0';
    bVar18 = false;
...
LAB_0069e7f0:
      if (uVar21 < 0xb) {
        if ((__c < L'0') || ((int)local_98 + L'0' <= __c)) goto LAB_0069ebf0;
        uVar8 = __c + L'\xffffffd0';
LAB_0069e811:
        if (uVar12 < uVar22) goto LAB_0069e81c;
LAB_0069ea10:
        ...
        if (*(ulong *)(local_68 + 0x18) <= uVar13) goto LAB_0069ea49;
LAB_0069e834:
...
LAB_0069e844:
        ...
        if (*(int **)(local_68 + 0x10) < *(int **)(local_68 + 0x18)) {
          iVar9 = **(int **)(local_68 + 0x10);
                    ...
                    /* try { // try from 0069eed8 to 0069eef2 has its CatchHandler @ 0069ef5b */
          iVar9 = (**(code **)(*(long *)local_68 + 0x48))();
        }
        cVar7 = '\0';
        if (iVar9 == -1) {
        ...
        if (uVar22 <= uVar12) goto LAB_0069ea10;
LAB_0069e81c:
        local_7b = 1;
        uVar13 = *(ulong *)(local_68 + 0x10);
        if (uVar13 < *(ulong *)(local_68 + 0x18)) goto LAB_0069e834;
LAB_0069ea49:
                    /* try { // try from 0069ea59 to 0069edc9 has its CatchHandler @ 0069ef5b */
        (**(code **)(*(long *)local_68 + 0x50))(local_68,&local_48,uVar16);
        local_60 = L'\xffffffff';
        if (local_68 != (wstreambuf *)0x0) goto LAB_0069e844;
        cVar7 = '\x01';
      }
        ...
        if ((local_60 == L'\xffffffff') && (local_68 != (wstreambuf *)0x0)) {
          if (*(wchar_t **)(local_68 + 0x10) < *(wchar_t **)(local_68 + 0x18)) {
            __c = **(wchar_t **)(local_68 + 0x10);
                    ...
                    /* try { // try from 0069ef21 to 0069ef23 has its CatchHandler @ 0069ef5b */
            __c = (**(code **)(*(long *)local_68 + 0x48))();
            uVar16 = extraout_RDX;
          }
          if (__c == L'\xffffffff') {
    ...
    if ((cVar20 != '\0') && (*(wchar_t *)(lVar10 + 0x4c) == __c)) goto LAB_0069ed11;
LAB_0069ec46:
    if ((__c != *(wchar_t *)(lVar10 + 0x48)) &&
      ...
      local_7b = bVar4;
      uVar16 = *(ulong *)(local_68 + 0x10);
      if (*(ulong *)(local_68 + 0x18) <= uVar16) goto LAB_0069ed4b;
      do {
        *(ulong *)(local_68 + 0x10) = uVar16 + 4;
        while( true ) {
          local_60 = L'\xffffffff';
          cVar7 = istreambuf_iterator<wchar_t,std::char_traits<wchar_t>>::equal
                            (local_c0,(istreambuf_iterator *)local_a0);
          cVar20 = cVar5;
          if (cVar7 != '\0') goto LAB_0069e88b;
          __c = istreambuf_iterator<wchar_t,std::char_traits<wchar_t>>::_M_get(local_c0);
          cVar20 = *(char *)(lVar10 + 0x20);
          if ((cVar20 == '\0') || (*(wchar_t *)(lVar10 + 0x4c) != __c)) goto LAB_0069ec46;
LAB_0069ed11:
          if (local_80 == 0) {
            cVar7 = '\0';
            goto LAB_0069e88b;
...
LAB_0069eb52:
    ...
    if (((local_80 != 0) || (bVar18)) || (*(long *)(local_48 + -0x18) != 0)) goto LAB_0069eb52;
  }
  *param_8 = 0;
  *param_7 = 4;
LAB_0069e8cb:
