...
/* WARNING: Instruction at (ram,0x007054bf) overlaps instruction at (ram,0x007054be)
    */

ulong * _int_malloc(undefined4 *param_1,size_t param_2)
...
LAB_00705356:
            ...
            if (((lVar21 != 0) && (uVar33 < DAT_00931148)) &&
               (*(ushort *)(lVar21 + uVar33 * 2) < DAT_00931158)) {
              while (uVar14 = *(ulong *)(puVar2 + 4), uVar14 != 0) {
                ...
                if (*(int *)(in_FS_OFFSET + 0x18) == 0) {
                  ...
                  *(ulong *)(puVar2 + 4) = *(ulong *)(uVar14 + 0x10) ^ uVar25;
                  ...
                  while( true ) {
                    ...
                    uVar14 = uVar15;
                    if (uVar15 == 0) goto joined_r0x00705774;
                  }
                }
                uVar11 = tcache_key;
                ...
                *(ushort *)(lVar21 + uVar33 * 2) = uVar31;
                if (DAT_00931158 <= uVar31) break;
              }
            }
            goto joined_r0x00705774;
          }
          do {
            puVar16 = (ulong *)(uVar14 + 0x10);
...
LAB_00705a40:
            ...
            if (uVar25 == uVar14) goto LAB_00705356;
            uVar14 = uVar25;
          } while (uVar25 != 0);
        }
...
LAB_00705555:
        ...
        local_b8 = 0;
        if ((*(long *)(in_FS_OFFSET + -0x30) != 0) && (local_b8 = 0, uVar14 < DAT_00931148)) {
          local_b8 = uVar33;
        }
        puVar2 = param_1 + 0x18;
        local_c0 = 0;
          ...
          do {
            while( true ) {
              ...
              if ((((uVar33 < 0x400) && (puVar23 == puVar2)) &&
                ...
                *(ulong *)(puVar22 + 2) = (ulong)(param_1 != &main_arena) << 2 | uVar33 | 1;
                *(ulong *)(lVar21 + 8) = uVar15 | 1;
                *puVar17 = uVar15;
                uVar34 = perturb_byte;
                goto joined_r0x00705aef;
              }
            ...
            if (uVar15 < 0x400) {
              ...
              if (puVar30 == puVar26) {
                ...
                *(undefined4 **)(puVar22 + 10) = puVar22;
                ...
                if ((uVar20 & 4) != 0) {
                    /* WARNING: Subroutine does not return */
                  __malloc_assert("chunk_main_arena (bck->bk)","malloc.c",0x1009,"_int_malloc");
                }
                if (uVar15 < uVar20) {
                  lVar1 = puVar26[5];
                  ...
                  *(undefined4 **)(lVar1 + 0x20) = puVar22;
                  ...
                  if ((uVar20 & 4) != 0) {
                    /* WARNING: Subroutine does not return */
                    __malloc_assert("chunk_main_arena (fwd)","malloc.c",0x1016,"_int_malloc");
                  }
                  while (uVar15 < uVar20) {
                    ...
                    if ((uVar20 & 4) != 0) {
                    /* WARNING: Subroutine does not return */
                      __malloc_assert("chunk_main_arena (fwd)","malloc.c",0x101a,"_int_malloc");
                    }
                  }
                  if (uVar15 == uVar20) {
...
LAB_00705953:
          ...
          do {
            if ((uVar24 < uVar12) || (uVar13 = uVar12, uVar12 == 0)) {
              if (uVar28 == 3) goto LAB_00705b85;
              uVar24 = param_1[(ulong)(uVar28 + 1) + 0x218];
              uVar12 = uVar28 + 1;
              if (uVar24 == 0) {
                if (uVar28 == 2) goto LAB_00705b85;
                uVar24 = param_1[(ulong)(uVar28 + 2) + 0x218];
                uVar12 = uVar28 + 2;
                if (uVar24 == 0) {
                  if ((uVar28 == 1) || (uVar24 = param_1[0x21b], uVar24 == 0)) goto LAB_00705b85;
                  uVar12 = 3;
                }
              }
              uVar28 = uVar12;
            ...
            while ((uVar13 & uVar24) == 0) {
              ...
              if (uVar13 == 0) {
                    /* WARNING: Subroutine does not return */
                __malloc_assert("bit != 0","malloc.c",0x10bb,"_int_malloc");
              }
            }
            puVar23 = *(undefined4 **)(puVar22 + 6);
            if (puVar22 != puVar23) {
              ...
              if (uVar14 < uVar33) {
                    /* WARNING: Subroutine does not return */
                __malloc_assert("(unsigned long) (size) >= (unsigned long) (nb)","malloc.c",0x10ce,
                                "_int_malloc");
              }
              uVar29 = uVar14 - uVar33;
              unlink_chunk_constprop_0(puVar23);
              if (uVar29 < 0x20) {
        ...
        if ((puVar32 == puVar30 + -2) || ((ulong)puVar32[1] < uVar33)) goto LAB_00705953;
        lVar21 = puVar32[5];
        while( true ) {
        ...
        unlink_chunk_constprop_0(lVar21);
        uVar29 = uVar14 - uVar33;
        if (uVar29 < 0x20) {
          ...
          *(ulong *)(lVar21 + 8) = (ulong)(param_1 != &main_arena) << 2 | uVar33 | 1;
...
joined_r0x00705aef:
      ...
      *(long *)(lVar19 + 0x10) = lVar1;
      ...
      if ((lVar7 != 0) && (uVar29 = uVar33 - 0x11 >> 4, uVar29 < DAT_00931148)) {
  ...
  puVar16 = (ulong *)sysmalloc(uVar33,0);
  if (puVar16 == (ulong *)0x0) {
    return (ulong *)0x0;
  }
joined_r0x00705774:
  if (perturb_byte != 0) {
    puVar16 = (ulong *)memset(puVar16,perturb_byte ^ 0xff,param_2);
  }
  return puVar16;
LAB_00705b85:
  ...
  if (param_1[2] == 0) {
    puVar16 = (ulong *)sysmalloc(uVar33,param_1);
    uVar34 = perturb_byte;
    if (puVar16 == (ulong *)0x0) {
      return (ulong *)0x0;
    }
...
LAB_00705af5:
    puVar17 = (ulong *)memset(puVar16,uVar34 ^ 0xff,param_2);
    return puVar17;
  }
  malloc_consolidate();
  local_ac = uVar34;
