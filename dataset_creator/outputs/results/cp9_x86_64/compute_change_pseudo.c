...
void compute_change(long param_1,uint param_2)
...
joined_r0x00756f28:
  if (iVar4 == 1) {
    ...
    lVar5 = (ulong)*(ushort *)(&DAT_008368de + (uVar1 + uVar9) * 2) * 0x15180 + lVar5;
    ...
    if (1 < uVar2) {
      ...
      do {
        iVar4 = iVar8 + 7;
        if ((int)((uint)*(ushort *)(__mon_yday + (uVar6 * 0xd + (long)(int)(uint)uVar1) * 2) -
                 (uint)*(ushort *)(&DAT_008368de + (uVar1 + uVar9) * 2)) <= iVar4) {
