...

{
  ...
  uVar48 = (ulong)(uVar58 < DAT_005eb008 || uVar58 - DAT_005eb008 < (ulong)(lVar59 != -1));
  uVar49 = (ulong)(uVar55 < uVar48);
  uVar52 = uVar50 - DAT_005eb018;
  bVar1 = (byte)(((char)((unkuint9)Var4 >> 0x40) != '\0') + ((char)((unkuint9)Var2 >> 0x40) != '\0')
                + (CARRY8(uVar56,uVar54) || CARRY8(uVar53,uVar47))) <
          (uVar50 < DAT_005eb018 || uVar52 < uVar49);
  uVar47 = (uVar58 - DAT_005eb008) - (ulong)(lVar59 != -1);
  lVar46 = lVar59 + 1;
  if (bVar1) {
    uVar47 = uVar58;
    lVar46 = lVar59;
