...

{
  ...
  if (local_48[0] != (sentry)0x0) {
    ...
    if (plVar1 == (long *)0x0) {
                    ...
                    /* try { // try from 0068ed0e to 0068ed17 has its CatchHandler @ 0068ed18 */
      __throw_bad_cast();
    }
    if (pwVar8[0xe4] == (wostream)0x0) {
      ...
      if (plVar3 == (long *)0x0) {
        ...
        __throw_bad_cast();
                    ...
                    /* try { // try from 0068ecc4 to 0068ecc6 has its CatchHandler @ 0068ed18 */
      ...
      *(undefined4 *)(pwVar8 + 0xe0) = uVar6;
      ...
      uVar6 = *(undefined4 *)(pwVar8 + 0xe0);
                    ...
                    /* try { // try from 0068ec36 to 0068ec38 has its CatchHandler @ 0068ed18 */
    (**(code **)(*plVar1 + 0x48))
              (plVar1,*(long *)(pwVar8 + 0xe8),*(long *)(pwVar8 + 0xe8) == 0,pwVar8,uVar6,param_1);
    if (extraout_DL != '\0') {
                    /* try { // try from 0068ec4e to 0068ec52 has its CatchHandler @ 0068ed24 */
