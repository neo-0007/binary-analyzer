...
uint __wcscmp_avx2_rtm(undefined1 (*param_1) [32],undefined1 (*param_2) [32])
...
LAB_00754aed:
            ...
            if (iVar15 == 0) {
              ...
              if (uVar11 < 0x40) {
                ...
                if (iVar13 == iVar15) goto LAB_007549e1;
              }
              else {
LAB_00754c80:
...
LAB_00754af9:
            ...
            if ((((((((((((((((((((((((((((((((auVar3 >> 7 & (undefined1  [32])0x1) ==
                ...
                -1 < auVar3[0x1f]) goto LAB_00754ae0;
...
LAB_00754d50:
    ...
    if (iVar15 == 0) {
      ...
      do {
        ...
        uVar11 = (int)uVar16 + 4;
        uVar16 = (ulong)uVar11;
        if (uVar11 == 0x80) goto LAB_00754aa9;
        iVar15 = *(int *)(*param_1 + uVar16);
        iVar13 = *(int *)(*param_2 + uVar16);
      } while (iVar15 != 0);
      uVar12 = -iVar13;
