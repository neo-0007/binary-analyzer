...
/* WARNING: Removing unreachable block (ram,0x006c28cf) */
...

{
  ...
  do {
    ...
    bVar8 = bVar9 & 0xc0;
    if (bVar8 == 0x40) {
      param_4[0x29] = (ulong)(bVar9 & 0x3f) * param_4[0x2c] + uVar18;
      goto LAB_006c2108;
    }
    if (bVar8 == 0x80) {
      uVar18 = 0;
      ...
      lVar11 = param_4[0x2b];
      if ((bVar9 & 0x3f) < 0x12) {
        *(undefined4 *)(param_4 + (ulong)(bVar9 & 0x3f) * 2 + 1) = 1;
        param_4[(ulong)(bVar9 & 0x3f) * 2] = uVar18 * lVar11;
      }
      goto LAB_006c2108;
    }
    if (bVar8 == 0xc0) {
      if (0x11 < (bVar9 & 0x3f)) goto switchD_006c20e7_caseD_0;
      *(undefined4 *)(param_4 + (ulong)(bVar9 & 0x3f) * 2 + 1) = 0;
      goto LAB_006c2108;
    }
    switch(bVar9) {
    case 0:
    case 0x2d:
switchD_006c20e7_caseD_0:
      break;
    case 1:
      uVar2 = *(undefined1 *)(param_4 + 0x2e);
      *(undefined8 *)(puVar12 + -8) = 0x6c21ee;
      local_50 = puVar16;
      pbVar6 = (byte *)read_encoded_value(param_3,uVar2,pbVar6,local_40);
    ...
    case 5:
      ...
      do {
        ...
        bVar1 = bVar9 & 0x3f;
        bVar9 = bVar9 + 7;
        uVar18 = uVar18 | (ulong)(bVar8 & 0x7f) << bVar1;
      } while ((char)bVar8 < '\0');
      uVar17 = 0;
      bVar9 = 0;
      do {
        ...
        bVar1 = bVar9 & 0x3f;
        bVar9 = bVar9 + 7;
        uVar17 = uVar17 | (ulong)(bVar8 & 0x7f) << bVar1;
      } while ((char)bVar8 < '\0');
      goto LAB_006c23f0;
    case 6:
      uVar18 = 0;
...
LAB_006c26fb:
    ...
    case 0x11:
      ...
      do {
        ...
        bVar8 = (byte)uVar10;
        uVar10 = uVar10 + 7;
        uVar17 = uVar17 | (ulong)(bVar9 & 0x7f) << (bVar8 & 0x3f);
      } while ((char)bVar9 < '\0');
      if ((uVar10 < 0x40) && ((bVar9 & 0x40) != 0)) {
...
LAB_006c23f0:
    ...
    case 0x12:
      ...
      do {
        ...
        bVar8 = (byte)uVar10;
        uVar10 = uVar10 + 7;
        uVar18 = uVar18 | (ulong)(bVar9 & 0x7f) << (bVar8 & 0x3f);
      } while ((char)bVar9 < '\0');
      if ((uVar10 < 0x40) && ((bVar9 & 0x40) != 0)) {
...
LAB_006c255b:
    ...
    default:
      ...
      *(code **)(puVar12 + -8) = uw_frame_state_for_cold;
      abort();
    case 0x2e:
      uVar18 = 0;
      bVar9 = 0;
