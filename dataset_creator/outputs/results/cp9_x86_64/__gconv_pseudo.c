...
undefined8
__gconv(long *param_1,long *param_2,ulong param_3,long *param_4,long param_5,undefined8 *param_6)

{
  ...
  if (param_6 == (undefined8 *)0x0) {
    ...
    __assert_fail("irreversible != NULL","gconv.c",0x2a,"__gconv");
  }
  *param_6 = 0;
  lVar3 = 0;
  if (param_4 != (long *)0x0) {
  ...
  if ((param_2 == (long *)0x0) || (*param_2 == 0)) {
    ...
    if ((param_4 == (long *)0x0) || (*param_4 == 0)) {
                    /* WARNING: Subroutine does not return */
      __assert_fail("outbuf != NULL && *outbuf != NULL","gconv.c",0x48,"__gconv");
    }
    lVar3 = *param_2;
    do {
      _dl_mcount_wrapper_check(pcVar7);
