...

{
  ...
  lVar3 = CRYPTO_zalloc(0xe0,"../crypto/evp/keymgmt_meth.c",0x18);
  if (lVar3 != 0) {
    ...
    *(long *)(lVar3 + 0x28) = lVar4;
    if (lVar4 != 0) {
      ...
      *(undefined8 *)(lVar3 + 0x10) = *(undefined8 *)(param_2 + 0x18);
      ...
      EVP_KEYMGMT_free(lVar3);
      ERR_new();
      ERR_set_debug("../crypto/evp/keymgmt_meth.c",0xc4,"keymgmt_from_algorithm");
  ...
  EVP_KEYMGMT_free(lVar3);
  ERR_new();
  ERR_set_debug("../crypto/evp/keymgmt_meth.c",0x1b,"keymgmt_new");
