...
uint * _dl_lookup_direct(long *param_1,byte *param_2,uint param_3,char *param_4,int param_5)
      ...
      if (param_2[2] != 0) {
        ...
        if (param_2[3] != 0) {
          ...
          if (param_2[4] != 0) {
            ...
            uVar11 = (ulong)(uVar9 & 0xfffffff);
          }
        }
      }
    }
    uVar9 = *(uint *)(param_1[0x62] + (uVar11 % (ulong)*(uint *)((long)param_1 + 0x2f4)) * 4);
    if (uVar9 != 0) {
      ...
      do {
        ...
        uVar11 = (ulong)uVar9;
        puVar13 = (uint *)(lVar8 + uVar11 * 0x18);
        bVar5 = (byte)puVar13[1] & 0xf;
        if ((((*(long *)(puVar13 + 2) != 0) || (*(short *)((long)puVar13 + 6) == -0xf)) ||
            (bVar5 == 6)) &&
           ((((0xfffffb98U >> bVar5 & 1) == 0 &&
             (iVar6 = strcmp((char *)(lVar7 + *(long *)(param_1[0xd] + 8) + (ulong)*puVar13),
                             (char *)param_2), iVar6 == 0)) &&
            ((puVar2 = (undefined8 *)
                       (param_1[0x5d] +
                       (ulong)(*(ushort *)(param_1[0x69] + uVar11 * 2) & 0x7fff) * 0x18),
             param_5 == *(int *)(puVar2 + 1) &&
             (iVar6 = strcmp((char *)*puVar2,param_4), iVar6 == 0)))))) {
          return puVar13;
        }
        uVar9 = *(uint *)(param_1[0x61] + uVar11 * 4);
      } while (uVar9 != 0);
    }
  }
  else {
    uVar9 = *(uint *)(param_1[0x61] + ((ulong)param_3 % (ulong)*(uint *)((long)param_1 + 0x2f4)) * 4
                     );
    if (uVar9 == 0) {
      return (uint *)0x0;
    }
    lVar3 = param_1[0x62];
    puVar13 = (uint *)(lVar3 + (ulong)uVar9 * 4);
    do {
      uVar9 = *puVar13;
      if ((uVar9 ^ param_3) >> 1 == 0) {
        lVar8 = 0;
        lVar7 = *(long *)(param_1[0xe] + 8);
        if ((*(byte *)((long)param_1 + 0x31e) & 0x20) != 0) {
          lVar8 = *param_1;
          lVar7 = lVar7 + lVar8;
        }
        uVar11 = (long)puVar13 - lVar3 >> 2 & 0xffffffff;
        puVar1 = (uint *)(lVar7 + uVar11 * 0x18);
        bVar4 = (byte)puVar1[1] & 0xf;
        if (((((*(long *)(puVar1 + 2) != 0) || (*(short *)((long)puVar1 + 6) == -0xf)) ||
             (bVar4 == 6)) &&
            ((((0xfffffb98U >> bVar4 & 1) == 0 &&
              (iVar6 = strcmp((char *)(lVar8 + *(long *)(param_1[0xd] + 8) + (ulong)*puVar1),
                              (char *)param_2), iVar6 == 0)) &&
             (puVar2 = (undefined8 *)
                       (param_1[0x5d] +
                       (ulong)(*(ushort *)(param_1[0x69] + uVar11 * 2) & 0x7fff) * 0x18),
