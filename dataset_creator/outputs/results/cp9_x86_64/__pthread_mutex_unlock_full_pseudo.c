...
/* WARNING: Removing unreachable block (ram,0x00701012) */
/* WARNING: Removing unreachable block (ram,0x0070101e) */
/* WARNING: Removing unreachable block (ram,0x00701057) */
/* WARNING: Removing unreachable block (ram,0x0070106f) */
/* WARNING: Removing unreachable block (ram,0x00701042) */
/* WARNING: Removing unreachable block (ram,0x0070104b) */
/* WARNING: Removing unreachable block (ram,0x00700f40) */
/* WARNING: Removing unreachable block (ram,0x00700f4c) */

undefined8 __pthread_mutex_unlock_full(uint *param_1,int param_2)

{
  ...
  if (0x33 < uVar3) {
    ...
    uVar6 = __pthread_tpp_change_priority((int)uVar4 >> 0x13,0xffffffff,uVar5);
    return uVar6;
  }
  if ((uVar5 & 0x60) == 0) {
    uVar5 = 0;
    if (uVar3 == 0x11) {
      ...
      *puVar1 = *puVar1 - 1;
      ...
      if (param_1[2] != 0x7fffffff) goto LAB_00700df7;
    }
    uVar5 = 0x7ffffffe;
LAB_00700df7:
...
LAB_00700fb2:
    ...
    if (uVar5 != 0) {
      if (param_1[2] == 0x7fffffff) goto LAB_00700fb2;
      uVar5 = 0;
    }
LAB_00700ef9:
    if ((param_1[4] & 0x10) == 0) goto LAB_00700d6c;
  }
