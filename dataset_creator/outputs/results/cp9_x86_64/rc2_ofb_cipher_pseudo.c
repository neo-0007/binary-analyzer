...

{
  ...
  if (0x3fffffffffffffff < param_4) {
    do {
      ...
      RC2_ofb64_encrypt(param_3 + lVar1,param_2 + lVar3,0x4000000000000000,(RC2_KEY *)(lVar2 + 4),
                        (uchar *)(param_1 + 0x28),&local_44);
  ...
  if (uVar4 != 0) {
    ...
    RC2_ofb64_encrypt(local_58,local_60,uVar4,(RC2_KEY *)(lVar3 + 4),(uchar *)(param_1 + 0x28),
                      &local_44);
    EVP_CIPHER_CTX_set_num(param_1,local_44);
  }
