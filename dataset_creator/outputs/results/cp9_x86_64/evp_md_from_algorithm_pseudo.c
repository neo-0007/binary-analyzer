...

{
  ...
  if (piVar2 == (int *)0x0) {
    ERR_new();
    ERR_set_debug("../crypto/evp/digest.c",0x3b0,"evp_md_from_algorithm");
  ...
  *piVar2 = 0;
  ...
  if ((iVar1 == 0) || (*piVar2 == -1)) {
    ERR_new();
    ERR_set_debug("../crypto/evp/digest.c",0x3b8,"evp_md_from_algorithm");
...
LAB_0051a3b7:
      EVP_MD_free(piVar2);
      ERR_new();
      ERR_set_debug("../crypto/evp/digest.c",0x413,"evp_md_from_algorithm");
...
joined_r0x0051a2b6:
    ...
    if (iVar4 == 0) goto LAB_0051a3a8;
    if (iVar4 != 5) goto LAB_0051a3b7;
  }
  *(long *)(piVar2 + 0x1c) = param_3;
  ...
  local_d8 = local_128;
  OSSL_PARAM_construct_size_t(&local_148,"size",&local_100);
  local_d0 = local_148;
  uStack_c8 = uStack_140;
  local_c0 = local_138;
  uStack_b8 = uStack_130;
  local_b0 = local_128;
  OSSL_PARAM_construct_int(&local_148,&DAT_007dae2e,&local_110);
  local_a8 = local_148;
  ...
  if (((local_100 < 0x80000000) && (local_108 < 0x80000000)) && (0 < iVar1)) {
    ...
    EVP_MD_free(piVar2);
    ERR_new();
    ERR_set_debug("../crypto/evp/digest.c",0x41c,"evp_md_from_algorithm");
