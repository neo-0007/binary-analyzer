...

{
  ...
  ptr = (undefined4 *)CRYPTO_zalloc(0x88,"../crypto/evp/asymcipher.c",0x130);
  if (ptr == (undefined4 *)0x0) {
    ERR_new();
    ERR_set_debug("../crypto/evp/asymcipher.c",0x133,"evp_asym_cipher_new");
...
joined_r0x00511d60:
        ...
        ERR_new();
        ERR_set_debug("../crypto/evp/asymcipher.c",0x1af,"evp_asym_cipher_from_algorithm");
        ERR_set_error(6,0xc1,0);
      }
      goto LAB_00511bfc;
    }
    ERR_new();
    ERR_set_debug("../crypto/evp/asymcipher.c",0x139,"evp_asym_cipher_new");
    ERR_set_error(6,0xc0100,0);
    CRYPTO_free(ptr);
  }
  ERR_new();
  ptr = (undefined4 *)0x0;
  ERR_set_debug("../crypto/evp/asymcipher.c",0x14e,"evp_asym_cipher_from_algorithm");
  ERR_set_error(6,0xc0100,0);
LAB_00511bfc:
