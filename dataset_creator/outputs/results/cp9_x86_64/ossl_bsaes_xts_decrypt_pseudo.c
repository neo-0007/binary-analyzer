...

{
  ...
  lVar5 = -((ulong)(uint)param_4->rounds * 0x80 + -0x60);
  *(undefined8 *)((long)local_78 + lVar5 + -8) = 0x499245;
  puVar10 = (undefined8 *)_bsaes_key_convert();
  uVar13 = *(ulong *)((long)local_78 + lVar5);
  uVar9 = *(ulong *)((long)local_78 + lVar5 + 8);
  *puVar10 = in_XMM6_Qa;
  puVar10[1] = in_XMM6_Qb;
  *(ulong *)((long)local_78 + lVar5) = in_XMM7_Qa ^ uVar13;
  *(ulong *)((long)local_78 + lVar5 + 8) = in_XMM7_Qb ^ uVar9;
  iVar46 = local_58[0]._0_4_;
  bVar3 = local_58[0]._4_4_ < 0;
  bVar4 = local_58[0]._12_4_ < 0;
  auVar47 = local_58[0];
  uVar13 = (param_3 & 0xfffffffffffffff0) + (ulong)((param_3 & 0xf) != 0) * -0x10;
  while( true ) {
    uVar9 = uVar13 - 0x80;
    ...
    *(undefined1 (*) [16])(auStack_f8 + lVar5) = auVar47;
    ...
    auVar18 = auVar18 ^ auVar48 & _DAT_00499b70;
    ...
    *(undefined1 (*) [16])((long)auStack_e8 + lVar5) = auVar18;
    ...
    auVar19._0_8_ = lVar6;
    iVar46 = -(uint)((int)lVar6 < 0);
    auVar19 = auVar19 ^ auVar49 & _DAT_00499b70;
    auVar48 = *param_1;
    ...
    *(undefined1 (*) [16])(auStack_c8 + lVar5) = auVar20;
    ...
    auVar21._0_8_ = lVar6;
    iVar46 = -(uint)((int)lVar6 < 0);
    auVar21 = auVar21 ^ auVar33 & _DAT_00499b70;
    ...
    *(undefined1 (*) [16])((long)auStack_b8 + lVar5) = auVar21;
    ...
    auVar22._0_8_ = lVar6;
    iVar46 = -(uint)((int)lVar6 < 0);
    auVar22 = auVar22 ^ auVar34 & _DAT_00499b70;
    auVar48 = param_1[3];
    ...
    *(undefined1 (*) [16])(auStack_a8 + lVar5) = auVar22;
    ...
    in_XMM5._0_8_ = lVar6;
    iVar46 = -(uint)((int)lVar6 < 0);
    in_XMM5 = in_XMM5 ^ auVar35 & _DAT_00499b70;
    auVar49 = param_1[4];
    ...
    *(undefined1 (*) [16])(auStack_98 + lVar5) = in_XMM5;
    ...
    auVar23 = auVar23 ^ auVar36 & _DAT_00499b70;
    ...
    *(undefined8 *)((long)&uStack_100 + lVar5) = 0x499435;
    auVar48 = _bsaes_decrypt8(auVar18._0_8_ ^ uVar13,auVar19._0_8_ ^ uVar14);
    uVar13 = *(ulong *)((long)auStack_e8 + lVar5);
    uVar14 = *(ulong *)((long)auStack_e8 + lVar5 + 8);
    *param_2 = auVar47 ^ *(undefined1 (*) [16])(auStack_f8 + lVar5);
    in_XMM5 = in_XMM5 ^ *(undefined1 (*) [16])(auStack_d8 + lVar5);
    *(ulong *)param_2[1] = auVar48._0_8_ ^ uVar13;
    *(ulong *)(param_2[1] + 8) = extraout_XMM0_Qb ^ uVar14;
    auVar47 = *(undefined1 (*) [16])(auStack_c8 + lVar5);
    param_2[2] = in_XMM5;
    uVar13 = *(ulong *)((long)auStack_b8 + lVar5);
    uVar14 = *(ulong *)((long)auStack_b8 + lVar5 + 8);
    param_2[3] = auVar21 ^ auVar47;
    auVar47 = *(undefined1 (*) [16])(auStack_a8 + lVar5);
    *(ulong *)param_2[4] = auVar48._8_8_ ^ uVar13;
    *(ulong *)(param_2[4] + 8) = extraout_XMM1_Qb ^ uVar14;
    ...
    bVar3 = lVar6 < 0;
    bVar4 = lVar7 < 0;
    auVar47 = auVar47 ^ auVar37 & _DAT_00499b70;
    uVar13 = uVar9;
  }
  if (uVar9 != 0xffffffffffffff80) {
    ...
    *(undefined1 (*) [16])((long)auStack_e8 + lVar5) = auVar24;
    ...
    if (uVar9 == 0xffffffffffffff90) {
      ...
      param_1 = param_1 + 1;
      *(undefined8 *)((long)&uStack_100 + lVar5) = 0x49993f;
      AES_decrypt((uchar *)local_58,(uchar *)local_58,param_4);
      ...
      *(undefined1 (*) [16])(auStack_d8 + lVar5) = auVar25;
      ...
      if (uVar9 == 0xffffffffffffffa0) {
        auVar47 = auVar47 ^ auVar48;
        param_1 = param_1 + 2;
        *(undefined8 *)((long)&uStack_100 + lVar5) = 0x4998ef;
        uVar14 = _bsaes_decrypt8(uVar13 ^ uVar14,uVar15);
        uVar13 = *(ulong *)((long)auStack_e8 + lVar5);
        uVar9 = *(ulong *)((long)auStack_e8 + lVar5 + 8);
        *param_2 = auVar47 ^ *(undefined1 (*) [16])(auStack_f8 + lVar5);
        *(ulong *)param_2[1] = uVar14 ^ uVar13;
        ...
        *(undefined1 (*) [16])(auStack_c8 + lVar5) = auVar26;
        ...
        if (uVar9 == 0xffffffffffffffb0) {
          param_1 = param_1 + 3;
          *(undefined8 *)((long)&uStack_100 + lVar5) = 0x49988f;
          uVar14 = _bsaes_decrypt8(uVar13 ^ uVar14,uVar15 ^ uVar8);
          uVar13 = *(ulong *)((long)auStack_e8 + lVar5);
          uVar9 = *(ulong *)((long)auStack_e8 + lVar5 + 8);
          *param_2 = auVar47 ^ *(undefined1 (*) [16])(auStack_f8 + lVar5);
          auVar47 = *(undefined1 (*) [16])(auStack_d8 + lVar5);
          ...
          *(undefined1 (*) [16])((long)auStack_b8 + lVar5) = auVar27;
          ...
          uVar14 = auVar48._0_8_;
          if (uVar9 == 0xffffffffffffffc0) {
            param_1 = param_1 + 4;
            *(undefined8 *)((long)&uStack_100 + lVar5) = 0x49982f;
            uVar14 = _bsaes_decrypt8(uVar13,uVar15 ^ uVar8,uVar16 ^ uVar14);
            uVar13 = *(ulong *)((long)auStack_e8 + lVar5);
            uVar9 = *(ulong *)((long)auStack_e8 + lVar5 + 8);
            *param_2 = auVar47 ^ *(undefined1 (*) [16])(auStack_f8 + lVar5);
            auVar47 = *(undefined1 (*) [16])(auStack_d8 + lVar5);
            ...
            *(undefined1 (*) [16])(auStack_a8 + lVar5) = auVar28;
            ...
            auVar29._0_8_ = lVar6;
            iVar46 = -(uint)((int)lVar6 < 0);
            auVar29 = auVar29 ^ auVar43 & _DAT_00499b70;
            auVar49 = param_1[4];
            if (uVar9 == 0xffffffffffffffd0) {
              param_1 = param_1 + 5;
              auVar27 = auVar27 ^ auVar49;
              *(undefined8 *)((long)&uStack_100 + lVar5) = 0x4997bf;
              auVar49 = _bsaes_decrypt8(uVar13,uVar15,uVar16 ^ uVar14,auVar27._0_8_,uVar17);
              uVar13 = *(ulong *)((long)auStack_e8 + lVar5);
              uVar9 = *(ulong *)((long)auStack_e8 + lVar5 + 8);
              *param_2 = auVar47 ^ *(undefined1 (*) [16])(auStack_f8 + lVar5);
              auVar47 = *(undefined1 (*) [16])(auStack_d8 + lVar5);
              *(ulong *)param_2[1] = auVar49._0_8_ ^ uVar13;
              *(ulong *)(param_2[1] + 8) = extraout_XMM0_Qb_02 ^ uVar9;
              auVar48 = *(undefined1 (*) [16])(auStack_c8 + lVar5);
              param_2[2] = in_XMM5 ^ auVar47;
              uVar13 = *(ulong *)((long)auStack_b8 + lVar5);
              uVar9 = *(ulong *)((long)auStack_b8 + lVar5 + 8);
              param_2[3] = auVar27 ^ auVar48;
              *(ulong *)param_2[4] = auVar49._8_8_ ^ uVar13;
              *(ulong *)(param_2[4] + 8) = extraout_XMM1_Qb_02 ^ uVar9;
              param_2 = param_2 + 5;
              auVar47 = *(undefined1 (*) [16])(auStack_a8 + lVar5);
            }
            else {
              ...
              *(undefined1 (*) [16])(auStack_98 + lVar5) = auVar29;
              ...
              auVar30 = auVar30 ^ auVar44 & _DAT_00499b70;
              uVar14 = *(ulong *)param_1[5];
              if (uVar9 == 0xffffffffffffffe0) {
                auVar27 = auVar27 ^ auVar49;
                param_1 = param_1 + 6;
                *(undefined8 *)((long)&uStack_100 + lVar5) = 0x49973f;
                auVar49 = _bsaes_decrypt8(uVar13,uVar15,auVar26._0_8_,auVar27._0_8_,uVar17 ^ uVar14)
                ;
                uVar13 = *(ulong *)((long)auStack_e8 + lVar5);
                uVar9 = *(ulong *)((long)auStack_e8 + lVar5 + 8);
                *param_2 = auVar47 ^ *(undefined1 (*) [16])(auStack_f8 + lVar5);
                ...
                *(ulong *)(param_2[1] + 8) = extraout_XMM0_Qb_01 ^ uVar9;
                ...
                auVar47 = *(undefined1 (*) [16])(auStack_a8 + lVar5);
                *(ulong *)param_2[4] = auVar49._8_8_ ^ uVar13;
                *(ulong *)(param_2[4] + 8) = extraout_XMM1_Qb_01 ^ uVar9;
                ...
                *(undefined8 *)((long)&uStack_100 + lVar5) = 0x4996af;
                auVar49 = _bsaes_decrypt8(uVar13,uVar15,auVar26._0_8_,auVar27._0_8_,uVar17 ^ uVar14)
                ;
                uVar13 = *(ulong *)((long)auStack_e8 + lVar5);
                uVar9 = *(ulong *)((long)auStack_e8 + lVar5 + 8);
                ...
                *(ulong *)(param_2[1] + 8) = extraout_XMM0_Qb_00 ^ uVar9;
                ...
                auVar47 = *(undefined1 (*) [16])(auStack_a8 + lVar5);
                *(ulong *)param_2[4] = auVar49._8_8_ ^ uVar13;
                *(ulong *)(param_2[4] + 8) = extraout_XMM1_Qb_00 ^ uVar9;
                auVar48 = *(undefined1 (*) [16])(auStack_98 + lVar5);
                param_2[5] = auVar30 ^ auVar47;
  ...
  uVar12 = (uint)param_3 & 0xf;
  pauVar11 = (undefined1 (*) [16])(auStack_f8 + lVar5);
  if ((param_3 & 0xf) != 0) {
    iVar46 = -(uint)(auVar47._0_4_ < 0);
    ...
    auVar31 = auVar31 ^ auVar45 & _DAT_00499b70;
    local_58[0] = *param_1 ^ auVar31;
    *(undefined8 *)((long)&uStack_100 + lVar5) = 0x4999aa;
    AES_decrypt((uchar *)local_58,(uchar *)local_58,param_4);
    *param_2 = auVar31 ^ local_58[0];
    ...
    do {
      ...
      (*pauVar11)[0] = (*pauVar1)[0];
      pauVar11[1][0] = uVar2;
      pauVar11 = (undefined1 (*) [16])(*pauVar11 + 1);
      uVar12 = uVar12 - 1;
    } while (uVar12 != 0);
    local_58[0] = *param_2 ^ auVar47;
    *(undefined8 *)((long)&uStack_100 + lVar5) = 0x4999f5;
    AES_decrypt((uchar *)local_58,(uchar *)local_58,param_4);
    *param_2 = auVar47 ^ local_58[0];
    pauVar11 = (undefined1 (*) [16])(auStack_f8 + lVar5);
  }
