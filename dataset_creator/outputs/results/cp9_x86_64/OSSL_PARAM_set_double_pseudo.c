      ...
      *(undefined8 *)(param_2 + 0x20) = 8;
      ...
      if (iVar1 == 2) {
        if (DAT_007c57c8 <= param_1) {
          uVar6 = (long)(param_1 - DAT_007c57c8) ^ 0x8000000000000000;
        }
        else {
          uVar6 = (ulong)param_1;
        }
        ...
        *(undefined8 *)(param_2 + 0x20) = 8;
        ...
        dVar4 = _default_rwlockattr;
        dVar5 = _DAT_007c57d0;
        if (lVar3 == 4) {
          if (param_1 < _default_rwlockattr) {
            return 0;
          }
          if (DAT_007c57b8 < param_1) {
            return 0;
          }
        ...
        *(undefined8 *)(param_2 + 0x20) = 8;
        ...
        dVar5 = DAT_007c57c8;
        if (lVar3 == 4) {
          if (param_1 < _DAT_007c57a0) {
            return 0;
          }
          if (DAT_007c57a8 < param_1) {
            return 0;
          }
          *(undefined8 *)(param_2 + 0x20) = 4;
