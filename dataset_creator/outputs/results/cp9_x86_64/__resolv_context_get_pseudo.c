...

{
  ...
  if (puVar3 == (undefined8 *)0x0) {
    uVar9 = *(undefined8 *)(in_FS_OFFSET + -0x70);
    __ptr = (undefined8 *)malloc(0x28);
    if (__ptr != (undefined8 *)0x0) {
      *__ptr = uVar9;
      lVar8 = __resolv_conf_get(uVar9);
      __ptr[2] = 1;
      __ptr[1] = lVar8;
      ...
      *(undefined8 **)(in_FS_OFFSET + -0x10) = __ptr;
      ...
      if ((uVar5 & 1) == 0) {
        ...
        iVar7 = __res_vinit(piVar4,0);
        if (-1 < iVar7) {
          uVar9 = __resolv_conf_get(*__ptr);
          __ptr[1] = uVar9;
          return __ptr;
        }
      }
      else {
        if (((((uVar5 & 0x2000000) != 0) || (lVar8 == 0)) || (uVar5 != *(uint *)(lVar8 + 0x38))) ||
           (((*piVar4 != *(int *)(lVar8 + 0x3c) || (piVar4[1] != *(int *)(lVar8 + 0x40))) ||
            ((*(byte *)(piVar4 + 0x62) & 0xf) != *(uint *)(lVar8 + 0x44))))) {
          return __ptr;
        }
        lVar8 = __resolv_conf_get_current();
        if (lVar8 != 0) {
          if (lVar8 == __ptr[1]) {
            __resolv_conf_put(lVar8);
            return __ptr;
          }
          if (0 < piVar4[4]) {
            __res_iclose(piVar4,1);
          }
          cVar6 = __resolv_conf_attach(*__ptr,lVar8);
          if (cVar6 == '\0') {
            return __ptr;
          }
