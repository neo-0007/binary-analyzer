...

{
  ...
  if ((_DAT_0093e5a0 & 0x80100) == 0x80100) {
    ...
    Var49 = (unkuint9)(ulong)Var50 + (unkuint9)uVar150 +
            (unkuint9)((char)((unkuint9)Var49 >> 0x40) != '\0');
    uVar147 = (ulong)Var49;
    uVar140 = (ulong)(uVar151 < DAT_005eb0c8 ||
                     uVar151 - DAT_005eb0c8 < (ulong)(uVar149 < DAT_005eb0c0));
    uVar137 = (ulong)(uVar146 < DAT_005eb0d0 || uVar146 - DAT_005eb0d0 < uVar140);
    uVar142 = (uVar147 - DAT_005eb0d8) - uVar137;
    uVar139 = (uVar151 - DAT_005eb0c8) - (ulong)(uVar149 < DAT_005eb0c0);
    uVar141 = uVar149 - DAT_005eb0c0;
    uVar140 = (uVar146 - DAT_005eb0d0) - uVar140;
    if (uVar148 + uVar138 + uVar150 + (ulong)((char)((unkuint9)Var50 >> 0x40) != '\0') +
        (ulong)((char)((unkuint9)Var49 >> 0x40) != '\0') <
        (ulong)(uVar147 < DAT_005eb0d8 || uVar147 - DAT_005eb0d8 < uVar137)) {
      uVar142 = uVar147;
      uVar139 = uVar151;
      uVar141 = uVar149;
      uVar140 = uVar146;
  ...
  uVar141 = (ulong)(uVar155 < DAT_005eb0c8 ||
                   uVar155 - DAT_005eb0c8 < (ulong)(uVar152 < DAT_005eb0c0));
  uVar142 = (ulong)(uVar153 < DAT_005eb0d0 || uVar153 - DAT_005eb0d0 < uVar141);
  uVar148 = (uVar145 - DAT_005eb0d8) - uVar142;
  uVar146 = (uVar155 - DAT_005eb0c8) - (ulong)(uVar152 < DAT_005eb0c0);
  uVar141 = (uVar153 - DAT_005eb0d0) - uVar141;
  uVar147 = uVar152 - DAT_005eb0c0;
  if ((byte)((CARRY8(uVar154,uVar149) || CARRY8(uVar137,uVar138)) +
            (CARRY8(uVar144,uVar151) || CARRY8(uVar139,uVar140))) <
      (uVar145 < DAT_005eb0d8 || uVar145 - DAT_005eb0d8 < uVar142)) {
    uVar148 = uVar145;
    uVar146 = uVar155;
    uVar141 = uVar153;
    uVar147 = uVar152;
