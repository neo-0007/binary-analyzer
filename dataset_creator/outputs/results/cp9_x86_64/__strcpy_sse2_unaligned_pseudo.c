...

{
  ...
  if (((ulong)param_2 & 0x3f) < 0x21) {
    ...
    if (uVar33 != 0) {
      for (; (uVar33 >> lVar34 & 1) == 0; lVar34 = lVar34 + 1) {
                    ...
                    /* WARNING: Could not recover jumptable at 0x0073dc2b. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&DAT_00821c10 + *(int *)(&DAT_00821c10 + lVar34 * 4)))
              (param_1,param_2,lVar34,&DAT_00821c10 + *(int *)(&DAT_00821c10 + lVar34 * 4));
    return;
  }
  ...
  if (uVar3 != 0) {
    ...
    if (uVar3 != 0) {
      for (; (uVar3 >> lVar34 & 1) == 0; lVar34 = lVar34 + 1) {
                    ...
                    /* WARNING: Could not recover jumptable at 0x0073dc06. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&DAT_00821c10 + *(int *)(&DAT_00821c10 + lVar34 * 4)))
              (param_1,pcVar36 + uVar33,lVar34,&DAT_00821c10 + *(int *)(&DAT_00821c10 + lVar34 * 4))
    ;
    return;
  }
  ...
  if (uVar3 != 0) {
    ...
    lVar34 = (lVar34 + 0x10) - uVar33;
                    /* WARNING: Could not recover jumptable at 0x0073dc4d. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)(&DAT_00821c10 + *(int *)(&DAT_00821c10 + lVar34 * 4)))
              (param_1,pcVar36 + uVar33,lVar34,&DAT_00821c10 + *(int *)(&DAT_00821c10 + lVar34 * 4))
    ;
  ...
  *(undefined8 *)((long)param_1 + (0x18 - uVar33)) = uVar32;
            ...
            if (uVar35 == 0) {
              ...
              *(byte *)((long)param_1 + (0x7f - uVar33)) = bVar103;
              ...
              if (uVar3 != 0) {
                ...
                if (uVar3 != 0) {
                  for (; (uVar3 >> lVar34 & 1) == 0; lVar34 = lVar34 + 1) {
                    ...
                    /* WARNING: Could not recover jumptable at 0x0073dc63. Too many branches */
                    /* WARNING: Treating indirect jump as call */
                (*(code *)(&DAT_00821c10 + *(int *)(&DAT_00821c10 + lVar34 * 4)))();
                return;
              }
              if (uVar4 != 0) {
                ...
                *pbVar40 = bVar103;
                ...
                pbVar40[0xe] = bVar117;
                pbVar40[0xf] = bVar118;
                    /* WARNING: Could not recover jumptable at 0x0073dc8f. Too many branches */
                    /* WARNING: Treating indirect jump as call */
                (*(code *)(&DAT_00821c10 + *(int *)(&DAT_00821c10 + lVar34 * 4)))
                          (pbVar40 + 0x10,pbVar38 + 0x10,lVar34,
                           &DAT_00821c10 + *(int *)(&DAT_00821c10 + lVar34 * 4));
                return;
              }
              ...
              if (uVar3 != 0) {
                ...
                *pbVar40 = bVar103;
                ...
                pbVar40[0x1f] = bVar134;
                    /* WARNING: Could not recover jumptable at 0x0073dcc4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
                (*(code *)(&DAT_00821c10 + *(int *)(&DAT_00821c10 + lVar34 * 4)))
              ...
              *pbVar40 = bVar103;
              ...
              pbVar40[0x2f] = bVar150;
                    /* WARNING: Could not recover jumptable at 0x0073db91. Too many branches */
                    /* WARNING: Treating indirect jump as call */
              (*(code *)(&DAT_00821c10 + *(int *)(&DAT_00821c10 + lVar34 * 4)))
  ...
  if (uVar35 != 0) {
    for (; (uVar35 >> lVar1 & 1) == 0; lVar1 = lVar1 + 1) {
                    ...
                    /* WARNING: Could not recover jumptable at 0x0073dbe9. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)(&DAT_00821c10 + *(int *)(&DAT_00821c10 + lVar1 * 4)))
            ((long)param_1 + (lVar34 - uVar33),uVar37 + lVar34,lVar1,
             &DAT_00821c10 + *(int *)(&DAT_00821c10 + lVar1 * 4));
  return;
}
