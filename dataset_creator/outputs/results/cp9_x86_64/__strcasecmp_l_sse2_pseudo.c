...

{
  ...
  if (uVar23 != uVar21) {
    ...
    uVar22 = (*(code *)(&DAT_00821a00 + *(int *)(&DAT_00821a00 + ((uVar22 + 0xf) - uVar24) * 4)))
...
LAB_00725df0:
  ...
  return (ulong)(uint)(*(int *)(_nl_C_LC_CTYPE_tolower + (ulong)(byte)(*param_1)[lVar27] * 4 + 0x200
                               ) -
                      *(int *)(_nl_C_LC_CTYPE_tolower + (ulong)(byte)(*param_2)[lVar27] * 4 + 0x200)
                      );
}
