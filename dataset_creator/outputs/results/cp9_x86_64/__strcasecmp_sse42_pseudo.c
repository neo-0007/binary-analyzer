...
/* WARNING: Removing unreachable block (ram,0x00729af5) */
...

{
  ...
  if ((*(uint *)(**(long **)(in_FS_OFFSET + -0x78) + 0x278) & 1) != 0) {
    if (param_1 == param_2) {
      ...
      lVar8 = (*(long **)(in_FS_OFFSET + -0x78))[0xe];
      lVar9 = 0;
      do {
        pbVar1 = *param_1 + lVar9;
        uVar5 = *(int *)(lVar8 + (ulong)*pbVar1 * 4) -
                *(int *)(lVar8 + (ulong)(byte)(*param_2)[lVar9] * 4);
        uVar4 = (ulong)uVar5;
        if (uVar5 != 0) {
          return uVar4;
        }
  ...
  uVar2 = (uint)param_1;
  cVar32 = DAT_008219d0;
  cVar33 = DAT_008219d0._1_1_;
  cVar34 = DAT_008219d0._2_1_;
  cVar35 = DAT_008219d0._3_1_;
  cVar36 = DAT_008219d0._4_1_;
  cVar37 = DAT_008219d0._5_1_;
  cVar38 = DAT_008219d0._6_1_;
  cVar39 = DAT_008219d0._7_1_;
  cVar40 = DAT_008219d0._8_1_;
  cVar41 = DAT_008219d0._9_1_;
  cVar42 = DAT_008219d0._10_1_;
  cVar43 = DAT_008219d0._11_1_;
  cVar44 = DAT_008219d0._12_1_;
  cVar45 = DAT_008219d0._13_1_;
  cVar46 = DAT_008219d0._14_1_;
  cVar47 = DAT_008219d0._15_1_;
  cVar52 = DAT_008219e0;
  cVar71 = DAT_008219e0._15_1_;
  cVar57 = DAT_008219e0._1_1_;
  cVar58 = DAT_008219e0._2_1_;
  cVar59 = DAT_008219e0._3_1_;
  cVar60 = DAT_008219e0._4_1_;
  cVar61 = DAT_008219e0._5_1_;
  cVar62 = DAT_008219e0._6_1_;
  cVar63 = DAT_008219e0._7_1_;
  cVar64 = DAT_008219e0._8_1_;
  cVar65 = DAT_008219e0._9_1_;
  cVar66 = DAT_008219e0._10_1_;
  cVar67 = DAT_008219e0._11_1_;
  cVar68 = DAT_008219e0._12_1_;
  cVar69 = DAT_008219e0._13_1_;
  cVar70 = DAT_008219e0._14_1_;
  if (((uVar5 & 0x3f) < 0x31) && ((uVar2 & 0x3f) < 0x31)) {
    ...
    auVar13 = auVar13 | auVar48 & auVar53 & _DAT_008219f0;
    auVar31 = auVar31 | auVar72 & auVar76 & _DAT_008219f0;
  ...
  if (uVar5 != uVar2) {
    ...
    if (uVar5 <= uVar2) {
      ...
      uVar6 = uVar4;
                    ...
                    /* WARNING: Could not recover jumptable at 0x007280a9. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    uVar4 = (*(code *)(&DAT_00821a80 + *(int *)(&DAT_00821a80 + ((uVar3 + 0xf) - uVar6) * 4)))();
    return uVar4;
  }
  auVar13 = *param_2;
  cVar12 = auVar13[0];
  ...
  auVar13 = auVar13 | auVar49 & auVar54 & _DAT_008219f0;
  auVar31 = auVar31 | auVar73 & auVar77 & _DAT_008219f0;
  ...
  if (bVar11) {
    lVar8 = 0x10;
    do {
      auVar13 = *(undefined1 (*) [16])(*param_1 + lVar8);
      auVar31 = *(undefined1 (*) [16])(*param_2 + lVar8);
      ...
      uVar5 = pcmpistri(auVar13 | auVar50 & auVar55 & _DAT_008219f0,
                        auVar31 | auVar74 & auVar78 & _DAT_008219f0,0x1a);
      lVar9 = lVar8 + 0x10;
      if (bVar10 || bVar11) break;
      auVar13 = *(undefined1 (*) [16])(param_1[1] + lVar8);
      auVar31 = *(undefined1 (*) [16])(param_2[1] + lVar8);
      ...
      uVar5 = pcmpistri(auVar13 | auVar51 & auVar56 & _DAT_008219f0,
                        auVar31 | auVar75 & auVar79 & _DAT_008219f0,0x1a);
      lVar9 = lVar8 + 0x20;
      lVar8 = lVar9;
    } while (!bVar10 && !bVar11);
    if (bVar10) {
      return (ulong)(uint)(*(int *)(_nl_C_LC_CTYPE_tolower +
                                   (ulong)(byte)param_1[-1][(ulong)uVar5 + lVar9] * 4 + 0x200) -
                          *(int *)(_nl_C_LC_CTYPE_tolower +
                                  (ulong)(byte)param_2[-1][(ulong)uVar5 + lVar9] * 4 + 0x200));
    }
    return 0;
  }
...
LAB_00729b00:
  ...
  return (ulong)(uint)(*(int *)(_nl_C_LC_CTYPE_tolower + (ulong)(byte)(*param_1)[lVar8] * 4 + 0x200)
                      - *(int *)(_nl_C_LC_CTYPE_tolower + (ulong)(byte)(*param_2)[lVar8] * 4 + 0x200
                                ));
}
