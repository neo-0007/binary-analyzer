...
ulong gf_deserialize(long param_1,long param_2,int param_3,byte param_4)
  ...
  do {
    if (uVar7 < 0x38) {
      ...
      while( true ) {
        ...
        uVar6 = uVar12 | uVar6;
        uVar5 = uVar11 | uVar5;
        if ((0x37 < uVar3) || (uVar2 = uVar3, 0x37 < uVar7)) goto LAB_004d2be5;
      }
...
LAB_004d2be5:
    do {
      ...
      *(ulong *)(param_1 + lVar9 * 8) = uVar6;
      ...
      lVar9 = lVar9 + 1;
      local_58 = *(ulong *)(MODULUS + lVar9 * 8);
