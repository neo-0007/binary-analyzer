...
LAB_0070a1b6:
        uVar5 = uVar12 + uVar13;
        uVar1 = uVar13;
        if (param_4 <= uVar5) goto LAB_0070a1ee;
      }
...
LAB_0070a21e:
        uVar5 = uVar13 + uVar9;
        uVar1 = uVar9;
        if (param_4 <= uVar5) goto LAB_0070a257;
      }
...
LAB_0070a257:
  ...
  iVar4 = bcmp(param_3,param_3 + uVar11,uVar5);
  ...
  if (iVar4 == 0) {
    ...
    do {
      while( true ) {
        ...
        if (uVar2 < uVar13 + 1) goto LAB_0070a3e8;
        uVar14 = uVar14 + uVar11;
        uVar13 = param_4 - uVar11;
        if (uVar12 < uVar14) goto LAB_0070a3e6;
      }
...
LAB_0070a314:
    ...
    do {
      ...
      if (uVar14 == 0) {
        ...
        uVar14 = uVar15;
        if (uVar15 == 0xffffffffffffffff) goto LAB_0070a3e8;
        while (param_3[uVar14] == *(byte *)(lVar10 + uVar14)) {
          bVar16 = uVar14 == 0;
          uVar14 = uVar14 - 1;
          if (bVar16) goto LAB_0070a3e8;
        }
