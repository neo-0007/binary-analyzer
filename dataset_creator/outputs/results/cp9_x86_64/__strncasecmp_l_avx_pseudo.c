...
/* WARNING: Removing unreachable block (ram,0x007336ca) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

ulong __strncasecmp_l_avx(undefined1 (*param_1) [16],undefined1 (*param_2) [16],ulong param_3,
                         long *param_4)

{
  ...
  if ((*(uint *)(*param_4 + 0x278) & 1) != 0) {
    if ((param_1 == param_2) || (param_3 == 0)) {
      ...
      uVar15 = 0;
      do {
        uVar10 = *(int *)(param_4[0xe] + (ulong)(byte)(*param_1)[uVar15] * 4) -
                 *(int *)(param_4[0xe] + (ulong)(byte)(*param_2)[uVar15] * 4);
        uVar9 = (ulong)uVar10;
        if (uVar10 != 0) {
          return uVar9;
        }
  ...
  if (((uVar10 & 0x3f) < 0x31) && ((uVar8 & 0x3f) < 0x31)) {
    auVar1 = *param_1;
    auVar2 = *param_2;
    auVar3 = vpcmpgtb_avx(auVar1,_DAT_008219d0);
    auVar4 = vpcmpgtb_avx(auVar1,_DAT_00821ac0);
    auVar5 = vpcmpgtb_avx(auVar2,_DAT_008219d0);
    auVar6 = vpcmpgtb_avx(auVar2,_DAT_00821ac0);
    auVar3 = vpandn_avx(auVar4,auVar3);
    auVar4 = vpandn_avx(auVar6,auVar5);
    auVar3 = vpand_avx(auVar3,_DAT_008219f0);
  ...
  if (uVar10 != uVar8) {
    ...
    auVar1 = vpcmpeqb_avx((undefined1  [16])0x0,*pauVar14);
                    /* WARNING: Could not recover jumptable at 0x00731e89. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    uVar9 = (*(code *)(&DAT_00821bd0 + *(int *)(&DAT_00821bd0 + ((uVar9 + 0xf) - uVar15) * 4)))
  ...
  auVar3 = vpcmpgtb_avx(auVar1,_DAT_008219d0);
  auVar4 = vpcmpgtb_avx(auVar1,_DAT_00821ac0);
  auVar6 = vpcmpgtb_avx(auVar2,_DAT_008219d0);
  auVar7 = vpcmpgtb_avx(auVar2,_DAT_00821ac0);
  auVar3 = vpandn_avx(auVar4,auVar3);
  ...
  if (uVar11 == 0) {
    ...
    return (ulong)(uint)(*(int *)(_nl_C_LC_CTYPE_tolower +
                                 (ulong)(byte)(*param_1)[lVar13] * 4 + 0x200) -
                        *(int *)(_nl_C_LC_CTYPE_tolower +
                                (ulong)(byte)(*param_2)[lVar13] * 4 + 0x200));
  }
...
LAB_007336d0:
  ...
  return (ulong)(uint)(*(int *)(_nl_C_LC_CTYPE_tolower + (ulong)(byte)(*param_1)[uVar9] * 4 + 0x200)
                      - *(int *)(_nl_C_LC_CTYPE_tolower + (ulong)(byte)(*param_2)[uVar9] * 4 + 0x200
                                ));
}
