...

{
  ...
  if ((param_4 != 0) || ((param_5 & 2) == 0)) {
    ERR_new();
    iVar1 = 0;
    ERR_set_debug("../providers/implementations/encode_decode/encode_key2any.c",0x56a,
...
LAB_0045d070:
    ...
    if (iVar1 != 0) {
      iVar1 = 0;
      a_00 = (X509_PUBKEY *)key_to_pubkey(param_3,0x198,local_38,local_3c,ec_spki_pub_to_der);
