...
undefined1 * __mempcpy_sse2_unaligned_erms(undefined8 *param_1,undefined8 *param_2,ulong param_3)

{
  ...
  if (__x86_rep_movsb_threshold < param_3) {
    ...
    if (uVar36 < param_3) goto LAB_00742d10;
    ...
    if (param_3 < __x86_rep_movsb_threshold) goto LAB_00742c8c;
  }
  else {
    if (param_3 < 0x81) {
      uVar5 = param_2[2];
...
LAB_00742d15:
    ...
    if (param_3 <= __x86_shared_non_temporal_threshold) {
LAB_00742c8c:
  ...
  if (param_3 <= -uVar36) {
    ...
    *param_1 = uVar3;
    ...
    if (((~(uint)-uVar36 & 0xf80) != 0) && (param_3 >> 4 < __x86_shared_non_temporal_threshold)) {
