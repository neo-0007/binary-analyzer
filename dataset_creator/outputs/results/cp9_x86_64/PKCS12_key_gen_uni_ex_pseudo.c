  ...
  if (0 < param_7) {
    ...
    if (lVar2 != 0) {
      ...
      if (lVar3 != 0) {
        ...
        OSSL_PARAM_construct_octet_string(&local_178,"pass",param_1,(long)param_2);
        local_110 = local_178;
        uStack_108 = uStack_170;
        local_100 = local_168;
        uStack_f8 = uStack_160;
        local_f0 = local_158;
        OSSL_PARAM_construct_octet_string(&local_178,"salt",param_3,(long)param_4);
        local_e8 = local_178;
        uStack_e0 = uStack_170;
        local_d8 = local_168;
        uStack_d0 = uStack_160;
        local_c8 = local_158;
        OSSL_PARAM_construct_int(&local_178,"id",&local_13c);
        local_c0 = local_178;
        uStack_b8 = uStack_170;
        local_b0 = local_168;
        uStack_a8 = uStack_160;
        local_a0 = local_158;
        OSSL_PARAM_construct_int(&local_178,"iter",&local_140);
        local_78 = local_158;
        local_98 = local_178;
