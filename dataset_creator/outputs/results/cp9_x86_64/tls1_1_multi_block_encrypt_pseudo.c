...

{
  ...
  iVar14 = RAND_bytes((uchar *)local_568,param_5 << 6);
  local_818 = (undefined8 **)0x0;
  if (iVar14 < 1) goto LAB_0051d70f;
...
LAB_0051d69c:
    local_810 = &local_728;
    sha256_multi_block(local_160,local_810,param_5);
    puVar28 = local_568;
    for (lVar27 = 0x80; lVar27 != 0; lVar27 = lVar27 + -1) {
      *puVar28 = 0;
      puVar28 = puVar28 + (ulong)bVar37 * -2 + 1;
...
LAB_0051d325:
    ...
    while( true ) {
      *(uchar *)(puVar28 + 1) = uVar2;
      ...
      lVar27 = lVar27 + 1;
      *puVar20 = uVar24;
      *(uchar *)((long)puVar28 + 0xb) = (uchar)(uVar10 >> 8);
      puVar20[8] = uVar5;
      *(uchar *)((long)puVar28 + 0xc) = (uchar)uVar10;
      puVar20[0x10] = uVar6;
      *(uchar *)((long)puVar28 + 9) = uVar1;
      puVar20[0x18] = uVar7;
      *(uchar *)((long)puVar28 + 10) = uVar3;
      puVar20[0x20] = uVar8;
      puVar20[0x30] = uVar35;
      puVar20[0x38] = uVar29;
      ...
      *(undefined2 *)((long)puVar28 + 0x3d) = *(undefined2 *)(local_830 + 6);
      uVar4 = *(uchar *)((long)local_830 + 0x32);
      *plVar23 = (long)puVar28;
      *(uint *)(ppuVar30 + 1) = uVar10 - 0x33 >> 6;
      *(uchar *)((long)puVar28 + 0x3f) = uVar4;
...
LAB_0051d7a3:
      ...
      do {
        local_818 = &local_7a8;
        sha256_multi_block(local_160,local_810,param_5);
        aesni_multi_cbc_encrypt(&local_6a8,param_1,param_5);
        ppuVar19 = &local_6a8;
        plVar23 = local_810;
        if (param_5 != 0) {
          do {
    ...
    if (param_5 == 0) goto LAB_0051d69c;
    lVar27 = 0;
    puVar28 = local_568;
    uVar26 = 0;
    do {
      ...
      *(void **)((long)local_810 + lVar27) = pvVar18;
    ...
    do {
      ...
      memcpy(local_7f0[1],*local_7f0,(ulong)(uVar26 - (int)local_830));
      uVar35 = *puVar20;
  ...
  local_7f0 = &local_6a8;
  aesni_multi_cbc_encrypt(local_7f0,param_1,param_5);
