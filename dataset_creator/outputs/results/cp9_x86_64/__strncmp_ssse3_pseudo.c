...
/* WARNING: Removing unreachable block (ram,0x007158e2) */

ulong __strncmp_ssse3(byte *param_1,byte *param_2,ulong param_3)
  ...
  if (uVar53 != uVar51) {
    ...
    if (uVar53 <= uVar51) {
      ...
      pcVar59 = pcVar57;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00714269. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    uVar52 = (*(code *)(&DAT_00820bd0 + *(int *)(&DAT_00820bd0 + ((uVar52 + 0xf) - uVar54) * 4)))
