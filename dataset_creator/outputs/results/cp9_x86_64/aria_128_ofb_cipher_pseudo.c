...
undefined8 aria_128_ofb_cipher(long param_1,long param_2,long param_3,undefined *param_4)

{
  ...
  if ((undefined *)0x3fffffffffffffff < param_4) {
    ...
    do {
      ...
      puVar2 = PTR_ossl_aria_encrypt_0092dfa8;
  ...
  if (puVar5 != (undefined *)0x0) {
    ...
    uVar1 = EVP_CIPHER_CTX_get_cipher_data(param_1);
    CRYPTO_ofb128_encrypt
              (local_58,local_60,puVar5,uVar1,param_1 + 0x28,&local_44,
