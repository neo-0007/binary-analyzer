...

{
  ...
  if ((int)uVar4 != 7) {
    ...
    __assert_fail("ELFW(R_TYPE)(reloc->r_info) == ELF_MACHINE_JMP_SLOT","dl-runtime.c",0x3f,
                  "_dl_fixup");
  }
  if ((*(byte *)((long)local_10 + 5) & 3) == 0) {
    ...
    plVar8 = (long *)_dl_lookup_symbol_x(lVar3 + lVar9 + (ulong)*local_10,param_1,&local_10,
                                         param_1[0x73],lVar10,1);
    if (*(int *)(in_FS_OFFSET + 0x18) != 0) {
      LOCK();
    ...
    pcVar6 = (code *)0x0;
    if (local_10 == (uint *)0x0) goto LAB_007b0d9b;
