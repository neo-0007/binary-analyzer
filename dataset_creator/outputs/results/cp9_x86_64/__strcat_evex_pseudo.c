...
undefined1 (*) [32]
__strcat_evex(undefined1 (*param_1) [32],undefined1 (*param_2) [32],undefined8 param_3)
      ...
      if ((int)uVar2 == 0) {
        ...
        if ((int)uVar2 == 0) {
          ...
          if ((int)uVar2 == 0) {
            ...
            pauVar12 = pauVar10 + 4;
            uVar5 = CONCAT44(uVar9,(int)uVar2);
            if ((int)uVar2 != 0) goto LAB_00749cd0;
            uVar2 = vpcmpb_avx512vl(auVar15,pauVar10[6],0);
            uVar5 = CONCAT44(uVar9,(int)uVar2);
            if ((int)uVar2 != 0) goto LAB_00749ce0;
            uVar2 = vpcmpb_avx512vl(auVar15,pauVar10[7],0);
            uVar5 = CONCAT44(uVar9,(int)uVar2);
            if ((int)uVar2 != 0) goto LAB_00749cf0;
            uVar2 = vpcmpb_avx512vl(auVar15,pauVar10[8],0);
            uVar5 = CONCAT44(uVar9,(int)uVar2);
            if ((int)uVar2 != 0) goto LAB_00749d00;
...
LAB_00749cc0:
              ...
              if (((ulong)pauVar12 & 0x7f) != 0) {
                ...
                uVar5 = CONCAT44(uVar9,(int)uVar2);
                if ((int)uVar2 != 0) goto LAB_00749cc0;
                if (((ulong)pauVar12 & 0x7f) != 0) {
