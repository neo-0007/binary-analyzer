...
wistream * __thiscall std::wistream::_M_extract<long_double>(wistream *this,longdouble *param_1)

{
  ...
  if (local_25 != (sentry)0x0) {
    ...
    if (plVar1 == (long *)0x0) {
                    ...
                    /* try { // try from 006753b5 to 006753b9 has its CatchHandler @ 006753bf */
      __throw_bad_cast();
    }
                    /* try { // try from 00675370 to 00675372 has its CatchHandler @ 006753bf */
    (**(code **)(*plVar1 + 0x58))
