...
int __strcmp_avx2_rtm(undefined1 (*param_1) [32],undefined1 (*param_2) [32])
...
LAB_00745e55:
    ...
    if ((*param_1)[uVar13] == 0) {
      ...
      do {
        iVar10 = uVar9 - uVar11;
        if (iVar10 != 0) goto LAB_00745aa8;
        uVar9 = (int)uVar13 + 1;
        uVar13 = (ulong)uVar9;
        if (uVar9 == 0x80) goto LAB_00745b76;
        uVar9 = (uint)(byte)(*param_1)[uVar13];
        uVar11 = (uint)(byte)(*param_2)[uVar13];
