...
LAB_0077650c:
    ...
    param_1 = pcVar5 + 1;
    cVar4 = *param_1;
    if ((*(byte *)(*(long *)(in_FS_OFFSET + -0x40) + 1 + lVar9 * 2) & 0x20) == 0) goto LAB_00776508;
    *pcVar5 = '\0';
    param_1 = pcVar5;
    do {
      pcVar5 = param_1 + 1;
...
LAB_00776540:
  ...
  if ((uVar6 >> 0x20 == 0) && (*(int *)(param_2 + 2) = (int)uVar6, local_48 != param_1)) {
    if ((*(byte *)(*(long *)(in_FS_OFFSET + -0x40) + 1 + (long)*local_48 * 2) & 0x20) == 0) {
      if (*local_48 != '\0') goto LAB_00776662;
    }
    else {
      do {
        local_48 = local_48 + 1;
    ...
    if (pcVar1 < puVar10 + 2) {
      *param_5 = 0x22;
      ...
      if (*pcVar5 != '\0') {
        ...
        pcVar11 = pcVar5;
        if ((uVar3 & 0x2000) != 0) goto LAB_007765f0;
        goto LAB_00776625;
      }
      *puVar10 = 0;
...
LAB_00776625:
    while ((uVar3 & 0x2000) == 0) {
      ...
      pcVar5 = pcVar5 + 1;
      if (*pcVar2 == '\0') {
        if (pcVar5 <= pcVar11) goto joined_r0x007765cb;
        goto LAB_007766a0;
      }
      uVar3 = *(ushort *)(lVar9 + (long)*pcVar2 * 2);
    }
