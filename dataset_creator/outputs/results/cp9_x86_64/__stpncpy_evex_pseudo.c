...
undefined1 (*) [32]
__stpncpy_evex(undefined1 (*param_1) [32],undefined1 (*param_2) [32],ulong param_3)
...
LAB_0079f12c:
      ...
      uVar8 = (ulong)uVar6;
      if ((uint)param_3 <= uVar6) goto LAB_0079f5f6;
    }
    else {
      if ((int)uVar4 == 0) {
...
LAB_0079f0e5:
    ...
    if ((int)uVar4 != 0) goto LAB_0079f3f0;
    auVar20 = vmovdqu64_avx512vl(auVar20);
    param_1[2] = auVar20;
    ...
    bVar16 = param_3 < 0x20;
    param_3 = uVar13 - 0x80;
    if (bVar16 || param_3 == 0) goto LAB_0079f0e0;
    if ((int)uVar4 != 0) {
LAB_0079f070:
...
LAB_0079f060:
    ...
    if ((int)uVar4 == 0) {
      ...
      if (bVar16 || param_3 == 0) goto LAB_0079f0e0;
      if ((int)uVar4 != 0) goto LAB_0079f070;
      auVar20 = vmovdqu64_avx512vl(auVar21);
      param_1[7] = auVar20;
...
LAB_0079f500:
      if (lVar15 != 0) {
        ...
        lVar15 = CONCAT44(uVar10,(int)uVar4);
        param_3 = uVar14 + 0x60;
        if (param_3 == 0 || SCARRY8(uVar14,0x60) != (long)param_3 < 0) goto LAB_0079f0e0;
        if ((int)uVar4 != 0) goto LAB_0079f060;
        uVar4 = vpcmpb_avx512vl(auVar26,auVar21,0);
        lVar15 = CONCAT44(uVar10,(int)uVar4);
        auVar20 = vmovdqu64_avx512vl(auVar20);
        *param_1 = auVar20;
...
LAB_0079ee04:
  ...
  *pauVar12 = auVar20;
  ...
  pauVar5 = pauVar11;
  pauVar12 = param_1;
  if (bVar16 || uVar14 == 0) goto LAB_0079f500;
  goto joined_r0x0079ee02;
}
