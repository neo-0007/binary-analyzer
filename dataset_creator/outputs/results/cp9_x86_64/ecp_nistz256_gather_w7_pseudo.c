...

{
  ...
  if ((_DAT_0093e5a0 & 0x20) == 0) {
    auVar16 = (undefined1  [16])0x0;
    auVar18 = (undefined1  [16])0x0;
    auVar20 = (undefined1  [16])0x0;
    auVar21 = (undefined1  [16])0x0;
    lVar14 = 0x40;
    uVar22 = _DAT_005eb040;
    uVar23 = _UNK_005eb044;
    uVar24 = _UNK_005eb048;
    uVar25 = _UNK_005eb04c;
    do {
      puVar11 = *param_2;
      puVar12 = *param_2;
      ...
      lVar14 = lVar14 + -1;
      uVar22 = uVar22 + _DAT_005eb040;
      uVar23 = uVar23 + _UNK_005eb044;
      uVar24 = uVar24 + _UNK_005eb048;
      uVar25 = uVar25 + _UNK_005eb04c;
    } while (lVar14 != 0);
  ...
  auVar1._4_4_ = _UNK_005eb044;
  auVar1._0_4_ = _DAT_005eb040;
  auVar1._8_4_ = _UNK_005eb048;
  auVar1._12_4_ = _UNK_005eb04c;
  auVar1._16_16_ = _UNK_005eb050;
  auVar10 = vpermd_avx2((undefined1  [32])0x0,ZEXT432(param_3));
  lVar14 = 0x15;
  auVar2 = _DAT_005eb060;
  auVar3 = _DAT_005eb080;
  do {
    pauVar15 = param_2;
    auVar7 = vpcmpeqd_avx2(auVar1,auVar10);
    auVar8 = vpcmpeqd_avx2(auVar2,auVar10);
    auVar9 = vpcmpeqd_avx2(auVar3,auVar10);
    auVar1 = vpaddd_avx2(auVar1,_DAT_005eb080);
    auVar2 = vpaddd_avx2(auVar2,_DAT_005eb080);
    auVar3 = vpaddd_avx2(auVar3,_DAT_005eb080);
