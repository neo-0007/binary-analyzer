...
undefined8 * __memcpy_ssse3(undefined8 *param_1,undefined8 *param_2,long param_3)

{
  ...
  if ((char)param_2 <= (char)param_1) {
    ...
    if (__x86_shared_cache_size_half < uVar23) {
      ...
      *(undefined8 *)(uVar28 - 8) = uVar7;
      ...
      puVar24 = (undefined8 *)
                (*(code *)((long)&switchD_007188f1::switchdataD_00820c50 +
                          (long)(int)(&switchD_007188f1::switchdataD_00820c50)[uVar19]))
                          (lVar26,lVar29,
                           (code *)((long)&switchD_007188f1::switchdataD_00820c50 +
                                   (long)(int)(&switchD_007188f1::switchdataD_00820c50)[uVar19]));
      return puVar24;
    ...
    if (uVar30 != 0) {
      ...
      case 1:
        ...
        if (__x86_data_cache_size_half <= uVar23) {
        ...
        puVar24 = (undefined8 *)
                  (*UNRECOVERED_JUMPTABLE_00)
                            (uVar28,uVar19,uVar23 - 0x40,__x86_data_cache_size_half,puVar24,
                             UNRECOVERED_JUMPTABLE_00);
        return puVar24;
      case 2:
        UNRECOVERED_JUMPTABLE_00 = (code *)((long)&UINT_00820df8 + lVar29);
    ...
    *puVar24 = uVar4;
    ...
    if (uVar30 < __x86_data_cache_size_half) {
      ...
      puVar24 = (undefined8 *)
                (*(code *)((long)&switchD_007188f1::switchdataD_00820c50 +
                          (long)(int)(&switchD_007188f1::switchdataD_00820c50)[uVar23]))
                          (lVar26,lVar29,
                           (code *)((long)&switchD_007188f1::switchdataD_00820c50 +
                                   (long)(int)(&switchD_007188f1::switchdataD_00820c50)[uVar23]));
      return puVar24;
  ...
  if (__x86_shared_cache_size_half < uVar19) {
    uVar6 = *param_2;
    uVar7 = param_2[1];
    *param_1 = uVar4;
    param_1[1] = uVar5;
  ...
  if (uVar28 != 0) {
    ...
    case 1:
      ...
      if (__x86_data_cache_size_half <= uVar19) {
    ...
    case 2:
      ...
      puVar24 = (undefined8 *)
                (*UNRECOVERED_JUMPTABLE_00)
                          (puVar24,param_2,uVar19 - 0x40,__x86_data_cache_size_half,param_1,
                           UNRECOVERED_JUMPTABLE_00);
      return puVar24;
    case 3:
      UNRECOVERED_JUMPTABLE_00 = (code *)((long)&UINT_00820db8 + lVar29);
