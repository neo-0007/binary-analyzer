...
void std::__facet_shims::__moneypunct_fill_cache<char,false>(long *param_1,long param_2)

{
  ...
  *(undefined8 *)(param_2 + 0x48) = 0;
  ...
  uVar2 = local_60;
                    /* try { // try from 0064e566 to 0064e57d has its CatchHandler @ 0064e6d0 */
  ...
  *(char **)(param_2 + 0x10) = pcVar5;
  ...
  uVar2 = local_60;
                    /* try { // try from 0064e5b5 to 0064e5cc has its CatchHandler @ 0064e6ca */
  pcVar5 = (char *)operator_new__(local_60 + 1);
  __cxx11::string::copy((string *)&local_68,pcVar5,uVar2,0);
  pcVar5[uVar2] = '\0';
  ...
  *(ulong *)(param_2 + 0x30) = uVar2;
  ...
  uVar2 = local_60;
                    /* try { // try from 0064e5ff to 0064e616 has its CatchHandler @ 0064e6c4 */
  pcVar5 = (char *)operator_new__(local_60 + 1);
  __cxx11::string::copy((string *)&local_68,pcVar5,uVar2,0);
  pcVar5[uVar2] = '\0';
  ...
  *(ulong *)(param_2 + 0x40) = uVar2;
  ...
  (**(code **)(*param_1 + 0x38))(&local_68,param_1);
                    /* try { // try from 0064e649 to 0064e660 has its CatchHandler @ 0064e6bb */
  pcVar5 = (char *)operator_new__(local_60 + 1);
