...
LAB_006fee76:
    if (param_3 == 0) {
      lVar6 = param_2;
      if (param_2 < 0) goto LAB_006ff0c0;
    }
    else {
      lVar6 = lVar8;
      if (param_3 == 1) {
    ...
    if (lVar8 < lVar6) {
      iVar4 = enlarge_userbuf(param_1,lVar6,1);
      if (iVar4 != 0) {
        return -1;
      }
      lVar7 = *(long *)(param_1 + 6);
    ...
    *(ulong *)(param_1 + 4) = uVar5;
    ...
    if ((uVar2 < uVar5) || ((uVar1 & 0x800) != 0)) goto LAB_006feee8;
    lVar7 = *(long *)(param_1 + 6);
LAB_006fef2e:
    lVar6 = -1;
    if (uVar5 < *(ulong *)(param_1 + 4)) {
    ...
    lVar8 = uVar5 - lVar7;
    if ((param_4 & 1) != 0) goto LAB_006fee76;
  }
  if ((param_4 & 2) == 0) {
    return lVar6;
  }
  ...
  if ((lVar6 <= param_2) && (!bVar3)) {
    lVar7 = lVar7 + param_2;
    if ((lVar8 < lVar7) && (iVar4 = enlarge_userbuf(param_1,lVar7,0), iVar4 != 0)) {
      return -1;
    }
