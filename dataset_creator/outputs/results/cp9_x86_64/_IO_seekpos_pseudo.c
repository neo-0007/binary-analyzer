...
__off64_t _IO_seekpos(_IO_FILE *param_1,__off64_t param_2,int param_3)

{
  ...
  if ((param_1->_flags & 0x8000U) == 0) {
    ...
    if (*(long *)(piVar4 + 2) != lVar2) {
      ...
      UNLOCK();
      if (iVar1 != 0) {
                    /* try { // try from 00798658 to 0079865c has its CatchHandler @ 00798662 */
  ...
  if (0x827 < lVar2 - 0x932180U) {
    _IO_vtable_check();
                    ...
                    /* try { // try from 007985d7 to 00798634 has its CatchHandler @ 00798662 */
  _Var3 = (**(code **)(lVar2 + 0x48))(param_1,param_2,0,param_3);
  if ((param_1->_flags & 0x8000U) == 0) {
    piVar4 = (int *)param_1->_lock;
    iVar1 = piVar4[1];
    piVar4[1] = iVar1 + -1;
