...

{
  ...
  if (0x3fffffffffffffff < param_4) {
    do {
      ...
      SEED_ofb128_encrypt(param_3 + lVar3,param_2 + lVar1,0x4000000000000000,pSVar2,
  ...
  if (uVar4 != 0) {
    local_44 = EVP_CIPHER_CTX_get_num(param_1);
    pSVar2 = (SEED_KEY_SCHEDULE *)EVP_CIPHER_CTX_get_cipher_data(param_1);
    SEED_ofb128_encrypt(local_58,local_60,uVar4,pSVar2,(uchar *)(param_1 + 0x28),&local_44);
    EVP_CIPHER_CTX_set_num(param_1,local_44);
  }
