...

{
  ...
  uVar10 = (ulong)(CARRY8(uVar5,DAT_005eb008) ||
                  CARRY8(uVar5 + DAT_005eb008,(ulong)CARRY8(uVar4,DAT_005eb000)));
  bVar12 = CARRY8(uVar7,DAT_005eb010);
  uVar2 = uVar7 + DAT_005eb010;
  lVar1 = uVar9 + DAT_005eb018;
  uVar6 = uVar5 + DAT_005eb008 + (ulong)CARRY8(uVar4,DAT_005eb000);
  uVar8 = uVar4 + DAT_005eb000;
  if (bVar11 && bVar3) {
    uVar6 = uVar5;
    uVar8 = uVar4;
  }
