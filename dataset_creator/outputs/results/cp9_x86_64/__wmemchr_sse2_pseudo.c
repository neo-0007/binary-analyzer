...
long __wmemchr_sse2(int *param_1,int param_2,ulong param_3)

{
  ...
  if ((uVar5 & 0x3f) < 0x31) {
    ...
    uVar8 = uVar7 - 0x10;
    piVar9 = param_1;
    if (0xf < uVar7 && uVar8 != 0) goto LAB_00752690;
  }
  else {
    uVar5 = uVar5 & 0xf;
...
LAB_00752890:
      ...
      if (((ulong)param_1 & 0x3f) != 0) {
        bVar10 = uVar8 < 0x10;
        uVar8 = uVar8 - 0x10;
        if (bVar10 || uVar8 == 0) goto LAB_00752800;
