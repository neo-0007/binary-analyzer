...

{
  ...
  uVar39 = (ulong)(uVar41 < DAT_005eb008 || uVar41 - DAT_005eb008 < (ulong)(lVar47 != -1));
  uVar37 = (ulong)(uVar40 < uVar39);
  uVar38 = uVar43 - DAT_005eb018;
  bVar1 = (CARRY8(uVar51,uVar42) || CARRY8(uVar49,uVar36)) <
          (uVar43 < DAT_005eb018 || uVar38 < uVar37);
  uVar36 = (uVar41 - DAT_005eb008) - (ulong)(lVar47 != -1);
  lVar35 = lVar47 + 1;
  if (bVar1) {
    uVar36 = uVar41;
    lVar35 = lVar47;
