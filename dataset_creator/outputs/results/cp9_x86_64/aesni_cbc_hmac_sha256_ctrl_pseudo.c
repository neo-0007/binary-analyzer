  ...
  case 0x17:
    ...
    if (-1 < param_3) {
      ...
      if (param_3 < 0x41) {
        ...
        SHA256_Init(c);
        sha256_update(c,param_4,(long)param_3);
        SHA256_Final(local_88,c);
      }
      do {
        *pbVar8 = *pbVar8 ^ 0x36;
        pbVar8 = pbVar8 + 1;
      ...
      SHA256_Init(c);
      sha256_update(c,local_88,0x40);
      do {
        *pbVar11 = *pbVar11 ^ 0x6a;
        pbVar11 = pbVar11 + 1;
      } while (pbVar11 != local_48);
      SHA256_Init((SHA256_CTX *)(lVar6 + 0x164));
      sha256_update((SHA256_CTX *)(lVar6 + 0x164),local_88,0x40);
    ...
    if (0x1f < param_3) {
      ...
      if ((iVar4 != 0) &&
        ...
        if (uVar9 == 0) {
          ...
          if (uVar9 < 0x1000) goto LAB_0051ded0;
          if (uVar9 < 0x2000) {
            iVar4 = 4;
            bVar12 = 2;
          }
          else {
            iVar4 = (-(uint)((_DAT_0093e5a0 & 0x20) == 0) & 0xfffffffc) + 8;
            bVar12 = 3 - ((_DAT_0093e5a0 & 0x20) == 0);
          }
        }
        *(undefined8 *)(lVar6 + 0x1d4) = *(undefined8 *)(lVar6 + 0xf4);
        *(undefined8 *)(lVar6 + 0x1dc) = *(undefined8 *)(lVar6 + 0xfc);
        ...
        *(undefined8 *)(lVar6 + 0x234) = *(undefined8 *)(lVar6 + 0x154);
        *(undefined8 *)(lVar6 + 0x23c) = *(undefined8 *)(lVar6 + 0x15c);
        sha256_update(lVar6 + 0x1d4,lVar2,0xd);
