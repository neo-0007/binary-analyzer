...
bool ec_to_EC_pem_encode(undefined8 *param_1,undefined8 param_2,void *param_3,long param_4,
                        byte param_5,long param_6,undefined8 param_7)
...
LAB_0045e48f:
    ERR_new();
    ERR_set_debug("../providers/implementations/encode_decode/encode_key2any.c",0x5a4,
                  "ec_to_EC_pem_encode");
  ...
  if ((param_5 & 1) == 0) {
    if ((param_5 & 0x84) == 0) goto LAB_0045e48f;
    if (param_3 == (void *)0x0) goto LAB_0045e5b0;
    bp = (BIO *)ossl_bio_new_from_core_bio(*param_1);
    if (bp == (BIO *)0x0) goto LAB_0045e520;
    u = (undefined8 *)0x0;
