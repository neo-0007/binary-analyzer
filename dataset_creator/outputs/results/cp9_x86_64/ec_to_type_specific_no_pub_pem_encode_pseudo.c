...
bool ec_to_type_specific_no_pub_pem_encode
...
LAB_0045e62f:
    ERR_new();
    ERR_set_debug("../providers/implementations/encode_decode/encode_key2any.c",0x535,
  ...
  if ((param_5 & 1) == 0) {
    if ((param_5 & 0x84) == 0) goto LAB_0045e62f;
    if (param_3 == (void *)0x0) goto LAB_0045e750;
    bp = (BIO *)ossl_bio_new_from_core_bio(*param_1);
    if (bp == (BIO *)0x0) goto LAB_0045e6c0;
    u = (undefined8 *)0x0;
