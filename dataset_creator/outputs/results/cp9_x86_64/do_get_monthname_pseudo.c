...

{
  ...
  local_108 = *(undefined8 *)(lVar1 + 0x128);
  local_100 = *(undefined8 *)(lVar1 + 0x130);
  local_f8 = *(undefined8 *)(lVar1 + 0x138);
  local_f0 = *(undefined8 *)(lVar1 + 0x140);
  local_e8 = *(undefined8 *)(lVar1 + 0x148);
  local_e0 = *(undefined8 *)(lVar1 + 0x150);
  local_d8 = *(undefined8 *)(lVar1 + 0x158);
  local_d0 = *(undefined8 *)(lVar1 + 0x160);
  local_c8 = *(undefined8 *)(lVar1 + 0x168);
  local_c0 = *(undefined8 *)(lVar1 + 0x170);
  local_b8 = *(undefined8 *)(lVar1 + 0x178);
  local_b0 = *(undefined8 *)(lVar1 + 0x180);
  ...
  auVar8 = _M_extract_wday_or_month
                     (param_1,param_2,param_3,param_4,param_5,&local_110,&local_108,0xc,param_6,
                      &local_10c);
  plVar5 = auVar8._0_8_;
  if (local_10c == 0) {
    *(undefined4 *)(param_8 + 0x10) = local_110;
  }
  else {
    *param_7 = *param_7 | 4;
  }
