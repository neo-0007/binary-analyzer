...
LAB_006c4548:
            ...
            if (bVar3 != 0x20) {
              if (bVar3 < 0x21) {
                ...
                if (bVar3 != 0x50) {
                    /* WARNING: Subroutine does not return */
                  classify_object_over_fdes_cold();
                }
              }
              goto LAB_006c4548;
            }
...
LAB_006c44d8:
        ...
        read_encoded_value_with_base(uVar4 & 0xff,uVar8,param_2 + 2,local_40);
        if ((byte)uVar4 == 0xff) {
          uVar6 = 0;
        }
        else {
