...
void batch_mul(ulong *param_1,ulong *param_2,ulong *param_3,long param_4,uint param_5,long param_6,
              undefined8 param_7,long param_8,ulong *param_9)
...
LAB_004fbf4e:
      ...
      do {
        ...
        ossl_ec_GFp_nistp_recode_scalar_bits(&local_24a,&local_249,uVar7);
        puVar9 = local_168;
      ...
      goto joined_r0x004fc35c;
    }
    if (iVar1 != -1) goto code_r0x004fbbe1;
    goto LAB_004fbdbc;
  }
...
LAB_004fbdbc:
  ...
  point_add(local_248,&uStack_200,&local_1b8,local_248,&uStack_200,&local_1b8,1,local_168,
            local_168 + 9,local_168 + 0x12);
  if ((param_5 != 0) && (iVar16 * -0x33333333 + 0x19999999U < 0x33333333)) goto LAB_004fbf4b;
  if (iVar1 == -1) goto LAB_004fbdbc;
LAB_004fbd21:
  point_double(local_248,&uStack_200,&local_1b8,local_248);
  bVar3 = false;
  iVar16 = iVar1;
  goto LAB_004fba66;
code_r0x004fbbe1:
  iVar16 = iVar1;
  if (bVar3) goto LAB_004fba66;
  goto LAB_004fbd21;
}
