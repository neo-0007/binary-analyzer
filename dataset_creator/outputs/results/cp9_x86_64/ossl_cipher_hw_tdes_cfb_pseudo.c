...

{
  ...
  if (0x3fffffffffffffff < param_4) {
    do {
      ...
      DES_ede3_cfb64_encrypt
                (param_3 + lVar2,param_2 + lVar1,0x4000000000000000,
  ...
  if (uVar3 != 0) {
    DES_ede3_cfb64_encrypt
              (local_58,local_60,uVar3,(DES_key_schedule *)(param_1 + 0xc0),
               (DES_key_schedule *)(param_1 + 0x140),(DES_key_schedule *)(param_1 + 0x1c0),
               (DES_cblock *)(param_1 + 0x94),&local_44,*(byte *)(param_1 + 0x3c) >> 1 & 1);
  }
