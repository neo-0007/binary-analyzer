...

{
  ...
  lVar25 = *plVar2;
  if (lVar25 == 0) {
                    /* try { // try from 00655625 to 00655629 has its CatchHandler @ 006559f0 */
    ...
    *(undefined8 *)(this + 0x48) = 0;
    this[0x148] = (__numpunct_cache<wchar_t>)0x0;
                    /* try { // try from 00655692 to 00655696 has its CatchHandler @ 006559e7 */
  ...
  if (bVar23 == bVar18) {
    ...
    bVar22 = false;
LAB_00654e6a:
    if (uVar20 == 0x10) goto LAB_00654d68;
LAB_00654e74:
...
LAB_00654d90:
      ...
      do {
        ...
        if (*(wchar_t *)(lVar25 + 0xf0) == __c) {
          ...
          iVar24 = 0;
          uVar20 = 8;
          if (piVar11 <= piVar13) goto LAB_006550a8;
LAB_00654e14:
          piVar13 = piVar13 + 1;
          param_2[2] = (long)piVar13;
          if (piVar13 < piVar11) goto LAB_00654e25;
LAB_006550d0:
...
LAB_00654e03:
          ...
          piVar11 = (int *)param_2[3];
          bVar22 = bVar23;
          if (piVar13 < piVar11) goto LAB_00654e14;
LAB_006550a8:
          (**(code **)(*param_2 + 0x50))(param_2);
          piVar13 = (int *)param_2[2];
          if ((int *)param_2[3] <= piVar13) goto LAB_006550d0;
LAB_00654e25:
          iVar8 = *piVar13;
        }
        if (iVar8 == -1) {
    ...
    bVar22 = false;
    local_c8 = L'\xffffffff';
    if (uVar20 != 0x10) goto LAB_00654e74;
LAB_00654d68:
    local_98 = 0x16;
    uVar16 = 0x16;
  }
...
LAB_00654f1b:
      if (uVar16 < 0xb) {
        if ((__c < L'0') || ((int)local_98 + L'0' <= __c)) goto LAB_00655350;
        uVar20 = __c + L'\xffffffd0';
LAB_00654f3c:
        if (uVar10 < uVar21) goto LAB_00654f47;
LAB_00655170:
        ...
        if (piVar13 <= piVar11) goto LAB_006551a6;
LAB_00654f5d:
        piVar11 = piVar11 + 1;
...
LAB_00654f65:
        ...
        if ((iVar8 == -1) == bVar26) goto code_r0x00654fa6;
        if (param_2 == (long *)0x0) {
          __c = L'\xffffffff';
        }
        else {
          if ((wchar_t *)param_2[2] < (wchar_t *)param_2[3]) {
            __c = *(wchar_t *)param_2[2];
                    ...
                    /* try { // try from 00655808 to 0065581a has its CatchHandler @ 006559de */
            __c = (**(code **)(*param_2 + 0x48))(param_2);
          }
          if (__c == L'\xffffffff') {
            param_2 = (long *)0x0;
      ...
      uVar20 = __c + L'\xffffffd0';
      if (uVar20 < 10) goto LAB_00654f3c;
      if ((uint)(__c + L'\xffffff9f') < 6) {
        uVar20 = __c + L'\xffffffa9';
        if (uVar21 <= uVar10) goto LAB_00655170;
LAB_00654f47:
        piVar11 = (int *)param_2[2];
        piVar13 = (int *)param_2[3];
        bVar3 = 1;
        if (piVar11 < piVar13) goto LAB_00654f5d;
LAB_006551a6:
                    /* try { // try from 006551ac to 00655566 has its CatchHandler @ 006559de */
        (**(code **)(*param_2 + 0x50))(param_2);
        piVar11 = (int *)param_2[2];
        piVar13 = (int *)param_2[3];
        goto LAB_00654f65;
    ...
    if (bVar23 == false) {
      ...
      do {
        ...
        if ((bVar5 == 0) || (*(wchar_t *)(lVar25 + 0x4c) != __c)) {
          ...
          piVar13 = (int *)param_2[2];
          bVar3 = bVar4;
          if (piVar11 <= piVar13) goto LAB_00655486;
LAB_0065540e:
          piVar13 = piVar13 + 1;
          param_2[2] = (long)piVar13;
        }
          ...
          if (uVar14 < uVar1) {
                    /* try { // try from 00655762 to 006557e6 has its CatchHandler @ 006559de */
...
LAB_00655401:
          piVar13 = (int *)param_2[2];
          piVar11 = (int *)param_2[3];
          if (piVar13 < piVar11) goto LAB_0065540e;
LAB_00655486:
          (**(code **)(*param_2 + 0x50))(param_2);
          piVar13 = (int *)param_2[2];
          piVar11 = (int *)param_2[3];
        ...
        if (piVar13 < piVar11) {
          iVar8 = *piVar13;
                    ...
                    /* try { // try from 006558b0 to 006558c2 has its CatchHandler @ 006559de */
          iVar8 = (**(code **)(*param_2 + 0x48))(param_2);
        }
        if (iVar8 == -1) {
          param_2 = (long *)0x0;
        ...
        if (bVar26 == (iVar8 == -1)) goto code_r0x00655453;
        if (param_2 == (long *)0x0) {
          __c = L'\xffffffff';
        }
        else {
...
LAB_006552ad:
    ...
    if (((iVar24 != 0) || (bVar22)) || (local_60 != 0)) goto LAB_006552ad;
  }
  *param_8 = 0;
  *param_7 = 4;
LAB_00654ff8:
