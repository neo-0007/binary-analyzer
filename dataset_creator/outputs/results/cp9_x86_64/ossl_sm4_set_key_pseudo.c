...
undefined8 ossl_sm4_set_key(uint *param_1,long param_2)

{
  ...
  while( true ) {
    ...
    uVar4 = (uint)(byte)(&SM4_S)[uVar3 >> 0x18] << 0x18 | (uint)(byte)(&SM4_S)[uVar3 & 0xff] |
            (uint)(byte)(&SM4_S)[uVar3 >> 0x10 & 0xff] << 0x10;
    uVar1 = uVar4 | (uint)(byte)(&SM4_S)[(int)(uVar3 >> 8 & 0xff)] << 8;
    ...
    *(uint *)(param_2 + -4 + lVar2 * 4) = uVar6;
    ...
    uVar3 = *(uint *)(&DAT_007fef3c + lVar2 * 4);
  }
