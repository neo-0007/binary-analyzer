...

{
  ...
  if ((_DAT_0093e5a0 & 0x80100) != 0x80100) {
    ...
    do {
      ...
      uVar103 = (ulong)(uVar107 < DAT_005eb0c8 ||
                       uVar107 - DAT_005eb0c8 < (ulong)(uVar110 < DAT_005eb0c0));
      uVar104 = (ulong)(uVar106 < DAT_005eb0d0 || uVar106 - DAT_005eb0d0 < uVar103);
      if ((uVar111 < DAT_005eb0d8 || uVar111 - DAT_005eb0d8 < uVar104) <=
          (CARRY8(uVar109,uVar116) || CARRY8(uVar114,uVar108))) {
        uVar111 = (uVar111 - DAT_005eb0d8) - uVar104;
        uVar107 = (uVar107 - DAT_005eb0c8) - (ulong)(uVar110 < DAT_005eb0c0);
        uVar106 = (uVar106 - DAT_005eb0d0) - uVar103;
        uVar110 = uVar110 - DAT_005eb0c0;
      }
      param_3 = param_3 + -1;
    } while (param_3 != 0);
    *param_1 = uVar110;
  ...
  do {
    ...
    uVar110 = uVar108 * DAT_005eb0e0;
    auVar53._8_8_ = 0;
    auVar53._0_8_ = uVar110;
    auVar79._8_8_ = 0;
    auVar79._0_8_ = DAT_005eb0c0;
    ...
    Var37 = (unkuint9)(ulong)Var40 + (unkuint9)0 +
            (unkuint9)((char)((unkuint9)Var39 >> 0x40) != '\0');
    uVar110 = uVar107 * DAT_005eb0e0;
    auVar57._8_8_ = 0;
    auVar57._0_8_ = uVar110;
    auVar83._8_8_ = 0;
    auVar83._0_8_ = DAT_005eb0c0;
    ...
    uVar114 = (ulong)(uVar107 < DAT_005eb0c8 ||
                     uVar107 - DAT_005eb0c8 < (ulong)(uVar110 < DAT_005eb0c0));
    uVar103 = (ulong)(uVar106 < DAT_005eb0d0 || uVar106 - DAT_005eb0d0 < uVar114);
    uVar104 = (ulong)(uVar111 < DAT_005eb0d8 || uVar111 - DAT_005eb0d8 < uVar103);
    if (uVar104 <= uVar108) {
      uVar111 = (uVar111 - DAT_005eb0d8) - uVar103;
      uVar107 = (uVar107 - DAT_005eb0c8) - (ulong)(uVar110 < DAT_005eb0c0);
      uVar110 = uVar110 - DAT_005eb0c0;
      uVar106 = (uVar106 - DAT_005eb0d0) - uVar114;
    }
    param_3 = param_3 + -1;
  } while (param_3 != 0);
  *param_1 = uVar110;
