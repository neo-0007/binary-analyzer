...

{
  ...
  if (local_48[0] != (sentry)0x0) {
    ...
    if (plVar1 == (long *)0x0) {
                    ...
                    /* try { // try from 0068e2ae to 0068e2b7 has its CatchHandler @ 0068e2b8 */
      __throw_bad_cast();
    }
    if (pwVar8[0xe4] == (wostream)0x0) {
      ...
      if (plVar3 == (long *)0x0) {
        ...
        __throw_bad_cast();
                    ...
                    /* try { // try from 0068e264 to 0068e266 has its CatchHandler @ 0068e2b8 */
      ...
      *(undefined4 *)(pwVar8 + 0xe0) = uVar6;
      ...
      uVar6 = *(undefined4 *)(pwVar8 + 0xe0);
                    ...
                    /* try { // try from 0068e1d8 to 0068e1da has its CatchHandler @ 0068e2b8 */
    (**(code **)(*plVar1 + 0x10))
              (plVar1,*(long *)(pwVar8 + 0xe8),*(long *)(pwVar8 + 0xe8) == 0,pwVar8,uVar6,param_1);
    if (extraout_DL != '\0') {
                    /* try { // try from 0068e1f0 to 0068e1f4 has its CatchHandler @ 0068e2c4 */
