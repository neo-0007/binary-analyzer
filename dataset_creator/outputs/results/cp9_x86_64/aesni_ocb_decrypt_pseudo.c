...
undefined8
aesni_ocb_decrypt(undefined8 param_1,undefined1 (*param_2) [16],undefined1 (*param_3) [16],
                 ulong param_4,long param_5,ulong param_6,undefined1 (*param_7) [16],
...

{
  ...
  if ((param_6 & 1) == 0) {
    ...
    *param_3 = auVar2;
    ...
    auVar9 = auVar8;
    if (param_4 == 0) goto LAB_00495b3d;
  }
  lVar1 = 0;
  if (param_6 + 1 != 0) {
