...

{
  ...
  if ((param_4 == 0) && ((param_5 & 2) != 0)) {
    if (param_3 != 0) {
      ...
      if ((a == (BIO *)0x0) ||
        ...
        uVar2 = 0;
        a_00 = (X509_PUBKEY *)key_to_pubkey(param_3,0x440,0,0xffffffff,ecx_spki_pub_to_der);
  ...
  ERR_new();
  ERR_set_debug("../providers/implementations/encode_decode/encode_key2any.c",0x57e,
                "ed448_to_SubjectPublicKeyInfo_der_encode");
