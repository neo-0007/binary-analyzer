...
ossl_rsa_padding_check_PKCS1_type_2_TLS
          (undefined8 param_1,long param_2,ulong param_3,byte *param_4,ulong param_5,uint param_6,
          uint param_7)

{
  ...
  if ((param_5 < 0x3b) || (param_3 < 0x30)) {
    ERR_new();
    ERR_set_debug("../crypto/rsa/rsa_pk1.c",0x234,"ossl_rsa_padding_check_PKCS1_type_2_TLS");
    ERR_set_error(4,0x9f,0);
    uVar4 = 0xffffffff;
  }
  else {
    iVar2 = RAND_priv_bytes_ex(param_1,local_78,0x30,0);
    if (iVar2 < 1) {
      ERR_new();
      ERR_set_debug("../crypto/rsa/rsa_pk1.c",0x23e,"ossl_rsa_padding_check_PKCS1_type_2_TLS");
