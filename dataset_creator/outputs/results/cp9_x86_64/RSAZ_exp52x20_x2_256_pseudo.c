...

{
  ...
  local_29c0[0] = 1;
  local_2920[0] = 1;
  ossl_rsaz_amm52x20_x2_256(local_2880,local_29c0,param_5,param_4,param_6);
  ossl_rsaz_amm52x20_x2_256(local_2740,param_2,param_5,param_4,param_6);
  puVar10 = local_2740;
  puVar12 = local_2600;
  do {
    puVar11 = puVar10 + 0x140;
    ossl_rsaz_amm52x20_x2_256(puVar12,puVar10,puVar10,param_4,param_6);
    ossl_rsaz_amm52x20_x2_256(puVar12 + 0x140,puVar12,local_2740,param_4,param_6);
    puVar10 = puVar11;
  ...
  local_2b38 = 0;
  uStack_2b40 = uVar2;
  ossl_extract_multiplier_2x20_win5(local_2b00,local_2880,uStack_2bc8 >> 0x3c,0);
  ossl_extract_multiplier_2x20_win5(local_2a60,local_2880,uVar2 >> 0x3c,1);
  uVar9 = 0x3f7;
  do {
    iVar8 = (int)uVar9 >> 6;
    bVar4 = (byte)uVar9;
    ...
    if ((uVar9 & 0x3f) < 0x3c) {
      ossl_extract_multiplier_2x20_win5(local_29c0,local_2880,uVar6 & 0x1f,0);
      uVar6 = (uint)(local_2bb8[iVar8] >> (bVar4 & 0x3f));
    }
    else {
      bVar3 = 0x40 - (char)(uVar9 & 0x3f);
      ossl_extract_multiplier_2x20_win5
                (local_29c0,local_2880,
                 (uVar6 ^ (uint)(local_2c40[iVar8 + 1] << (bVar3 & 0x3f))) & 0x1f,0);
      uVar6 = (uint)(local_2bb8[iVar8 + 1] << (bVar3 & 0x3f)) ^
              (uint)(local_2bb8[iVar8] >> (bVar4 & 0x3f));
    }
    uVar9 = uVar9 - 5;
    ossl_extract_multiplier_2x20_win5(local_2920,local_2880,uVar6 & 0x1f,1);
    ossl_rsaz_amm52x20_x2_256(local_2b00,local_2b00,local_2b00,param_4,param_6);
    ossl_rsaz_amm52x20_x2_256(local_2b00,local_2b00,local_2b00,param_4,param_6);
    ossl_rsaz_amm52x20_x2_256(local_2b00,local_2b00,local_2b00,param_4,param_6);
    ossl_rsaz_amm52x20_x2_256(local_2b00,local_2b00,local_2b00,param_4,param_6);
    ossl_rsaz_amm52x20_x2_256(local_2b00,local_2b00,local_2b00,param_4,param_6);
    ossl_rsaz_amm52x20_x2_256(local_2b00,local_2b00,local_29c0,param_4,param_6);
  ...
  local_29c0[0] = 1;
  local_2920[0] = 1;
  ossl_rsaz_amm52x20_x2_256(param_1,local_2b00,local_29c0,param_4,param_6);
  OPENSSL_cleanse(local_2c40,0x110);
  OPENSSL_cleanse(local_2b00,0x140);
