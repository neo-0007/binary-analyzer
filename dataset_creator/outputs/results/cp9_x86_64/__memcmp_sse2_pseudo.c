    ...
    if ((uVar12 & 0xf) == 0) {
      if (param_1 < (ulong *)((ulong)pbVar14 & 0xffffffffffffffe0)) {
        if (((ulong)param_1 & 0x10) != 0) {
          ...
          if (uVar10 != 0) goto LAB_00717a50;
          param_1 = param_1 + 2;
          if ((ulong *)((ulong)pbVar14 & 0xffffffffffffffe0) == param_1) goto joined_r0x00717bb0;
        }
...
LAB_00717adc:
        if ((ulong *)((ulong)pbVar14 & 0xffffffffffffffc0) == param_1) goto LAB_007179fa;
        do {
          pbVar3 = (byte *)((long)param_1 + uVar12);
...
joined_r0x00717bb0:
  ...
  if ((param_3 & 1) != 0) {
    ...
    uVar9 = (uint)*pbVar14;
    param_3 = param_3 - 1;
    if (param_3 == 0) goto LAB_00717897;
