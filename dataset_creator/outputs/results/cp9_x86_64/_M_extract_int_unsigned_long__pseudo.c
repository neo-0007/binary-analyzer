...
LAB_006a0b96:
      ...
      if ((bVar22) || (*(wchar_t *)(lVar10 + 0xe4) == __c)) {
        ...
        if (((cVar7 != '\0') && (*(wchar_t *)(lVar10 + 0x4c) == __c)) ||
           (*(wchar_t *)(lVar10 + 0x48) == __c)) goto LAB_006a0ca9;
...
LAB_006a11f0:
          ...
          if (*(wchar_t *)(lVar10 + 0xf0) == __c) {
            ...
            if (*(ulong *)(local_68 + 0x18) <= uVar11) goto LAB_006a0f90;
LAB_006a0d38:
...
LAB_006a0d25:
            uVar11 = *(ulong *)(local_68 + 0x10);
            bVar18 = bVar19;
            if (uVar11 < *(ulong *)(local_68 + 0x18)) goto LAB_006a0d38;
LAB_006a0f90:
            (**(code **)(*(long *)local_68 + 0x50))();
            local_60 = L'\xffffffff';
            if (local_68 != (wstreambuf *)0x0) goto LAB_006a0d48;
            bVar19 = true;
          }
...
joined_r0x006a0d9a:
    ...
    uVar8 = 10;
    if (uVar21 != 8) goto LAB_006a0b6f;
    uVar8 = 0x10;
    cVar6 = istreambuf_iterator<wchar_t,std::char_traits<wchar_t>>::equal
                      ((istreambuf_iterator<wchar_t,std::char_traits<wchar_t>> *)&local_68,
                       (istreambuf_iterator *)&local_78);
    if (cVar6 == '\0') goto LAB_006a0b96;
    bVar22 = false;
    cVar7 = *(char *)(lVar10 + 0x20);
    __c = L'\0';
    bVar18 = false;
...
LAB_006a0e0f:
      if (uVar21 < 0xb) {
        if ((__c < L'0') || ((int)local_98 + L'0' <= __c)) goto LAB_006a11e0;
        uVar8 = __c + L'\xffffffd0';
LAB_006a0e30:
        if (uVar11 < uVar12) goto LAB_006a0e3a;
LAB_006a1018:
        ...
        local_80 = local_80 + 1;
        if (*(ulong *)(local_68 + 0x18) <= uVar16) goto LAB_006a1048;
LAB_006a0e52:
...
LAB_006a0e62:
        ...
        if (*(int **)(local_68 + 0x10) < *(int **)(local_68 + 0x18)) {
          iVar9 = **(int **)(local_68 + 0x10);
                    ...
                    /* try { // try from 006a14c5 to 006a14df has its CatchHandler @ 006a1548 */
          iVar9 = (**(code **)(*(long *)local_68 + 0x48))();
        }
        bVar19 = false;
        if (iVar9 == -1) {
        ...
        if (uVar12 <= uVar11) goto LAB_006a1018;
LAB_006a0e3a:
        local_7b = 1;
        uVar16 = *(ulong *)(local_68 + 0x10);
        if (uVar16 < *(ulong *)(local_68 + 0x18)) goto LAB_006a0e52;
LAB_006a1048:
                    /* try { // try from 006a1058 to 006a13b9 has its CatchHandler @ 006a1548 */
        (**(code **)(*(long *)local_68 + 0x50))();
        local_60 = L'\xffffffff';
        if (local_68 != (wstreambuf *)0x0) goto LAB_006a0e62;
        bVar19 = true;
      }
      bVar17 = local_78 != (long *)0x0 && (int)local_70 == -1;
      bVar15 = (int)local_70 == -1;
        ...
        if ((local_60 == L'\xffffffff') && (local_68 != (wstreambuf *)0x0)) {
          if (*(wchar_t **)(local_68 + 0x10) < *(wchar_t **)(local_68 + 0x18)) {
            __c = **(wchar_t **)(local_68 + 0x10);
                    ...
                    /* try { // try from 006a150e to 006a1510 has its CatchHandler @ 006a1548 */
            __c = (**(code **)(*(long *)local_68 + 0x48))();
          }
          if (__c == L'\xffffffff') {
            local_68 = (wstreambuf *)0x0;
    ...
    if ((cVar20 != '\0') && (*(wchar_t *)(lVar10 + 0x4c) == __c)) goto LAB_006a12f7;
LAB_006a1236:
    if ((__c != *(wchar_t *)(lVar10 + 0x48)) &&
      ...
      local_7b = bVar5;
      uVar16 = *(ulong *)(local_68 + 0x10);
      if (*(ulong *)(local_68 + 0x18) <= uVar16) goto LAB_006a1331;
      do {
        *(ulong *)(local_68 + 0x10) = uVar16 + 4;
        while( true ) {
          local_60 = L'\xffffffff';
          cVar7 = istreambuf_iterator<wchar_t,std::char_traits<wchar_t>>::equal
                            (local_b8,(istreambuf_iterator *)local_a0);
          cVar20 = cVar6;
          if (cVar7 != '\0') goto LAB_006a0ea9;
          __c = istreambuf_iterator<wchar_t,std::char_traits<wchar_t>>::_M_get(local_b8);
          cVar20 = *(char *)(lVar10 + 0x20);
          if ((cVar20 == '\0') || (*(wchar_t *)(lVar10 + 0x4c) != __c)) goto LAB_006a1236;
LAB_006a12f7:
          if (local_80 == 0) {
            cVar7 = '\0';
            goto LAB_006a0ea9;
...
LAB_006a1152:
    ...
    if (((local_80 != 0) || (bVar18)) || (*(long *)(local_48 + -0x18) != 0)) goto LAB_006a1152;
  }
  *param_8 = 0;
  *param_7 = 4;
LAB_006a0ee9:
