...
ulong __gconv_transform_internal_ucs2
    ...
    *(undefined8 *)param_2[4] = 0;
    if ((param_2[2] & 1) == 0) {
      ...
      if (local_40[0] == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x006d1ac7. Too many branches */
      ...
      do {
        ...
        if (param_4 < puVar11) {
          ...
          *param_3 = (ulong)puVar12;
          if (param_5 == (ulong *)0x0) goto LAB_006d15b4;
          goto LAB_006d1682;
        }
        puVar1 = puVar14 + 1;
        if (puVar4 < puVar1) {
        ...
        if (uVar3 < 0x10000) {
          if (uVar3 - 0xd800 < 0x800) {
            if ((plVar10 == (long *)0x0) || ((uVar6 & 2) == 0)) goto LAB_006d16fa;
            *plVar10 = *plVar10 + 1;
            uVar7 = 6;
            local_58 = puVar11;
          }
...
LAB_006d16fa:
          ...
          if (((param_2[2] & 8) == 0) ||
             ...
             puVar12 = local_58, puVar14 = local_50, uVar7 == 6)) {
            if ((uVar6 & 2) == 0) goto LAB_006d16fa;
            uVar7 = 6;
            local_58 = puVar12 + 1;
            *plVar10 = *plVar10 + 1;
            puVar11 = puVar12 + 1;
    ...
    *(int *)((long)param_2 + 0x14) = *(int *)((long)param_2 + 0x14) + 1;
    if ((param_2[2] & 1) == 0) {
      if (puVar20 < puVar14) {
        ...
        _dl_mcount_wrapper_check(local_a0);
        uVar6 = (*local_a0)(param_1 + 0x68,param_2 + 6,&local_60,puVar14,0,param_6,0,param_8);
        puVar1 = local_60;
        if (uVar6 != 4) {
          uVar7 = uVar6;
          if (local_60 != puVar14) {
            ...
            if (lVar13 + local_68 == lVar18) {
              *param_3 = *param_3 + ((long)puVar14 - (long)local_60) * -2;
            }
            else {
              local_58 = puVar19;
              local_50 = puVar20;
...
LAB_006d1a0f:
              ...
              while( true ) {
                puVar11 = puVar19 + 1;
                if (param_4 < puVar11) goto LAB_006d19fe;
                puVar2 = puVar14 + 1;
                if (puVar1 < puVar2) break;
                uVar3 = *puVar19;
                if (uVar3 < 0x10000) {
                  if (uVar3 - 0xd800 < 0x800) {
                    if ((plVar10 == (long *)0x0) || (uVar6 == 0)) goto LAB_006d19fe;
                    local_58 = puVar11;
                    *plVar10 = *plVar10 + 1;
                  }
                  else {
                  ...
                  if (plVar10 == (long *)0x0) goto LAB_006d19fe;
                  if (((param_2[2] & 8) == 0) ||
                     (iVar8 = __gconv_transliterate
                                        (param_1,param_2,*param_3,&local_58,param_4,&local_50,
                                         plVar10), puVar14 = local_50, puVar19 = local_58,
                     iVar8 == 6)) {
                    if (uVar6 == 0) goto LAB_006d19fe;
                    local_58 = puVar19 + 1;
                    *plVar10 = *plVar10 + 1;
                    puVar11 = puVar19 + 1;
                  }
              ...
              *param_3 = (ulong)puVar19;
              if (puVar14 != local_60) goto LAB_006d1a0f;
              if (puVar20 == puVar14) {
                *(int *)((long)param_2 + 0x14) = *(int *)((long)param_2 + 0x14) + -1;
              }
            }
        ...
        if (uVar7 != 5) goto LAB_006d1641;
      }
      else {
LAB_006d1641:
        if (uVar7 != 0) goto LAB_006d1824;
      }
      uVar6 = (uint)param_2[2];
      puVar19 = (uint *)*param_3;
      puVar20 = (undefined2 *)*param_2;
      goto LAB_006d1508;
    }
    *param_2 = (ulong)puVar14;
...
LAB_006d1824:
    if ((param_8 != 0) && (uVar7 == 7)) {
      ...
      if (4 < uVar15) {
        ...
        __assert_fail("cnt_after <= sizeof (data->__statep->__value.__wchb)","../iconv/skeleton.c",
                      0x31e,"__gconv_transform_internal_ucs2");
      }
    ...
    if ((*puVar11 & 7) == 0) goto LAB_006d1508;
    if (param_5 != (ulong *)0x0) {
                    /* WARNING: Subroutine does not return */
    ...
    local_44 = CONCAT31(local_44._1_3_,(byte)puVar11[1]);
    if ((*puVar11 & 6) == 0) {
      if ((uint *)((long)puVar19 + 3U) <= param_4) {
        if (puVar4 < puVar20 + 1) goto LAB_006d17de;
        lVar18 = 1;
LAB_006d1b04:
        local_b8 = lVar18 + 1;
...
LAB_006d1b7f:
        ...
        if (local_44 < 0x10000) {
          if (0x7ff < local_44 - 0xd800) {
            *puVar20 = (short)local_44;
            local_50 = puVar20 + 1;
            goto LAB_006d1bc4;
          }
          if ((plVar10 == (long *)0x0) || ((uVar6 & 2) == 0)) goto LAB_006d1df5;
                ...
                if (uVar7 != 6) {
                  if (local_58 == &local_44) {
                    ...
                    /* WARNING: Subroutine does not return */
                      ...
                      uVar6 = *puVar11 & 0xfffffff8;
                      *param_3 = *param_3 + (local_b8 - (*puVar11 & 7));
                      if ((long)local_b8 <= (long)(int)uVar6) {
                    /* WARNING: Subroutine does not return */
                        __assert_fail("inend - inptr > (state->__count & ~7)","../iconv/loop.c",
                                      0x1ec,"internal_ucs2_loop_single");
                      }
                      if (4 < local_b8) {
                    /* WARNING: Subroutine does not return */
                        __assert_fail("inend - inptr <= sizeof (state->__value.__wchb)",
                                      "../iconv/loop.c",0x1ed,"internal_ucs2_loop_single");
                      }
                      *puVar11 = uVar6 | (uint)local_b8;
                      if (local_b8 != 0) {
                        *(byte *)(puVar11 + 1) = (byte)local_44;
                        if (local_b8 != 1) {
                          *(byte *)((long)puVar11 + 5) = local_44._1_1_;
                          if (local_b8 != 2) {
                            *(byte *)((long)puVar11 + 6) = local_44._2_1_;
                            if (local_b8 == 4) {
                              *(byte *)((long)puVar11 + 7) = local_44._3_1_;
                            }
                          }
                        }
                      }
...
LAB_006d1f7d:
                ...
                if ((uVar6 & 2) == 0) {
                  if (local_58 != &local_44) goto LAB_006d1f7d;
                }
                else {
                  puVar19 = local_58 + 1;
                  local_58 = puVar19;
                  *plVar10 = *plVar10 + 1;
                  if (puVar19 != &local_44) goto LAB_006d1dcf;
                }
              }
            }
LAB_006d1df5:
...
LAB_006d1e4e:
      ...
      if (pbVar17 < pbVar16) {
        ...
        *(byte *)((long)puVar11 + (long)(pbVar17 + 4)) = (byte)*puVar19;
        if (pbVar17 + 1 < pbVar16) {
          local_58 = (uint *)((long)puVar19 + 2);
          *(byte *)((long)puVar11 + (long)(pbVar17 + 5)) = *(byte *)((long)puVar19 + 1);
          if ((byte *)((ulong)(pbVar17 + 1 != (byte *)0x2) + 3) < pbVar16) {
            local_58 = (uint *)((long)puVar19 + 3);
            *(byte *)((long)puVar11 + 7) = *(byte *)((long)puVar19 + 2);
          }
        }
      }
LAB_006d1ef3:
      ...
      local_44._0_2_ = CONCAT11(*(byte *)((long)puVar11 + 5),(byte)puVar11[1]);
      if ((*puVar11 & 7) < 3) {
        ...
        lVar18 = 2;
        if (puVar20 + 1 <= puVar4) goto LAB_006d1b04;
      }
      else {
        local_44._3_1_ = SUB41(uVar7,3);
        local_44._0_3_ = CONCAT12(*(byte *)((long)puVar11 + 6),(undefined2)local_44);
        if ((*puVar11 & 4) == 0) {
          ...
          local_44 = CONCAT13(*(byte *)((long)puVar11 + 7),(undefined3)local_44);
          if (param_4 < puVar19) {
            *param_3 = (ulong)param_4;
            if ((byte *)0x4 < (byte *)((long)param_4 + (4 - (long)puVar19))) goto LAB_006d1e4e;
            goto LAB_006d1ef3;
          }
        }
      }
