...
undefined8 _vpaes_encrypt_core(undefined8 param_1,undefined8 param_2,undefined1 (*param_3) [16])

{
  ...
  auVar7 = pshufb(_DAT_0049a470,in_XMM0 & in_XMM9);
  auVar5 = pshufb(_DAT_0049a480,auVar6);
  pauVar3 = param_3 + 1;
  ...
  while( true ) {
    ...
    auVar6 = pshufb(auVar7,*(undefined1 (*) [16])(&DAT_0049a4f0 + uVar4));
    pauVar3 = pauVar3 + 1;
    auVar6 = auVar6 ^ auVar5 ^ auVar8;
    auVar7 = pshufb(auVar7,*(undefined1 (*) [16])(&DAT_0049a530 + uVar4));
    auVar5 = pshufb(auVar6,*(undefined1 (*) [16])(&DAT_0049a4f0 + uVar4));
    uVar4 = uVar4 + 0x10 & 0x30;
    pauVar2 = (undefined1 (*) [16])(pauVar2[-1] + 0xf);
    auVar5 = auVar5 ^ auVar7 ^ auVar6;
    pauVar1 = pauVar2;
  }
  auVar6 = pshufb(_DAT_0049a4d0,auVar6);
  auVar5 = pshufb(_DAT_0049a4e0,auVar5);
  auVar5 = pshufb(auVar5 ^ auVar6 ^ *pauVar3,*(undefined1 (*) [16])(&DAT_0049a570 + uVar4));
  return auVar5._0_8_;
}
