...

{
  ...
  do {
    local_48 = 0;
    plVar6 = (long *)ossl_provider_query_operation(param_1,iVar7,&local_48);
    uVar3 = local_48;
    local_44 = 0;
...
LAB_0041658b:
      ...
      if (*(code **)(param_2 + 0x20) == (code *)0x0) goto LAB_00416630;
      iVar5 = (**(code **)(param_2 + 0x20))
                        (param_1,iVar7,uVar3,*(undefined8 *)(param_2 + 0x28),&local_44);
      iVar4 = local_44;
      if (iVar5 == 0) goto LAB_0041664d;
      ossl_provider_unquery_operation(param_1,iVar7,plVar6);
      if (iVar4 < 0) goto LAB_0041665a;
      uVar3 = 0;
      if (iVar4 != 0) {
        uVar3 = local_58;
      }
...
LAB_0041665a:
      ...
      if (local_44 != 0) goto LAB_0041658b;
LAB_00416630:
      ossl_provider_unquery_operation(param_1,iVar7,plVar6);
      uVar3 = local_58;
    }
