...
undefined8 __ocb_encrypt1(undefined8 param_1,undefined8 param_2)

{
  ...
  auVar11 = aesenc(auVar11,auVar1);
  aesenclast(auVar11,in_XMM7 ^ in_XMM15);
  return auVar2._0_8_;
}
