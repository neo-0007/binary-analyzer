...
undefined8 d_maybe_print_fold_expression(long param_1,undefined8 param_2,long param_3)
  ...
  if (cVar1 == 'l') {
    ...
    while( true ) {
      ...
      *(undefined1 *)(param_1 + 0x108) = uVar11;
      if (puVar9 == &DAT_00817e60) break;
      uVar11 = *puVar9;
      lVar6 = lVar5;
    }
    d_print_expr_op(param_1,0x11,uVar4);
  }
  else {
    if ('l' < cVar1) {
      if (cVar1 == 'r') {
        ...
        *(undefined1 *)(param_1 + 0x108) = 0x28;
        d_print_subexpr(param_1,0x11,piVar7);
        d_print_expr_op(param_1,0x11,uVar4);
        uVar11 = 0x2e;
        lVar6 = *(long *)(param_1 + 0x100);
        while( true ) {
    ...
    if ((cVar1 != 'L') && (cVar1 != 'R')) goto LAB_006c0529;
    lVar6 = *(long *)(param_1 + 0x100);
    if (lVar6 == 0xff) {
      *(undefined1 *)(param_1 + 0xff) = 0;
      (**(code **)(param_1 + 0x110))(param_1,0xff,*(undefined8 *)(param_1 + 0x118));
