...
/* WARNING: Removing unreachable block (ram,0x0072b175) */
...

{
  ...
  if ((*(uint *)(*param_3 + 0x278) & 1) != 0) {
    if (param_1 == param_2) {
      ...
      do {
        ...
        uVar12 = *(int *)(param_3[0xe] + (ulong)*pbVar1 * 4) -
                 *(int *)(param_3[0xe] + (ulong)(byte)(*param_2)[lVar16] * 4);
        uVar11 = (ulong)uVar12;
        if (uVar12 != 0) {
          return uVar11;
        }
  ...
  if (((uVar12 & 0x3f) < 0x31) && ((uVar9 & 0x3f) < 0x31)) {
    auVar2 = *param_1;
    auVar3 = *param_2;
    auVar4 = vpcmpgtb_avx(auVar2,_DAT_008219d0);
    auVar5 = vpcmpgtb_avx(auVar2,_DAT_00821ac0);
    auVar6 = vpcmpgtb_avx(auVar3,_DAT_008219d0);
    auVar7 = vpcmpgtb_avx(auVar3,_DAT_00821ac0);
    auVar4 = vpandn_avx(auVar5,auVar4);
    auVar5 = vpandn_avx(auVar7,auVar6);
    auVar4 = vpand_avx(auVar4,_DAT_008219f0);
    auVar5 = vpand_avx(auVar5,_DAT_008219f0);
  ...
  if (uVar12 != uVar9) {
    ...
    auVar2 = vpcmpeqb_avx((undefined1  [16])0x0,*pauVar17);
                    /* WARNING: Could not recover jumptable at 0x00729c49. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    uVar11 = (*(code *)(&DAT_00821ad0 + *(int *)(&DAT_00821ad0 + ((uVar10 + 0xf) - uVar13) * 4)))
  ...
  auVar4 = vpcmpgtb_avx(auVar2,_DAT_008219d0);
  auVar5 = vpcmpgtb_avx(auVar2,_DAT_00821ac0);
  auVar7 = vpcmpgtb_avx(auVar3,_DAT_008219d0);
  auVar8 = vpcmpgtb_avx(auVar3,_DAT_00821ac0);
  auVar4 = vpandn_avx(auVar5,auVar4);
  ...
  if (bVar19) {
    lVar16 = 0x10;
    do {
      auVar2 = *(undefined1 (*) [16])(*param_1 + lVar16);
      auVar3 = *(undefined1 (*) [16])(*param_2 + lVar16);
      auVar4 = vpcmpgtb_avx(auVar2,_DAT_008219d0);
      auVar5 = vpcmpgtb_avx(auVar2,_DAT_00821ac0);
      auVar6 = vpcmpgtb_avx(auVar3,_DAT_008219d0);
      auVar7 = vpcmpgtb_avx(auVar3,_DAT_00821ac0);
      ...
      auVar2 = *(undefined1 (*) [16])(param_1[1] + lVar16);
      auVar3 = *(undefined1 (*) [16])(param_2[1] + lVar16);
      auVar4 = vpcmpgtb_avx(auVar2,_DAT_008219d0);
      auVar5 = vpcmpgtb_avx(auVar2,_DAT_00821ac0);
      auVar6 = vpcmpgtb_avx(auVar3,_DAT_008219d0);
      auVar7 = vpcmpgtb_avx(auVar3,_DAT_00821ac0);
    ...
    if (bVar18) {
      return (ulong)(uint)(*(int *)(_nl_C_LC_CTYPE_tolower +
                                   (ulong)(byte)(*param_1)[lVar15] * 4 + 0x200) -
                          *(int *)(_nl_C_LC_CTYPE_tolower +
                                  (ulong)(byte)(*param_2)[lVar15] * 4 + 0x200));
    }
    return 0;
  }
...
LAB_0072b180:
  ...
  return (ulong)(uint)(*(int *)(_nl_C_LC_CTYPE_tolower + (ulong)(byte)(*param_1)[lVar16] * 4 + 0x200
                               ) -
                      *(int *)(_nl_C_LC_CTYPE_tolower + (ulong)(byte)(*param_2)[lVar16] * 4 + 0x200)
                      );
}
