...
int * get_free_list(FILE *param_1)

{
  ...
  if (free_list != (int *)0x0) {
    LOCK();
    bVar17 = free_list_lock == 0;
    if (bVar17) {
      free_list_lock = 1;
    }
    UNLOCK();
    if (!bVar17) {
      param_1 = (FILE *)&free_list_lock;
      __lll_lock_wait_private();
    }
    piVar13 = free_list;
    if (free_list != (int *)0x0) {
      if (*(long *)(free_list + 0x220) != 0) {
        free_list = *(int **)(free_list + 0x21e);
                    /* WARNING: Subroutine does not return */
        __malloc_assert("result->attached_threads == 0","arena.c",0x335,"get_free_list");
      }
      free_list = *(int **)(free_list + 0x21e);
      piVar13[0x220] = 1;
      piVar13[0x221] = 0;
      if (lVar16 != 0) {
        if (*(long *)(lVar16 + 0x880) == 0) {
          ...
          do {
            ...
            UNLOCK();
            if (iVar2 != 0) {
              __lll_lock_wait_private(piStack_1200);
            }
            lStack_11e8 = 0;
            lStack_11e0 = 0;
...
LAB_00702a00:
            ...
            *piStack_1200 = 0;
            ...
            if (piStack_1200 == &main_arena) {
              ...
              lStack_1190 = DAT_00931a08;
              fputs("</heap>\n",param_1);
              piStack_1200 = (int *)PTR_main_arena_009319f0;
              lVar15 = lStack_1190;
            }
            else {
              fprintf(param_1,
            ...
            if (piStack_1200 == &main_arena) {
              fprintf(param_1,
                      ...
                      ,lStack_11d0,lStack_11c8,lStack_11c0,lStack_11b8,(ulong)DAT_0093111c,
                      DAT_00931130,lStack_11b0,lStack_11a8,lStack_11a0,lStack_1198);
    ...
    if (piVar13 != (int *)0x0) {
      ...
      UNLOCK();
      if (iVar2 != 0) {
        __lll_lock_wait_private(piVar13);
      }
