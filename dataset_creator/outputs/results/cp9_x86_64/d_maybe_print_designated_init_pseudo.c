...
undefined8 d_maybe_print_designated_init(long param_1,undefined8 param_2,uint *param_3)
    ...
    if (*pcVar2 == 'd') {
      ...
      if (((bVar1 & 0xdf) == 0x58) || (bVar1 == 0x69)) {
        ...
        *(undefined1 *)(param_1 + 0x108) = uVar3;
        d_print_comp(param_1,0x11,uVar8);
        cVar4 = pcVar2[1];
        if (cVar4 == 'X') {
          puVar7 = &DAT_00817e66;
          uVar3 = 0x20;
          ...
          while( true ) {
            ...
            *(undefined1 *)(param_1 + 0x108) = uVar3;
            if (puVar7 == &DAT_00817e6b) break;
            uVar3 = *puVar7;
            lVar5 = lVar6;
          }
          d_print_comp(param_1,0x11,*(undefined8 *)(puVar9 + 4));
        ...
        if ((((*puVar9 & 0xfffffffd) == 0x38) &&
          ...
          d_print_comp(param_1,0x11,puVar9);
          uVar8 = 1;
        }
        else {
          lVar5 = *(long *)(param_1 + 0x100);
          ...
          *(undefined1 *)(param_1 + 0x108) = 0x3d;
          d_print_subexpr(param_1,0x11,puVar9);
          uVar8 = 1;
        }
      }
    }
