...

{
  ...
  if (local_48[0] != (sentry)0x0) {
    ...
    if (plVar1 == (long *)0x0) {
                    ...
                    /* try { // try from 0068de0e to 0068de17 has its CatchHandler @ 0068de18 */
      __throw_bad_cast();
    }
    if (pwVar8[0xe4] == (wostream)0x0) {
      ...
      if (plVar3 == (long *)0x0) {
        ...
        __throw_bad_cast();
                    ...
                    /* try { // try from 0068ddc4 to 0068ddc6 has its CatchHandler @ 0068de18 */
      ...
      *(undefined4 *)(pwVar8 + 0xe0) = uVar6;
      ...
      uVar6 = *(undefined4 *)(pwVar8 + 0xe0);
                    ...
                    /* try { // try from 0068dd36 to 0068dd38 has its CatchHandler @ 0068de18 */
    (**(code **)(*plVar1 + 0x18))
              (plVar1,*(long *)(pwVar8 + 0xe8),*(long *)(pwVar8 + 0xe8) == 0,pwVar8,uVar6,param_1);
    if (extraout_DL != '\0') {
                    /* try { // try from 0068dd4e to 0068dd52 has its CatchHandler @ 0068de24 */
