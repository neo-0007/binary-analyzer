...

{
  ...
  uVar11 = (ulong)(uVar6 < DAT_005eb008 || uVar6 - DAT_005eb008 < (ulong)(uVar5 < DAT_005eb000));
  uVar2 = uVar8 - DAT_005eb010;
  uVar1 = (ulong)(uVar8 < DAT_005eb010 || uVar2 < uVar11);
  uVar3 = uVar10 - DAT_005eb018;
  bVar4 = (CARRY8(uVar7,uVar7) || CARRY8(uVar7 * 2,uVar9)) <
          (uVar10 < DAT_005eb018 || uVar3 < uVar1);
  uVar7 = (uVar6 - DAT_005eb008) - (ulong)(uVar5 < DAT_005eb000);
  uVar9 = uVar5 - DAT_005eb000;
  if (bVar4) {
    uVar7 = uVar6;
    uVar9 = uVar5;
  }
