...

{
  ...
  if (local_c8 == 0) {
    ...
    if (iVar15 != 0) {
      ...
      uVar17 = *local_c0;
      if (local_c0 + 1 <= param_5) goto LAB_006d3cac;
      goto LAB_006d3b37;
    }
...
LAB_006d3b48:
    ...
    do {
      ...
      while (*puVar11 == uVar2) {
        ...
        if (uVar2 == 0) goto LAB_006d3b80;
        puVar11 = puVar11 + 1;
        if (param_5 <= puVar11) goto LAB_006d3b48;
      }
      puVar11 = local_c0;
      if (iVar15 != 0) {
        if (uVar2 != 0) goto LAB_006d3b48;
LAB_006d3b80:
