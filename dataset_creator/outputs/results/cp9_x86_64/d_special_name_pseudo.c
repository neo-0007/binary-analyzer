...
undefined8 d_special_name(long param_1)
  ...
  *(int *)(param_1 + 0x48) = iVar4 + 0x14;
  ...
  if (*pcVar3 == 'T') {
    *(char **)(param_1 + 0x18) = pcVar3 + 1;
    if (pcVar3[1] == '\0') {
switchD_006b9e09_caseD_42:
      return 0;
    }
    *(char **)(param_1 + 0x18) = pcVar3 + 2;
    switch(pcVar3[1]) {
    case 'A':
      puVar5 = (undefined4 *)d_template_arg();
      puVar11 = (undefined4 *)0x0;
      uVar7 = 0x30;
      break;
    default:
      goto switchD_006b9e09_caseD_42;
    case 'C':
      puVar11 = (undefined4 *)d_type();
      ...
      *(char **)(param_1 + 0x18) = *(char **)(param_1 + 0x18) + 1;
      puVar5 = (undefined4 *)d_type(param_1);
      *(int *)(param_1 + 0x48) = *(int *)(param_1 + 0x48) + 5;
      uVar7 = 0xb;
      break;
    case 'F':
      puVar5 = (undefined4 *)d_type();
      puVar11 = (undefined4 *)0x0;
      uVar7 = 0xe;
      break;
    case 'H':
      puVar5 = (undefined4 *)d_name();
      puVar11 = (undefined4 *)0x0;
      uVar7 = 0x14;
      break;
    case 'I':
    ...
    case 'c':
      ...
      if ((**(char **)(param_1 + 0x18) == 'G') || (**(char **)(param_1 + 0x18) == 'T')) {
        puVar5 = (undefined4 *)d_special_name(param_1);
      }
      else {
        puVar5 = (undefined4 *)d_encoding_part_0(param_1,0);
      }
      puVar11 = (undefined4 *)0x0;
      uVar7 = 0x11;
      break;
    case 'h':
      iVar4 = d_call_offset(param_1,0x68);
      if (iVar4 == 0) {
        return 0;
      }
      if ((**(char **)(param_1 + 0x18) == 'G') || (**(char **)(param_1 + 0x18) == 'T')) {
      ...
      break;
    case 'v':
      iVar4 = d_call_offset(param_1,0x76);
      if (iVar4 == 0) {
        return 0;
      }
      if ((**(char **)(param_1 + 0x18) == 'G') || (**(char **)(param_1 + 0x18) == 'T')) {
      ...
      do {
        ...
        if (*pcVar9 == '$') {
          ...
          *(char **)(param_1 + 0x18) = pcVar9;
          ...
          puVar5 = (undefined4 *)d_make_name(param_1,pcVar9,uVar8 & 0xffffffff);
        ...
        if ((puVar11 != (undefined4 *)0x0) &&
           (puVar5 = (undefined4 *)d_make_comp(param_1,0x41,puVar11), puVar5 == (undefined4 *)0x0))
        {
          return 0;
        }
        puVar11 = puVar5;
...
LAB_006ba130:
    ...
    *(char **)(param_1 + 0x18) = pcVar3 + 3;
    ...
    if ((cVar1 != 'G') && (cVar1 != 'T')) goto LAB_006ba130;
    puVar5 = (undefined4 *)d_special_name(param_1);
  }
  puVar11 = (undefined4 *)0x0;
  uVar7 = 0x4a;
LAB_006b9de7:
  uVar7 = d_make_comp(param_1,uVar7,puVar5,puVar11);
  return uVar7;
}
