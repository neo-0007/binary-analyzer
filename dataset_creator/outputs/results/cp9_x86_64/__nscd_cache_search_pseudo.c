...

{
  ...
  uVar7 = __nss_hash(param_2,param_3);
  uVar4 = param_4[4];
  ...
  while( true ) {
    ...
    if ((((*pbVar1 == param_1) && ((long)*(int *)(pbVar1 + 4) == param_3)) &&
        (*(uint *)(pbVar1 + 8) + param_3 <= uVar4)) &&
       (iVar6 = bcmp(param_2,(void *)((ulong)*(uint *)(pbVar1 + 8) + lVar5),param_3), iVar6 == 0)) {
