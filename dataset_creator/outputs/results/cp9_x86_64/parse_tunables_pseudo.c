...
void parse_tunables(char *param_1,long param_2)
...
LAB_00783080:
        ...
        if (cVar16 != '\0') {
          do {
            pcVar5 = pcVar2;
            if ((*pcVar5 == '\0') || (*pcVar5 != cVar3)) goto LAB_007830be;
            cVar3 = pcVar14[1];
            pcVar14 = pcVar14 + 1;
            pcVar2 = pcVar5 + 1;
          } while (cVar3 != '\0');
        ...
        if (cVar4 != '=') goto LAB_007830be;
        if (local_5c == 0) goto LAB_007832cd;
        if ((&DAT_0092cef4)[lVar17 * 0x1c] != 0) {
          if (local_50 == 0) {
            lVar11 = 1;
            pcVar7 = param_1;
          }
...
LAB_0078322a:
              ...
              if (uVar13 != uVar9) {
                uVar8 = uVar13 - uVar9;
                if (6 < (uVar13 - uVar9) - 1) goto LAB_00783204;
                goto LAB_0078322a;
              }
            }
            local_50 = local_50 + uVar13;
          }
          if ((&DAT_0092cef4)[lVar17 * 0x1c] == 2) {
LAB_007832cd:
            pcVar10[uVar13] = '\0';
            if (*(int *)(&DAT_0092ced0 + lVar17 * 0x70) != 3) {
              pcVar10 = (char *)_dl_strtoul(pcVar10,0);
            }
            local_40[0] = pcVar10;
            do_tunable_update_val(pcVar19,local_40,0,0);
          }
          local_5c = __libc_enable_secure;
        }
        goto LAB_007830d0;
...
LAB_007830be:
  ...
  if (lVar17 == 0x23) {
LAB_007830d0:
    if (*pcVar20 == '\0') goto LAB_00782ff4;
