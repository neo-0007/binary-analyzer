...
num_get * std::use_facet<std::num_get<char,std::istreambuf_iterator<char,std::char_traits<char>>>>
                    (locale *param_1)

{
  ...
  uVar2 = locale::id::_M_id((id *)&num_get<char,std::istreambuf_iterator<char,std::char_traits<char>>>
                                   ::id);
